...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/jonasblunck/AL-Go/private/jonasbl/warn/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/jonasblunck/AL-Go/private/jonasbl/warn/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/jonasblunck/AL-Go/private/jonasbl/warn/Actions/Packages.json' -folder $tmpFolder | Out-Null
