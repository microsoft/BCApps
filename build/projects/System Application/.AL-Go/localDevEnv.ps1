...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/optimize-localdevenv/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/optimize-localdevenv/Actions/AL-Go-Helper.ps1'
