...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go-Actions/optimize-localdevenv/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go-Actions/optimize-localdevenv/AL-Go-Helper.ps1'
