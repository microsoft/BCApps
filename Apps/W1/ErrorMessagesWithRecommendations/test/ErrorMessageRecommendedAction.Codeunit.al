...
codeunit 139622 ErrorMessageRecommendedAction
{
    ...
    begin
        ...
        TempErrorMessageGlobalRec.TestField("Recommended Action Caption", 'Set the value to blank');
    ...
    begin
        ...
        Assert.ExpectedError('required to be blank');

        // [WHEN] User drills down on the recommended action and user confirms the action
        LibraryVariableStorage.Enqueue('has been deleted');
    ...
    begin
        ...
        // [THEN] Error dialog is raised
        Assert.ExpectedError('isn''t valid.');

        // [WHEN] User drills down on the recommended action and user confirms the action
        LibraryVariableStorage.Enqueue('has been set to');
        ErrorMessagesTestPage."Recommended Action".Drilldown(); //RecommendedActionDrillDownConfirmTrueHandler is used to confirm the action
        //OnSuccessMessageHandler is used to close the success message
    ...
    [Test]
    [HandlerFunctions('PostOrderStrMenuHandler,RecommendedActionDrillDownHandler,OnSuccessMessageHandler')]
    ...
    begin
        ...
        LibraryVariableStorage.Enqueue('has been deleted'); //OnSuccessMessageHandler is used to close the success message
