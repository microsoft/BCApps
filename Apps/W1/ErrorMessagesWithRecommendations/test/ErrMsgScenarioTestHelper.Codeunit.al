...
codeunit 139620 ErrMsgScenarioTestHelper
{
    ...
    internal procedure GetErrMsgTestPageFromPostingPO(var PurchaseHeader: Record "Purchase Header"; var ErrorMessagesTestPage: TestPage "Error Messages"; ErrScenario: Option DimMustBeBlank,DimMustBeSame,ErrFixNotImplemented)
    var
    ...
    begin
        case
            LibraryRandom.RandIntInRange(1, 2) of
            1:
