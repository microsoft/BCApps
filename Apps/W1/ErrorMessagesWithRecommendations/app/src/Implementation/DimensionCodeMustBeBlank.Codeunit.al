...
codeunit 7904 "Dimension Code Must Be Blank" implements ErrorMessageFix
{
    ...
    var
        ...
        DimSetEntryFixMustBeBlankAckTok: Label 'The %1 %2 has been deleted.', Comment = '%1 = "Dimension Entry Set", %2 = "Dimension Code" value';
        DimensionUseRequiredActionLbl: Label 'Set the value to blank';
        DimensionMismatchTitleErr: Label 'The %1 %2 isn''t valid.', Comment = '%1 = "Dimension Value Code" caption, %2 = Dim Code';
    ...
    begin
        exit(StrSubstNo(DimSetEntryFixMustBeBlankAckTok, TempDimSetEntryGbl.FieldCaption("Dimension Value Code"), TempDimSetEntryGbl."Dimension Value Code"));
    end;
