...
codeunit 4886 "EU3 Feature Data Update" implements "Feature Data Update"
{
    ...
    begin
        CountRecords(Database::"Purchase Header", PurchaseHeader.TableCaption, PurchaseHeader.FieldNo("EU 3-Party Trade"));
        CountRecords(Database::"Purch. Inv. Header", PurchInvHeader.TableCaption, PurchInvHeader.FieldNo("EU 3-Party Trade"));
        CountRecords(Database::"Purch. Cr. Memo Hdr.", PurchCrMemoHdr.TableCaption, PurchCrMemoHdr.FieldNo("EU 3-Party Trade"));
        CountRecords(Database::"VAT Statement Line", VATStatementLine.TableCaption, VATStatementLine.FieldNo("EU 3-Party Trade"));
    ...
    begin
        if Company.FindSet() then
            repeat
                UpdateRecords(Database::"Purchase Header", PurchaseHeader.FieldNo("EU 3-Party Trade"), PurchaseHeader.FieldNo("EU 3 Party Trade"), Company);
                UpdateRecords(Database::"Purch. Inv. Header", PurchInvHeader.FieldNo("EU 3-Party Trade"), PurchInvHeader.FieldNo("EU 3 Party Trade"), Company);
                UpdateRecords(Database::"Purch. Cr. Memo Hdr.", PurchCrMemoHdr.FieldNo("EU 3-Party Trade"), PurchCrMemoHdr.FieldNo("EU 3 Party Trade"), Company);
                UpdateRecords(Database::"VAT Statement Line", VATStatementLine.FieldNo("EU 3-Party Trade"), VATStatementLine.FieldNo("EU 3 Party Trade"), Company);
