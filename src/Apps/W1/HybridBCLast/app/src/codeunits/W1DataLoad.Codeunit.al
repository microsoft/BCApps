...
codeunit 4028 "W1 Data Load"
{
    ...
    begin
        ...
        LoadTableData_21x(HybridReplicationSummary, CountryCode, 21.0);
    end;
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"W1 Company Handler", 'OnLoadTableDataForVersion', '', false, false)]
    local procedure LoadTableData_21x(HybridReplicationSummary: Record "Hybrid Replication Summary"; CountryCode: Text; TargetVersion: Decimal)
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"W1 Management", 'OnLoadNonCompanyTableDataForVersion', '', false, false)]
    local procedure LoadNonCompanyTableData_21x(HybridReplicationSummary: Record "Hybrid Replication Summary"; CountryCode: Text; TargetVersion: Decimal)
    begin
        if TargetVersion <> 21.0 then
            exit;
