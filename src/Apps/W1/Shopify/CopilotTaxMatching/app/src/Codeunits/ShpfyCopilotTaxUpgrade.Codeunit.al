...
/// <summary>
/// Codeunit Shpfy Copilot Tax Upgrade (ID 30478).
/// Backfills the Copilot tax configuration defaults onto Shop records that already existed
...
/// </summary>
codeunit 30478 "Shpfy Copilot Tax Upgrade"
{
    Access = Internal;
    Subtype = Upgrade;
    ...
    /// <summary>
    /// New Shop records pick up the Copilot tax defaults from the field InitValues, but Shop
    ...
    /// any shops that already exist. The two intentionally-false defaults (Copilot Tax Matching
    ...
    /// <summary>
    /// Sets the InitValue-backed Copilot tax defaults on a single Shop. Reading them from an
    ...
    begin
        exit('MS-445769-CopilotTaxShopDefaults-20260720');
    end;
}
