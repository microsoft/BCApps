...
table 46888 "BC14 Old Vendor Ledg. Entry"
{
    Caption = 'BC14 Old Vendor Ledger Entry';
    DataClassification = CustomerContent;
    DrillDownPageId = "BC14 Old Vendor Ledg. List";
    LookupPageId = "BC14 Old Vendor Ledg. List";
