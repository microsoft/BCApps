...
table 46882 "BC14 Arch. Sales Inv. Header"
{
    Caption = 'BC14 Archived Sales Invoice Header';
    DataClassification = CustomerContent;
    DrillDownPageId = "BC14 Arch. Sales Inv. List";
    LookupPageId = "BC14 Arch. Sales Inv. List";
