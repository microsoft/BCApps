...
// /// <summary>
// /// Interface for PEPPOL 3.0 services export operations.
// /// Provides methods for calculating VAT totals and handling service-specific export functionality.
// /// </summary>
// interface "PEPPOL30 Services Export"
// {
//     /// <summary>
//     /// Calculates and retrieves VAT totals for a service document.
//     /// </summary>
