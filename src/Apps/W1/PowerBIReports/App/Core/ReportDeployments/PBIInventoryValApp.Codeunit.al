...
codeunit 36967 "PBI Inventory Val. App" implements "Power BI Deployable Report", "PBI Report Setup"
{
    Access = Internal;

    procedure GetReportName(): Text[200]
    begin
        exit('Inventory Valuation');
    end;

    procedure GetStream(var InStr: InStream)
    begin
        NavApp.GetResource('Inventory Valuation app.pbix', InStr);
    end;
    ...
    begin
        exit(Enum::"Power BI Deployable Report"::"Inventory Valuation App");
    end;
    ...
    begin
        exit(PowerBIReportsSetup.FieldNo("Inventory Val. Report Id"));
    end;
    ...
    var
        PowerBIReportsSetup: Record "PowerBI Reports Setup";
    begin
        exit(PowerBIReportsSetup.FieldNo("Inventory Val. Report Name"));
    end;
}
