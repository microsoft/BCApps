...
pageextension 20405 "Qlty. Sales Order Subform" extends "Sales Order Subform"
{
    actions
    {
        addafter("O&rder")
        {
            group(Qlty_Management)
            {
                ...
                action(Qlty_InspectionTestCreate)
                {
                    ...
                    ToolTip = 'Creates a quality inspection test for this sales order line.';
                    AboutTitle = 'Create Quality Inspection Test';
                    AboutText = 'Create a quality inspection test for this sales order line.';
