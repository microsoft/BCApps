...
/// <summary>
/// Provides person contact information lookup across multiple Business Central person-related tables.
/// Searches Contact, Employee, Resource, User, User Setup, and Salesperson/Purchaser records.
/// </summary>
codeunit 20592 "Qlty. Person Lookup"
{
    /// <summary>
