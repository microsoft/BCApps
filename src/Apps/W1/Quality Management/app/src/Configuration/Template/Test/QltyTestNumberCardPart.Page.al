            ...
            group(SettingsForPassConditions)
            {
                ...
                group(SettingsForVisible1)
                {
                    ...
                    group(SettingsForVisible1Easy)
                    {
                        ...
                        field(ChooseMin1; MatrixMinValue[1])
                        {
                            ...
                            CaptionClass = '3,' + MatrixArrayCaptionSet[1] + ' ' + MinLbl;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                            ShowCaption = true;
                            ShowMandatory = true;
                        ...
                        field(ChooseMax1; MatrixMaxValue[1])
                        {
                            ...
                            CaptionClass = '3,' + MatrixArrayCaptionSet[1] + ' ' + MaxLbl;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                            ShowCaption = true;
                            ShowMandatory = true;
                ...
                group(SettingsForVisible2)
                {
                    ...
                    group(SettingsForVisible2Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[2] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[2] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible3)
                {
                    ...
                    group(SettingsForVisible3Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[3] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[3] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible4)
                {
                    ...
                    group(SettingsForVisible4Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[4] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[4] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible5)
                {
                    ...
                    group(SettingsForVisible5Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[5] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[5] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible6)
                {
                    ...
                    group(SettingsForVisible6Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[6] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[6] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible7)
                {
                    ...
                    group(SettingsForVisible7Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[7] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[7] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible8)
                {
                    ...
                    group(SettingsForVisible8Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[8] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[8] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible9)
                {
                    ...
                    group(SettingsForVisible9Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[9] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[9] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                ...
                group(SettingsForVisible10)
                {
                    ...
                    group(SettingsForVisible10Easy)
                    {
                        ...
                        {
                            ToolTip = 'Specifies the minimum allowed value for this result. ';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[10] + ' ' + MinLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
                        ...
                        {
                            ToolTip = 'Specifies the maximum allowed value for this result.';
                            CaptionClass = '3,' + MatrixArrayCaptionSet[10] + ' ' + MaxLbl;
                            ShowCaption = true;
                            ShowMandatory = true;
                            AutoFormatType = 0;
                            DecimalPlaces = 0 : 5;
