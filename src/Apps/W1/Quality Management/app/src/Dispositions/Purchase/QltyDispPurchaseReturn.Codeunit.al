...
codeunit 20441 "Qlty. Disp. Purchase Return" implements "Qlty. Disposition"
{
    ...
    procedure OnBeforeProcessDisposition(var QltyInspectionHeader: Record "Qlty. Inspection Header"; var TempInstructionQltyDispositionBuffer: Record "Qlty. Disposition Buffer" temporary; var DidSomething: Boolean; var Handled: Boolean)
    begin
    end;
