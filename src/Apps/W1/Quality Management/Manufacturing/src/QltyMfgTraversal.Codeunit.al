...
/// <summary>
/// Manufacturing-specific methods to assist with traversing records, connecting one record to another.
/// This codeunit contains procedures for finding Manufacturing-related records (Routing Header, Production BOM Header, Prod. Order Routing Line).
/// </summary>
codeunit 20472 "Qlty. Mfg. Traversal"
{
    var
