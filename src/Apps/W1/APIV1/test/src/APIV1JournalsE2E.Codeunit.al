codeunit 139727 "APIV1 - Journals E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', PAGE::"APIV1 - Journals", ServiceNameTxt);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(JournalGUID, PAGE::"APIV1 - Journals", ServiceNameTxt);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(GenJournalBatchId, PAGE::"APIV1 - Journals", ServiceNameTxt, ActionPostTxt);
