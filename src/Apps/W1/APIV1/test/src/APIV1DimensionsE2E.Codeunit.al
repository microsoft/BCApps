codeunit 139724 "APIV1 - Dimensions E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', PAGE::"APIV1 - Dimensions", ServiceNameTxt);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(Dimension.SystemId, PAGE::"APIV1 - Dimensions", ServiceNameTxt, SubpageServiceNameTxt);
        LibraryGraphMgt.GetFromWebService(ResponseText, TargetURL);
