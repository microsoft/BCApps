...
page 46866 "BC14 Balance Validation"
{
    PageType = List;
    ApplicationArea = All;
    Caption = 'Balance Validation';
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Source Debit Amount';
                    AutoFormatType = 1;
                    AutoFormatExpression = '<Precision,2:2><Standard Format,0>';
                    ToolTip = 'Specifies the debit amount from source data.';
                    Style = Attention;
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Source Credit Amount';
                    AutoFormatType = 1;
                    AutoFormatExpression = '<Precision,2:2><Standard Format,0>';
                    ToolTip = 'Specifies the credit amount from source data.';
                    Style = Attention;
                    StyleExpr = HasDifference;
                }
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Source Net Balance';
                    AutoFormatType = 1;
                    AutoFormatExpression = '<Precision,2:2><Standard Format,0>';
                    ToolTip = 'Specifies the net balance from source data (Debit - Credit).';
                    Style = Attention;
                    StyleExpr = HasDifference;
                }
                ...
                field(Difference; BalanceDifference)
                {
                    ...
                    AutoFormatType = 1;
                    AutoFormatExpression = '<Precision,2:2><Standard Format,0>';
                    ToolTip = 'Specifies the difference between source and current balances.';
                    Style = Unfavorable;
                    StyleExpr = HasDifference;
                }
        ...
        area(Processing)
        {
            ...
            action(ShowDifferencesOnly)
            {
                ...
                begin
                    ...
                    Rec.MarkedOnly(ShowOnlyDifferences);
                    CurrPage.Update(false);
                end;
            }
    ...
    begin
        ...
        BCOnlineBalance := Rec."Net Change";
        ...
        if HasDifference then
            StatusText := StatusDifferenceLbl
        else
            StatusText := StatusOkLbl;

        // Mark only rows with differences. The page uses MarkedOnly when ShowOnlyDifferences is on.
        Rec.Mark(HasDifference);
    end;
    ...
    var
        ...
        StatusOkLbl: Label 'OK';
        StatusDifferenceLbl: Label 'DIFFERENCE';
}
