...
table 46941 "BC14 Vendor Ledger Entry"
{
    Caption = 'Vendor Ledger Entry Migration Data';
    ...
    fields
    {
        ...
        // NOT present on the source "Vendor Ledger Entry" table so replication never overwrites it.
