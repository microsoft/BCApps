...
table 50181 "BC14 Posted Sales Inv Line"
{
    Caption = 'BC14 Posted Sales Invoice Line';
    ...
    fields
    {
        ...
        field(61; "Gen. Prod. Posting Group"; Code[20])
        {
            Caption = 'Gen. Prod. Posting Group';
        }
        field(62; "VAT Bus. Posting Group"; Code[20])
        {
            Caption = 'VAT Bus. Posting Group';
        }
        field(63; "VAT Prod. Posting Group"; Code[20])
        {
            Caption = 'VAT Prod. Posting Group';
        }
        field(70; "Bin Code"; Code[20])
        {
            Caption = 'Bin Code';
        }
    }
