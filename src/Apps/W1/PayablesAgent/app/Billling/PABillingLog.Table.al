...
table 3306 "PA Billing Log"
{
    DataClassification = SystemMetadata;
    Access = Internal;
    ObsoleteReason = 'Monetization tracking is moved to platform.';
#if not CLEAN28
    ...
    fields
    {
        ...
        field(2; Operation; Enum "PA Billing Operation")
        {
            Caption = 'Operation';
        ...
        field(5; Usage; Integer)
        {
            Caption = 'Usage';
            ToolTip = 'Specifies the cost of the operation in terms of tokens used';
        }
