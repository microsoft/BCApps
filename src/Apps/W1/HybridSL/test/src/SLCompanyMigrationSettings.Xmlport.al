...
xmlport 147624 "SL Company Migration Settings"
{
    ...
    // procedure GetExpectedCompanyMigrationSettings(var NewTempCompanyMigrationSettings: Record "SL Company Migration Settings" temporary)
    // begin
    //     if TempCompanyMigrationSettings.FindSet() then begin
    //         repeat
    //             NewTempCompanyMigrationSettings.Copy(TempCompanyMigrationSettings);
    //             NewTempCompanyMigrationSettings.Insert();
    //         until TempCompanyMigrationSettings.Next() = 0;
    //     end;
    // end;
