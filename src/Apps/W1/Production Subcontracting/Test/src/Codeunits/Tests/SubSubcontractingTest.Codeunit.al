...
codeunit 139989 "Sub. Subcontracting Test"
{
    ...
    var
        SubcontractingMgmtSetupPage: TestPage "Sub. Management Setup";
    begin
...
#pragma warning restore AA0210
    ...
    var
        ...
        WorkCenter: array[2] of Record "Work Center";
        SubPurchaseLineFactbox: TestPage "Sub. Purchase Line Factbox";
    begin
        // [SCENARIO] Create Subcontracting Purchase Order directly from Prod. Order Routing Line
...
#pragma warning restore AA0210
    ...
    begin
        ...
        XmlParameters := Report.RunRequestPage(Report::"Sub. Dispatching List");
        LibraryReportDataset.RunReportAndLoad(Report::"Sub. Dispatching List", PurchaseHeader, XmlParameters);
    ...
    [RequestPageHandler]
    procedure SubcontrDispatchingListDefaultRequestPageHandler(var PurchaseOrderRequestPage: TestRequestPage "Sub. Dispatching List")
    begin
    ...
    begin
        Assert.TableIsEmpty(Database::"Sub. Management Setup");
    end;

    local procedure CheckSubcontractingManagementSetupRecordExist()
    begin
        Assert.TableIsNotEmpty(Database::"Sub. Management Setup");
    end;
...
#pragma warning restore AA0210
    ...
    begin
        ...
        Codeunit.Run(Codeunit::"Sub. Create Prod. Ord. Opt.", PurchaseLine);
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Subcontracting Test");
        ...
        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Subcontracting Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Subcontracting Test");
    end;
