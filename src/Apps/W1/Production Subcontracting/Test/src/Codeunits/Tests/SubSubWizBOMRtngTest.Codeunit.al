...
codeunit 139995 "Sub. Sub. Wiz. BOM/Rtng Test"
{
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSelectDifferentBOM(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        NewItemNo: Text;
        OriginalItemNo: Text;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSelectDifferentRouting(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSelectBothDifferent(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSelectSameBOM(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        NewItemNo: Text;
        OriginalItemNo: Text;
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. BOM/Rtng Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. BOM/Rtng Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. BOM/Rtng Test");
    end;
}