...
codeunit 139996 "Sub. Sub. Wiz. Variant Test"
{
    ...
    var
        ...
        SubCreateProdOrdWizLibrary: Codeunit "Sub. CreateProdOrdWizLibrary";
        LibraryMfgManagement: Codeunit "Sub. Library Mfg. Management";
        SubcontractingMgmtLibrary: Codeunit "Sub. Management Library";
        ProdOrderCheckLib: Codeunit "Sub. ProdOrderCheckLib";
        SubSetupLibrary: Codeunit "Sub. Setup Library";
    ...
    var
        ...
        CreateProdOrdOpt: Codeunit "Sub. Create Prod. Ord. Opt.";
        BOMNo: Code[20];
        ItemNo: Code[20];
        RoutingNo: Code[20];
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Edit, "Sub. Show/Edit Type"::Edit);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNewBOMVariant(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardModifyBOMLines(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNewRoutingVariant(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardModifyRoutingLines(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSaveToStockkeeping(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
        ...
        PurchProvisionWizard.SaveBomRtngToSource.SetValue("Sub. RtngBOMSourceType"::StockkeepingUnit);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSaveToItem(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
        ...
        PurchProvisionWizard.SaveBOMRouting.SetValue(true);
        Assert.IsTrue(PurchProvisionWizard.SaveBomRtngToSource.Editable(), 'Save to source should be Editable after enabling save');
        PurchProvisionWizard.SaveBomRtngToSource.SetValue("Sub. RtngBOMSourceType"::Item);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSaveNoChanges(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
        // [SCENARIO H3] Handle wizard without making changes (no save needed)
        WizardWasOpened := true;

        Assert.AreEqual(Format("Sub. RtngBOMSourceType"::Empty), PurchProvisionWizard.SaveBomRtngToSource.Value(), 'Save to source should be empty initially');
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNewBOMVersion(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNewRoutingVersion(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    procedure HandlePurchProvisionWizardSelectBOMVariant(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    procedure HandlePurchProvisionWizardSelectRoutingVariant(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSwitchVariants(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardInvalidVariant(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Variant Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Variant Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Variant Test");
    end;
}