...
codeunit 139994 "Sub. Sub. Wiz. Config Test"
{
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Edit, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Edit);
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Show, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Show);
    ...
    begin
        ...
        // Configure setup to select BOM/Routing (view only) and hide ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForPartiallyPresentScenario("Sub. Show/Edit Type"::Show, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        // Configure setup to hide BOM/Routing and select ProdRouting/Components (view only)
        SubSetupLibrary.ConfigureSubManagementForPartiallyPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Show);
    ...
    begin
        ...
        // Configure setup to hide BOM/Routing and edit ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForPartiallyPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Edit);
    ...
    begin
        ...
        // Configure setup to edit BOM/Routing and hide ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForPartiallyPresentScenario("Sub. Show/Edit Type"::Edit, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        // Configure setup to select BOM/Routing (view only) and hide ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Show, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        ...
        // Configure setup to hide BOM/Routing and select ProdRouting/Components (view only)
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Show);
    ...
    begin
        ...
        // Configure setup to hide BOM/Routing and edit ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Edit);
    ...
    begin
        ...
        // Configure setup to edit BOM/Routing and hide ProdRouting/Components
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Edit, "Sub. Show/Edit Type"::Hide);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNotExpected(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardBOMRtngOnly(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardProdRtngCompOnly(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardBothShownEdit(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardDefaultBehavior(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardBOMSelect(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardRoutingSelect(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
            ...
            case StepCount of
                1:
                    begin
                        ...
                        Assert.IsFalse(PurchProvisionWizard.ProdCompRoutingShowEditTypeField.Value() = Format("Sub. Show/Edit Type"::Edit), 'Components should not be editable when set to Select');
                    end;
                2:
                    begin
                        RecordStepVisited('ProdRouting');
                        // Verify ProdRouting is not editable (Select mode)
                        Assert.IsFalse(PurchProvisionWizard.ProdCompRoutingShowEditTypeField.Value() = Format("Sub. Show/Edit Type"::Edit), 'ProdRouting should not be editable when set to Select');
                    end;
                else
                    RecordStepVisited('Unexpected Step');
            end;
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardComponentsEdit(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardComponentsHide(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        StepCount: Integer;
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Config Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Config Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Config Test");
    end;
}