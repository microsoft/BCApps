...
codeunit 139998 "Sub. Sub. Wiz. Save Test"
{
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNoSave(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardSaveToStockkeepingUnit(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardCreateNewVersion(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardCreateNewVersionNoSave(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardCreateNewVersionSaveToItem(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Save Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Save Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Save Test");
    end;
}