...
codeunit 139981 "Sub. Location Handler Test"
{
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Location Handler Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Location Handler Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Location Handler Test");
    end;
    ...
    var
        ...
        CreateSubCTransfOrder: Report "Sub. Create SubC.Transf. Order";
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizard(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
