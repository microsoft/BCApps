...
codeunit 139990 "Sub. Subcontracting UI Test"
{
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Subcontracting UI Test");
        ...
        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Subcontracting UI Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Subcontracting UI Test");
    end;
