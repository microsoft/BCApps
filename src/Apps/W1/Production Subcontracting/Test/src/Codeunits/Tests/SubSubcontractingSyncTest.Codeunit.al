...
{ // [FEATURE] Subcontracting Management
    ...
    var
        ...
        SubTestManSubscription: Codeunit "Sub. Test Man. Subscription";
    begin
...
#pragma warning restore
    ...
    var
        EsMgmtSetup: Record "Sub. Management Setup";
    begin
        EsMgmtSetup.Get();
...
#pragma warning restore AA0210
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Subcontracting Sync Test");
        ...
        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Subcontracting Sync Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Subcontracting Sync Test");
    end;
