...
codeunit 139999 "Sub. Sub. Wiz. Put-Away Test"
{
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Hide, "Sub. Show/Edit Type"::Hide);
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Put-Away Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Put-Away Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Put-Away Test");
    end;
}