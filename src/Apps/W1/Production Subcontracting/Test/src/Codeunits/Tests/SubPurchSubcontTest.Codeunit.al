...
codeunit 139991 "Sub. Purch. Subcont. Test"
{
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Purch. Subcont. Test");
        ...
        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Purch. Subcont. Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Purch. Subcont. Test");
    end;
