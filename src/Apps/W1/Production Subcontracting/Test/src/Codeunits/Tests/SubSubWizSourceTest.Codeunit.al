...
codeunit 139997 "Sub. Sub. Wiz. Source Test"
{
    ...
    var
        ...
        ExpectedSourceType: Enum "Sub. RtngBOMSourceType";
    ...
    begin
        ...
        // Configure setup to edit both
        SubSetupLibrary.ConfigureSubManagementForNothingPresentScenario("Sub. Show/Edit Type"::Edit, "Sub. Show/Edit Type"::Edit);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardVerifyStockkeepingSource(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardVerifyItemSource(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardVerifySetupSource(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardVerifyEmptySource(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        SubManSetupLbl: Label 'Subcontracting Management Setup', Locked = true;
    begin
        // [SCENARIO G4] Verify that BomRtngFromSource shows Empty when no setup exists
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardVerifyNewSetupSource(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        SubManSetupLbl: Label 'Subcontracting Management Setup', Locked = true;
    begin
        // [SCENARIO G5] Verify that BomRtngFromSource reflects new setup
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Source Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Source Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Source Test");
    end;
}