...
codeunit 139988 "Sub. Setup Library"
{
    ...
    procedure ConfigureSubManagementForNothingPresentScenario(ShowRtngBOMSelect: Enum "Sub. Show/Edit Type"; ShowProdRtngCompSelect: Enum "Sub. Show/Edit Type")
    var
        SubManagementSetup: Record "Sub. Management Setup";
    begin
    ...
    procedure ConfigureSubManagementForPartiallyPresentScenario(ShowRtngBOMSelect: Enum "Sub. Show/Edit Type"; ShowProdRtngCompSelect: Enum "Sub. Show/Edit Type")
    var
        SubManagementSetup: Record "Sub. Management Setup";
    begin
        SubManagementSetup.Get();
    ...
    procedure ConfigureSubManagementForBothPresentScenario(ShowRtngBOMSelect: Enum "Sub. Show/Edit Type"; ShowProdRtngCompSelect: Enum "Sub. Show/Edit Type")
    var
        SubManagementSetup: Record "Sub. Management Setup";
    begin
        SubManagementSetup.Get();
