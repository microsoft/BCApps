...
table 99001501 "Sub. Management Setup"
{
    ...
    fields
    {
        ...
        field(200; ShowRtngBOMSelect_Both; Enum "Sub. Show/Edit Type")
        {
            Caption = 'Routing/BOM Selection - Both';
        }
        field(210; ShowProdRtngCompSelect_Both; Enum "Sub. Show/Edit Type")
        {
            Caption = 'Show Prod. Routing/Component Selection - Both';
        }
        field(220; ShowRtngBOMSelect_Partial; Enum "Sub. Show/Edit Type")
        {
            Caption = 'Routing/BOM Selection - Partial';
        }
        field(230; ShowProdRtngCompSelect_Partial; Enum "Sub. Show/Edit Type")
        {
            Caption = 'Show Prod. Routing/Component Selection - Partial';
        }
        field(240; ShowRtngBOMSelect_Nothing; Enum "Sub. Show/Edit Type")
        {
            Caption = 'Routing/BOM Selection - Nothing';
        }
        field(250; ShowProdRtngCompSelect_Nothing; Enum "Sub. Show/Edit Type")
        {
