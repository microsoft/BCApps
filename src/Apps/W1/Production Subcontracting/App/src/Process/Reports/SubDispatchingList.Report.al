...
report 99001504 "Sub. Dispatching List"
{
    ...
    WordLayout = '.\src\Process\Reports\SubDispatchingList.docx';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Purchase_Line_Operation_No_; "Purchase Line"."Sub. Operation No.")
                {
                }
                column(Purchase_Line_Outstanding_Qty; "Purchase Line"."Outstanding Quantity")
                { }
                column(Purchase_Line_Prod__Order_Line_No_; "Purchase Line"."Sub. Prod. Order Line No.")
                {
                }
                column(Purchase_Line_Prod__Order_No_; "Purchase Line"."Sub. Prod. Order No.")
                {
                }
                column(Purchase_Line_Routing_No_; "Purchase Line"."Sub. Routing No.")
                {
                }
                column(Purchase_Line_Routing_Reference_No_; "Purchase Line"."Sub. Rtng Reference No.")
                {
                }
