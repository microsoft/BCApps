...
codeunit 99001507 "Sub. Factbox Mgmt."
{
    ...
    begin
        ...
        PurchaseLine.SetRange(PurchaseLine."Sub. Prod. Order No.", ProdOrderRoutingLine."Prod. Order No.");
        PurchaseLine.SetRange(PurchaseLine."Sub. Prod. Order Line No.", ProdOrderRoutingLine."Routing Reference No.");
        PurchaseLine.SetRange(PurchaseLine."Sub. Routing No.", ProdOrderRoutingLine."Routing No.");
        PurchaseLine.SetRange(PurchaseLine."Sub. Operation No.", ProdOrderRoutingLine."Operation No.");
        PurchaseLine.SetRange(PurchaseLine."Sub. Work Center No.", ProdOrderRoutingLine."Work Center No.");
    ...
    begin
        ...
        ProdOrderComponent.SetRange(ProdOrderComponent."Prod. Order Line No.", ProdOrderRoutingLine."Routing Reference No.");
        ProdOrderComponent.SetRange(ProdOrderComponent."Routing Link Code", ProdOrderRoutingLine."Routing Link Code");
        Page.Run(Page::"Sub. Prod. Order Components", ProdOrderComponent);
    end;
