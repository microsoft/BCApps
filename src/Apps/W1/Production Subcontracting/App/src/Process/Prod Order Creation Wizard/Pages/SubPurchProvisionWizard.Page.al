...
page 99001505 "Sub. PurchProvisionWizard"
{
        ...
        area(Content)
        {
            ...
            group(BOMStep)
            {
                ...
                group(BOMSelection)
                {
                    ...
                    part(BOMLinesPart; "Sub. Temp BOM Lines")
                    {
            ...
            group(RoutingStep)
            {
                ...
                group(RoutingSelection)
                {
                    ...
                    part(RoutingLinesPart; "Sub. Temp Routing Lines")
                    {
            ...
            group(ComponentsStep)
            {
                ...
                group(ComponentsPreview)
                {
                    ...
                    part(ComponentsPart; "Sub. Temp Prod Order Comp")
                    {
                        Caption = 'Components';
            ...
            group(ProdRoutingStep)
            {
                ...
                group(ProdRoutingPreview)
                {
                    ...
                    part(ProdOrderRoutingPart; "Sub. TempProdOrdRtngLines")
                    {
    ...
    protected var
        ...
        SaveBomRtngToSource: Enum "Sub. RtngBOMSourceType";
        BOMRoutingShowEditType, ProdCompRoutingShowEditType : Enum "Sub. Show/Edit Type";
    ...
    var
        ...
        VersionSelectionMgmt: Codeunit "Sub. Version Mgmt.";
        Finished: Boolean;
        BomRtngFromSource: Enum "Sub. RtngBOMSourceType";
    ...
    procedure SetBOMRoutingShowEditType(ShowEditType: Enum "Sub. Show/Edit Type")
    begin
    ...
    procedure SetProdCompRoutingShowEditType(ShowEditType: Enum "Sub. Show/Edit Type")
    begin
    ...
    procedure SetTempDataInitializer(var NewTempDataInitializer: Codeunit "Sub. Temp Data Initializer")
    begin
    ...
    procedure GetApplyBomRtngToSource(): Enum "Sub. RtngBOMSourceType"
    begin
