...
page 42802 "SL Hist. APTran Entries"
{
    AdditionalSearchTerms = 'SL AP Transactions, SL Historical Entries, SL Historical AP Entries, SL Payables Transactions';
    ApplicationArea = Basic, Suite;
    Caption = 'SL Historical Accounts Payable Transaction Entries';
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    LinksAllowed = false;
    ...
    PageType = List;
    SourceTable = "SL Hist. APTran Archive";
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                field("Vendor ID"; Rec.VendID)
                {
                    Caption = 'Vendor ID';
                    Editable = false;
                    ToolTip = 'Specifies the Vendor ID that the entry is associated with.';
                }
