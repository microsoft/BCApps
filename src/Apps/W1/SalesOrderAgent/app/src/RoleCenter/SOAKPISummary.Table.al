...
table 4596 "SOA KPI Summary"
{
    ...
    internal procedure UpdateEmailKPIs(AgentSecurityID: Guid)
    begin
        UpdateEmailKPIs(AgentSecurityID, true);
    end;

    internal procedure UpdateEmailKPIs(AgentSecurityID: Guid; UseRefreshInterval: Boolean)
    var
