...
codeunit 5525 "Create Currency"
{
    ...
    var
        ...
        AfghaniLbl: Label 'Afghani Afghani', MaxLength = 30;
        LekLbl: Label 'Albanian Lek', MaxLength = 30;
        ArmenianDramLbl: Label 'Armenian Dram', MaxLength = 30;
        KwanzaLbl: Label 'Angolan Kwanza', MaxLength = 30;
        ...
        ConvertibleMarkLbl: Label 'Bosnian Convertible Mark', MaxLength = 30;
        BarbadosDollarLbl: Label 'Barbados Dollar', MaxLength = 30;
        TakaLbl: Label 'Bangladeshi Taka', MaxLength = 30;
        ...
        BolivianoLbl: Label 'Bolivian Boliviano', MaxLength = 30;
        MvdolLbl: Label 'Bolivian Mvdol', MaxLength = 30;
        BahamianDollarLbl: Label 'Bahamian Dollar', MaxLength = 30;
        NgultrumLbl: Label 'Bhutanese Ngultrum', MaxLength = 30;
        PulaLbl: Label 'Botswana Pula', MaxLength = 30;
        ...
        UnidadDeFomentoLbl: Label 'Chilean Unidad de Fomento', MaxLength = 30;
        ChileanPesoLbl: Label 'Chilean Peso', MaxLength = 30;
        YuanRenminbiLbl: Label 'Chinese Yuan Renminbi', MaxLength = 30;
        ...
        LotiLbl: Label 'Lesotho Loti', MaxLength = 30;
        ...
        DenarLbl: Label 'North Macedonian Denar', MaxLength = 30;
        KyatLbl: Label 'Myanmar Kyat', MaxLength = 30;
        TugrikLbl: Label 'Mongolian Tugrik', MaxLength = 30;
        PatacaLbl: Label 'Macanese Pataca', MaxLength = 30;
        OuguiyaLbl: Label 'Mauritanian Ouguiya', MaxLength = 30;
        MauritiusRupeeLbl: Label 'Mauritius Rupee', MaxLength = 30;
        RufiyaaLbl: Label 'Maldivian Rufiyaa', MaxLength = 30;
        MalawiKwachaLbl: Label 'Malawi Kwacha', MaxLength = 30;
        NamibiaDollarLbl: Label 'Namibia Dollar', MaxLength = 30;
        CordobaOroLbl: Label 'Nicaraguan Cordoba Oro', MaxLength = 30;
        NepaleseRupeeLbl: Label 'Nepalese Rupee', MaxLength = 30;
        RialOmaniLbl: Label 'Rial Omani', MaxLength = 30;
        BalboaLbl: Label 'Panamanian Balboa', MaxLength = 30;
        SolLbl: Label 'Peruvian Sol', MaxLength = 30;
        KinaLbl: Label 'Papua New Guinean Kina', MaxLength = 30;
        PakistanRupeeLbl: Label 'Pakistan Rupee', MaxLength = 30;
        GuaraniLbl: Label 'Paraguayan Guarani', MaxLength = 30;
        ...
        LeoneLbl: Label 'Sierra Leonean Leone', MaxLength = 30;
        ...
        DobraLbl: Label 'Sao Tome and Principe Dobra', MaxLength = 30;
        ElSalvadorColonLbl: Label 'El Salvador Colon', MaxLength = 30;
        SyrianPoundLbl: Label 'Syrian Pound', MaxLength = 30;
        SomoniLbl: Label 'Tajikistani Somoni', MaxLength = 30;
        ...
        HryvniaLbl: Label 'Ukrainian Hryvnia', MaxLength = 30;
        ...
        UnidadPrevisionalLbl: Label 'Uruguayan Unidad Previsional', MaxLength = 30;
        UzbekistanSumLbl: Label 'Uzbekistan Sum', MaxLength = 30;
        BolivarSoberanoLbl: Label 'Venezuelan Bolívar Soberano', MaxLength = 30;
        BolivarSoberanoVesLbl: Label 'Venezuelan Bolívar Soberano', MaxLength = 30;
        DongLbl: Label 'Vietnamese Dong', MaxLength = 30;
