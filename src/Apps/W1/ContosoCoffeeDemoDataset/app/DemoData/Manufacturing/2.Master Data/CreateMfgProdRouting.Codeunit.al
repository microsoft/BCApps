...
codeunit 4772 "Create Mfg Prod. Routing"
{
    ...
    begin
        ...
        ContosoManufacturing.InsertRoutingLine(SPSCM1009SUBF(), '', OperationNo10(), '', "Capacity Type Routing"::"Work Center", MfgCapacity.WorkCenter500(), UnitAssemblyTok, 0, 25, 100, 0, RoutingLink500(), ContosoUtilities.AdjustPrice(45.32), MfgStandardTask.FullSubcontractedProduction());  //Currency
