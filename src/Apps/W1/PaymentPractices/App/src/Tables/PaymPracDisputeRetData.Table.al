...
table 689 "Paym. Prac. Dispute Ret. Data"
{
    ...
    fields
    {
        ...
        field(44; "Retent. Above Specific Sum"; Boolean)
        {
            ToolTip = 'Specifies whether retention clauses are used above a specific contract sum.';
        }
        ...
        repeat
            if PreviousHeader.Get(PreviousDisputeRetData."Header No.") then
                if (PreviousHeader."Reporting Scheme" = CurrentHeader."Reporting Scheme") and (PreviousHeader."Ending Date" = BestEndingDate) then begin
                    ...
                    "Retent. Above Specific Sum" := PreviousDisputeRetData."Retent. Above Specific Sum";
    ...
    begin
        ...
        "Retention Circs. Desc." := '';
        "Retent. Above Specific Sum" := false;
