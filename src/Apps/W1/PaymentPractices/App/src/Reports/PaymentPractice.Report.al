...
report 685 "Payment Practice"
{
    ...
    rendering
    {
        ...
        layout(PaymentPractice_PeriodDetailedLayout)
        {
            Type = Word;
            Caption = 'Payment Practice by Period Detailed';
            Summary = 'Payment Practice by Period Detailed';
            LayoutFile = 'src/Reports/Payment Practice by Period Detailed.docx';
        }
