...
codeunit 99001556 "Sub. Create Prod. Ord. Opt."
{
    ...
    var
        ...
        TempDataInitializer: Codeunit "Sub. Temp Data Initializer";
        ...
        ApplyBomRtngToSource: Enum "Sub. RtngBOMSourceType";
    ...
    var
        Item: Record Item;
        ScenarioType: Enum "Sub. Scenario Type";
    begin
    ...
    /// </summary>
    local procedure DetermineScenarioAndPrepareData(Item: Record Item; PurchLine: Record "Purchase Line") ScenarioType: Enum "Sub. Scenario Type"
    var
        BOMNo, RoutingNo : Code[20];
        SourceType: Enum "Sub. RtngBOMSourceType";
    begin
    ...
    /// </summary>
    local procedure GetBOMAndRoutingFromBestSource(var Item: Record Item; var BOMNo: Code[20]; var RoutingNo: Code[20]; var SourceType: Enum "Sub. RtngBOMSourceType")
    var
    ...
    /// </summary>
    local procedure GetScenarioTypeFromBOMRouting(BOMNo: Code[20]; RoutingNo: Code[20]): Enum "Sub. Scenario Type"
    var
        ScenarioType: Enum "Sub. Scenario Type";
    begin
    ...
    /// </summary>
    local procedure ExecuteBOMRoutingWizardProcess(Item: Record Item; ScenarioType: Enum "Sub. Scenario Type"): Boolean
    begin
    ...
    /// </summary>
    local procedure RunBOMRoutingWizardWithUserInteraction(Item: Record Item; ScenarioType: Enum "Sub. Scenario Type"): Boolean
    var
        SubTempProdOrdBind: Codeunit "Sub. TempProdOrdBind";
        BOMRoutingShowEditType: Enum "Sub. Show/Edit Type";
        ProdCompRoutingShowEditType: Enum "Sub. Show/Edit Type";
    begin
    ...
    /// </summary>
    local procedure GetShowEditTypesForScenario(ScenarioType: Enum "Sub. Scenario Type"; var BOMRoutingShowEditType: Enum "Sub. Show/Edit Type"; var ProdCompRoutingShowEditType: Enum "Sub. Show/Edit Type")
    begin
    ...
    /// </summary>
    local procedure ShouldSkipUserInteraction(BOMRoutingShowEditType: Enum "Sub. Show/Edit Type"; ProdCompRoutingShowEditType: Enum "Sub. Show/Edit Type"): Boolean
    begin
    ...
    /// </summary>
    local procedure ExecuteWizardPageWithTemporaryData(Item: Record Item; BOMRoutingShowEditType: Enum "Sub. Show/Edit Type"; ProdCompRoutingShowEditType: Enum "Sub. Show/Edit Type"): Boolean
    var
        PurchProvisionWizard: Page "Sub. PurchProvisionWizard";
    begin
    ...
    /// </summary>
    local procedure UpdateWizardResults(var PurchProvisionWizard: Page "Sub. PurchProvisionWizard")
    begin
    ...
    /// </summary>
    local procedure SetupWizardPageWithTemporaryData(var PurchProvisionWizard: Page "Sub. PurchProvisionWizard"; Item: Record Item; BOMRoutingShowEditType: Enum "Sub. Show/Edit Type"; ProdCompRoutingShowEditType: Enum "Sub. Show/Edit Type")
    begin
    ...
    var
        ...
        SubProdOrderCreateBind: Codeunit "Sub. ProdOrderCreateBind";
    begin
    ...
    var
        SubcontractingPriceMgt: Codeunit "Sub. Price Management";
    begin
    ...
    begin
        SkipProcessBOMAndRouting := CheckCreateProdOrderCompRtng() and (ApplyBomRtngToSource = "Sub. RtngBOMSourceType"::Empty);
