...
codeunit 99001554 "Sub. TempProdOrdBind"
{
    EventSubscriberInstance = Manual;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Sub. Temp Data Initializer", OnBeforeBuildTemporaryStructureFromBOMRouting, '', false, false)]
    local procedure "Sub. Temp Data Initializer_OnBeforeBuildTemporaryStructureFromBOMRouting"(TempDataInitializer: Codeunit "Sub. Temp Data Initializer")
    var
    ...
    [EventSubscriber(ObjectType::Page, Page::"Sub. PurchProvisionWizard", OnClosePageEvent, '', false, false)]
