...
codeunit 99001524 "Subc. Prod. Order Comp. Ext."
{
    ...
    begin
        if ProdOrderComponent."Component Supply Method" <> "Component Supply Method"::TransferToVendor then
            exit;
    ...
    begin
        if ProdOrderComponent."Component Supply Method" = ProdOrderComponent."Component Supply Method"::TransferToVendor then
            exit;
