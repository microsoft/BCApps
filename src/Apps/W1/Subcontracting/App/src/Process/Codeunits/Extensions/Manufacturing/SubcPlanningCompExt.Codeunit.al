        ...
        if PlanningComponent."Routing Link Code" <> '' then begin
            ...
            if PlanningRoutingLine.FindFirst() then
                if SubcontractingManagement.GetSubcontractor(PlanningRoutingLine."No.", Vendor) then
                    SubcontractingManagement.ChangeLocation_OnPlanningComponent(PlanningComponent, Vendor."Subc. Location Code", PlanningComponent."Orig. Location Code", PlanningComponent."Orig. Bin Code");
        end else
