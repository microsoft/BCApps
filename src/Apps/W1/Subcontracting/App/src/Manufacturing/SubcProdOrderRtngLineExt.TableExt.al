...
tableextension 8130 "Subc. ProdOrderRtngLine Ext." extends "Prod. Order Routing Line"
{
    fields
    {
        modify(Type)
...
#pragma warning restore AL0432
        ...
        field(8174; "Vendor No. Subc. Price"; Code[20])
        {
        ...
        field(8175; Subcontracting; Boolean)
        {
            AllowInCustomizations = AsReadOnly;
        ...
        field(8185; "Transfer Description"; Text[100])
        {
            AllowInCustomizations = AsReadWrite;
        ...
        field(8186; "Transfer Description 2"; Text[50])
        {
            AllowInCustomizations = AsReadWrite;
...
#pragma warning disable AA0232
        field(8187; "WIP Qty. (Base) at Subc."; Decimal)
#pragma warning restore AA0232
        ...
        field(8188; "WIP Qty. (Base) in Transit"; Decimal)
        {
            AllowInCustomizations = AsReadOnly;
            AutoFormatType = 0;
            CalcFormula = sum("Subcontractor WIP Ledger Entry"."Quantity (Base)" where("Prod. Order Status" = field(Status),
        ...
        field(8158; "WIP Location Filter"; Code[10])
        {
        ...
        field(8159; "Prod. Order Line Filter"; Integer)
        {
