...
tableextension 8141 "Subc. Transfer Line" extends "Transfer Line"
{
...
#pragma warning restore AL0432
        ...
        field(8185; "Whse. Inbnd. Otsdg. Qty"; Decimal)
        {
            AutoFormatType = 0;
            BlankZero = true;
        ...
        field(8186; "Whse Outbnd. Otsdg. Qty"; Decimal)
        {
            AutoFormatType = 0;
            BlankZero = true;
        ...
        field(8187; "Prev. Operation No."; Code[10])
        {
            AllowInCustomizations = AsReadOnly;
