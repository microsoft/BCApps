...
#pragma warning restore AA0210
    ...
    [Test]
    procedure TransferSubcTypeProdOrderCompExcludedFromPlanning()
    var
        ComponentItem: Record Item;
        Item: Record Item;
        Location: Record Location;
        ...
        WorkCenter: array[2] of Record "Work Center";
    begin
        // [SCENARIO 630597] Prod. Order Components with Subcontracting Type "Transfer" should be
        // excluded from planning engines because they will be transferred later via the subcontracting
        // transfer order.
        ...
        // [GIVEN] Set Subcontracting Type = Transfer on the linked BOM line
        UpdateProdBomWithSubcontractingType(Item, "Subcontracting Type"::Transfer);
        ...
        // [GIVEN] Verify prod. order component with Transfer subcontracting type exists
        ProdOrderComp.SetRange("Prod. Order No.", ProductionOrder."No.");
        ProdOrderComp.SetRange("Item No.", ComponentItem."No.");
        ProdOrderComp.SetRange("Subcontracting Type", "Subcontracting Type"::Transfer);
        Assert.RecordIsNotEmpty(ProdOrderComp);
        ...
        // [THEN] No requisition line is suggested for the component with Transfer subcontracting type
        RequisitionLine.SetRange("No.", ComponentItem."No.");
        Assert.RecordIsEmpty(RequisitionLine);
