...
codeunit 139980 "Sub. Sub. Wiz. Change Test"
{
    ...
    begin
        ...
        SubSetupLibrary.ConfigureSubManagementForBothPresentScenario("Sub. Show/Edit Type"::Show, "Sub. Show/Edit Type"::Edit);
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardModifyComponents(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardAddComponent(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardDeleteComponent(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardAddRoutingOperation(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardDeleteRoutingOperation(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardModifyRouting(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardModifyBoth(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    var
        Step: Option Intro,BOM,Routing,Components,ProdRouting;
    begin
    ...
    [ModalPageHandler]
    procedure HandlePurchProvisionWizardNoChanges(var PurchProvisionWizard: TestPage "Sub. PurchProvisionWizard")
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sub. Sub. Wiz. Change Test");
        LibrarySetupStorage.Restore();

        if IsInitialized then
            exit;
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Change Test");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sub. Sub. Wiz. Change Test");
    end;
