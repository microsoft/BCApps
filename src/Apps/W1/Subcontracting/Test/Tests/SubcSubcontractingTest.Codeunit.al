...
#pragma warning restore AA0210
        ...
        // [THEN] No. of Transfer Orders in the FactBox equals 1 â€” only the outbound order is counted
        Assert.AreEqual(
...
#pragma warning restore AA0210
        ...
        // [GIVEN] All items are direct-transferred (ship + receive in one step) â€” outbound lines are consumed
        Location.Get(OutboundFromCode);
        Item.Get(ProdOrderComp."Item No.");
        CreateInventory(Item, Location, Bin, ProdOrderComp."Expected Qty. (Base)");
        ...
        // [THEN] No. of Transfer Orders in the FactBox equals 0 â€” no outbound transfer lines remain
        Assert.AreEqual(
