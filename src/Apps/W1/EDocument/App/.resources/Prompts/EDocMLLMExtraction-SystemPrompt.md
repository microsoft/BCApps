...
- Allowance Charge: Leave allowance_charge section empty if no discount/charge exists on the document. Use allowance_charge.percent when the invoice shows a discount percentage; use allowance_charge.amount.value when the invoice shows a monetary discount amount
