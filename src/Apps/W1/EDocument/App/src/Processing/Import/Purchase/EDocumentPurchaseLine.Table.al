...
#pragma warning restore AS0086
        ...
        field(110; "[BC] Order Line SystemId"; Guid)
        {
            Caption = 'Order line SystemId';
            Editable = false;
            ...
            begin
                if PurchaseLine.GetBySystemId(Rec."[BC] Order Line SystemId") then begin
                    Rec."[BC] Purchase Line Type" := PurchaseLine.Type;
                    Rec."[BC] Purchase Type No." := PurchaseLine."No.";
                end;
            end;
        }
