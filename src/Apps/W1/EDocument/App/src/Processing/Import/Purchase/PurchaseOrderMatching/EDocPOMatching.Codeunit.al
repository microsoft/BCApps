...
codeunit 6196 "E-Doc. PO Matching"
{
    ...
    var
        ...
        ExceedsInvoiceableQtyLbl: Label 'Invoice quantity (%1) exceeds the quantity that can be invoiced according to what has been received (%2) by %3', Comment = '%1 = Invoice qty, %2 = Invoiceable qty, %3 = Difference';
        ExceedsRemainingToInvoiceLbl: Label 'Invoice quantity (%1) exceeds the quantity missing to invoice from the order (%2) by %3', Comment = '%1 = Invoice qty, %2 = Remaining to invoice, %3 = Difference';
