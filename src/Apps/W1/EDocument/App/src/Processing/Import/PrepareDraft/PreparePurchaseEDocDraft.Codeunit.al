...
codeunit 6125 "Prepare Purchase E-Doc. Draft" implements IProcessStructuredData
{
    ...
    begin
        // Treatment branch: unconditionally skip AL-based line matching regardless of ECS config.
        // The agent performs line matching, so PrepareDraftHelper is intentionally not invoked.
