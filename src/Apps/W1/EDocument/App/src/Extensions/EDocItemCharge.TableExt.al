...
tableextension 6432 "E-Doc. Item Charge" extends "Item Charge"
{
    fields
    {
        field(6427; "E-Invoice Mapping"; Enum "Item Charge Mapping Override")
        {
        ...
        field(6428; "E-Invoice Reason Text"; Text[100])
        {
        ...
        field(6429; "E-Invoice Reason Code"; Code[10])
        {
        ...
        field(6430; "E-Invoice Unit Code"; Code[10])
        {
