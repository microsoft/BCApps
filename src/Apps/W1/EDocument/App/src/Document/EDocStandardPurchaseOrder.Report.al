...
report 6199 "E-Doc Standard Purchase Order"
{
    Caption = 'Purchase - Order';
    DefaultRenderingLayout = "EDocStandardPurchaseOrder.docx";
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    LastPurchaseLineNo := 0;
                    if OmitLastLine then begin
                        LastPurchaseLine.SetRange("Document Type", "Purchase Header"."Document Type");
                        LastPurchaseLine.SetRange("Document No.", "Purchase Header"."No.");
                        if LastPurchaseLine.FindLast() then
                            LastPurchaseLineNo := LastPurchaseLine."Line No.";
                    end;
                end;
            }
            dataitem(Totals; "Integer")
            {
                ...
                begin
                    ...
                    if VATAmountDifference then begin
                        TotalAmountInclVAT -= 0.01;
                        VATAmount -= 0.01;
                    end;
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(OmitLastLineField; OmitLastLine)
                    {
                        ApplicationArea = Suite;
                        Caption = 'Omit last line';
                        ToolTip = 'Specifies whether the last purchase line is excluded from the printed document.';
                    }
                    field(VATAmountDifferenceField; VATAmountDifference)
                    {
                        ApplicationArea = Suite;
                        Caption = 'VAT Amount Difference';
                        ToolTip = 'Specifies whether the total VAT amount and the total amount in the footer are each decreased by 0.01.';
                    }
                }
            }
        }
    ...
    rendering
    {
        layout("EDocStandardPurchaseOrder.docx")
        {
            Type = Word;
            LayoutFile = './.resources/Template/Purchases/EDocStandardPurchaseOrder.docx';
    ...
    protected var
        ...
        VATAmountDifference: Boolean;
        LastPurchaseLineNo: Integer;
