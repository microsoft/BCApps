    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the description of the Subscription that was invoiced via the sales line.';
                }
                field("Service Commitment Description"; Rec."Subscription Line Description")
                {
                    ToolTip = 'Specifies the description of the Subscription Line that was invoiced via the sales line.';
                }
