...
page 30228 "APIV2 - S. Bl. Ord. Archives"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Sales Blanket Order Archive';
    EntitySetCaption = 'Sales Blanket Order Archives';
    ...
    InsertAllowed = false;
    ModifyAllowed = false;
    EntityName = 'salesBlanketOrderArchive';
    EntitySetName = 'salesBlanketOrderArchives';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Sales Blanket Order Archive");
                }
                part(salesBlanketOrderArchiveLines; "APIV2 - S. Bl. O. Arch. Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Sales Archive Blanket Order");
                }
