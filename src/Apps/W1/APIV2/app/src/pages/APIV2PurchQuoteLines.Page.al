...
page 30248 "APIV2 - Purch. Quote Lines"
{
    DelayedInsert = true;
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    Extensible = false;
    AboutText = 'Provides access to individual purchase quote line data, including item details, quantities, unit pricing, discounts, and amounts. Supports read-only (GET) operations for retrieving purchase quote lines within Business Central, enabling integration with external systems for vendor bid evaluation and procurement planning.';
