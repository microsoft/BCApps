...
page 30221 "APIV2 - S. Ret. Ord. A. Lines"
{
    DelayedInsert = true;
    APIVersion = 'v2.0';
    EntityCaption = 'Sales Return Order Archive Line';
    EntitySetCaption = 'Sales Return Order Archive Lines';
    PageType = API;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ODataKeyFields = SystemId;
    EntityName = 'salesReturnOrderArchiveLine';
    EntitySetName = 'salesReturnOrderArchiveLines';
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Sales Return Order Archive Line");
                }
            }
        }
    }
