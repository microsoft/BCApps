codeunit 139830 "APIV2 - GLEntries E2E"
{
    ...
    begin
        ...
        GLEntryId := Format(GLEntry.SystemId);

        // [WHEN] we GET all the entry from the web service
        ClearLastError();
        TargetURL := LibraryGraphMgt.CreateTargetURL(GLEntry.SystemId, Page::"APIV2 - G/L Entries", ServiceNameTxt);
