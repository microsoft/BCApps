codeunit 139813 "APIV2 - Currencies E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', Page::"APIV2 - Currencies", ServiceNameTxt);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(Currency.SystemId, Page::"APIV2 - Currencies", ServiceNameTxt);
