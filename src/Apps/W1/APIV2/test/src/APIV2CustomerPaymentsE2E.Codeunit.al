codeunit 139840 "APIV2 - Customer Payments E2E"
{
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(
            GetJournalID(JournalName), Page::"APIV2 - Cust. Paym. Journals", ServiceNameTxt, ServiceSubpageNameTxt);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(
            GetJournalID(JournalName), Page::"APIV2 - Cust. Paym. Journals", ServiceNameTxt, GetCustomerPaymentURL(CustomerPaymentGUID));
