...
codeunit 148341 EACorpCardL3VATTests
{
    ...
    begin
        ...
        CorpCardTestLib.RunImportAndGetLastBatch(CorpCardL3ProviderCodeTok, CorpCardBatch);
        DetailCount := CorpCardTestLib.CountTransDetailsForBatch(CorpCardBatch."Batch No.", CorpCardL3ProviderCodeTok);
    ...
    begin
        ...
        CorpCardTestLib.RunImportAndGetLastBatch(CorpCardL3ProviderCodeTok, CorpCardBatch);
        CorpCardTestLib.FindTransInBatchByProviderTransId(CorpCardBatch."Batch No.", CorpCardL3ProviderCodeTok, ProviderTransIdOneTok, CorpCardTrans);
        ...
        VatSpecAmountTotal := CorpCardTestLib.SumExpenseVatSpecAmounts(ExpenseNo);
        ...
        begin
                Initialize();
                CorpCardTestLib.SetProviderSourcePayload(CorpCardL3ProviderCodeTok, GetL3PayloadWithoutDetails(), L3SourceFileNameTok);
        ...
        begin
                Initialize();
                CorpCardTestLib.SetProviderSourcePayload(CorpCardL3ProviderCodeTok, GetL3PayloadMissingCardId(), L3SourceFileNameTok);
