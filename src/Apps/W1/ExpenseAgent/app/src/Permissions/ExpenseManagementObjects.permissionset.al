...
#pragma warning restore AL0432
        ...
        table "EA Corp Card" = X,
        table "EA Corp Card Batch" = X,
        table "EA Corp Card Exception" = X,
        table "EA Corp Card MCC Map" = X,
        table "EA Corp Card Merchant Rule" = X,
        table "EA Corp Card Provider" = X,
        table "EA Corp Card Trans" = X,
        table "EA Corp Card Trans Detail" = X,
...
#pragma warning restore AL0432
        ...
        page Travelers = X,
        page "EA Corp Card Batches" = X,
        page "EA Corp Card Cards" = X,
        page "EA Corp Card Dashboard" = X,
        page "EA Corp Card Dashboard Fact" = X,
        page "EA Corp Card Exceptions" = X,
        page "EA Corp Card JQ Schedule" = X,
        page "EA Corp Card JQ Schedule Sub" = X,
        page "EA Corp Card Details" = X,
        page "EA Corp Card MCC Map" = X,
        page "EA Corp Card Merchant Rules" = X,
        page "EA Corp Card Providers" = X,
        page "EA Corp Card Stats Factbox" = X,
        page "EA Corp Card Trans List" = X,
        ...
        codeunit "EA Corp Card JQ Runner" = X,
        codeunit "EA Corp Card Map Mgt" = X,
        codeunit "EA Corp Card Match Mgt" = X,
        codeunit "EA Corp Card MCC Mgt" = X,
        codeunit "EA Corp Card Merchant Norm" = X,
        codeunit "EA Corp Card Post Import Orch" = X,
        codeunit "EA Corp Card Prov Reg" = X,
        codeunit "EA Corp Card Report Mgt" = X,
        codeunit "EA Corp Card Validate Mgt" = X,
