...
#pragma warning restore AL0432
        ...
        table EACorpCard = X,
        table EACorpCardBatch = X,
        table EACorpCardException = X,
        table EACorpCardMCCMap = X,
        table EACorpCardMerchantRule = X,
        table EACorpCardProvider = X,
        table EACorpCardTrans = X,
        table EACorpCardTransDetail = X,
...
#pragma warning restore AL0432
        ...
        page Travelers = X,
        page EACorpCardBatches = X,
        page EACorpCardCards = X,
        page EACorpCardDashboard = X,
        page EACorpCardDashboardFactbox = X,
        page EACorpCardExceptions = X,
        page EACorpCardJQSchedule = X,
        page EACorpCardJQScheduleSubpage = X,
        page EACorpCardDetails = X,
        page EACorpCardMCCMap = X,
        page EACorpCardMerchantRules = X,
        page EACorpCardProviders = X,
        page EACorpCardStatisticsFactbox = X,
        page EACorpCardTransList = X,
        ...
        codeunit EACorpCardExpWriter = X,
        codeunit EACorpCardFeedMgt = X,
        codeunit EACorpCardImportOrch = X,
        codeunit EACorpCardJQMgt = X,
        codeunit EACorpCardJQRunner = X,
        codeunit EACorpCardMapMgt = X,
        codeunit EACorpCardMatchMgt = X,
        codeunit EACorpCardMCCMgt = X,
        codeunit EACorpCardMerchantNorm = X,
        codeunit EACorpCardPostImportOrch = X,
        codeunit EACorpCardProvReg = X,
        codeunit EACorpCardReportMgt = X,
        codeunit EACorpCardValidateMgt = X,
