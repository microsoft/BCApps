...
// Permission-set extensions must include only permissions for objects owned by this app.
permissionset 6908 "Expense Mgmt. Read Data"
{
    Caption = 'Expense Management - Read Data';
    Access = Internal;
    Assignable = false;
