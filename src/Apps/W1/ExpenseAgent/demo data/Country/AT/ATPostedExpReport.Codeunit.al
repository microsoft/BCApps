...
codeunit 8335 "AT Posted Exp. Report"
{
    SingleInstance = true;
    ...
    begin
        AccountNo := ExpenseGLAccount.FindGLAccountByName(ATGLAccountNames.SalesRevenuesResourcesExportName());
    end;
    ...
    var
        ...
        ATExpCategories: Codeunit "AT Exp. Categories";
