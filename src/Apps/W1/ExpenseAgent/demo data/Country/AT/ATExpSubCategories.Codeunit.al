...
codeunit 8329 "AT Exp. SubCategories"
{
    ...
    begin
        ...
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), ATExpCategories.PerDiemA(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), ATExpCategories.PerDiemI(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
