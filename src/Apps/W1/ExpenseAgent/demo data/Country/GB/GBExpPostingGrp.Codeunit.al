...
codeunit 8237 "GB Exp. Posting Grp"
{
    SingleInstance = true;
    ...
    begin
        case Rec.Code of
            CreateExpensePostingGroup.ExpenseEntertainment():
                ValidateRecordFields(Rec, ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.BusinessEntertainingDeductibleName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherIncidentalRevenueName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherPrepaidExpensesAndAccruedIncomeName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()));
            ...
            CreateExpensePostingGroup.ExpenseMileage():
                ValidateRecordFields(Rec, ExpenseGLAccount.MileageTravelExpensesAccount(), '', ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherPrepaidExpensesAndAccruedIncomeName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()));
            CreateExpensePostingGroup.ExpenseOther():
                ValidateRecordFields(Rec, ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.MiscExternalExpensesName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherIncidentalRevenueName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherPrepaidExpensesAndAccruedIncomeName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()));
            ExpensePerDiem():
            ...
            CreateExpensePostingGroup.ExpenseTravel():
                ValidateRecordFields(Rec, ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherTravelExpensesName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherIncidentalRevenueName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherPrepaidExpensesAndAccruedIncomeName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()));
            CreateExpensePostingGroup.ExpenseRentalCars():
                ValidateRecordFields(Rec, ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.RentalVehiclesName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherIncidentalRevenueName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.OtherPrepaidExpensesAndAccruedIncomeName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(GBGLAccountNames.PayableInvoiceRoundingName()));
        end;
    end;
