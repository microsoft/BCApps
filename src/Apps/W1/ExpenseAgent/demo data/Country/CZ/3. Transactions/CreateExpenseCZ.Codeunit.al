...
codeunit 8475 "Create Expense CZ"
{
    ...
    begin
        Expense := ContosoExpenseAgent.InsertExpense(CreateExpenseUser.EH(), CreateExpCategoriesCZ.PerDiem(), CreateExpenseLocation.GermanyAll(), PerDiemByAssignedPolicyLbl, '', ContosoUtility.AdjustDate(19030203D), '', 0, '', CreateExpensePaymentMethod.Cash(), true, false, '', CreateDateTime(ContosoUtility.AdjustDate(19030115D), 144000T), CreateDateTime(ContosoUtility.AdjustDate(19030121D), 000500T), 0, 0, '', '', '', '', '');
    ...
    var
        ...
        CreateExpCategoriesCZ: Codeunit "Create Exp. Categories CZ";
