...
codeunit 8250 "CA Exp. SubCategories"
{
    ...
    begin
        ...
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CAExpCategories.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CAExpCategories.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
