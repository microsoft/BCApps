...
codeunit 8314 "DE Exp. Posting Grp"
{
    SingleInstance = true;
    ...
    begin
        case Rec.Code of
            ...
            CreateExpensePostingGroup.ExpenseMileage():
                ValidateRecordFields(Rec, ExpenseGLAccount.MileageTravelExpensesAccount(), '', ExpenseGLAccount.FindGLAccountByName(DEGLAccountNames.AssetsintheformofprepaidexpensesName()), ExpenseGLAccount.FindGLAccountByName(DEGLAccountNames.SalesInvoiceRoundingName()), ExpenseGLAccount.FindGLAccountByName(DEGLAccountNames.SalesInvoiceRoundingName()));
