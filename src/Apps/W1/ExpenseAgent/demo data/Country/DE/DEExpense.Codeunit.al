...
codeunit 8320 "DE Expense"
{
    ...
    begin
        Expense := ContosoExpenseAgent.InsertExpense(CreateExpenseUser.EH(), DEExpCategories.PerDiem(), CreateExpenseLocation.FranceAll(), PerDiemByAssignedPolicyLbl, '', ContosoUtility.AdjustDate(19030203D), '', 0, '', CreateExpensePaymentMethod.Cash(), true, false, '', CreateDateTime(ContosoUtility.AdjustDate(19030115D), 144000T), CreateDateTime(ContosoUtility.AdjustDate(19030121D), 000500T), 0, 0, '', '', '', '', '');
