...
codeunit 8298 "DK Posted Exp. Report"
{
    SingleInstance = true;
    ...
    begin
        AccountNo := ExpenseGLAccount.FindGLAccountByName(DKGLAccountNames.DomesticsalesofgoodsandservicesName());
    end;
    ...
    var
        ...
        DKExpCategories: Codeunit "DK Exp. Categories";
    ...
    begin
        ...
        Expense := ContosoExpenseAgent.InsertExpense(CreateExpenseUser.JO(), DKExpCategories.PerDiem(), CreateExpenseLocation.GermanyAll(), BusinessTripToHamburgLbl, '', ContosoUtility.AdjustDate(19021103D), '', 0, '', CreateExpensePaymentMethod.Cash(), true, false, '', CreateDateTime(ContosoUtility.AdjustDate(19021024D), 064500T), CreateDateTime(ContosoUtility.AdjustDate(19021027D), 161500T), 0, 0, '', '', '', '', '');
