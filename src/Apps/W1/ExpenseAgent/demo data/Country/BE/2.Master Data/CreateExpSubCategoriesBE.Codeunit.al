...
codeunit 8417 "Create Exp. SubCategories BE"
{
    ...
    begin
        ...
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CreateExpCategoriesBE.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CreateExpCategoriesBE.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
