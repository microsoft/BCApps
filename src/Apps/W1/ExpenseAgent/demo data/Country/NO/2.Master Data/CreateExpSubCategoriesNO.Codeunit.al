...
codeunit 8450 "Create Exp. SubCategories NO"
{
    ...
    begin
        ...
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CreateExpCategoriesNO.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CreateExpCategoriesNO.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
