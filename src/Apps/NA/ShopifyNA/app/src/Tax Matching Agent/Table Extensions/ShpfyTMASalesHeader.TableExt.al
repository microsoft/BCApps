...
/// Carries the Shopify Tax Matching marker forward from the Shopify order so
...
tableextension 30477 "Shpfy TMA Sales Header" extends "Sales Header"
{
    fields
    {
        field(30476; "Shpfy Tax Match Applied"; Boolean)
        {
            ...
            Editable = false;
            ToolTip = 'Specifies that Shopify Tax Matching populated the Tax Area Code on the originating Shopify order. Use the Review Tax Match action to review the AI-generated decisions.';
        }
    }
}
