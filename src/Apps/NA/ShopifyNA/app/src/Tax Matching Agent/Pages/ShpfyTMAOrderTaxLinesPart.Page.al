...
/// <summary>
/// Page Shpfy TMA Order Tax Lines Part (ID 30479).
/// ListPart variant of the Shopify Order Tax Lines surface, embedded as a subform on the
/// Tax Match Review page (page 30471). The platform renders AI confidence indicators
/// on Activity Log-anchored fields when they appear on a Card or in a ListPart embedded
/// in a Card — so embedding this part is what makes per-tax-line agent indicators
...
/// </summary>
page 30479 "Shpfy TMA Order Tax Lines Part"
{
    Caption = 'Tax Lines';
    PageType = ListPart;
    ...
    begin
        ...
        FeatureTelemetry.LogUsage('0000UNP', TMARegister.FeatureName(), 'Reviewer adopted Shopify rate into Tax Detail');
