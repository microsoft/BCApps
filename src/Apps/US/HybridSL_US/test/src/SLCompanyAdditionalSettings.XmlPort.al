    ...
    schema
    {
        textelement(Root)
        {
            tableelement("SL Company Additional Settings"; "SL Company Additional Settings")
            {
                ...
                textelement(MigrateCurrent1099Year)
                {
                }
                textelement(MigrateNext1099Year)
                {
                }
                ...
                begin
                    ...
                    Evaluate(SLCompanyAdditionalSettings."Migrate Current 1099 Year", MigrateCurrent1099Year, 9);
                    Evaluate(SLCompanyAdditionalSettings."Migrate Next 1099 Year", MigrateNext1099Year, 9);
