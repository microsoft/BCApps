...
codeunit 11616 "Create CH VAT Posting Groups"
{
    ...
    begin
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.Domestic(), Hotel(), CreateCHGLAccounts.VatOwed(), CreateCHGLAccounts.PurchVatMatDl(), 'C', 3.8, Enum::"Tax Calculation Type"::"Normal VAT", 'S', '', '', false);
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", CreateCHGLAccounts.VatOwed(), CreateCHGLAccounts.PurchVatMatDl(), 'A', 8.1, Enum::"Tax Calculation Type"::"Normal VAT", 'S', '', '', false);
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.Domestic(), OperatingExpense(), CreateCHGLAccounts.VatOwed(), CreateCHGLAccounts.PurchVatInvOperatingExp(), 'A', 8.1, Enum::"Tax Calculation Type"::"Normal VAT", 'S', '', '', false);
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", CreateCHGLAccounts.VatOwed(), CreateCHGLAccounts.PurchVatMatDl(), 'B', 2.6, Enum::"Tax Calculation Type"::"Normal VAT", 'S', '', '', false);
