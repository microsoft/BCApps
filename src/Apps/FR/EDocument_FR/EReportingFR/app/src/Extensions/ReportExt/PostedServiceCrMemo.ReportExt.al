...
reportextension 10973 "Posted Service Cr. Memo" extends "Service - Credit Memo"
{
    ...
    begin
        ...
        ExportFacturXFRDocument.CreateAndAddXMLAttachmentToRenderingPayload("Service Cr.Memo Header", RenderingPayload);
    end;
}
