...
reportextension 10974 "Issued Reminder" extends Reminder
{
    ...
    begin
        ...
        ExportFacturXFRDocument.CreateAndAddXMLAttachmentToRenderingPayload("Issued Reminder Header", RenderingPayload);
    end;
}
