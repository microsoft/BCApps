...
codeunit 144052 "UT REP Fiscal Year FR"
{
    ...
    var
        ...
        PeriodStartFilterTxt: Label '%1..%2', Comment = '%1 = Date, %2 = Date';
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"G/L Journal FR", '', DialogTxt);  // Use Blank Period Start Date.
    end;
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"G/L Journal FR", StrSubstNo(PeriodStartFilterTxt, '', WorkDate()), DialogTxt);  // Use first parameter as Blank for Period Start.
    end;
    ...
    begin
        ...
        LocalGLReportErrors(
          REPORT::"G/L Journal FR", StrSubstNo(PeriodStartFilterTxt, CalcDate('<1D>', CalcDate('<-CM>', WorkDate())), WorkDate()), DialogTxt);  // Use a Date that is not a Starting Date of month.
    end;
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"G/L Trial Balance FR", '', DialogTxt);  // Use Blank for Date Filter Field.
    end;
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"G/L Trial Balance FR", StrSubstNo(PeriodStartFilterTxt, '', WorkDate()), DialogTxt);  // Use first parameter as Blank for Date Filter field.
    end;
    ...
    begin
        ...
        // Actual error message: You must fill in the Date Filter field.
        LocalGLReportErrors(REPORT::"G/L Detail Trial Balance FR", '', DialogTxt);  // Use first parameter as Blank for Date Filter field.
    end;
    ...
    begin
        // Purpose of the test is to verify error message on OnPreDataItem GL Account trigger for Report 10804 (G/L Detail Trial Balance).
        // Actual error message: You must specify a Starting Date.
        LocalGLReportErrors(REPORT::"G/L Detail Trial Balance FR", StrSubstNo(PeriodStartFilterTxt, '', WorkDate()), DialogTxt);  // Use first parameter as Blank for Date Filter field.
    end;
    ...
    begin
        ...
        LocalGLReportErrors(
          REPORT::"G/L Detail Trial Balance FR", StrSubstNo(PeriodStartFilterTxt, CalcDate('<1D>', CalcDate('<-CM>', WorkDate())), WorkDate()),
    ...
    begin
        ...
        LocalGLReportErrors(
          REPORT::"G/L Detail Trial Balance FR",
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"Journals FR", '', DialogTxt);  // Use Blank Period Start Date.
    end;
    ...
    begin
        // Purpose of the test is to verify error message on OnPreDataItemDate trigger for Report 10801 (Journals).
        // Actual error message: You must specify a Starting Date.
        LocalGLReportErrors(REPORT::"Journals FR", StrSubstNo(PeriodStartFilterTxt, '', WorkDate()), DialogTxt);  // Use first parameter as Blank for Period Start.
    end;
    ...
    begin
        ...
        // Actual error message: The selected starting date XXXXXX is not the start of a Month.
        LocalGLReportErrors(
          REPORT::"Journals FR", StrSubstNo(PeriodStartFilterTxt, CalcDate('<1D>', CalcDate('<-CW>', WorkDate())), WorkDate()), DialogTxt);  // Use a Date that is not a Starting Date of month.
    end;
    ...
    begin
        ...
        // Actual error message: The selected ending date XXXXXX is not the end of a Month.
        LocalGLReportErrors(
          REPORT::"Journals FR", StrSubstNo(PeriodStartFilterTxt, CalcDate('<-1D>', CalcDate('<CM>', WorkDate())), WorkDate()), DialogTxt);  // Period End;
    end;
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"Journals FR", SortingBy::"Document No.", TestValidationTxt);
    end;
    ...
    begin
        ...
        LocalGLReportErrors(REPORT::"Journals FR", SortingBy::"Posting Date", TestValidationTxt);
    end;
    ...
    begin
        ...
        asserterror REPORT.Run(REPORT::"Journals FR");  // Invokes NoFilterOnJournalsRequestPageHandler.
    ...
    begin
        ...
        // [SCENARIO 375111] If one date is specified in Period Start filter of "G/L Journal FR" report (10800) instead of period - error message should appear
        LocalGLReportErrors(REPORT::"G/L Journal FR", Format(CalcDate('<-CY>', WorkDate())), DialogTxt);
    end;
    ...
    begin
        ...
        // [WHEN] Report "G/L Detail Trial Balance FR" is run for these accounts.
        ...
        Commit();
        REPORT.Run(REPORT::"G/L Detail Trial Balance FR", true);
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure CentralizeJournalsRequestPageHandler(var Journals: TestRequestPage "Journals FR")
    var
        Date: Record Date;
        PostingDate: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure GLDetailTrialBalanceForGLAccountNoRequestPageHandler(var GLDetailTrialBalance: TestRequestPage "G/L Detail Trial Balance FR")
    var
        DateFilter: Variant;
    begin
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure GLJournalRequestPageHandler(var GLJournal: TestRequestPage "G/L Journal FR")
    var
        PeriodStart: Variant;
    begin
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure JournalsRequestPageHandler(var Journals: TestRequestPage "Journals FR")
    var
        Date: Record Date;
        PeriodStart: Variant;
    begin
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure NoFilterOnJournalsRequestPageHandler(var Journals: TestRequestPage "Journals FR")
    begin
        Journals.SaveAsXml(LibraryReportDataset.GetParametersFileName(), LibraryReportDataset.GetFileName());
    end;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure WrongEndDateJournalsRequestPageHandler(var Journals: TestRequestPage "Journals FR")
    var
        Date: Record Date;
        PeriodEnd: Variant;
    begin
