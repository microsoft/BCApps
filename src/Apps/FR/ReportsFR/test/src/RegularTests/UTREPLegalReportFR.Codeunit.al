...
codeunit 144053 "UT REP Legal Report FR"
{
    Subtype = Test;
    ...
    var
        ...
        BankAccountCreditAmountLCYCapLbl: Label 'Bank_Account__Credit_Amount__LCY__';
        BankAccountDebitAmountLCYCapLbl: Label 'Bank_Account__Debit_Amount__LCY__';
        BankAccountLedgerEntryCrAmtCapLbl: Label 'Bank_Account_Ledger_Entry__Credit_Amount__LCY__';
        BankAccountNoCapLbl: Label 'Bank_Account__No__';
        CustomerNoCapLbl: Label 'Customer__No__';
        DialogErr: Label 'Dialog';
        IndexOutOfBoundsLbl: Label 'IndexOutOfBounds';
        FilterCapLbl: Label 'Filter';
        FilterValueTxt: Label 'No.: %1, Global Dimension 1 Code: %2, Date Filter: %3', Comment = '%1 = No., %2 = Global Dimension 1 Code, %3 = Date Filter';
        GLAccountNoCapLbl: Label 'No_GLAcc';
        GLAccountDebitAmountCapLbl: Label 'DebitAmt_GLAcc';
        GLAccountCreditAmountCapLbl: Label 'CreditAmt_GLAcc';
        GeneralCreditAmountLCYCapLbl: Label 'GeneralCreditAmountLCY';
        GLEntryCreditAmountCapLbl: Label 'G_L_Entry__Credit_Amount_';
        GLEntryDebitAmountCapLbl: Label 'G_L_Entry__Debit_Amount_';
        DetailTrialBalanceGLEntryCreditAmountCapLbl: Label 'CreditAmount_GLEntry';
        DetailTrialBalanceGLEntryDebitAmountCapLbl: Label 'DebitAmount_GLEntry';
        PeriodCreditAmountLCYCapLbl: Label 'PeriodCreditAmountLCY';
        PreviousCreditAmountLCYCapLbl: Label 'PreviousCreditAmountLCY';
        RangeCapLbl: Label '%1..%2', Comment = '%1 = Start Date, %2 = End Date';
        VendorNoCapLbl: Label 'Vendor__No__';
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(BankAccount."No.", Format(WorkDate()), false, '', REPORT::"Bank Acc. Trial Balance");  // PrintBankAccountsWithoutBalance FALSE.
        ...
        VerifyReportCapAndValue(
          BankAccountNoCapLbl, BankAccount."No.", BankAccountDebitAmountLCYCapLbl, BankAccount."Debit Amount (LCY)",
          BankAccountCreditAmountLCYCapLbl, BankAccount."Credit Amount (LCY)");
    end;
    ...
    begin
        ...
        RunTrialBalanceReport(
          BankAccount."No.", Format(WorkDate()), true, BankAccount."Global Dimension 1 Code", REPORT::"Bank Acc. Trial Balance");  // PrintBankAccountsWithoutBalance TRUE.
        ...
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(FilterValueTxt, BankAccount."No.", BankAccount."Global Dimension 1 Code", Format(WorkDate())));
    end;
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(BankAccount."No.", Format(WorkDate()), true, '', REPORT::"Bank Acc. Trial Balance");  // PrintBankAccountsWithoutBalance TRUE.

        // Verify: Verify the Bank Account No, Debit Amount and Credit Amount as zero after running report Bank Account Trial Balance.
        LibraryReportDataset.LoadDataSetFile();
        BankAccount.CalcFields("Debit Amount (LCY)", "Credit Amount (LCY)");
        VerifyReportCapAndValue(BankAccountNoCapLbl, BankAccount."No.", BankAccountDebitAmountLCYCapLbl, 0, BankAccountCreditAmountLCYCapLbl, 0);
    end;
    ...
    begin
        ...
        RunTrialBalanceReport(
          ...
          REPORT::"Cust. Detail Trial Balance");  // ExcludeBalanceOnly FALSE.
        ...
        VerifyReportCapAndValue(
          CustomerNoCapLbl, Customer."No.", PreviousCreditAmountLCYCapLbl, Customer."Credit Amount (LCY)",
          GeneralCreditAmountLCYCapLbl, Customer."Credit Amount (LCY)");
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(FilterValueTxt, Customer."No.", Customer."Global Dimension 1 Code", Format(CalcDate('<1M>', WorkDate()))));
    end;
    ...
    begin
        ...
        CreateCustomerWithDimension(Customer);
        CreateDetailedCustomerLedgerEntry(CreateCustomerLedgerEntry(Customer."No.", WorkDate()));
        RunTrialBalanceReport(Customer."No.", Format(CalcDate('<1M>', WorkDate())), true, '', REPORT::"Cust. Detail Trial Balance");  // ExcludeBalanceOnly TRUE.
        LibraryReportDataset.LoadDataSetFile();
        LibraryReportDataset.GetNextRow();

        // Exercise.
        asserterror LibraryReportDataset.CurrentRowHasElement(CustomerNoCapLbl);

        // Verify: Verify that no record is available after running report Customer Detail Trial Balance without Balance.
        Assert.ExpectedErrorCode(IndexOutOfBoundsLbl);
    end;
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(Customer."No.", Format(CalcDate('<1M>', WorkDate())), false, '', REPORT::"Cust. Detail Trial Balance");  // ExcludeBalanceOnly FALSE.
    ...
    begin
        ...
        CustomerTrialBalanceReport(false, REPORT::"Customer Trial Balance");
    end;
    ...
    begin
        ...
        CustomerTrialBalanceReport(true, REPORT::"Customer Trial Balance");
    end;
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile();
        Customer.CalcFields("Credit Amount (LCY)");
        VerifyNoAndCreditAmount(CustomerNoCapLbl, Customer."No.", PeriodCreditAmountLCYCapLbl, Customer."Credit Amount (LCY)");
    end;
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(Customer."No.", Format(WorkDate()), false, Customer."Global Dimension 1 Code", REPORT::"Customer Trial Balance");  // PrintCustomersWithoutBalance FALSE.
        ...
        VerifyNoAndCreditAmount(CustomerNoCapLbl, Customer."No.", PeriodCreditAmountLCYCapLbl, Customer."Credit Amount (LCY)");
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(FilterValueTxt, Customer."No.", Customer."Global Dimension 1 Code", Format(WorkDate())));
    end;
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile();
        for Index := 1 to ArrayLen(CustomerNo) do
            LibraryReportDataset.AssertElementWithValueExists(CustomerNoCapLbl, CustomerNo[Index]);
    end;
    ...
    begin
        ...
        GLDetailTrialBalanceTestReport(SummarizedBy::Date, Format(StrSubstNo(RangeCapLbl, WorkDate(), WorkDate())));
    end;
    ...
    begin
        ...
        GLDetailTrialBalanceTestReport(
          SummarizedBy::Week, Format(StrSubstNo(RangeCapLbl, CalcDate('<-CW>', WorkDate()), CalcDate('<CW>', WorkDate()))));
    end;
    ...
    begin
        ...
        GLDetailTrialBalanceTestReport(
          SummarizedBy::Month, Format(StrSubstNo(RangeCapLbl, CalcDate('<-CM>', WorkDate()), CalcDate('<CM>', WorkDate()))));
    end;
    ...
    begin
        ...
        GLDetailTrialBalanceTestReport(
          SummarizedBy::Quarter, Format(StrSubstNo(RangeCapLbl, CalcDate('<-CQ>', WorkDate()), CalcDate('<CQ>', WorkDate()))));
    end;
    ...
    begin
        ...
        GLDetailTrialBalanceTestReport(
          SummarizedBy::Year, Format(StrSubstNo(RangeCapLbl, CalcDate('<-CY>', WorkDate()), CalcDate('<CY>', WorkDate()))));
    end;
    ...
    begin
        ...
        LibraryReportDataset.AssertElementWithValueExists(DetailTrialBalanceGLEntryDebitAmountCapLbl, GLAccount."Debit Amount");
        LibraryReportDataset.AssertElementWithValueExists(DetailTrialBalanceGLEntryCreditAmountCapLbl, GLAccount."Credit Amount");
    end;
    ...
    begin
        ...
        RunTrialBalanceReport(Vendor."No.", Format(CalcDate('<1M>', WorkDate())), true, '', REPORT::"Vendor Detail Trial Balance");  // ExcludeBalanceOnly TRUE.
        LibraryReportDataset.LoadDataSetFile();
        LibraryReportDataset.GetNextRow();

        // Exercise.
        asserterror LibraryReportDataset.CurrentRowHasElement(VendorNoCapLbl);
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(Vendor."No.", Format(CalcDate('<1M>', WorkDate())), false, '', REPORT::"Vendor Detail Trial Balance");  // ExcludeBalanceOnly FALSE.
        ...
        VerifyReportCapAndValue(
          VendorNoCapLbl, Vendor."No.", PreviousCreditAmountLCYCapLbl, Vendor."Credit Amount (LCY)", GeneralCreditAmountLCYCapLbl,
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(
          Vendor."No.", Format(CalcDate('<1M>', WorkDate())), false, Vendor."Global Dimension 1 Code", REPORT::"Vendor Detail Trial Balance");  // ExcludeBalanceOnly FALSE.
        ...
        VerifyReportCapAndValue(
          ...
          Vendor."Credit Amount (LCY)");
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(FilterValueTxt, Vendor."No.", Vendor."Global Dimension 1 Code", Format(CalcDate('<1M>', WorkDate()))));
    end;
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(
          Vendor."No.", Format(WorkDate()), false, Vendor."Global Dimension 1 Code", REPORT::"Vendor Trial Balance");  // PrintVendorsWithoutBalance FALSE.
        ...
        LibraryReportDataset.LoadDataSetFile();
        Vendor.CalcFields("Credit Amount (LCY)");
        VerifyNoAndCreditAmount(VendorNoCapLbl, Vendor."No.", PeriodCreditAmountLCYCapLbl, Vendor."Credit Amount (LCY)");
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(FilterValueTxt, Vendor."No.", Vendor."Global Dimension 1 Code", Format(WorkDate())));
    end;
    ...
    begin
        ...
        // Exercise.
        RunTrialBalanceReport(Vendor."No.", Format(WorkDate()), true, '', REPORT::"Vendor Trial Balance");  // PrintVendorsWithoutBalance TRUE.

        // Verify: Verify the Vendor No and Credit Amount as zero after running report Vendor Trial Balance without Balance.
        LibraryReportDataset.LoadDataSetFile();
        VerifyNoAndCreditAmount(VendorNoCapLbl, Vendor."No.", PeriodCreditAmountLCYCapLbl, 0);
    end;
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile();
        for Index := 1 to ArrayLen(VendorNo) do
            LibraryReportDataset.AssertElementWithValueExists(VendorNoCapLbl, VendorNo[Index]);
    end;
    ...
    begin
        ...
        RunGLDetailTrialBalanceReport(
          GLAccount."No.", Format(StrSubstNo(RangeCapLbl, CalcDate('<-CY>', WorkDate()), CalcDate('<CY>', WorkDate()))),
        ...
        LibraryReportDataset.AssertElementWithValueExists(DetailTrialBalanceGLEntryCreditAmountCapLbl, GLAccount."Credit Amount");
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(
            FilterValueTxt, GLAccount."No.", GLAccount."Global Dimension 1 Code", Format(
              StrSubstNo(RangeCapLbl, CalcDate('<-CY>', WorkDate()), CalcDate('<CY>', WorkDate())))));
    end;
        ...
        LibraryReportDataset.AssertElementWithValueExists(
          FilterCapLbl, StrSubstNo(
            FilterValueTxt, BankAccount."No.", BankAccount."Global Dimension 1 Code", Format(
              StrSubstNo(RangeCapLbl, CalcDate('<-CY>', WorkDate()), WorkDate()))));
    end;
    ...
    begin
        ...
        BankAccount.CalcFields("Credit Amount (LCY)");
        LibraryReportDataset.AssertElementWithValueExists(BankAccountLedgerEntryCrAmtCapLbl, BankAccount."Credit Amount (LCY)");
    end;
    ...
    begin
        ...
        RunBankAccountDetailTrialBalanceReport(
          BankAccount."No.", Format(
            StrSubstNo(RangeCapLbl, CalcDate('<-CY>', WorkDate()), WorkDate())), GlobalDimension1Code);
    ...
    begin
        ...
        GLAccount.CalcFields("Debit Amount", "Credit Amount");
        VerifyReportCapAndValue(
          GLAccountNoCapLbl, GLAccount."No.", GLAccountCreditAmountCapLbl, GLAccount."Credit Amount",
          GLAccountDebitAmountCapLbl, GLAccount."Debit Amount");
    end;
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile();
        GLAccount.CalcFields("Debit Amount", "Credit Amount");
        VerifyReportCapAndValue(GLAccountNoCapLbl, GLAccount."No.", GLAccountCreditAmountCapLbl, 0, GLAccountDebitAmountCapLbl, 0);
    end;
    ...
    begin
        ...
        VerifyReportCapAndValue(
          GLAccountNoCapLbl, GLAccount."No.", GLAccountCreditAmountCapLbl, -GLAccount."Debit Amount",
          GLAccountDebitAmountCapLbl, 0);
    end;
    ...
    begin
        ...
        VerifyReportCapAndValue(
          GLAccountNoCapLbl, GLAccount."No.", GLAccountCreditAmountCapLbl, 0,
          GLAccountDebitAmountCapLbl, -GLAccount."Credit Amount");
    end;
    ...
    begin
        ...
        // Exercise.
        asserterror RunTrialBalanceReport(BankAccount."No.", '', false, '', REPORT::"Bank Acc. Trial Balance");  // Blank DateFilter, Dimension.
    ...
    begin
        ...
        DateFilterErrorOnCustomerBalanceReport(REPORT::"Cust. Detail Trial Balance");
    end;
    ...
    begin
        ...
        DateFilterErrorOnCustomerBalanceReport(REPORT::"Customer Trial Balance");
    end;
    ...
    begin
        ...
        DateFilterErrorOnVendorBalanceReport(REPORT::"Vendor Detail Trial Balance");
    end;
    ...
    begin
        ...
        DateFilterErrorOnVendorBalanceReport(REPORT::"Vendor Trial Balance");
    end;
    ...
    begin
        ...
        VerifyReportCapAndValue(
          'G_L_Entry_Document_No_', GLEntry."Document No.", GLEntryCreditAmountCapLbl, GLAccount."Credit Amount",
          GLEntryDebitAmountCapLbl, GLAccount."Debit Amount");
    end;
    ...
    begin
        ...
        RunJournalReportWithPeriodType(PeriodType, SortingBy, PeriodStart, REPORT::"Journals FR");

        // Verify: Verify the GL Account No, Credit Amount and Debit Amount after running report Journal.
        LibraryReportDataset.LoadDataSetFile();
        GLAccount.CalcFields("Debit Amount", "Credit Amount");
        VerifyReportCapAndValue(
          'G_L_Entry__G_L_Account_No__', GLAccount."No.", GLEntryCreditAmountCapLbl, GLAccount."Credit Amount",
          GLEntryDebitAmountCapLbl, GLAccount."Debit Amount");
    end;
    ...
    begin
        ...
        RunJournalReportWithPeriodType(PeriodType, SortingBy, PeriodStart, REPORT::"Customer Journal FR");
    ...
    begin
        ...
        RunJournalReportWithPeriodType(PeriodType, SortingBy, PeriodStart, REPORT::"Vendor Journal FR");
    ...
    begin
        ...
        RunJournalReportWithPeriodType(PeriodType, SortingBy, PeriodStart, REPORT::"Bank Account Journal FR");
    ...
    begin
        ...
        RunTrialBalanceReport(
          Customer."No.", Format(CalcDate('<1M>', WorkDate())), false, Customer."Global Dimension 1 Code",
          REPORT::"Cust. Detail Trial Balance");
    ...
    begin
        ...
        RunTrialBalanceReport(
          ...
          REPORT::"Vendor Detail Trial Balance");

        // [THEN] Row found for Vendor where Field 'General Credit Amount (LCY)' = 150
        LibraryReportDataset.LoadDataSetFile();
        Vendor.CalcFields("Credit Amount (LCY)");
        VerifyReportCapAndValue(
          VendorNoCapLbl, Vendor."No.", PreviousCreditAmountLCYCapLbl, Vendor."Credit Amount (LCY)",
          GeneralCreditAmountLCYCapLbl, Vendor."Credit Amount (LCY)");
    end;
    ...
    begin
        ...
        RunTrialBalanceReport(BankAccount."No.", Format(WorkDate()), false, '', REPORT::"Bank Acc. Trial Balance");
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile();
        VerifyReportCapAndValue(
          GLAccountNoCapLbl, GLAccount."No.", 'GLAcc2CreditAmtDebitAmt', CreditAmount - DebitAmount,
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(CODEUNIT::"UT REP Legal Report FR");
    ...
    begin
        ...
        LibraryVariableStorage.Enqueue(DateFilter);
        LibraryVariableStorage.Enqueue(DimensionCode);
        REPORT.Run(REPORT::"Bank Acc. Det. Trial Balance");
    end;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure BankAccountDetailTrialBalanceRequestPageHandler(var BankAccDetailTrialBalance: TestRequestPage "Bank Acc. Det. Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure BankAccountJournalRequestPageHandler(var BankAccountJournal: TestRequestPage "Bank Account Journal FR")
    var
        PeriodType: Variant;
        PeriodStart: Variant;
        SortingBy: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure BankAccountTrialBalanceRequestPageHandler(var BankAccountTrialBalance: TestRequestPage "Bank Acc. Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
        GlobalDimensionCode: Variant;
    ...
    begin
        ...
        BankAccountTrialBalance.Print_BanksWithoutBalance.SetValue(PrintBanksWithoutBalance);
        BankAccountTrialBalance.SaveAsXml(LibraryReportDataset.GetParametersFileName(), LibraryReportDataset.GetFileName());
    end;

    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure BankAccountTrialBalanceSaveAsPDFRequestPageHandler(var BankAccountTrialBalance: TestRequestPage "Bank Acc. Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
        GlobalDimensionCode: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure BankAccountTrialBalanceExcelRequestPageHandler(var BankAccountTrialBalance: TestRequestPage "Bank Acc. Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
        GlobalDimensionCode: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure CustomerDetailTrialBalanceRequestPageHandler(var CustomerDetailTrialBalance: TestRequestPage "Cust. Detail Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
    ...
    begin
        ...
        CustomerDetailTrialBalance.ExcludeCustomersBalanceOnly.SetValue(ExcludeBalanceOnly);
        CustomerDetailTrialBalance.SaveAsXml(LibraryReportDataset.GetParametersFileName(), LibraryReportDataset.GetFileName());
    end;

    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure CustomerJournalRequestPageHandler(var CustomerJournal: TestRequestPage "Customer Journal FR")
    var
        PeriodType: Variant;
        PeriodStart: Variant;
        SortingBy: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure CustomerTrialBalanceDateFilterRequestPageHandler(var CustomerTrialBalance: TestRequestPage "Customer Trial Balance")
    begin
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure GLDetailTrialBalanceRequestPageHandler(var GLDetailTrialBalance: TestRequestPage "G/L Detail Trial Balance FR")
    var
        No: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure GLJournalRequestPageHandler(var GLJournals: TestRequestPage "G/L Journal FR")
    begin
        GLJournals.Date.SetFilter(
          "Period Start", StrSubstNo(RangeCapLbl, Format(CalcDate('<-CM>', WorkDate())), Format(CalcDate('<CM>', WorkDate()))));
        GLJournals.SaveAsXml(LibraryReportDataset.GetParametersFileName(), LibraryReportDataset.GetFileName());
    end;

    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure GLTrialBalanceRequestPageHandler(var GLTrialBalance: TestRequestPage "G/L Trial Balance FR")
    var
        No: Variant;
        DateFilter: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure JournalRequestPageHandler(var Journals: TestRequestPage "Journals FR")
    var
        PeriodType: Variant;
        PeriodStart: Variant;
        SortingBy: Variant;
    ...
    begin
        ...
        VendorDetailTrialBalance.ExcludeVendorsBalanceOnly.SetValue(ExcludeBalanceOnly);
        VendorDetailTrialBalance.SaveAsXml(LibraryReportDataset.GetParametersFileName(), LibraryReportDataset.GetFileName());
    end;

    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure VendorJournalRequestPageHandler(var VendorJournal: TestRequestPage "Vendor Journal FR")
    var
        PeriodType: Variant;
        PeriodStart: Variant;
        SortingBy: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure VendorTrialBalanceRequestPageHandler(var VendorTrialBalance: TestRequestPage "Vendor Trial Balance")
    var
        No: Variant;
        DateFilter: Variant;
        GlobalDimensionCode: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure VendorTrialBalanceDateFilterRequestPageHandler(var VendorTrialBalance: TestRequestPage "Vendor Trial Balance")
    begin
