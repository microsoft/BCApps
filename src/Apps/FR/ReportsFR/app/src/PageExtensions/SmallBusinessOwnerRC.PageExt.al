...
pageextension 10830 "Small Business Owner RC" extends "Small Business Owner RC"
{
    actions
    {
        addbefore("EC Sal&es List")
        {
            separator(Action1120003_FR)
            {
            }
            action("Journals FR")
            {
        ...
        addbefore("Trial Balance by &Period")
        {
