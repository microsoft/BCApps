...
report 10825 "Bank Acc. Det. Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/BankAccDetTrialBalance.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            column(STRSUBSTNO_Text003____; StrSubstNo(Text003Lbl, ''))
            {
            }
            column(STRSUBSTNO_Text005____; StrSubstNo(Text005Lbl, ''))
            {
            }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(DocumentNumSort; DocNumSort)
                    {
                        ApplicationArea = Basic, Suite;
    ...
    var
        ...
        Text001Lbl: Label 'You must fill in the %1 field.', Comment = '%1 = Field Caption';
