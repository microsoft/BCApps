...
report 10832 "G/L Journal FR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/GLJournalFR.rdlc';
    ...
    dataset
    {
        dataitem(Date; Date)
        {
            ...
            column(PageCaption; StrSubstNo(Text004Lbl, ' '))
            {
            }
            ...
            begin
                ...
                if GetFilter("Period Start") = '' then
                    Error(Text001Lbl, FieldCaption("Period Start"));
...
#pragma warning disable AA0139
                FiscalYearStatusText := StrSubstNo(Text005Lbl, FiscalYearFiscalClose.CheckFiscalYearStatus(GetFilter("Period Start")));
#pragma warning restore AA0139
            end;
        }
    }
    ...
    var
        ...
        "Filter": Text;
        Year: Integer;
        Text001Lbl: Label 'You must fill in the %1 field.', Comment = '%1 = Period Start';
        Text002Lbl: Label 'You must specify a Starting Date.';
        Text003Lbl: Label 'Printed by %1', Comment = '%1 = User ID';
        Text004Lbl: Label 'Page %1', Comment = '%1 = Page';
        Text005Lbl: Label 'Fiscal-Year Status: %1', Comment = '%1 = Status';
        Hidden: Boolean;
