...
report 10827 "Bank Acc. Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/BankAccTrialBalance.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            column(STRSUBSTNO_Text005_____; StrSubstNo(Text005Lbl, ' '))
            {
            }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(Print_BanksWithoutBalance; PrintBanksWithoutBalance)
                    {
                        ApplicationArea = Basic, Suite;
