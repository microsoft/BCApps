...
codeunit 10937 "Create Exp. SubCategories FR"
{
    ...
    var
        ...
        CreateExpCategoriesFR: Codeunit "Create Expense Categories FR";
    begin
        // PER-DIEM subcategories
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CreateExpCategoriesFR.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CreateExpCategoriesFR.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
