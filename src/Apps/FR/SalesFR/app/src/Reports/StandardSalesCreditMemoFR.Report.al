...
report 10819 "Standard Sales-Credit Memo FR"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(CustomerSirenNo; Cust.GetSIRENNoWithCaptionFR())
            {
            }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(LogInteraction; IsInteractionLogged)
                    {
        ...
        begin
            InitLogInteraction();
            LogInteractionEnable := IsInteractionLogged;
        end;
    }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Reports/StandardSalesCreditMemoFR.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesCreditMemoFR.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesCreditMemoThemable.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesCreditMemoEmail.docx';
    ...
    begin
        if IsInteractionLogged and not IsReportInPreviewMode() then
...
#pragma warning restore AA0470
    ...
    begin
        IsInteractionLogged := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Sales Cr. Memo") <> '';
    end;
    ...
    begin
        IsInteractionLogged := NewLogInteraction;
