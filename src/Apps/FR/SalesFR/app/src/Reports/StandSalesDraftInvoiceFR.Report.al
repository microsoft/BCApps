...
report 10802 "Stand. Sales-Draft Invoice FR"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Reports/StandardSalesDraftInvoiceFR.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesDraftInvoiceFR.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardDraftSalesInvoiceBlue.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardDraftSalesInvoiceBlueThemable.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardDraftSalesInvoiceEmail.docx';
