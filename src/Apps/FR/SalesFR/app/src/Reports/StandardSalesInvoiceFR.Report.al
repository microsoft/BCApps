...
report 10816 "Standard Sales - Invoice FR"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(DisplayAdditionalFeeNote; ShowAdditionalFeeNote)
            {
            }
            ...
            dataitem(LineFee; "Integer")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    if not ShowAdditionalFeeNote then
                        CurrReport.Break();
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(DisplayAdditionalFeeNote; ShowAdditionalFeeNote)
                    {
                        ApplicationArea = Basic, Suite;
        ...
        trigger OnInit()
        begin
            IsInteractionLogged := LogInteractionTemplateExists();
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Reports/StandardSalesInvoiceFR.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesInvoiceFR.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesInvoiceBlueSimple.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesInvoiceBlueSimpleThemable.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesInvoiceVatSpec.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Reports/StandardSalesInvoiceDefEmail.docx';
...
#pragma warning restore AA0074
    ...
    local procedure GetJobTaskDescription(JobNumber: Code[20]; JobTaskNumber: Code[20]): Text[100]
    var
        JobTask: Record "Job Task";
    begin
        JobTask.SetRange("Job No.", JobNumber);
        JobTask.SetRange("Job Task No.", JobTaskNumber);
