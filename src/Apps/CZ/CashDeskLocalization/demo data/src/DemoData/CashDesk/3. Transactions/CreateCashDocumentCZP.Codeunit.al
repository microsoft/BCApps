...
codeunit 31469 "Create Cash Document CZP"
{
    ...
    begin
        ...
        ContosoCashDeskCZP.InsertCashDocumentLine(CashDocumentHeaderCZP, CreateCashDeskEventCZP.Subsidy(), 15000.00, CashtransferLbl);
        ...
        ContosoCashDeskCZP.InsertCashDocumentLine(CashDocumentHeaderCZP, CreateCashDeskEventCZP.Transfer(), 5000.00, CashtransferLbl);
