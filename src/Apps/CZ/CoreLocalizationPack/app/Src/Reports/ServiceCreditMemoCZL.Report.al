...
report 31198 "Service Credit Memo CZL"
{
    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            column(CompanyAddr1; CompanyAddr[1])
            {
                ...
                ObsoleteReason = 'Replaced by CompanyAddress1 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
            column(CompanyAddr2; CompanyAddr[2])
            {
                ObsoleteState = Pending;
                ObsoleteReason = 'Replaced by CompanyAddress2 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
            column(CompanyAddr3; CompanyAddr[3])
            {
                ObsoleteState = Pending;
                ObsoleteReason = 'Replaced by CompanyAddress3 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
            column(CompanyAddr4; CompanyAddr[4])
            {
                ObsoleteState = Pending;
                ObsoleteReason = 'Replaced by CompanyAddress4 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
            column(CompanyAddr5; CompanyAddr[5])
            {
                ObsoleteState = Pending;
                ObsoleteReason = 'Replaced by CompanyAddress5 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
            column(CompanyAddr6; CompanyAddr[6])
            {
                ObsoleteState = Pending;
                ObsoleteReason = 'Replaced by CompanyAddress6 column in Service Cr.Memo Header dataitem to ensure address translation matches document language.';
                ObsoleteTag = '29.0';
            }
#endif
    ...
    begin
        FormatAddress.GetCompanyAddr(ServiceCrMemoHeader."Responsibility Center", ResponsibilityCenter, "Company Information", CompanyAddr);
