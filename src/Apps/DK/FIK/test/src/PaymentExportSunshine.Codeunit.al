...
codeunit 148021 "Payment Export Sunshine"
{
    ...
    begin
        ...
        // Verify
        VerifyCustomerLedgerEntry(CustomerNo, DocumentNo, '', '');
    end;
    ...
    begin
        ...
        // Verify
        VerifyCustomerLedgerEntry(CustomerNo, DocumentNo, RecipientBankAccount, MessageToRecipient);
    end;
    ...
    begin
        ...
        // Verify
        VerifyVendorLedgerEntry(VendorNo, DocumentNo, '', '');
    end;
    ...
    begin
        ...
        // Verify
        VerifyVendorLedgerEntry(VendorNo, DocumentNo, RecipientBankAccount, MessageToRecipient);
    end;
    ...
    local procedure VerifyCustomerLedgerEntry(CustomerNo: Code[20]; DocumentNo: Code[20]; RecipientBankAccount: Code[20]; MessageToRecipient: Text[140]);
    var
        CustLedgerEntry: Record "Cust. Ledger Entry";
    begin
        FindOpenCustomerLedgerEntry(CustLedgerEntry, CustomerNo, DocumentNo);
    ...
    local procedure VerifyVendorLedgerEntry(VendorNo: Code[20]; DocumentNo: Code[20]; RecipientBankAccount: Code[20]; MessageToRecipient: Text[140]);
    var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
    begin
        FindOpenVendorLedgerEntry(VendorLedgerEntry, VendorNo, DocumentNo);
