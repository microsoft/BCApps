...
codeunit 13708 "Create FA Posting Grp. DK"
{
    ...
    begin
        ContosoFixedAsset.InsertFAPostingGroup(
            Furniture(), CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.OutputLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.Chargeexsalestax(), CreateGLAccountDK.Chargebeforesalestax(), CreateGLAccount.RepairsandMaintenance(),
            CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccount.LandandBuildings(),
        ...
        ContosoFixedAsset.InsertFAPostingGroup(
            IP(), CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.OutputLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.Chargeexsalestax(), CreateGLAccountDK.Chargebeforesalestax(), CreateGLAccount.RepairsandMaintenance(),
            CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccount.LandandBuildings(),
            CreateGLAccount.DerogatoryAccount(), CreateGLAccount.DerogatoryAccount(),
            CreateGLAccount.DerogExpenseAccForCredit(), CreateGLAccount.DerogExpenseAccForDebit());
        ContosoFixedAsset.InsertFAPostingGroup(
            Leasehold(), CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.OutputLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.Chargeexsalestax(), CreateGLAccountDK.Chargebeforesalestax(), CreateGLAccount.RepairsandMaintenance(),
            CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccount.LandandBuildings(),
            CreateGLAccount.DerogatoryAccount(), CreateGLAccount.DerogatoryAccount(),
            CreateGLAccount.DerogExpenseAccForCredit(), CreateGLAccount.DerogExpenseAccForDebit());
        ContosoFixedAsset.InsertFAPostingGroup(
            Patents(), CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.OutputLandBuildings(), CreateGLAccountDK.AccdepreciationLandBuildings(),
            CreateGLAccountDK.Chargeexsalestax(), CreateGLAccountDK.Chargebeforesalestax(), CreateGLAccount.RepairsandMaintenance(),
            CreateGLAccountDK.AcquisitioncostLandBuildings(), CreateGLAccount.LandandBuildings(),
            CreateGLAccount.DerogatoryAccount(), CreateGLAccount.DerogatoryAccount(),
