...
codeunit 11371 "Create E-Doc Sample Inv. DE"
{
    Access = Internal;
    ...
    begin
        ...
        EDocSamplePurchaseInvoice.AddLine(
            Enum::"Purchase Line Type"::" ", '', CreateDemoEDocsDE.GetShipmentDHLInvoiceDescription(), 1, 60, '', CreateCommonUnitOfMeasure.Piece());
        EDocSamplePurchaseInvoice.Generate();

        EDocSamplePurchaseInvoice.AddInvoice(CreateVendor.DomesticWorldImporter(), '108240', BasicCoffeeEquipmentLbl, 7571.5);
        EDocSamplePurchaseInvoice.AddLine(
