...
/// <summary>
/// Reads ZUGFeRD documents into the v2 import draft staging tables.
/// ZUGFeRD is a PDF/A-3 container that embeds the invoice as UN/CEFACT Cross Industry Invoice (CII)
...
/// Spec reference: https://www.ferd-net.de/standards/zugferd
/// </summary>
codeunit 11041 "E-Document ZUGFeRD Handler" implements IStructuredFormatReader, IStructureReceivedEDocument, IStructuredDataType
{
    Access = Internal;
    ...
    var
        ...
        NoEmbeddedInvoiceErr: Label 'The PDF file does not contain an embedded ZUGFeRD invoice.';
    ...
    /// <summary>
    /// Reads a ZUGFeRD document and converts it into a draft purchase document.
    /// </summary>
    ...
    /// <summary>
    /// Lifts the embedded CII XML out of the ZUGFeRD PDF/A-3 container so that the draft is built from
