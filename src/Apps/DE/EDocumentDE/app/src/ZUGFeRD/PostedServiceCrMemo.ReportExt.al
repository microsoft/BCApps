...
reportextension 13921 "Posted Service Cr. Memo" extends "Service - Credit Memo"
{
    ...
    begin
        ...
        ExportZUGFeRDDocument.CreateAndAddXMLAttachmentToRenderingPayload("Service Cr.Memo Header", RenderingPayload);
    end;
}
