...
codeunit 11039 "E-Document XRechnung Handler" implements IStructuredFormatReader
{
    Access = Internal;
...
#pragma warning restore AA0139
        ...
        InsertXRechnungPurchaseLines(XRechnungXml, XmlNamespaces, EDocumentPurchaseHeader."E-Document Entry No.", "E-Document Type"::"Purchase Invoice");
    end;
...
#pragma warning restore AA0139
        ...
        if VendorNo <> '' then
            EDocumentPurchaseHeader."[BC] Vendor No." := VendorNo;
        InsertXRechnungPurchaseLines(XRechnungXml, XmlNamespaces, EDocumentPurchaseHeader."E-Document Entry No.", "E-Document Type"::"Purchase Credit Memo");
    end;
