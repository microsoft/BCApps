...
codeunit 11337 "Create Exp. SubCategories DE"
{
    ...
    begin
        ...
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CreateExpCategoriesDE.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CreateExpCategoriesDE.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
