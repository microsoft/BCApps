...
codeunit 6917 "Expense Event Subscriber DE"
{
    ...
    var
        ...
        ExpenseOtherNonRefundableLbl: Label 'Other travel expenses', MaxLength = 100;
        ExpenseOtherNonRefundableSearchLbl: Label 'Travel', MaxLength = 30;
        ExpenseOtherPrepaymentLbl: Label 'Assets in the form of prepaid expenses', MaxLength = 100;
        ExpenseOtherPrepaymentSearchLbl: Label 'prepaid expenses', MaxLength = 30;
        ExpenseOtherDebitRoundingLbl: Label 'Sales Invoice Rounding', MaxLength = 100;
        ExpenseOtherCreditRoundingLbl: Label 'Sales Invoice Rounding', MaxLength = 100;
        ...
        ExpenseMealsRefundableLbl: Label 'Board and lodging', MaxLength = 100;
        ...
        ExpensePrepaymentLbl: Label 'Assets in the form of prepaid expenses', MaxLength = 100;
        ...
        ExpensePayableBankPaidLbl: Label 'Business account, Operating, Domestic', MaxLength = 100;
