...
codeunit 10559 "Create E-Doc Sample Inv. GB"
{
    Access = Internal;
    ...
    begin
        ...
        EDocSamplePurchaseInvoice.AddLine(
            Enum::"Purchase Line Type"::" ", '', CreateDemoEDocsGB.GetShipmentDHLInvoiceDescription(), 1, 60, '', CreateCommonUnitOfMeasure.Piece());
