...
codeunit 17147 "Create AU FA Posting Group"
{
    ...
    begin
        ...
        ContosoFixedAsset.InsertFAPostingGroup(
            Building(), CreateGLAccount.LandAndBuildings(), CreateGLAccount.AccumDepreciationBuildings(),
            CreateGLAccount.LandAndBuildings(), CreateGLAccount.AccumDepreciationBuildings(),
            CreateGLAccount.GainsAndLosses(), CreateGLAccount.GainsAndLosses(), CreateGLAccount.RepairsAndMaintenance(),
            CreateGLAccount.DepreciationBuildings(), CreateGLAccount.LandAndBuildings(),
