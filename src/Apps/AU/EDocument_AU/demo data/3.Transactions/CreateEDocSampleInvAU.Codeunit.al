...
codeunit 17214 "Create E-Doc Sample Inv. AU"
{
    Access = Internal;
    ...
    begin
        EDocSamplePurchaseInvoice.AddInvoice(CreateVendor.ExportFabrikam(), '108256', CoffeeBeansAndPartsLbl);
        ...
        EDocSamplePurchaseInvoice.AddLine(
            Enum::"Purchase Line Type"::" ", '', CreateDemoEDocsAU.GetShipmentDHLInvoiceDescription(), 1, 60, '', CreateCommonUnitOfMeasure.Piece());
        EDocSamplePurchaseInvoice.Generate();

        EDocSamplePurchaseInvoice.AddInvoice(CreateVendor.DomesticWorldImporter(), '108528', BasicCoffeeEquipmentLbl);
        EDocSamplePurchaseInvoice.AddLine(
