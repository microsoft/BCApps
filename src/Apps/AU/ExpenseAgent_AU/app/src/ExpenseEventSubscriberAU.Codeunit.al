...
codeunit 6915 "Expense Event Subscriber AU"
{
    ...
    var
        ...
        ExpenseOtherRefundableLbl: Label 'Business Entertaining, nondeductible', MaxLength = 100;
        ExpenseOtherRefundableSearchLbl: Label 'Business Entertaining', MaxLength = 30;
