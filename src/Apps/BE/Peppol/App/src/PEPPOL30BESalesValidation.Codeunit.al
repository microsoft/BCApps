...
codeunit 37311 "PEPPOL30 BE Sales Validation" implements "PEPPOL30 Validation"
{
    ...
    begin
        ...
        case RecordRef.Number() of
            Database::"Sales Invoice Header":
                CheckSalesInvoice(RecordVariant);
            Database::"Sales Cr.Memo Header":
                CheckSalesCreditMemo(RecordVariant);
            else
    ...
    begin
        ...
        if not IsHandled then
            ...
            then
                if (Customer.GLN + Customer."VAT Registration No." + GetCustomerEnterpriseNo(Customer)) = '' then
    ...
    begin
        ...
        case true of
            PEPPOL30Management.IsStandardVATCategory(VATPostingSetup."Tax Category"):
                EnsurePositiveRate(SalesLine."VAT %", VATPostingSetup."Tax Category");
            PEPPOL30Management.IsOutsideScopeVATCategory(VATPostingSetup."Tax Category"):
                begin
                    EnsureZeroRate(SalesLine."VAT %", VATPostingSetup."Tax Category");
                    EnsureSingleOutsideScopeVATBreakdown(SalesLine);
                end;
    ...
    local procedure CheckSalesLineTypeAndDescription(SalesLine: Record "Sales Line"): Boolean
    begin
