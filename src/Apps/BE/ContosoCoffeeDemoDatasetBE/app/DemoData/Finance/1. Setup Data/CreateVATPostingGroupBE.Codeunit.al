...
codeunit 11365 "Create VAT Posting Group BE"
{
    ...
    begin
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), G2(), CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), G2(), 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), I0(), CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), I0(), 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), I3(), CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), I3(), 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), S1(), CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), S1(), 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
        ContosoPostingSetup.InsertVATPostingSetup(CreatePostingGroup.ExportPostingGroup(), S3(), CreateGLAccount.VATPayable(), CreateBEGLAccount.VatRecoverable(), S3(), 0, Enum::"Tax Calculation Type"::"Normal VAT", 'E', CreateGLAccountBE.VatRecoverable(), '', false);
