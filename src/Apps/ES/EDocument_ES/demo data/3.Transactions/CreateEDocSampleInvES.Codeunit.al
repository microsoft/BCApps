...
codeunit 10887 "Create E-Doc Sample Inv. ES"
{
    Access = Internal;
    ...
    begin
        ...
        EDocSamplePurchaseInvoice.AddLine(
            Enum::"Purchase Line Type"::" ", '', CreateDemoEDocsES.GetShipmentDHLInvoiceDescription(), 1, 60, '', CreateCommonUnitOfMeasure.Piece());
