...
codeunit 10794 "Create ES VAT Posting Groups"
{
    ...
    begin
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", CreateESGLAccounts.VatCollByTheComp(), CreateESGLAccounts.GovVatDeductible(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", 10, Enum::"Tax Calculation Type"::"Normal VAT", 'S', '', '', false);
        ...
        ContosoPostingSetup.InsertVATPostingSetup(CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", CreateESGLAccounts.VatCollByTheComp(), CreateESGLAccounts.GovVatDeductible(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", 10, Enum::"Tax Calculation Type"::"Reverse Charge VAT", 'S', CreateESGLAccounts.VatEuReversion(), '', true);
