...
codeunit 10928 "Create Exp. SubCategories ES"
{
    ...
    var
        ...
        CreateExpCategoriesES: Codeunit "Create Expense Categories ES";
    begin
        // PER-DIEM subcategories
        ContosoExpenseAgent.InsertExpenseSubcategory(Country(), CreateExpCategoriesES.PerDiem(), LocalCountryPerDiemLbl, LocalCountryPerDiemPostingLbl, false, true, false);
        ContosoExpenseAgent.InsertExpenseSubcategory(Intl(), CreateExpCategoriesES.PerDiem(), InternationalPerDiemLbl, InternationalPerDiemPostingLbl, false, true, false);
    end;
