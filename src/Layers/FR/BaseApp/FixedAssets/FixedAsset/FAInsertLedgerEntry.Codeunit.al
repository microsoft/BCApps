...
#pragma warning restore AA0074
    ...
    begin
        case FAEntryType of
            FAEntryType::"Fixed Asset":
                begin
                    OriginalFALedgerEntry.SetLoadFields("Derogatory Source Entry No.");
    ...
    begin
        AutomaticSalvageFALedgerEntry.SetLoadFields(
            "FA No.", "Depreciation Book Code", "FA Posting Category", "FA Posting Type", "Automatic Entry", "Transaction No.",
            "Document Type", "Document No.", "Posting Date", "FA Posting Date", "Derogatory Source Entry No.");
        OriginalAcquisitionFALedgerEntry.SetLoadFields(
            "FA No.", "Depreciation Book Code", "FA Posting Category", "FA Posting Type", "Automatic Entry", "Transaction No.",
            "Document Type", "Document No.", "Posting Date", "FA Posting Date", "Derogatory Source Entry No.");
        OriginalSalvageFALedgerEntry.SetLoadFields(
            "FA No.", "Depreciation Book Code", "FA Posting Category", "FA Posting Type", "Automatic Entry", "Transaction No.",
            "Document Type", "Document No.", "Posting Date", "FA Posting Date", "Derogatory Source Entry No.");
    ...
    begin
        ...
        if not AcceleratedDeprFeature.IsEnabled() then begin
            // Use the old matching logic when the feature is not enabled.
            ...
            FALedgEntryForDerog.SetLoadFields("Entry No.");
        ...
        FALedgEntryForDerog.SetLoadFields("Depreciation Book Code", "FA No.", "Reversed by Entry No.");
        FALedgEntryForDerog.SetRange("Derogatory Source Entry No.", ReversingFALedgerEntry."Reversed Entry No.");
        OriginalFALedgerEntry.SetLoadFields("Reversed Entry No.");
    ...
    begin
        ...
        if DerogatoryFALedgerEntry."Transaction No." <> 0 then
            CompetingFALedgerEntry.SetRange("Transaction No.", DerogatoryFALedgerEntry."Transaction No.");
    ...
    local procedure SetLegacyFAIdentityFilters(var FALedgerEntry: Record "FA Ledger Entry"; OriginalFALedgerEntry: Record "FA Ledger Entry"; DepreciationBookCode: Code[10])
    begin
        FALedgerEntry.Reset();
        FALedgerEntry.SetRange("Depreciation Book Code", DepreciationBookCode);
        FALedgerEntry.SetRange("FA No.", OriginalFALedgerEntry."FA No.");
        FALedgerEntry.SetRange("Canceled from FA No.", OriginalFALedgerEntry."Canceled from FA No.");
        FALedgerEntry.SetRange("FA Posting Type", OriginalFALedgerEntry."FA Posting Type");
        FALedgerEntry.SetRange(Amount, OriginalFALedgerEntry.Amount);
        FALedgerEntry.SetRange("Document Type", OriginalFALedgerEntry."Document Type");
        FALedgerEntry.SetRange("Document No.", OriginalFALedgerEntry."Document No.");
        FALedgerEntry.SetRange("External Document No.", OriginalFALedgerEntry."External Document No.");
        FALedgerEntry.SetRange("FA Posting Date", OriginalFALedgerEntry."FA Posting Date");
        FALedgerEntry.SetRange("Posting Date", OriginalFALedgerEntry."Posting Date");
        FALedgerEntry.SetRange("Document Date", OriginalFALedgerEntry."Document Date");
        FALedgerEntry.SetRange("Reversed Entry No.", 0);
        FALedgerEntry.SetRange("Derogatory Source Entry No.", 0);
    end;
    ...
    begin
        ...
        if DerogatoryMaintenanceLedgerEntry."Transaction No." <> 0 then
            CompetingMaintenanceLedgerEntry.SetRange("Transaction No.", DerogatoryMaintenanceLedgerEntry."Transaction No.");
    ...
    local procedure SetLegacyMaintenanceIdentityFilters(var MaintenanceLedgerEntry: Record "Maintenance Ledger Entry"; OriginalMaintenanceLedgerEntry: Record "Maintenance Ledger Entry"; DepreciationBookCode: Code[10])
    begin
        MaintenanceLedgerEntry.Reset();
        MaintenanceLedgerEntry.SetRange("Depreciation Book Code", DepreciationBookCode);
        MaintenanceLedgerEntry.SetRange("FA No.", OriginalMaintenanceLedgerEntry."FA No.");
        MaintenanceLedgerEntry.SetRange("Maintenance Code", OriginalMaintenanceLedgerEntry."Maintenance Code");
        MaintenanceLedgerEntry.SetRange(Amount, OriginalMaintenanceLedgerEntry.Amount);
        MaintenanceLedgerEntry.SetRange("Document Type", OriginalMaintenanceLedgerEntry."Document Type");
        MaintenanceLedgerEntry.SetRange("Document No.", OriginalMaintenanceLedgerEntry."Document No.");
        MaintenanceLedgerEntry.SetRange("External Document No.", OriginalMaintenanceLedgerEntry."External Document No.");
        MaintenanceLedgerEntry.SetRange("FA Posting Date", OriginalMaintenanceLedgerEntry."FA Posting Date");
        MaintenanceLedgerEntry.SetRange("Posting Date", OriginalMaintenanceLedgerEntry."Posting Date");
        MaintenanceLedgerEntry.SetRange("Document Date", OriginalMaintenanceLedgerEntry."Document Date");
        MaintenanceLedgerEntry.SetRange("Reversed Entry No.", 0);
        MaintenanceLedgerEntry.SetRange("Derogatory Source Entry No.", 0);
    end;
