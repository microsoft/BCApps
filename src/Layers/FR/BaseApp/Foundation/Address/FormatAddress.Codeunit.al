        ...
        if CountryCode = '' then begin
            ...
            case true of
                GLSetup."Local Address Format" = GLSetup."Local Address Format"::"City+County+Post Code":
                    exit(true);
                GLSetup."Local Address Format" = GLSetup."Local Address Format"::"County\Post Code+City":
                    exit(true);
                GLSetup."Local Address Format" = GLSetup."Local Address Format"::"Post Code+City\County":
                    exit(true);
        ...
        if CountryRegion.Get(CountryCode) then
            case true of
                CountryRegion."Address Format" = CountryRegion."Address Format"::"City+County+Post Code":
                    exit(true);
                CountryRegion."Address Format" = CountryRegion."Address Format"::"County/Post Code+City":
                    exit(true);
                CountryRegion."Address Format" = CountryRegion."Address Format"::"Post Code+City/County":
                    exit(true);
