codeunit 101810 "Create FA Allocation"
{
    ...
    begin
        ...
        InsertData(XTELEPHONE, "FA Allocation Type"::Gain, '675200', XADM, 30);
        InsertData(XTELEPHONE, "FA Allocation Type"::Gain, '675200', XPROD, 20);
        InsertData(XTELEPHONE, "FA Allocation Type"::Gain, '675200', XSALES, 50);
        InsertData(XTELEPHONE, "FA Allocation Type"::Loss, '775200', XADM, 30);
        InsertData(XTELEPHONE, "FA Allocation Type"::Loss, '775200', XPROD, 20);
        InsertData(XTELEPHONE, "FA Allocation Type"::Loss, '775200', XSALES, 50);
    end;
