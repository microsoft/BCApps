codeunit 101287 "Create C/V Bank Account"
{
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296696298, X44296696504, X1000, X1000100000, '', '', '', 0);
        InsertData(
          '', '', XPAR, XParkHouseBankingGroup, XScottMacDonald, XWickRoad56, CreatePostCode.Convert('GB-B27 4KT'),
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296311044, X44296704144, X1100, X1100100000, '', '', '', 0);
        InsertData(
          ...
          XGB54BARC20992012345678, XGB29NWBK60161331926819, '', 0);
        InsertData(
          '', '', XANT, XAntwerp, XDavidJaffe, XFrankrijklei10, 'BE-2050', XBE, XEUR, XNLB,
          X3232322093, X3232339287, X2000, X2000200000, '', '', '', 0);
        InsertData(
          '', '', XUTR, XUtrecht, XDavidDollas, XBernadottelaan31, 'NL-6827 BP', XNL, XEUR, XNLD,
          X3130947091, X3130917917, X3000, X3000300000, '', '', '', 0);
        InsertData(
          '', '', XSPA, XSparbanken, XJohnFrum, XVollsveien31, 'NO-1324', XNO, XNOK, XNOR,
          X4721250314, X4725309137, X4000, X4000400000, '', '', '', 0);
        InsertData(
          '', '', XHAN, XHandelsbanken, XBjornRettig, XEngelbrektsgatan71, 'SE-114 32', XSE, XSEK, XSVE,
          X4640523788, X4640176743, X5000, X5000500000, '', '', '', 0);
        InsertData(
          '', '', XCOM, XCommerzBank, XYvonneSchleger, XEickelscheidt67, 'DE-40593', XDE, XEUR, XDEU,
          X49210267511, X49210368024, X6000, X6000600000, '', '', '', 0);

        InsertData(
          '10000', '10000', XBN, XBanqueNationale, XMarieAnneFroissant, X34ruedOrient, XFR75000, XFR, '', XFRA,
          X0196196933, X0196151727, '12000', '00012123002', '', '', '03100', 7);
        InsertData(
          '20000', '20000', XBN, XBanqueNationale, XMarieAnneFroissant, X34ruedOrient, XFR75000, XFR, '', XFRA,
          X0196196933, X0196151727, '12000', '00012123003', '', '', '03100', 4);
        InsertData(
          '10000', '10000', XCBC, XGroupeBancCBC, XMichelSchmidt, X65ruedelaVictoire, XFR75000, XFR, '', XFRA,
          X0196311044, X0196704144, '11000', '00011231004', '', '', '02100', 78);
        InsertData(
          '20000', '20000', XCBC, XGroupeBancCBC, XMichelSchmidt, X65ruedelaVictoire, XFR75000, XFR, '', XFRA,
          X0196311044, X0196704144, '11000', '00011231005', '', '', '02100', 75);
        InsertData(
          '30000', '30000', XCBC, XGroupeBancCBC, XMichelSchmidt, X65ruedelaVictoire, XFR75000, XFR, '', XFRA,
          X0196311044, X0196704144, '11000', '00011231006', '', '', '02100', 72);
        InsertData(
          '40000', '40000', XCBC, XGroupeBancCBC, XMichelSchmidt, X65ruedelaVictoire, XFR75000, XFR, '', XFRA,
          X0196311044, X0196704144, '11000', '00011231007', '', '', '02100', 69);
        InsertData(
          '50000', '50000', XCBC, XGroupeBancCBC, XMichelSchmidt, X65ruedelaVictoire, XFR75000, XFR, '', XFRA,
          X0196311044, X0196704144, '11000', '00011231008', '', '', '02100', 66);
        InsertData(
          '10000', '10000', XCF, XCreditdeFrance, XJeanPierreDumas, X74FaubStMathieu, XFR75000, XFR, '', XFRA,
          X0196696298, X0196696504, '10000', '00010321004', '', '', '01100', 29);
        InsertData(
          '20000', '20000', XCF, XCreditdeFrance, XJeanPierreDumas, X74FaubStMathieu, XFR75000, XFR, '', XFRA,
          X0196696298, X0196696504, '10000', '00010321005', '', '', '01100', 26);
        InsertData(
          '30000', '30000', XCF, XCreditdeFrance, XJeanPierreDumas, X74FaubStMathieu, XFR75000, XFR, '', XFRA,
          X0196696298, X0196696504, '10000', '00010321006', '', '', '01100', 23);
        InsertData(
          '40000', '40000', XCF, XCreditdeFrance, XJeanPierreDumas, X74FaubStMathieu, XFR75000, XFR, '', XFRA,
          X0196696298, X0196696504, '10000', '00010321007', '', '', '01100', 20);
        InsertData(
    ...
    var
        ...
        XBN: Label 'BN';
        XBanqueNationale: Label 'Banque Nationale';
        XMarieAnneFroissant: Label 'Marie-Anne Froissant';
        X34ruedOrient: Label '34 rue d''Orient';
        XFR75000: Label 'FR-75000';
        XFR: Label 'FR';
        XFRA: Label 'FRA';
        X0196196933: Label '01 96 19 69 33';
        X0196151727: Label '01 96 15 17 27';
        XCBC: Label 'CBC';
        XGroupeBancCBC: Label 'Groupe Bancaire CBC';
        XMichelSchmidt: Label 'Michel Schmidt';
        X65ruedelaVictoire: Label '65 rue de la Victoire';
        X0196311044: Label '01 96 31 10 44';
        X0196704144: Label '01 96 70 41 44';
        XCF: Label 'CF';
        XCreditdeFrance: Label 'Crédit de France';
        XJeanPierreDumas: Label 'Jean-Pierre Dumas';
        X74FaubStMathieu: Label '74 Faubourg St-Mathieu';
        X0196696298: Label '01 96 69 62 98';
        X0196696504: Label '01 96 69 65 04';
    ...
    begin
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                "Bank Account No." := IncStr("Bank Account No.");
                // Modif Demo Finance (MVD) : re-calcul de la clé rib
                if "RIB Key" < 3 then
                    "RIB Key" := "RIB Key" + 97
                else
                    "RIB Key" := "RIB Key" - 3;
