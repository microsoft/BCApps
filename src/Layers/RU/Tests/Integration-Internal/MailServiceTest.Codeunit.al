codeunit 139111 "Mail Service Test"
{
    ...
    Permissions = tabledata "Issued Reminder Header" = imd,
    ...
    [Scope('OnPrem')]
    procedure EmailFileFromSalesHeader()
    var
    ...
    begin
        ...
        SetReportAsDefault(ReportSelections.Usage::"S.Invoice", REPORT::"Standard Sales - Invoice");
        SetReportAsDefault(ReportSelections.Usage::"S.Shipment", REPORT::"Sales - Shipment");
    ...
    local procedure SetReportAsDefault(ReportUsage: Enum "Report Selection Usage"; ReportId: Integer)
    var
        ReportSelections: Record "Report Selections";
    begin
        ...
        if not ReportSelections.FindFirst() then begin
            ...
            ReportSelections.ModifyAll(Default, true);
    end;
