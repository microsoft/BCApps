codeunit 135200 "Time Series Tests"
{
    ...
    begin
        ...
        TimeSeriesManagement.PrepareData(
          ItemLedgerEntry, ItemLedgerEntry.FieldNo("Item No."), ItemLedgerEntry.FieldNo("Posting Date"),
          ItemLedgerEntry.FieldNo(Quantity), Date."Period Type"::Month, WorkDate(), GetNoObservationPeriods());
    ...
    begin
        ...
        Assert.RecordCount(TempTimeSeriesForecast, GetNoObservationPeriods());
    end;
    ...
    begin
        ...
        Assert.AreEqual(NumberOfPeriodsWithHistory, GetNoObservationPeriods(), 'It should have 12 months of historical data.');
    ...
    begin
        ...
        for count := 1 to GetNoObservationPeriods() do begin
    ...
    begin
        ...
        GLAccount.FindFirst();
        VATPostingSetup.ModifyAll("Sales VAT Account", GLAccount."No.");
    end;
    ...
    [Normal]
    local procedure GetNoObservationPeriods(): Integer
    begin
        exit(12);
    end;
    ...
    begin
        ...
        NoSeriesLine."Series Code" := SalesReceivablesSetup."Invoice Nos.";
        NoSeriesLine."Starting Date" := CalcDate('<-' + Format(GetNoObservationPeriods()) + 'M>', WorkDate());
        NoSeriesLine."Starting No." := 'S001';
        NoSeriesLine."Ending No." := 'S999';
        NoSeriesLine.Insert();

        NoSeriesLine."Series Code" := SalesReceivablesSetup."Posted Invoice Nos.";
        NoSeriesLine."Starting Date" := CalcDate('<-12M>', WorkDate());
        NoSeriesLine."Starting No." := 'S001';
        NoSeriesLine."Ending No." := 'S999';
        NoSeriesLine.Insert();
