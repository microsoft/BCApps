...
codeunit 136146 "Service Item Tracking"
{
    ...
    var
        ...
        SkilledResourceCaption: Label 'Skilled Resource List - %1 %2', Comment = '%1:Value1,%2:Value2';
        QuoteCaption: Label 'Service Quotes - %1';
        OrderCaption: Label 'Service Orders - %1';
        InvoicesCaption: Label 'Service Invoices - %1';
        CreditMemosCaption: Label 'Service Credit Memos - %1';
        PostedServiceShipmentsCaption: Label 'Posted Service Shipments';
        PostedServiceInvoicesCaption: Label 'Posted Service Invoices';
        PostedServiceCreditMemosCaption: Label 'Posted Service Credit Memos';
