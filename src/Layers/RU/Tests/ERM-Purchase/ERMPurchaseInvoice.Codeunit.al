...
#pragma warning restore AA0210
    ...
    begin
        ...
        // [VERIFY] Verify deferral schedule will be created with get receipt line and verify Deferral Schedule have entry
        DeferralHeader.SetFilter("Document No.", PurchaseHeader2."No.");
