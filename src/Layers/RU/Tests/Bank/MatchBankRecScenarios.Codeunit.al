codeunit 134253 "Match Bank Rec. Scenarios"
{
    ...
    begin
        ...
        BankAccount."Bank Payment Order No. Series" := LibraryERM.CreateNoSeriesCode();
        BankAccount.Modify();
        exit(BankAccount."No.");
    end;
    ...
    begin
        ...
        BindSubscription(MatchBankRecScenarios);
        GenJournalLine.SetRecFilter();
        BankPaymentOrder.SetFileNameSilent(FileMgt.ServerTempFileName('.xlsx'));
        BankPaymentOrder.SetTableView(GenJournalLine);
        BankPaymentOrder.UseRequestPage(false);
