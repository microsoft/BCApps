codeunit 101413 "Create IC Partner"
{
    ...
    begin
        ...
        CreateVendor.InsertData(XIC1030, 'Cronus Cardoxy Procurement', 'Geradeausweg 77', 'DE-20097', '', '', 'EUR', 'DE',
          '111111111', '', '', '', XBUSINESS, XPURCHNOVAT, '');
        CreateVendor.InsertData(XIC1020, 'Cronus Cardoxy Sales', 'Ligeudvej 24', 'DK-2100', '', '', 'DKK', 'DK',
          '34192020', '', '', '', XBUSINESS, XPURCHNOVAT, '');

        InsertData(XICP20, 'Cronus Cardoxy Sales', 'DKK', 0, '', '62-9000', '60-9000', false, XIC1020, XIC1020);
        InsertData(XICP30, 'Cronus Cardoxy Procurement', 'EUR', 0, '', '62-9000', '60-9000', false, XIC1030, XIC1030);
    end;
