page 101900 "Demonstration Data Tool"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Skip sequence of actions"; "Skip sequence of actions")
                {
                }
                field("Skip creation of master data"; "Skip creation of master data")
                {
                }
                field("Import Electronic Reporting"; "Import Electronic Reporting")
                {
                }
            ...
            group("Country/Region")
            {
                ...
                field("VAT Rate 1"; "VAT Rate 1")
                {
                }
                field("VAT Rate 2"; "VAT Rate 2")
                {
                }
            }
            group(Domains)
            {
                ...
                field("Russian Accounting"; "Russian Accounting")
                {
                }
                field("Tax Accounting"; "Tax Accounting")
                {
                }
            }
            group("VAT Rates")
    ...
    begin
        ...
        Validate("Skip creation of master data", false);
        if GlobalLanguage = 1049 then
            Validate("Import Electronic Reporting", false);
        Modify(true);
    end;
