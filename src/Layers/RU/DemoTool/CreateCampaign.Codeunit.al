codeunit 101571 "Create Campaign"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(XCP1001, XIncreasesale, 19021101D, 19030401D, XHR, XCRM + XCAMP, XSALES, '', X5START);
        InsertData(XCP1002, XEvent, 19030118D, 19030121D, XBC, XCRM + XCAMP, XSALES, '', X9DONE);
        InsertData(XCP1003, XWorkingplacearrangement, 19030108D, 19030401D, XOF, XCRM + XCAMP, XSALES, '', X5START);
        InsertData(XCP1004, XSpringoffer, 19030301D, 19030601D, XBC, XCRM + XCAMP, XSALES, '', X1PLAN);
    end;
