codeunit 101999 "Create Vendor Template"
{
    ...
    var
        ...
        xPURCHASETxt: Label 'PURCHASE', Comment = 'Translate.';
    ...
    begin
        ...
        InsertTemplate(ConfigTemplateHeader,
          xCashDescriptionTxt, DemoDataSetup."Country/Region Code", xBUSINESSTxt, xPURCHASETxt, '60-1010', true);
        ...
        InsertTemplate(ConfigTemplateHeader,
          xPrivateDescriptionTxt, DemoDataSetup."Country/Region Code", xBUSINESSTxt, xPURCHASETxt, '60-1010', true);
        InsertPaymentsInfo(ConfigTemplateHeader, xManualTxt, X14DAYSTxt, xGIROTxt);
        // Business-to-Business vendor template
        InsertTemplate(ConfigTemplateHeader,
          xBusinessDescriptionTxt, DemoDataSetup."Country/Region Code", xBUSINESSTxt, xPURCHASETxt, '60-1010', false);
        InsertPaymentsInfo(ConfigTemplateHeader, xManualTxt, X1M8DTxt, xBANKTxt);
        // EU vendor template
        InsertTemplate(ConfigTemplateHeader, xEuDescriptionTxt, '', xBUSINESSTxt, xPURCHASETxt, '60-1010', false);
