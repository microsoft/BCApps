    ...
    begin
        ...
        if JobsSetup."Job Nos." = '' then
            if not NoSeries.Get(XJOBTxt) then
                CreateNoSeries.InitBaseSeries(JobsSetup."Job Nos.", XRJTxt + '-01', XJOBTxt, XJ10Txt, XJ99990Txt, '', '', 10, Enum::"No. Series Implementation"::Sequence)
            else
