codeunit 119088 "Create Cost Acct. Jnl Line"
{
    ...
    begin
        ...
        InsertData(XINTINVC, DMY2Date(31, 12, DemoDataSetup."Starting Year"), 'U18', MakeAdjustments.Convert('26-3000'), '',
          XFURNITURE, MakeAdjustments.Convert('26-3000'), XPERS, '', Text119, 1422000);
        InsertData(XINTINVC, DMY2Date(31, 12, DemoDataSetup."Starting Year"), 'U19', MakeAdjustments.Convert('26-3000'), '',
          XCHAIRS, MakeAdjustments.Convert('26-3000'), XPERS, '', Text120, 580000);
        InsertData(XINTINVC, DMY2Date(31, 12, DemoDataSetup."Starting Year"), 'U20', MakeAdjustments.Convert('26-3000'), '',
          XACCESSO, MakeAdjustments.Convert('26-3000'), XPERS, '', Text121, 226000);
