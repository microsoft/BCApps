codeunit 117014 "Create Loaner"
{
    ...
    trigger OnRun()
    begin
        InsertData(XL00001, XMonitor, '', XPCS, '', false, XSRV + '-01', 'A3452');
        InsertData(XL00002, XMonitor, '', XPCS, '', false, XSRV + '-01', '12365');
        InsertData(XL00003, XServerdashTeamwearPackage, '', XPCS, '8920-W', false, XSRV + '-01', 'AB-123');
        InsertData(XL00004, XServerdashTeamwearPackage, '', XPCS, '8920-W', false, XSRV + '-01', 'AC-256');
        InsertData(XL00005, XATHENSspaceDesk, '', XPCS, '1896-S', false, XSRV + '-01', 'CG-123');
    end;
