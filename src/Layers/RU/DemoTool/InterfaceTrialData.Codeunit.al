codeunit 122000 "Interface Trial Data"
{
    ...
    begin
        ...
        CreateVATBusPostingGr.InsertMiniAppData();
        CreateVATProdPostingGr.InsertMiniAppData();
        ...
        RunCodeunit(CODEUNIT::"Create Jobs Setup");
        CreateVATPostingSetup.InsertMiniAppData();
        ...
        CreateFAPostingGroup5606.InsertMiniAppData();
