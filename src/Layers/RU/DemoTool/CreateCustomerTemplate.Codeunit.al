codeunit 101998 "Create Customer Template"
{
    ...
    var
        ...
        xBUSINESSTxt: Label 'BUSINESS', Comment = 'Translate.';
        xSALESTxt: Label 'SALES', Comment = 'Translate.';
    ...
    begin
        ...
        InsertTemplate(ConfigTemplateHeader,
          GetCustomerTemplateDescriptionCashCustomer(), DemoDataSetup."Country/Region Code", xBUSINESSTxt, xSALESTxt, '62-1010', true, true,
        ...
        InsertTemplate(ConfigTemplateHeader,
          xPrivateDescriptionTxt, DemoDataSetup."Country/Region Code", xBUSINESSTxt, xSALESTxt, '62-1010', true, true,
          Customer."Contact Type"::Person);
        InsertPaymentsInfo(ConfigTemplateHeader, xManualTxt, X14DAYSTxt, xGIROTxt, '', '', true);
        // Business customer template
        InsertTemplate(ConfigTemplateHeader,
          xBusinessDescriptionTxt, DemoDataSetup."Country/Region Code", xBUSINESSTxt, xSALESTxt, '62-1010', true, false,
        ...
        InsertTemplate(ConfigTemplateHeader,
          xEuDescriptionTxt, '', xBUSINESSTxt, xSALESTxt, '62-1110', true, false, Customer."Contact Type"::Company);
