table 101900 "Demo Data Setup"
{
    ...
    fields
    {
        ...
        field(12400; "Russian Accounting"; Boolean)
        {
        }
        field(12401; "Tax Accounting"; Boolean)
        {
        }
        field(12403; "Skip creation of master data"; Boolean)
        {
            trigger OnValidate()
            begin
                "Skip sequence of actions" := "Skip creation of master data";
            end;
        }
        field(12404; "Import Electronic Reporting"; Boolean)
        {
        }
        field(26501; "VAT Rate 1"; Decimal)
        {
            AutoFormatType = 0;
        }
        field(26502; "VAT Rate 2"; Decimal)
        {
            AutoFormatType = 0;
        }
    }
    ...
    begin
        ...
        ADCS := SelectAll;
        "Russian Accounting" := SelectAll;
        "Tax Accounting" := SelectAll;
    end;
