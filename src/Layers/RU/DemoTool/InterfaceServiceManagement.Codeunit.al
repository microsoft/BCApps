codeunit 117000 "Interface Service Management"
{
    ...
    begin
        ...
        case SalesHeader."Sell-to Customer No." of
            '40000', '50000':
                begin
                    DimensionMgt.GetDimensionSet(TempDimSetEntry, SalesHeader."Dimension Set ID");
                    TempDimSetEntry."Dimension Code" := XINCEXP;
                    TempDimSetEntry."Dimension Value Code" := '1103000';
                    ...
                    SalesHeader."Dimension Set ID" := DimensionMgt.GetDimensionSetID(TempDimSetEntry);
