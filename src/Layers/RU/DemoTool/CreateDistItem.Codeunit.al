codeunit 118838 "Create Dist. Item"
{
    ...
    trigger OnRun()
    begin
        InsertData('LS-75', XLoudspeakerCherry75W, 79.0, 36.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-120', XLoudspeakerBlack120W, 88.0, 45.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-150', XLoudspeakerCherry150W, 129.0, 72.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-10PC', XLoudspeakersWhiteforPC, 59.0, 25.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-Man-10', XManualforLoudspeakers, 0.0, 12.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-2', XCablesforLoudspeakers, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-S15', XStandforLoudspeakersLS150, 79.0, 45.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
        InsertData('LS-100', XLoudspeaker100WOakwoodDeluxe, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 1, 1, true, 0);
        InsertData('LSU-15', XBasespeakerunit15100W, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('LSU-8', XMiddletonespeakerunit8100W, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('LSU-4', XTweeterspeakerunit4100W, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('FF-100', XFrequencyfilterforLS100, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('C-100', XCablingforLS100, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('HS-100', XHousingLS100Oakwood120lts, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('SPK-100', XSpikeforLS100, 21.0, 15.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 1, true, 0);
        InsertData('LS-81', XLoudspeakerWalnut80W, 79.0, 36.0, 0, XGOODS20, XGOODS20, '41-1000', 0, 0, false, 0);
    end;
