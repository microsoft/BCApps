codeunit 118842 "Create Dist. Customer"
{
    ...
    begin
        ...
        InsertData(
          ...
          XBlanemarkHifiShop, XOF, XLondon, XBUSINESS, XSALES, '62-1010', 0, X1M8D, DemoDataSetup.DomesticCode(), X1POINT5DOM, XWHITE);
        InsertData(
          '61000', XFairwaySound, X159Fairway, CreatePostCode.Convert('GB-W2 8HG'), DemoDataSetup."Country/Region Code",
          XFairwaySound, XJO, XLondon, XBUSINESS, XSALES, '62-1010', 0, X1M8D, DemoDataSetup.DomesticCode(), X1POINT5DOM, XWHITE);
        InsertData(
          '62000', XTheDeviceShop, X273BasinStreet, CreatePostCode.Convert('GB-N16 34Z'), DemoDataSetup."Country/Region Code",
          XTheDeviceShop, XJO, XLondon, XBUSINESS, XSALES, '62-1010', 0, X14Days, DemoDataSetup.DomesticCode(), X1POINT5DOM, XWHITE);
