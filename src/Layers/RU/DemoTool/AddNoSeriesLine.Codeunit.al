codeunit 117557 "Add No. Series Line"
{
    ...
    trigger OnRun()
    begin
        InsertRec(XSRV + '-20', 10000, XTEMPL0001, XTEMPL0004, 19030127D);
        InsertRec(XSRV + '-02', 10000, XSC00001, XSC00007, 19030127D);
        InsertRec(XSRV + '-11', 10000, XSCI0000001, '', 0D);
        InsertRec(XSRV + '-13', 10000, XSOI0000001, '', 0D);
        InsertRec(XSRV + '-14', 10000, XSOI0000001, '', 0D);
        InsertRec(XSRV + '-04', 10000, '1', '29', 19030126D);
        InsertRec(XSRV + '-01', 10000, XL00001, XL00005, 19030126D);
        InsertRec(XSRV + '-12', 10000, XSO000001, XSO000008, 19030126D);
        InsertRec(XSRV + '-10', 10000, XSQ000001, '', 19030126D);
        InsertRec(XSRV + '-03', 10000, XTR00001, XTR00005, 19030126D);
        InsertRec(XSRV + '-30', 10000, XSM00001, '', 0D);
        InsertRec(XSRV + '-05', 10000, XPRE000001, '', 0D);
        InsertRec(XSRV + '-19', 10000, XSCCR0000001, '', 0D);
        InsertRec(XSRV + '-15', 10000, XSCR00001, '', 0D);
        InsertRec(XSRV + '-16', 10000, XSCSP00001, '', 0D);
        InsertRec(XSRV + '-17', 10000, XSP00001, '', 0D);
