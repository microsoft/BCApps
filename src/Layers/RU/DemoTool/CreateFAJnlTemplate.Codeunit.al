codeunit 101812 "Create FA Jnl. Template"
{
    ...
    trigger OnRun()
    begin
        InsertData(XASSETS, XFixedAssetGLJournal, '', false, XFixedAssetGLJournal, '1', XF01000);
        InsertData(XRECURRING, XRecurringFixedAssetGLJournal, XFAJNLGLR, true, XRecurringFixedAssetGLJournal, '1', XRF01000);
        InsertData(XQTYACC, XFixedAssetQtyAcc, '', false, '', '', '');
    end;
    ...
    var
        ...
        XFixedAssetQtyAcc: Label 'Fixed Asset Qty. Journal';
