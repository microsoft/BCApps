codeunit 118831 "Create Whse. Journal Template"
{
    ...
    begin
        ...
        InsertData(
          ...
          SourceCodeSetup."Whse. Item Journal", XINV + '-34', XWhseAdjustmentJournal, '5001', 'T06000');
        InsertData(
          XRECLASS, XReclassificationJournal, "Warehouse Journal Template".Type::Reclassification,
          SourceCodeSetup."Whse. Reclassification Journal", XINV + '-35', XWhseReclassificationJournal, '6001', 'T07000');
        InsertData(
          XPHYSINVT, XPhysicalInventoryJournal, "Warehouse Journal Template".Type::"Physical Inventory",
          SourceCodeSetup."Whse. Phys. Invt. Journal", XINV + '-33', XWhsePhysInvtJournal, '7001', 'T08000');
    end;
