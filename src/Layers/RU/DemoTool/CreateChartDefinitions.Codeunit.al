codeunit 119100 "Create Chart Definitions"
{
    ...
    begin
        ...
        CreateAccScheduleLine(
          XCashFlowAccSchedNameTxt, '10', XTotalReceivablesTxt, MakeAdjustments.Convert('62-9999'), TotalAccounts, BalanceAtDate);
        CreateAccScheduleLine(
          XCashFlowAccSchedNameTxt, '20', XTotalPayablesTxt, MakeAdjustments.Convert('60-9999'), TotalAccounts, BalanceAtDate);
        CreateAccScheduleLine(
          XCashFlowAccSchedNameTxt, '30', XTotalLiquidFundsTxt,
          StrSubstNo('%1|%2', MakeAdjustments.Convert('01-9999'), MakeAdjustments.Convert('51-1001')), TotalAccounts,
          BalanceAtDate);
        ...
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '10', XTotalRevenueCreditTxt, MakeAdjustments.Convert('90-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '11', XTotalRevenueTxt, '-10', Formula, NetChange);
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '20', XTotalGoodsSoldTxt, MakeAdjustments.Convert('16-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '30', XTotalExternalCostsTxt, MakeAdjustments.Convert('26-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '40', XTotalPersonnelCostsTxt, MakeAdjustments.Convert('70-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '50', XTotalFADepricationTxt, MakeAdjustments.Convert('02-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '60', XOtherExpensesTxt, MakeAdjustments.Convert('44-2990'), PostingAccounts, NetChange);
        ...
        CreateAccScheduleLine(
          XCashCycleAccSchedNameTxt, '10', XTotalRevenueTxt, MakeAdjustments.Convert('90-9999'), TotalAccounts, BalanceAtDate);
        CreateAccScheduleLine(
          XCashCycleAccSchedNameTxt, '20', XTotalReceivablesTxt, MakeAdjustments.Convert('62-9999'), TotalAccounts, BalanceAtDate);
        CreateAccScheduleLine(
          XCashCycleAccSchedNameTxt, '30', XTotalPayablesTxt, MakeAdjustments.Convert('60-9999'), TotalAccounts, NetChange);
        CreateAccScheduleLine(
          XCashCycleAccSchedNameTxt, '40', XTotalInventoryTxt, MakeAdjustments.Convert('41-9999'), TotalAccounts, NetChange);
        ...
        CreateAccScheduleLineExtended(
          XReducedTrialBalanceAccSchedNameTxt, '10', XTotalRevenueTxt, MakeAdjustments.Convert('90-9999'), TotalAccounts, NetChange, true);
        CreateAccScheduleLineExtended(
          XReducedTrialBalanceAccSchedNameTxt, '20', XTotalCostTxt, MakeAdjustments.Convert('16-9999'), TotalAccounts, NetChange, true);
        ...
        CreateAccScheduleLine(
          ...
          StrSubstNo('%1|%2|%3', MakeAdjustments.Convert('26-9999'), MakeAdjustments.Convert('70-9999'), MakeAdjustments.Convert('02-9999')),
        ...
        CreateAccScheduleLine(
          XReducedTrialBalanceAccSchedNameTxt, '80', XOtherExpensesTxt, MakeAdjustments.Convert('44-2990'), PostingAccounts,
          NetChange);
        CreateAccScheduleLineExtended(
          XReducedTrialBalanceAccSchedNameTxt, '90', XIncomeBeforeInterestAndTaxTxt, MakeAdjustments.Convert('90-9999'), TotalAccounts,
          NetChange, true);
    end;
