codeunit 101289 "Create Payment Method"
{
    ...
    trigger OnRun()
    begin
        InsertData(XBANK, XBanktransfer, "Payment Method"."Bal. Account Type"::"Bank Account", XWWBRUR, '');
        ...
        InsertData(XCASH, XCashpayment, "Payment Method"."Bal. Account Type"::"Bank Account", XCASH + '1', '');
