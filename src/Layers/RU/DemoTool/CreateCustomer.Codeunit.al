codeunit 101018 "Create Customer"
{
    ...
    begin
        ...
        InsertData(XCLE + '001', XAdventureWorks, XMarketSquare19, '', '', '', '', '', '', '7700000009', XLND, '', '');
        InsertData(XCLE + '002', XAlpineSkiHouses, XLeninaStreet15, '', '', '', '', '', '', '7753698411', XLND, '', '');
        InsertData(XCLE + '003', XSouthridgeVideo, XMayakovskogoStreet16, '', '', '', '', '', '', '7712458964', XLND, '', '');
        InsertData(XCLE + '004', XADatumCorporation, XMehanizatorovStreet33, '', '', '', '', '', '', '7712458957', XLND, '', '');
        InsertData(XCLE + '005', XBlueYonderAirlines, XVodnyPassage11, '', '', '', '', '', '', '7712458940', XLND, '', '');
        InsertData(XCLE + '006', XAlpineSkiHousePlus, X26BakinskyComissarsStreet5, '', '', '', '', '', '', '7712458932', XLND, '', '');
        InsertData(XCSH + '001', XNordTraders, '', '', XSpartakovskayaStreet6, '', '', '', '', '7712458925', XLND, '', '');
        InsertData(XCSH + '002', XCohoVineyardWinery, XLeninaStreet15, '', '', '', '', '', '', '7712458918', XLND, '', '');
    ...
    var
        ...
        XAlpineSkiHouses: Label 'Alpine Ski Houses';
        XSouthridgeVideo: Label 'Southridge Video';
        XADatumCorporation: Label 'A. Datum Corporation';
        XBlueYonderAirlines: Label 'Blue Yonder Airlines';
        XAlpineSkiHousePlus: Label 'Alpine Ski House +';
        XNordTraders: Label 'Nord Traders';
        XCohoVineyardWinery: Label 'Coho Vineyard & Winery';
        XCLE: Label 'CLE';
        XLND: Label 'LND';
        XMarketSquare19: Label 'Market square, 19';
        XLeninaStreet15: Label 'Lenina street, 15';
        XMayakovskogoStreet16: Label 'Mayakovskogo steet, 16';
        XMehanizatorovStreet33: Label 'Mehanizatorov steet, 33';
        XVodnyPassage11: Label 'Vodny passage, 11';
        X26BakinskyComissarsStreet5: Label '26 Bakinsky Comis. street, 5';
        XSpartakovskayaStreet6: Label 'Spartakovskaya street, 6';
    ...
    begin
        ...
        Customer.Validate("Customer Posting Group", CreateCurrency.GetCustPostingGroup("Country Code"));
        case Customer."No." of
            XCSH + '001',
          XCSH + '002':
                Customer.Validate("Customer Posting Group", '76-2200');
        end;
        Customer.Validate("Gen. Bus. Posting Group", CreateCurrency.GetCustBusPostingGroup());
        Customer.Validate("VAT Bus. Posting Group", XSALES);
