codeunit 101579 "Create Marketing Setup"
{
    ...
    begin
        ...
        CreateNoSeries.InitBaseSeries(MarketingSetup."Contact Nos.", XCRM + XCONT, XContact, XCT000001, XCT100000, '', '', 1);
        CreateNoSeries.InitBaseSeries(MarketingSetup."Campaign Nos.", XCRM + XCAMP, XCampaign, XCP0001, XCP9999, '', '', 1, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."Segment Nos.", XCRM + XSEGM, XSegment, XSM00001, XSM99999, '', '', 1, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."To-do Nos.", XCRM + XTASK, XTaskDescr, XTD000001, XTD999999, '', '', 1, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."Opportunity Nos.", XCRM + XOPP, XOpportunity, XOP000001, XOP999999, '', '', 1, Enum::"No. Series Implementation"::Sequence);
