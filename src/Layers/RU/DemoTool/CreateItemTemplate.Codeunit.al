codeunit 101997 "Create Item Template"
{
    ...
    var
        ...
        xGOODS0Txt: Label 'GOODS0', Comment = 'Translate.';
        XGOODS20Txt: Label 'GOODS20', Comment = 'Translate.';
        XSERV20Txt: Label 'SERV20', Comment = 'Translate.';
        xSERV0Txt: Label 'SERV0', Comment = 'Translate.';
    ...
    begin
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, XGOODS20Txt, XGOODS20Txt, DemoDataSetup.ResaleCode());
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, xGOODS0Txt, xGOODS0Txt, DemoDataSetup.ResaleCode());
        InsertPricingInfo(ConfigTemplateHeader, false);
        // Service template
        InsertTemplateHeader(ConfigTemplateHeader, xServiceDescTxt);
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, XSERV20Txt, XSERV20Txt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, xSERV0Txt, xSERV0Txt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
        // Freight template
        InsertTemplateHeader(ConfigTemplateHeader, DemoDataSetup.FreightCode());
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.FreightCode(), XGOODS20Txt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
