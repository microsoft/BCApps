codeunit 118843 "Create Dist. Vendor"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '60000', XGrassblueLtd, X8OneWay, CreatePostCode.Convert('GB-N12 5XY'), XGB, XGrassblueLtd, XRB, XLondon,
          XBUSINESS, XPURCHASE, '60-1010', 0, XCOD, 1, XWHITE, XCIF, '');
        InsertData(
          '61000', XElectronicsLtd, X354OxfordStreet, CreatePostCode.Convert('GB-N16 34Z'), XGB, XElectronicsLtd, XRB, XLondon,
          XBUSINESS, XPURCHASE, '60-1010', 0, XCOD, 2, XWHITE, XCPT, '');
        InsertData(
          '62000', XWalkerHolland, X116KensingtonRoad, CreatePostCode.Convert('GB-WC1 3DG'), XGB, XWalkerHolland, XRB, XLondon,
          XBUSINESS, XPURCHASE, '60-1010', 0, XCOD, 3, XWHITE, XCFR, '');
    end;
