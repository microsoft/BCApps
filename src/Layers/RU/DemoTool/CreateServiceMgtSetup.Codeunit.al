codeunit 117012 "Create Service Mgt. Setup"
{
    ...
    begin
        ...
        ModifyData2(
          false, 24, '<1Y>', XSRV + '-13', XSRV + '-14',
          XSRV + '-11', XSRV + '-04', XSRV + '-12', XSRV + '-02', XSRV + '-20', XSRV + '-03', XSRV + '-05',
          XSRV + '-01', XSERVICE, ServiceMgtSetup."Contract Value Calc. Method"::"Based on Unit Price", 15, XSRV + '-10');
        ModifyData3(XSERVICE, XSRV + '-19', XSRV + '-15', XSRV + '-16', XSRV + '-17',
