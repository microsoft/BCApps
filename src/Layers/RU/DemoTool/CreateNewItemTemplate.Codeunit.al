codeunit 122008 "Create New Item Template"
{
    ...
    begin
        ...
        InsertPostingInfo(ItemTempl, CreateGenProdPostingGr.GetGoods20Code(), CreateVATProdPostingGr.GetGoods20Code(), '41-2000');
        ...
        InsertPostingInfo(ItemTempl, CreateGenProdPostingGr.GetServ20Code(), CreateVATProdPostingGr.GetServ20Code(), '');
