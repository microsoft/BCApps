codeunit 101592 "Create Opportunity"
{
    ...
    begin
        InsertData(XOP100001, XNewTables, XBC, '', XCT200116,
          XCT100006, XEXLARGE, '', 19021105D, 1, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100002, XNewTables, XBC, '', XCT200097,
          XCT100003, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100003, XNewTables, XBC, '', XCT200094,
          XCT100009, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100004, XNewTables, XBC, '', XCT200091,
          XCT100012, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100005, XNewTables, XBC, '', XCT100002,
          XCT100001, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100006, XNewTables, XBC, '', XCT200107,
          XCT100017, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100007, XNewTables, XBC, '', XCT200112,
          XCT100010, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        ...
        InsertData(XOP100010, XNewTables, XBC, '', XCT200122,
          XCT100007, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100011, XNewTables, XBC, '', XCT200001,
          XCT100007, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100012, XNewTables, XBC, '', XCT200101,
          XCT100005, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100013, XNewTables, XBC, '', XCT200105,
          XCT100019, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100014, XNewTables, XBC, '', XCT200130,
          XCT100241, XEXLARGE, '', 19021205D, 0, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100015, XAssemblingfurniture, XJO, '', XCT200136,
          ContactNo(DATABASE::Customer, '10000'), XEXLARGE, '', 19030104D, 2, 0, true, 19030126D, XCRM + XOPP);
        InsertData(XOP100016, XAssemblingfurniture, XJO, '', ContactNo(DATABASE::Customer, '20000'),
          ContactNo(DATABASE::Customer, '20000'), XEXSMALL, '', 19030104D, 2, 1, true, 19030121D, XCRM + XOPP);
        InsertData(XOP100017, XAssemblingfurniture, XJO, '', XCT200080,
          ContactNo(DATABASE::Customer, '30000'), XEXSMALL, '', 19030106D, 2, 1, true, 19030120D, XCRM + XOPP);
        InsertData(XOP100018, XFurnituretosalesdepartment, XJO, '', ContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XFIRSTSMALL, '', 19030106D, 2, 0, true, 19030120D, XCRM + XOPP);
        InsertData(XOP100019, XFurniturefortheconference, XJO, '', XCT200136,
          ContactNo(DATABASE::Customer, '10000'), XEXLARGE, '', 19030101D, 2, 1, true, 19030111D, XCRM + XOPP);
        InsertData(XOP100020, XChairsforthecanteen, XOF, '', ContactNo(DATABASE::Customer, '42147258'),
          ContactNo(DATABASE::Customer, '42147258'), XEXSMALL, '', 19030103D, 2, 2, true, 19030112D, XCRM + XOPP);
        InsertData(XOP100021, XComplconferencearrangement, XOF, '', ContactNo(DATABASE::Customer, '43687129'),
          ContactNo(DATABASE::Customer, '43687129'), XFIRSTSMALL, '', 19030111D, 2, 1, true, 19030116D, XCRM + XOPP);
        InsertData(XOP100022, XStoragefacilities, XBC, '', XCT100140,
          ContactNo(DATABASE::Customer, '10000'), XEXLARGE, '', 19030121D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100023, XSwivelchair, XBC, '', ContactNo(DATABASE::Customer, '20000'),
          ContactNo(DATABASE::Customer, '20000'), XEXSMALL, '', 19021111D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100024, XTablelightingTxt, XHR, '', XCT200079,
          ContactNo(DATABASE::Customer, '30000'), XEXSMALL, '', 19021214D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100025, XGuestchairsforthereception, XHR, '', ContactNo(DATABASE::Customer, '40000'),
          ContactNo(DATABASE::Customer, '40000'), XEXLARGE, '', 19030124D, 1, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100026, XStoragesystem, XHR, '', ContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XEXLARGE, '', 19021126D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100027, XDesksfortheservicedep, XJO, '', ContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XEXSMALL, '', 19021101D, 0, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100028, XChangingofficefurniture, XBC, '', XCT100148,
          ContactNo(DATABASE::Customer, '31669966'), XEXLARGE, '', 19021014D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100029, XLookingforthreepiecesuite, XBC, '', ContactNo(DATABASE::Customer, '31987987'),
          ContactNo(DATABASE::Customer, '31987987'), XEXSMALL, '', 19020905D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100030, X10to15Whiteboards, XHR, '', XCT100215,
          ContactNo(DATABASE::Customer, '32124578'), XEXSMALL, '', 19021112D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100031, XNewconferencesystem, XOF, '', XCT100215,
          ContactNo(DATABASE::Customer, '32124578'), XEXSMALL, '', 19021116D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100032, XDeskandchairforthemanager, XHR, '', ContactNo(DATABASE::Customer, '32656565'),
          ContactNo(DATABASE::Customer, '32656565'), XEXSMALL, '', 19030108D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100033, X12greenswivelchairs, XBC, '', XCT100163,
          ContactNo(DATABASE::Customer, '32789456'), XFIRSTSMALL, '', 19021010D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100034, XNeedaMobilePedestal, XHR, '', XCT100230,
          ContactNo(DATABASE::Customer, '34010100'), XFIRSTLARGE, '', 19021213D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100035, X2Guestchairsblue, XHR, '', XCT100230,
          ContactNo(DATABASE::Customer, '34010100'), XFIRSTLARGE, '', 19021223D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100036, XConferencetableblack, XOF, '', ContactNo(DATABASE::Customer, '34010199'),
          ContactNo(DATABASE::Customer, '34010199'), XEXSMALL, '', 19021128D, 1, 0, false, 0D, XCRM + XOPP);
        InsertData(XOP100037, XConferencetable, XOF, '', ContactNo(DATABASE::Customer, '01445544'),
          ContactNo(DATABASE::Customer, '01445544'), XFIRSTSMALL, '', 19020926D, 3, 1, true, 19021016D, XCRM + XOPP);
        InsertData(XOP100038, XNewofficesystem, XOF, '', XCT200009,
          ContactNo(DATABASE::Customer, '31505050'), XFIRSTLARGE, '', 19020922D, 3, 2, true, 19021003D, XCRM + XOPP);
        InsertData(XOP100039, XCompletestoragesystem, XHR, '', ContactNo(DATABASE::Customer, '34010602'),
          ContactNo(DATABASE::Customer, '34010602'), XFIRSTLARGE, '', 19030105D, 3, 1, true, 19030116D, XCRM + XOPP);
        InsertData(XOP100040, X30chairsblue, XBC, '', ContactNo(DATABASE::Customer, '34010602'),
          ContactNo(DATABASE::Customer, '34010602'), XEXSMALL, '', 19030109D, 3, 2, true, 19030124D, XCRM + XOPP);
        InsertData(XOP100041, XInnsbruckStorageunits, XBC, '', XCT100189,
          ContactNo(DATABASE::Customer, '35122112'), XEXLARGE, '', 19021018D, 3, 1, true, 19021024D, XCRM + XOPP);
        InsertData(XOP100042, X2guestchairs, XBC, '', XCT100189,
          ContactNo(DATABASE::Customer, '35122112'), XEXLARGE, '', 19030106D, 3, 1, true, 19030121D, XCRM + XOPP);
        InsertData(XOP100043, XLampsforthemanageroffice, XHR, '', ContactNo(DATABASE::Customer, '35963852'),
          ContactNo(DATABASE::Customer, '35963852'), XEXSMALL, '', 19021117D, 3, 2, true, 19021120D, XCRM + XOPP);
        InsertData(XOP100044, XLampsforthecanteen, XOF, '', ContactNo(DATABASE::Customer, '32656565'),
          ContactNo(DATABASE::Customer, '32656565'), XFIRSTSMALL, '', 19030110D, 3, 1, true, 19030121D, XCRM + XOPP);
        InsertData(XOP100045, XNewInterior, XBC, '', XCT100132,
          ContactNo(DATABASE::Customer, '01121212'), XFIRSTLARGE, '', 19021011D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100046, XNewlampsinthereception, XHR, '', ContactNo(DATABASE::Customer, '01445544'),
          ContactNo(DATABASE::Customer, '01445544'), XFIRSTSMALL, '', 19021107D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100047, XGuestchairsforthereception, XOF, '', XCT100152,
          ContactNo(DATABASE::Customer, '01454545'), XFIRSTLARGE, '', 19021015D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(XOP100048, XInterestedintheROMEchair, XBC, '', XCT100152,
          ContactNo(DATABASE::Customer, '01454545'), XFIRSTLARGE, '', 19021103D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(XOP100049, XStorageunitsorshelves, XHR, '', XCT100226,
          ContactNo(DATABASE::Customer, '31505050'), XFIRSTSMALL, '', 19021203D, 1, 0, false, 0D, XCRM + XOPP);
    end;
    ...
    begin
        InsertData(
          ...
          ContactNo(DATABASE::Customer, '10000'), XEXISTING, '', 19030104D, 2, 0, true, 19030126D, XCRM + XOPP);
        InsertData(
          XOP100016, XAssemblingfurniture, XJO, '', PersonContactNo(DATABASE::Customer, '20000'),
          ContactNo(DATABASE::Customer, '20000'), XEXISTING, '', 19030104D, 2, 1, true, 19030121D, XCRM + XOPP);
        InsertData(
          XOP100017, XAssemblingfurniture, XOF, '', PersonContactNo(DATABASE::Customer, '30000'),
          ContactNo(DATABASE::Customer, '30000'), XEXISTING, '', 19030106D, 2, 1, true, 19030120D, XCRM + XOPP);
        InsertData(
          XOP100018, XFurnituretosalesdepartment, XJO, '', PersonContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XNEW, '', 19030106D, 2, 0, true, 19030120D, XCRM + XOPP);
        InsertData(
          XOP100019, XFurniturefortheconference, XJO, '', PersonContactNo(DATABASE::Customer, '10000'),
          ContactNo(DATABASE::Customer, '10000'), XEXISTING, '', 19030101D, 2, 1, true, 19030111D, XCRM + XOPP);
        InsertData(
          XOP100022, XStoragefacilities, XBC, '', PersonContactNo(DATABASE::Customer, '10000'),
          ContactNo(DATABASE::Customer, '10000'), XEXISTING, '', 19030121D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100023, XSwivelchair, XBC, '', PersonContactNo(DATABASE::Customer, '20000'),
          ContactNo(DATABASE::Customer, '20000'), XEXISTING, '', 19021111D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100024, XTablelightingTxt, XHR, '', PersonContactNo(DATABASE::Customer, '30000'),
          ContactNo(DATABASE::Customer, '30000'), XEXISTING, '', 19021214D, 1, 1, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100025, XGuestchairsforthereception, XHR, '', PersonContactNo(DATABASE::Customer, '40000'),
          ContactNo(DATABASE::Customer, '40000'), XEXISTING, '', 19030124D, 1, 0, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100026, XStoragesystem, XHR, '', PersonContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XEXISTING, '', 19021126D, 1, 2, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100027, XDesksfortheservicedep, XJO, '', PersonContactNo(DATABASE::Customer, '50000'),
          ContactNo(DATABASE::Customer, '50000'), XEXISTING, '', 19021101D, 0, 1, false, 0D, XCRM + XOPP);
        InsertData(
          XOP100037, XConferencetable, XOF, '', PersonContactNo(DATABASE::Customer, '40000'),
          ContactNo(DATABASE::Customer, '40000'), XNEW, '', 19020926D, 3, 1, true, 19021016D, XCRM + XOPP);
        InsertData(
          XOP100038, XNewofficesystem, XOF, '', PersonContactNo(DATABASE::Customer, '20000'),
          ContactNo(DATABASE::Customer, '20000'), XNEW, '', 19020922D, 3, 2, true, 19021003D, XCRM + XOPP);
        InsertData(
          XOP100039, XCompletestoragesystem, XHR, '', PersonContactNo(DATABASE::Customer, '30000'),
          ContactNo(DATABASE::Customer, '30000'), XNEW, '', 19030105D, 3, 1, true, 19030116D, XCRM + XOPP);
        InsertData(
          XOP100040, X30chairsblue, XBC, '', PersonContactNo(DATABASE::Customer, '40000'),
          ContactNo(DATABASE::Customer, '40000'), XEXISTING, '', 19030109D, 3, 2, true, 19030124D, XCRM + XOPP);
    end;
}
