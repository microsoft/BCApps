codeunit 101080 "Create Gen. Journal Template"
{
    ...
    begin
        ...
        InsertData(
          ...
          XBNK + '-05', XRecurringGeneralJournal, '6001', 'G07000');

        InsertData(
          XCASHORDER, XCashOrderPayments, "Gen. Journal Template".Type::"Cash Order Payments", false, '',
          XCASHORDER, XCashOrderPayments, '00001', '99999');
        InsertData(
          XVATSET, XVATSettlement, "Gen. Journal Template".Type::"VAT Settlement", false, '',
          '', '', '', '');
        InsertData(
          XFUTEXP, XFutureExpenses, "Gen. Journal Template".Type::"Future Expenses", true, '',
          XFUTEXP, XFutureExpenses, '00001', '99999');
        InsertData(
          XPAYROLL, XPayroll2, "Gen. Journal Template".Type::Payments, false, '',
          XJNL + '-25', XPayroll2, '5001', 'G06000');
    end;
    ...
    begin
        ...
        "Gen. Journal Template".Validate(Archive, true);
        "Gen. Journal Template"."Copy VAT Setup to Jnl. Lines" := false;
