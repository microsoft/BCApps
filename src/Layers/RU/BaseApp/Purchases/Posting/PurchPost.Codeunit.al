...
codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        SavedIndirectCall := IndirectCall;
        ...
        IndirectCall := SavedIndirectCall;
    ...
    begin
        ...
        TempPurchLineGlobal.SetRange(Type, TempPurchLineGlobal.Type::"Empl. Purchase");
        ChangeTransaction := not TempPurchLineGlobal.FindFirst();
        TempPurchLineGlobal.SetRange(Type);
        ...
        PostEmplPurchLine(PurchHeader, TempEmplPurchLine);

        OnRunOnBeforePostInvoice(PurchHeader, EverythingInvoiced);

        if PurchHeader.Invoice then
            PostInvoice(PurchHeader, CVLedgEntryBuf);
...
#pragma warning restore AA0470
    ...
    begin
        ...
        if not (InvtPickPutaway or SuppressCommit) and CommitAllowed then begin
            Commit();
    ...
    begin
        ...
        if PurchHeader."Prepmt. Diff." then begin
            PrepmtDiffVendorLedgerEntry.Get(PurchHeader."Prepmt. Diff. Appln. Entry No.");
            PurchHeader."Prepmt. Diff. Appln. Entry No." := 0;
            InitialVATTransactionNo := PurchHeader."No. Printed";
            PurchHeader."No. Printed" := 0;
        end;

        CommitAllowed := (PurchHeader."Prepmt. Diff. Appln. Entry No." = 0) and (not PurchHeader."Prepmt. Diff.") and (not PreviewMode);
        ...
        if not PreviewMode and ModifyHeader then begin
            ...
            if (not IsHandled) and (not SuppressCommit) and CommitAllowed then
                Commit();
        end;
        ...
        SourceCodeSetup.Get();
        if PurchHeader."Empl. Purchase" then
            SrcCode := SourceCodeSetup."Advance Statements"
        else
    ...
    begin
        ...
        CheckVendAgreement(PurchHeader, PurchHeader."Buy-from Vendor No.");
        ...
        if GLSetup."Enable Russian Accounting" and not PurchHeader."Empl. Purchase" then
            DocSignMgt.CheckDocSignatures(DATABASE::"Purchase Header", PurchHeader."Document Type".AsInteger(), PurchHeader."No.");

        if (PurchHeader."Prepmt. Diff. Appln. Entry No." = 0) and (not PurchHeader."Prepmt. Diff.") then
            if PurchHeader.Invoice then
    ...
    local procedure PostPurchLine(var PurchHeader: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var TempVATAmountLine: Record "VAT Amount Line" temporary; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary; var TempDropShptPostBuffer: Record "Drop Shpt. Post. Buffer" temporary; var EverythingInvoiced: Boolean; var ICGenJnlLineNo: Integer; var TempEmplPurchLine: Record "Purchase Line" temporary)
    var
    ...
    begin
        ...
        if (PurchLine.Type = PurchLine.Type::Item) and (PurchLine."No." <> '') then begin
            ...
            if InventorySetup."Employee No. Mandatory" and
               ((PurchLine."Document Type" = PurchLine."Document Type"::Order) or
                (PurchLine."Document Type" = PurchLine."Document Type"::Invoice) or
                (PurchLine."Document Type" = PurchLine."Document Type"::"Credit Memo") or
                (PurchLine."Document Type" = PurchLine."Document Type"::"Return Order"))
            then
                PurchLine.TestField("Employee No.");
            ...
            if Item."Unit Volume Mandatory" then
                PurchLine.TestField("Unit Volume");
        end;
        ...
        if PurchLine.Type = PurchLine.Type::"Empl. Purchase" then begin
            PurchLine.TestField("Empl. Purchase Vendor No.");
            PurchLine.TestField("Empl. Purchase Entry No.");
            PurchLine.TestField("Empl. Purchase Document No.");
            PurchLine.TestField("Empl. Purchase Document Date");
        ...
        case PurchLine.Type of
            ...
            PurchLine.Type::"Empl. Purchase":
                begin
                    TempEmplPurchLine := PurchLine;
                    TempEmplPurchLine.Insert();
                end;
            else
        ...
        if (PurchLine.Type <> PurchLine.Type::" ") and (PurchLine."Qty. to Invoice" <> 0) and (PurchLine.Type <> PurchLine.Type::"Empl. Purchase") then begin
    ...
    local procedure PostInvoice(var PurchHeader: Record "Purchase Header"; var CVLedgEntryBuf: Record "CV Ledger Entry Buffer")
    var
    ...
    begin
        ...
        if (not PurchHeader."Prepmt. Diff.") and (not VendorPostingGroup."Skip Posting") then
    ...
    local procedure PostEmplPurchLine(PurchHeader: Record "Purchase Header"; var TempEmplPurchLine: Record "Purchase Line" temporary)
    var
        GenJnlLine: Record "Gen. Journal Line";
        VendLedgEntry2: Record "Vendor Ledger Entry";
    begin
        if TempEmplPurchLine.FindSet() then begin
            repeat
                GenJnlLine.Init();
                ...
                GenJnlLine."Account No." := TempEmplPurchLine."Empl. Purchase Vendor No.";
                GenJnlLine."System-Created Entry" := true;
                GenJnlLine.Amount := TempEmplPurchLine.Amount;
                GenJnlLine."Source Currency Code" := PurchHeader."Currency Code";
                GenJnlLine."Source Currency Amount" := TempEmplPurchLine.Amount;
                GenJnlLine.Correction := PurchHeader.Correction;
                GenJnlLine."Gen. Bus. Posting Group" := TempEmplPurchLine."Gen. Bus. Posting Group";
                GenJnlLine."Gen. Prod. Posting Group" := TempEmplPurchLine."Gen. Prod. Posting Group";
                GenJnlLine."VAT Bus. Posting Group" := TempEmplPurchLine."VAT Bus. Posting Group";
                GenJnlLine."VAT Prod. Posting Group" := TempEmplPurchLine."VAT Prod. Posting Group";
                GenJnlLine."Tax Area Code" := TempEmplPurchLine."Tax Area Code";
                GenJnlLine."Tax Liable" := TempEmplPurchLine."Tax Liable";
                GenJnlLine."Tax Group Code" := TempEmplPurchLine."Tax Group Code";
                GenJnlLine."Use Tax" := TempEmplPurchLine."Use Tax";
                GenJnlLine.Quantity := TempEmplPurchLine.Quantity;
                GenJnlLine."VAT Difference" := TempEmplPurchLine."VAT Difference";
                GenJnlLine."VAT Posting" := GenJnlLine."VAT Posting"::"Manual VAT Entry";
                GenJnlLine."Job No." := TempEmplPurchLine."Job No.";
                ...
                GenJnlLine."Agreement No." := TempEmplPurchLine."Agreement No.";
                GenJnlLine."Dimension Set ID" := TempEmplPurchLine."Dimension Set ID";
                if VendLedgEntry2.Get(TempEmplPurchLine."Empl. Purchase Entry No.") then begin
                    GenJnlLine."Applies-to Doc. Type" := VendLedgEntry2."Document Type";
                    GenJnlLine."Applies-to Doc. No." := VendLedgEntry2."Document No.";
                    GenJnlLine."Posting Group" := VendLedgEntry2."Vendor Posting Group";
                end;
                ...
                if not ChangeTransaction then
                    GenJnlPostLine.SpecialRunWithCheck(GenJnlLine)
                else
                    GenJnlPostLine.RunWithCheck(GenJnlLine);
            until TempEmplPurchLine.Next() = 0;
            TempEmplPurchLine.DeleteAll();
        end;
    end;
    ...
    var
        ...
        IsHandled: Boolean;
    begin
        if PurchLine."No Ledger Entry" then
            exit;
        ...
        ItemJnlLine."Red Storno" := PurchHeader.Correction and
    ...
    begin
        ...
        if FASetup."FA Location Mandatory" then
            PurchaseLine.TestField("FA Location Code", ErrorInfo.Create());
        if FASetup."Employee No. Mandatory" then
            PurchaseLine.TestField("Employee No.", ErrorInfo.Create());
        ...
        if PurchaseLine."FA Charge No." <> '' then
            if not (FixedAsset.Status in [FixedAsset.Status::Inventory, FixedAsset.Status::Montage]) then begin
                FACharge.Get(PurchaseLine."FA Charge No.");
                FACharge.TestField("G/L Acc. for Released FA", ErrorInfo.Create());
                PurchaseLine.Type := PurchaseLine.Type::"G/L Account";
                PurchaseLine."No." := FACharge."G/L Acc. for Released FA";
            end;
        ...
        if GLSetup."Enable Russian Accounting" then
            if PurchaseLine."FA Posting Type" = PurchaseLine."FA Posting Type"::"Acquisition Cost" then begin
                ...
                if GetTaxRegisterSetup() then
                    if TaxRegisterSetup."Calculate TD for each FA" and DeprBook."Control FA Acquis. Cost" then
                        PurchaseLine.TestField("Tax Difference Code", ErrorInfo.Create());
            end;
        ...
        if (PurchaseLine."Shortcut Dimension 1 Code" <> '') or (PurchaseLine."Shortcut Dimension 2 Code" <> '') then begin
            FixedAsset.Validate("Global Dimension 1 Code", PurchaseLine."Shortcut Dimension 1 Code");
            FixedAsset.Validate("Global Dimension 2 Code", PurchaseLine."Shortcut Dimension 2 Code");
        end;
    end;
        ...
        if ShouldUpdateReceivingNo then
            ...
            then
                if not PreviewMode then begin
                    ...
                    if (PurchHeader."Posting No." <> '') and (PurchHeader."Receiving No. Series" = PurchHeader."Posting No. Series") then
                        PurchHeader."Receiving No." := PurchHeader."Posting No."
                    else
        ...
        if PurchHeader.Ship and (PurchHeader."Return Shipment No." = '') then
            ...
            then
                if not PreviewMode then begin
                    ...
                    if (PurchHeader."Posting No." <> '') and (PurchHeader."Return Shipment No. Series" = PurchHeader."Posting No. Series") then
                        PurchHeader."Return Shipment No." := PurchHeader."Posting No."
                    else
            ...
            if PurchHeader.Invoice and (PurchHeader."Posting No." = '') then begin
                ...
                then
                    if not PreviewMode then begin
                        ...
                        if not IsHandled then
                            if (PurchHeader."Receiving No." <> '') and (PurchHeader."Receiving No. Series" = PurchHeader."Posting No. Series") then
                                PurchHeader."Posting No." := PurchHeader."Receiving No."
                            else
                                if (PurchHeader."Return Shipment No." <> '') and (PurchHeader."Return Shipment No. Series" = PurchHeader."Posting No. Series") then
                                    PurchHeader."Posting No." := PurchHeader."Return Shipment No."
                                else
    ...
    begin
        ...
        if PreviewMode and (CalledBy = 0) and (not IndirectCall) then begin
            if GuiAllowed() and not HideProgressWindow then
                Window.Close();
        ...
        if not IsHandled then
            if not (InvtPickPutaway or SuppressCommit or PreviewMode) and CommitAllowed then
                Commit();
    ...
    begin
        ...
        if (PurchLineQty = 0) or (PurchLine."Direct Unit Cost" = 0) then begin
            ...
            PurchLine."Amount (LCY)" := 0;
            PurchLine."Amount Including VAT (LCY)" := 0;
...
#pragma warning restore AA0005
    ...
    begin
        ...
        xPurchLine."Amount (LCY)" := PurchaseLine.Amount;
        xPurchLine."Amount Including VAT (LCY)" := PurchaseLine."Amount Including VAT";
    ...
    begin
        ...
        PurchLine."Amount (LCY)" := -PurchLine."Amount (LCY)";
        PurchLine."Amount Including VAT (LCY)" := -PurchLine."Amount Including VAT (LCY)";
    ...
    begin
        ...
        InvoicePostingParameters."Initial VAT Transaction No." := InitialVATTransactionNo;
        InvoicePostingParameters."Change Transaction" := ChangeTransaction;
        InvoicePostingParameters."Prepmt. Diff. Appln. Entry No." := PrepmtDiffVendorLedgerEntry."Entry No.";
    end;
    ...
    begin
        ...
        if PurchHeader."Document Type" in [PurchHeader."Document Type"::Order, PurchHeader."Document Type"::Invoice] then
            CopyFACommentLines(PurchHeader."No.", PurchInvHeader."No.");
    ...
    begin
        FAComment.SetRange("Document Type", FAComment."Document Type"::"Purchase Invoice");
    ...
    [Scope('OnPrem')]
    procedure UpdatePurchLines(var PurchHeader: Record "Purchase Header"; Amount: Decimal; DocNo: Code[20]; CurrencyCode: Code[10]; CurrencyCode2: Code[10]; CorrType: Option Loss,Gain): Boolean
    var
        PurchLine: Record "Purchase Line";
        VATProdPostingGroup: Record "VAT Product Posting Group";
        TempPurchRcptLine: Record "Purch. Rcpt. Line" temporary;
        TmpPurchLine: Record "Purchase Line";
        VendLedgEntry: Record "Vendor Ledger Entry";
    ...
    begin
        if PurchHeader."Prepmt. Diff." then
            VendLedgEntry.Get(PurchHeader."Prepmt. Diff. Appln. Entry No.");

        PurchHeader.CalcFields("Amount Including VAT");
        PurchHeader.RecalculatePurchLines(Abs(Amount));
        ...
        repeat
            if (PurchLine.Type <> PurchLine.Type::" ") and (PurchLine."No." <> '') then begin
                if UseZeroVAT then begin // zero VAT
                    VATProdPostingGroup.Get(PurchLine."VAT Prod. Posting Group");
                    VATProdPostingGroup.TestField("Zero VAT Group Code");
                    PurchLine."VAT Prod. Posting Group" := VATProdPostingGroup."Zero VAT Group Code";
                end;
                TmpPurchLine := PurchLine;
                case PurchLine.Type of
                    PurchLine.Type::Item,
                    PurchLine.Type::"Charge (Item)":
                        begin
                            case VendLedgEntry."Document Type" of
                                VendLedgEntry."Document Type"::Invoice:
                                    begin
                                        FindPurchReceipts(PurchLine, TempPurchRcptLine, DocNo, VendLedgEntry."Posting Date");
                                        RcptShptIsFound := not TempPurchRcptLine.IsEmpty();
                                    end;
                                VendLedgEntry."Document Type"::"Credit Memo":
                                    begin
                                        FindReturnShipments(PurchLine, TempReturnShptLine, DocNo, VendLedgEntry."Posting Date");
                                        RcptShptIsFound := not TempReturnShptLine.IsEmpty();
                                    end;
                            end;
                            if RcptShptIsFound then begin
                                CostAdjmt := true;
                                if PurchLine.Type = PurchLine.Type::Item then begin
                                    InvPostingGroup.Get(PurchLine."Posting Group");
                                    if PurchHeader."Prepmt. Diff." then begin
                                        InventoryPeriod.SetRange("Ending Date", CalcDate('<1M+CM>', PurchHeader."Posting Date"));
                                        if InventoryPeriod.FindFirst() then begin
                                            if InventoryPeriod.Closed then begin
                                                ...
                                                PurchLine.Validate(
                                                  "No.",
                                                  InvPostingGroup.GetPDAccount(
                                                    CorrType = CorrType::Gain,
                                                    PurchLine."Location Code"));
                                            end else
                                                SetPurchLineChargeItem(PurchLine, TmpPurchLine, InvPostingGroup, CurrencyCode2);
                                        end else
                                            SetPurchLineChargeItem(PurchLine, TmpPurchLine, InvPostingGroup, CurrencyCode2);
                                    end;
                                end;
                                ...
                                PurchLine.Validate(Quantity, 1);
                                PurchLine.Validate("Direct Unit Cost", TmpPurchLine."Direct Unit Cost");

                                if CostAdjmt then
                                    case VendLedgEntry."Document Type" of
                                        VendLedgEntry."Document Type"::Invoice:
                                            PurchItemChargeAssgnt(PurchLine, TempPurchRcptLine, PurchHeader."Prices Including VAT");
                                        VendLedgEntry."Document Type"::"Credit Memo":
                                            PurchReturnItemChargeAssgnt(PurchLine, TempReturnShptLine, PurchHeader."Prices Including VAT");
                                    end;
                            end;
                        end;
                    PurchLine.Type::"Fixed Asset":
                        begin
                            if PurchHeader."Prepmt. Diff." then
                                FAProcessing2(PurchLine, CorrType, CurrencyCode2);
                            PurchLine."Line Discount %" := 0;
                            PurchLine.Validate(Quantity, 1);
                            PurchLine.Validate("Direct Unit Cost", TmpPurchLine."Direct Unit Cost");
                        end;
                        ...
                        PurchLine.Type := PurchLine.Type::"G/L Account";
                        if PurchHeader."Prepmt. Diff." then
                            PurchLine.Validate("No.", TmpPurchLine."No.");
                        PurchLine.Validate("VAT Prod. Posting Group", TmpPurchLine."VAT Prod. Posting Group");
                        PurchLine."Line Discount %" := 0;
                        PurchLine.Validate(Quantity, 1);
                        PurchLine.Validate("Direct Unit Cost", TmpPurchLine."Direct Unit Cost");
                    end;
                ...
                PurchLine."System-Created Entry" := true;
                PurchLine."Dimension Set ID" := TmpPurchLine."Dimension Set ID";
                PurchLine.Modify();
                if PurchHeader."Prepmt. Diff." and (CurrencyCode2 <> '') then
                    AmtDiffMgt.UpdateCorrDocDimSetID(
                      AccountType::Vendor, PurchLine."Dimension Set ID", CorrType, PurchHeader."Prepmt. Diff.");
            end;
        until PurchLine.Next() = 0;
        exit(true);
    end;
    ...
    [Scope('OnPrem')]
    procedure FindPurchReceipts(var PurchLine: Record "Purchase Line"; var TmpPurchRcptLine: Record "Purch. Rcpt. Line"; DocNo: Code[20]; PostingDate: Date)
    var
    ...
    begin
        ...
        ValueEntry.SetRange("Document Line No.", PurchLine."Line No.");
                ...
                then begin
                    ...
                    if ValueEntry.ItemValueEntryExists() then
                        if PurchRcptLine.Get(ItemLedgEntry."Document No.", ItemLedgEntry."Document Line No.") then begin
                            ...
                            if TmpPurchRcptLine.Insert() then;
                        end;
                end;
    ...
    [Scope('OnPrem')]
    procedure PurchItemChargeAssgnt(var PurchLine: Record "Purchase Line"; var TmpPurchRcptLine: Record "Purch. Rcpt. Line"; PricesIncludingVAT: Boolean)
    var
        ItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)";
    ...
    begin
        ...
        if not PricesIncludingVAT then
            ...
            ItemChargeAssgntLineAmt :=
              Round(PurchLine.CalcLineAmount() / (1 + PurchLine."VAT %" / 100), Currency."Unit-Amount Rounding Precision");
        ItemChargeAssgntPurch."Unit Cost" := Round(ItemChargeAssgntLineAmt / PurchLine.Quantity, Currency."Unit-Amount Rounding Precision");

        TmpPurchRcptLine.Find('-');
        AssignItemChargePurch.CreateRcptChargeAssgnt(TmpPurchRcptLine, ItemChargeAssgntPurch);

        AssignItemChargePurch.AssignItemCharges(PurchLine, 1, ItemChargeAssgntLineAmt, AssignItemChargePurch.AssignByAmountMenuText());
    end;

    [Scope('OnPrem')]
    procedure FindReturnShipments(var PurchLine: Record "Purchase Line"; var TmpReturnShptLine: Record "Return Shipment Line"; DocNo: Code[20]; PostingDate: Date)
    var
        ValueEntry: Record "Value Entry";
        ItemLedgEntry: Record "Item Ledger Entry";
        ReturnShptLine: Record "Return Shipment Line";
    begin
        TmpReturnShptLine.Reset();
        TmpReturnShptLine.DeleteAll();
                ...
                then begin
                    ...
                    if ValueEntry.ItemValueEntryExists() then
                        if ReturnShptLine.Get(ItemLedgEntry."Document No.", ItemLedgEntry."Document Line No.") then begin
                            TmpReturnShptLine := ReturnShptLine;
                            if TmpReturnShptLine.Insert() then;
                        end;
                end;
            until ValueEntry.Next() = 0;
    end;
    ...
    [Scope('OnPrem')]
    procedure PurchReturnItemChargeAssgnt(var PurchLine: Record "Purchase Line"; var TmpReturnShptLine: Record "Return Shipment Line"; PricesIncludingVAT: Boolean)
    var
        ItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)";
        AssignItemChargePurch: Codeunit "Item Charge Assgnt. (Purch.)";
    begin
        ...
        if not PricesIncludingVAT then
            ...
            ItemChargeAssgntPurch."Unit Cost" :=
              Round(PurchLine.CalcLineAmount() / PurchLine.Quantity / (1 + PurchLine."VAT %" / 100), Currency."Unit-Amount Rounding Precision");

        TmpReturnShptLine.Find('-');
        AssignItemChargePurch.CreateShptChargeAssgnt(TmpReturnShptLine, ItemChargeAssgntPurch);

        AssignItemChargePurch.AssignItemCharges(PurchLine, 1, PurchLine."Line Amount", AssignItemChargePurch.AssignByAmountMenuText());
    end;

    [Scope('OnPrem')]
    procedure CreateCorrDoc(DtldCVLedgEntryBuf: Record "Detailed CV Ledg. Entry Buffer"; PrepmtDiff: Boolean)
    var
        PurchHeader: Record "Purchase Header";
        PurchLine: Record "Purchase Line";
    ...
    begin
        ...
        case InvEntry."Document Type" of
            InvEntry."Document Type"::Invoice:
                begin
                    FromPurchInvHeader.Get(InvEntry."Document No.");
                    DocType := DocType::"Posted Invoice";
                end;
            InvEntry."Document Type"::"Credit Memo":
                begin
                    FromPurchCrMemoHeader.Get(InvEntry."Document No.");
        ...
        PurchHeader."No." := DtldCVLedgEntryBuf."Document No.";
        ...
        if PrepmtDiff then
            ...
            PurchHeader."Prepmt. Diff. Appln. Entry No." := DtldCVLedgEntryBuf."Transaction No.";
        ...
        then
            AmtDiffMgt.UpdateCorrDocDimSetID(
              AccountType::Vendor, PurchHeader."Dimension Set ID", CorrType, PrepmtDiff);

        if UpdatePurchLines(
             PurchHeader, DtldCVLedgEntryBuf."Amount (LCY)", InvEntry."Document No.",
    ...
    local procedure CopyUpdateCorrDoc(var PurchaseHeader: Record "Purchase Header"; VendorLedgerEntry: Record "Vendor Ledger Entry"; DetailedCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer"; var PrepmtDiffManagement: Codeunit PrepmtDiffManagement; DocType: Enum "Purchase Document Type From"; PrepmtDiff: Boolean)
    var
        PurchaseLine: Record "Purchase Line";
    ...
    begin
        ...
        if PrepmtDiff then begin
            ...
            if PurchaseHeader."Document Type".AsInteger() = PostedDocType::"Credit Memo" then
    ...
    [Scope('OnPrem')]
    procedure IsFAReleased(FANo: Code[20]): Boolean
    var
        FA: Record "Fixed Asset";
    begin
        FA.Get(FANo);
        exit(FA."Initial Release Date" <> 0D);
    end;

    [Scope('OnPrem')]
    procedure FAProcessing2(var PurchLine: Record "Purchase Line"; CorrType: Option Loss,Gain; CurrencyCode: Code[10])
    var
    ...
    begin
        ...
        FAPostGroup.Get(FADeprBook."FA Posting Group");
        if IsFAReleased(PurchLine."No.") then begin
            PurchLine.Type := PurchLine.Type::"G/L Account";
            PurchLine.Validate("No.", FAPostGroup.GetPDAccount(CorrType = CorrType::Gain));
        end else begin
            PurchLine.Validate("FA Charge No.", FAPostGroup.GetPDChargeFA(CurrencyCode));
            PurchLine.Validate("Gen. Prod. Posting Group", TmpPurchLine."Gen. Prod. Posting Group");
            PurchLine.Validate("VAT Prod. Posting Group", TmpPurchLine."VAT Prod. Posting Group");
        end;
    end;
    ...
    var
        ...
        AccountType: Option Vendor,Customer;
    begin
        if not DtldVendLedgEntry.Get(DtldCVLedgEntryBuf."Entry No.") then
            exit;

        InvEntry.Get(DtldVendLedgEntry."Vendor Ledger Entry No.");
        PayEntry.Get(DtldVendLedgEntry."Applied Vend. Ledger Entry No.");
        ...
        PurchHeader.Init();
        PurchHeader.SetHideValidationDialog(true);
        PurchHeader."No." := DtldVendLedgEntry."Document No.";

        case InvEntry."Document Type" of
            InvEntry."Document Type"::Invoice:
                begin
                    if DtldVendLedgEntry."Amount (LCY)" < 0 then begin
                        PurchHeader."Document Type" := PurchHeader."Document Type"::"Credit Memo";
                        CorrType := CorrType::Loss;
                    end else begin
                        PurchHeader."Document Type" := PurchHeader."Document Type"::Invoice;
        ...
        if PayEntry."Currency Code" <> '' then
            AmtDiffMgt.UpdateCorrDocDimSetID(
              AccountType::Vendor, PurchHeader."Dimension Set ID", CorrType, PurchHeader."Prepmt. Diff.");
    ...
    [Scope('OnPrem')]
    procedure SetPurchLineChargeItem(var PurchLine: Record "Purchase Line"; TmpPurchLine: Record "Purchase Line"; InvPostingGroup: Record "Inventory Posting Group"; CurrencyCode: Code[10])
    begin
        PurchLine.Validate(Type, PurchLine.Type::"Charge (Item)");
        PurchLine."Gen. Prod. Posting Group" := TmpPurchLine."Gen. Prod. Posting Group";
        PurchLine."VAT Prod. Posting Group" := TmpPurchLine."VAT Prod. Posting Group";
        if CurrencyCode = '' then begin
            InvPostingGroup.TestField("Purch. PD Charge Conv. (Item)");
            PurchLine.Validate("No.", InvPostingGroup."Purch. PD Charge Conv. (Item)");
        end else begin
            InvPostingGroup.TestField("Purch. PD Charge FCY (Item)");
            PurchLine.Validate("No.", InvPostingGroup."Purch. PD Charge FCY (Item)");
        end;
    end;

    [Scope('OnPrem')]
    procedure SumPurchLines2Ex(PurchHeader: Record "Purchase Header"; var NewPurchLine: Record "Purchase Line"; var OldPurchLine: Record "Purchase Line"; QtyType: Option General,Invoicing,Shipping; var TotalAmount: Decimal; var TotalAmountLCY: Decimal; var TotalAmountInclVAT: Decimal; var TotalAmountInclVATLCY: Decimal)
    var
        PurchLine: Record "Purchase Line";
        TempVATAmountLine: Record "VAT Amount Line" temporary;
        TempVATAmountLineRemainder: Record "VAT Amount Line" temporary;
    ...
    begin
        ...
        TotalAmountInclVAT := TotalPurchLine."Amount Including VAT";
        TotalAmountLCY := TotalPurchLineLCY.Amount;
        TotalAmountInclVATLCY := TotalPurchLineLCY."Amount Including VAT";
    end;
    ...
    local procedure GetTaxRegisterSetup(): Boolean
    begin
        if TaxRegisterSetupRead then
            exit(true);

        if TaxRegisterSetup.Get() then begin
            TaxRegisterSetupRead := true;
            exit(true);
        end;
    ...
    local procedure CheckVendAgreement(PurchHeader: Record "Purchase Header"; VendorNo: Code[20])
    var
        Vendor: Record Vendor;
    begin
        Vendor.Get(VendorNo);
        if Vendor."Agreement Posting" <> Vendor."Agreement Posting"::"No Agreement" then
    ...
    local procedure PostItemTracking(PurchHeader: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var TempTrackingSpecification: Record "Tracking Specification" temporary; var TrackingSpecificationExists: Boolean)
    var
    ...
    /// <summary>
    /// Event raised by OnAfterGetPurchSetup.
    /// </summary>
    /// <param name="PurchSetup"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterModifyTempLine.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterInsertCombinedSalesShipment.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnAfterPostUpdateCreditMemoLine.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(true, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterPostUpdateInvoiceLine.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(true, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterRevertWarehouseEntry.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnAfterReleasePurchDoc.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterRefreshTempLines.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnAfterResetTempLines.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnAfterReverseAmount.
    /// </summary>
    /// <param name="PurchLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterSetPostingFlags.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterUpdateLastPostingNos.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforeModifyTempLine.
    /// </summary>
    /// <param name="TempPurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforeGetPurchLines.
    /// </summary>
    /// <param name="PurchaseHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforePrepareCheckDocument.
    /// </summary>
    /// <param name="PurchaseHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforeSumPurchLinesTemp.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCheckWarehouseOnAfterSetFilters.
    /// </summary>
    /// <param name="TempItemPurchLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCopyAndCheckItemChargeOnBeforeCheckIfEmpty.
    /// </summary>
    /// <param name="TempPurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCreatePrepmtLinesOnAfterInitTempPrepmtPurchLineFromPurchHeader.
    /// </summary>
    /// <param name="TempPrepmtPurchLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCreatePrepmtLinesOnAfterTempPurchLineSetFilters.
    /// </summary>
    /// <param name="TempPurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnUpdateAssociatedSalesOrderOnBeforeClearTempDropShptPostBuffer.
    /// </summary>
    /// <param name="TempDropShptPostBuffer"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnUpdateAssocOrderOnAfterOrderNoClearFilter.
    /// </summary>
    /// <param name="TempDropShptPostBuffer"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnUpdateWhseDocumentsOnAfterUpdateWhseRcpt.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnUpdateWhseDocumentsOnAfterUpdateWhseShpt.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnBeforeRunItemJnlPostLineWithReservation.
    /// </summary>
    /// <param name="ItemJournalLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCheckAndUpdateOnAfterCopyAndCheckItemCharge.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(true, false)]
    ...
    /// <summary>
    /// Event raised by OnCreatePositiveOnBeforeWhseJnlPostLine.
    /// </summary>
    /// <param name="WhseJnlLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnSaveInvoiceSpecificationOnBeforeAssignTempInvoicingSpecification.
    /// </summary>
    /// <param name="TempInvoicingSpecification"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforeCheckAssociatedOrderLines.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnPostItemTrackingItemChargePerOrderOnAfterUpdateItemJnlLine2LocationCode.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnRunOnAfterFillTempLines.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(true, false)]
    ...
    /// <summary>
    /// Event raised by OnPostGLAccICLineOnAfterCreateJobPurchLine.
    /// </summary>
    /// <param name="PurchaseHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnCheckAndUpdateOnAfterInsertPostedHeaders.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnUpdatePostingNosOnAfterSetReturnShipmentNoFromNos.
    /// </summary>
    /// <param name="PurchHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnPostUpdateInvoiceLineOnBeforePurchOrderLineModify.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnCopyToTempLinesLoop.
    /// </summary>
    /// <param name="PurchLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnPostUpdateCreditMemoLineOnBeforeTempPurchLineSetFilters.
    /// </summary>
    /// <param name="TempPurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterPostItemChargePerRetRcpt.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterPostItemChargePerTransfer.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterPostItemChargePerRetShpt.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnAfterPostItemChargePerSalesShpt.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
...
#if not CLEAN27
    /// <summary>
    /// Event raised by OnSetPostingPreviewDocumentNo.
    /// </summary>
    /// <param name="PreviewDocumentNo"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnGetPostingPreviewDocumentNos.
    /// </summary>
    /// <param name="PreviewDocumentNos"></param>
    [IntegrationEvent(false, false)]
    [Obsolete('This event is no longer used.', '27.0')]
    ...
    /// <summary>
    /// Event raised by OnAfterDeleteItemChargeAssgnt.
    /// </summary>
    /// <param name="PurchaseHeader"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnDivideAmountOnAfterCalcVATBaseAmount.
    /// </summary>
    /// <param name="PurchaseLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnBeforeMakeInventoryAdjustment.
    /// </summary>
    ...
    /// <summary>
    /// Event raised by OnAfterUpdateInvoicedQtyOnReturnShipmentLine.
    /// </summary>
    /// <param name="ReturnShipmentLine"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnUpdateItemChargeAssgntOnBeforeItemChargeAssignmentPurchModify.
    /// </summary>
    /// <param name="ItemChargeAssgntPurch"></param>
    [IntegrationEvent(false, false)]
    ...
    /// <summary>
    /// Event raised by OnSetCommitBehavior.
    /// </summary>
    /// <param name="IgnoreCommit"></param>
    [IntegrationEvent(false, false)]
