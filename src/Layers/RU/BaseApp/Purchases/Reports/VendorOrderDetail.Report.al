...
report 308 "Vendor - Order Detail"
{
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            {
                DataItemLink = "Pay-to Vendor No." = field("No."), "Shortcut Dimension 1 Code" = field("Global Dimension 1 Filter"), "Shortcut Dimension 2 Code" = field("Global Dimension 2 Filter"), "Agreement No." = field("Agreement Filter");
