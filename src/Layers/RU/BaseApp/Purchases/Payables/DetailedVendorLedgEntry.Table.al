...
table 380 "Detailed Vendor Ledg. Entry"
{
    ...
    fields
    {
        ...
        field(12435; "Vendor Posting Group"; Code[20])
        {
            Caption = 'Vendor Posting Group';
            TableRelation = "Vendor Posting Group";
        }
    ...
    keys
    {
        ...
        key(Key3; "Vendor Ledger Entry No.", "Entry Type", "Posting Date", "Prepmt. Diff. in TA")
        {
        ...
        key(Key5; "Initial Document Type", "Entry Type", "Vendor No.", "Currency Code", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Agreement No.", "Prepmt. Diff. in TA", "Posting Date")
        {
            IncludedFields = Amount, "Amount (LCY)";
        }
        key(Key6; "Vendor No.", "Currency Code", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Initial Entry Due Date", "Agreement No.", "Prepmt. Diff. in TA", "Posting Date")
        {
            IncludedFields = Amount, "Amount (LCY)";
        }
        key(Key7; "Document No.", "Document Type", "Posting Date", "Prepmt. Diff. in TA")
        {
        }
