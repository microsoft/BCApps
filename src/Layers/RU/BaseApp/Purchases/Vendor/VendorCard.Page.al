    ...
    layout
    {
        area(content)
        {
            ...
            group(Customer)
            {
                ...
                field(TotalBalance; Cust."Balance (LCY)" - Rec."Balance (LCY)")
                {
                    AutoFormatType = 1;
                    AutoFormatExpression = '';
                    ApplicationArea = All;
            ...
            {
                Caption = 'VAT Agent';
                field(Control1210004; Rec."VAT Agent")
                {
                    ApplicationArea = Basic, Suite;
...
#pragma warning restore AA0074
    ...
    begin
        ...
        IsCountyVisible := FormatAddress.UseCounty(Rec."Country/Region Code");
        CustomerNameVisible := Rec."Customer No." <> '';
        CustomerBalanceVisible := Rec."Customer No." <> '';
        TotalBalanceVisible := Rec."Customer No." <> '';
