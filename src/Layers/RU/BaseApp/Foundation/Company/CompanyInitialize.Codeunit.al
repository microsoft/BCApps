...
#pragma warning restore AA0074
    ...
    begin
        ...
        if not TaxRegSetup.FindFirst() then begin
            TaxRegSetup.Init();
            TaxRegSetup.Insert();
        end;

        if not StatRepSetup.FindFirst() then begin
            StatRepSetup.Init();
            StatRepSetup.Insert();
        end;
    ...
    begin
        if not (SourceCodeSetup.FindFirst() or SourceCode.FindFirst()) then begin
            ...
            InsertSourceCode(SourceCodeSetup."Advance Statements", Text12400, PageName(PAGE::"Advance Statement"));
            InsertSourceCode(SourceCodeSetup."Deferred VAT Settlement", Text12402, PageName(PAGE::"VAT Settlement Journal"));
            InsertSourceCode(SourceCodeSetup."Customer Prepayments", Text12403, SourceCodeSetup.FieldCaption("Customer Prepayments"));
            InsertSourceCode(SourceCodeSetup."Vendor Prepayments", Text12404, SourceCodeSetup.FieldCaption("Vendor Prepayments"));
            InsertSourceCode(SourceCodeSetup."Cash Order Payments", Text12407, SourceCodeSetup.FieldCaption("Cash Order Payments"));
            InsertSourceCode(SourceCodeSetup."Tax Difference Journal", Text17300, PageName(PAGE::"Tax Difference Journal Batches"));
            InsertSourceCode(SourceCodeSetup."FA Movement", Text12471, SourceCodeSetup.FieldCaption("FA Movement"));
            InsertSourceCode(SourceCodeSetup."FA Writeoff", Text12472, SourceCodeSetup.FieldCaption("FA Writeoff"));
            InsertSourceCode(SourceCodeSetup."VAT for Customer Adjustment", Text12474, SourceCodeSetup.FieldCaption("VAT for Customer Adjustment"));
