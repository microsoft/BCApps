...
codeunit 9998 "Upgrade Tag Definitions"
{
    ...
    begin
        ...
        PerCompanyUpgradeTags.Add(GetDeleteOrphanReminderLinesTag());
    ...
    internal procedure GetItemCategoryOnItemAPIUpgradeTag(): Code[250]
    begin
    ...
    internal procedure GetMoveCurrencyISOCodeTag(): Code[250]
    begin
    ...
    internal procedure GetGLAccountAPITypeUpgradeTag(): Code[250];
    begin
    ...
    internal procedure GetDeleteOrphanReminderLinesTag(): Code[250]
    begin
        exit('MS-648301-DeleteOrphanReminderLines-20260922');
    end;
