...
#pragma warning restore AS0086
                    ...
                    if ("Agreement No." <> '') then begin
                        ...
                        if Confirmed then begin
                            ...
                            if "Ship-to Code" <> CustomerAgreement."Ship-to Code" then
                                Rec.Validate("Ship-to Code", CustomerAgreement."Ship-to Code");
    ...
    begin
        ...
        DocSignMgt.DeleteDocSign(DATABASE::"Sales Header", Rec."Document Type".AsInteger(), Rec."No.");
    ...
    begin
        ...
        DocSignMgt.SetDefaults(DATABASE::"Sales Header", Rec."Document Type".AsInteger(), Rec."No.");
...
#pragma warning restore AA0074
    ...
    begin
        ...
        case "Document Type" of
            ...
            "Document Type"::Invoice:
                begin
                    if "Corrective Document" then begin
                        if NoSeries.IsAutomatic(SalesSetup."Posted Corr. Invoice Nos.") then
                            "Posting No. Series" := SalesSetup."Posted Corr. Invoice Nos."
                    end else
            ...
            "Document Type"::"Credit Memo":
                begin
                    if "Corrective Document" then begin
                        if NoSeries.IsAutomatic(SalesSetup."Posted Corr. Credit Memo Nos.") then
                            "Posting No. Series" := SalesSetup."Posted Corr. Credit Memo Nos."
                    end else
