    ...
    layout
    {
        area(content)
        {
            ...
            group(Vendor)
            {
                ...
                field(TotalBalance; Rec."Balance (LCY)" - Vend."Balance (LCY)")
                {
                    AutoFormatType = 1;
                    AutoFormatExpression = '';
                    ApplicationArea = All;
            ...
            {
                Caption = 'Agreements';
                field("Agreement Posting"; Rec."Agreement Posting")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Invoicing)
            {
                ...
                field("Act Signed by Name"; Rec."Act Signed by Name")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'This field is used internally.';
                }
                field("Act Signed by Position"; Rec."Act Signed by Position")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'This field is used internally.';
                }
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            action("Customer - Reconciliation Act")
            {
                ...
                trigger OnAction()
                begin
                    RunReport(REPORT::"Customer - Reconciliation Act", Rec."No.");
                end;
            }
        ...
        area(Promoted)
        {
            ...
            group(Category_Report)
            {
                ...
                actionref("Customer G/L Turnover_Promoted"; "Customer G/L Turnover")
                {
                }
