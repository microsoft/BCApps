    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Enable Russian Accounting"; Rec."Enable Russian Accounting")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows for accounting regulations.';
                }
                field("Automatic G/L Correspondence"; Rec."Automatic G/L Correspondence")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger correspondence is automatically set up.';
                }
                field("Red Storno VAT Reinstatement"; Rec."Red Storno VAT Reinstatement")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("VAT Purch. Ledger No. Series"; Rec."VAT Purch. Ledger No. Series")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series that you want to use for VAT ledgers for purchase documents.';
                }
                field("VAT Sales Ledger No. Series"; Rec."VAT Sales Ledger No. Series")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series that you want to use for VAT ledgers for sales documents.';
                }
                field("Contractor Invent. Act Nos."; Rec."Contractor Invent. Act Nos.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Allow VAT Set. before FA Rel."; Rec."Allow VAT Set. before FA Rel.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows for VAT settlement before fixed assets are released.';
                }
                field("Void Payment as Correction"; Rec."Void Payment as Correction")
                {
                }
            ...
            group("Amount Difference")
            {
                ...
                field("Currency Adjmt with Correction"; Rec."Currency Adjmt with Correction")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows a currency adjustment with correction.';
                }
                field("Summarize Gains/Losses"; Rec."Summarize Gains/Losses")
                {
                    ApplicationArea = Basic, Suite;
            ...
            {
                Caption = 'Prepayment';
                field("Cancel Curr. Prepmt. Adjmt."; Rec."Cancel Curr. Prepmt. Adjmt.")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies if the general ledger setup information allows for the prepayment adjustment to be canceled.';
                }
                field("Cancel Prepmt. Adjmt. in TA"; Rec."Cancel Prepmt. Adjmt. in TA")
                {
                    ApplicationArea = Prepayments;
            ...
            {
                Caption = 'Templates';
                field("Bank Payment Order Tmpl. Code"; Rec."Bank Payment Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Cash Outgoin Order Tmpl. Code"; Rec."Cash Outgoin Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Ingoing Order Tmpl. Code"; Rec."Cash Ingoing Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Order KO3 Template Code"; Rec."Cash Order KO3 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Order KO4 Template Code"; Rec."Cash Order KO4 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Reg. (Month) Tmpl. Code"; Rec."Cash Reg. (Month) Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("C/V Recon. Act Template Code"; Rec."C/V Recon. Act Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
