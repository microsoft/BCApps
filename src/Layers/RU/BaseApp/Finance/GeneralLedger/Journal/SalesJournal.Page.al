    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Prepayment Document No."; Rec."Prepayment Document No.")
                {
                    ApplicationArea = Prepayments;
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies sales/revenue. If you populate a balancing account it will be populated automatically otherwise users are supposed to fill it out themselves.';
                    Visible = false;
                }
