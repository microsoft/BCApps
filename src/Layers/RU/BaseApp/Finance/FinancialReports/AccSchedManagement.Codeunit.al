...
#pragma warning restore AA0470
#pragma warning disable AA0470
        RowConstantMsg: Label 'Row constant: %1.';
#pragma warning restore AA0470
#pragma warning disable AA0470
...
#pragma warning restore AA0470
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            if TempAccSchedCellValue.Get(AccSchedLine."Schedule Name", AccSchedLine."Line No.", ColumnLayout."Line No.") then begin
                ...
                TempAccSchedCellValue."Schedule Name" := AccSchedLine."Schedule Name";
                ...
                ColumnLayout."Ledger Entry Type"::"Corr. Entries":
                    begin
                        GLCorrespondenceEntry.SetCurrentKey(
                            "Debit Account No.", "Credit Account No.", "Debit Global Dimension 1 Code",
                            "Debit Global Dimension 2 Code", "Business Unit Code", "Posting Date");
                        if GLAcc."No." <> '' then
                            GLCorrespondenceEntry.SetFilter("Debit Account No.", GLAcc."No.")
                        else
                            GLAcc.CopyFilter("No.", GLCorrespondenceEntry."Debit Account No.");
                        GLCorrespondenceEntry.SetFilter("Posting Date", GetPostingDateFilter(AccSchedLine, ColumnLayout));
                        GLCorrespondenceEntry.SetFilter("Business Unit Code", AccSchedLine."Business Unit Filter");
                        ...
                        GLCorrespondenceEntry.SetFilter("Debit Global Dimension 1 Code", GetDimTotalingFilter(1, AccSchedLine."Dimension 1 Totaling"));
                        GLCorrespondenceEntry.SetFilter("Debit Global Dimension 2 Code", GetDimTotalingFilter(2, AccSchedLine."Dimension 2 Totaling"));
                        GLCorrespondenceEntry.SetFilter("Credit Global Dimension 1 Code", GetDimTotalingFilter(12401, AccSchedLine."Dimension 1 Corr. Totaling"));
                        GLCorrespondenceEntry.SetFilter("Credit Global Dimension 2 Code", GetDimTotalingFilter(12402, AccSchedLine."Dimension 2 Corr. Totaling"));
                        GLCorrespondenceEntry.FilterGroup(8);
                        GLCorrespondenceEntry.SetFilter("Debit Global Dimension 1 Code", GetDimTotalingFilter(1, ColumnLayout."Dimension 1 Totaling"));
                        GLCorrespondenceEntry.SetFilter("Debit Global Dimension 2 Code", GetDimTotalingFilter(2, ColumnLayout."Dimension 2 Totaling"));
                        GLCorrespondenceEntry.SetFilter("Credit Global Dimension 1 Code", GetDimTotalingFilter(12401, ColumnLayout."Dimension 1 Corr. Totaling"));
                        GLCorrespondenceEntry.SetFilter("Credit Global Dimension 2 Code", GetDimTotalingFilter(12402, ColumnLayout."Dimension 2 Corr. Totaling"));
                        GLCorrespondenceEntry.FilterGroup(0);

                        GLCorrespondenceEntry.CalcSums(Amount, "Amount (ACY)");
                        if CalcAddCurr then
                            ColValue := GLCorrespondenceEntry."Amount (ACY)"
                        else
                            ColValue := GLCorrespondenceEntry.Amount;
                    end;
            end;
    ...
    var
        ...
        IsFilter: Boolean;
        Show: Enum "Acc. Schedule Line Show";
    begin
        Result := 0;
    ...
    begin
        ...
        then begin
            GLCorrespondenceEntry.SetFilter("Debit Account No.", AccScheduleLine.Totaling);
            GLCorrespondenceEntry.SetFilter("Credit Account No.", AccScheduleLine."Corr. Totaling");
            AccScheduleLine.CopyFilter("Dimension 1 Filter", GLCorrespondenceEntry."Debit Global Dimension 1 Code");
            AccScheduleLine.CopyFilter("Dimension 2 Filter", GLCorrespondenceEntry."Debit Global Dimension 2 Code");
            AccScheduleLine.CopyFilter("Corr. Dimension 1 Filter", GLCorrespondenceEntry."Credit Global Dimension 1 Code");
            AccScheduleLine.CopyFilter("Corr. Dimension 2 Filter", GLCorrespondenceEntry."Credit Global Dimension 2 Code");
            GLCorrespondenceEntry.FilterGroup(2);
            ...
            GLCorrespondenceEntry.SetFilter(
              ...
              GetDimTotalingFilter(1, AccScheduleLine."Dimension 1 Corr. Totaling"));
            GLCorrespondenceEntry.SetFilter(
              "Credit Global Dimension 2 Code",
              GetDimTotalingFilter(2, AccScheduleLine."Dimension 2 Corr. Totaling"));
            GLCorrespondenceEntry.FilterGroup(8);
            GLCorrespondenceEntry.SetFilter(
              "Debit Global Dimension 1 Code",
        ...
        case AccScheduleLine."Totaling Type" of
            AccScheduleLine."Totaling Type"::Constant:
                begin
                    Message(RowConstantMsg, AccScheduleLine.Totaling);
                    exit;
                end;
            ...
            AccScheduleLine."Totaling Type"::Custom:
                begin
        ...
        case AccScheduleLine."Totaling Type" of
            ...
            AccScheduleLine."Totaling Type"::Custom:
                AccSchedExtensionMgt.DrillDownAmount(
                  AccScheduleLine, TempColumnLayout, AccScheduleLine.Totaling, AccScheduleLine.GetRangeMin("Date Filter"), AccScheduleLine.GetRangeMax("Date Filter"));
    ...
    begin
        if TempAccSchedCellValue.FindSet() then
            repeat
        ...
        case ColumnLayout."Column Type" of
            ...
            ColumnLayout."Column Type"::"Year to Date":
                case AccSchedLine2."Row Type" of
                    ...
                    AccSchedLine2."Row Type"::"Beginning Balance":
                        exit(StrSubstNo('<%1', FiscalStartDate2));
                    // always includes closing date
                    AccSchedLine2."Row Type"::"Balance at Date":
                        exit(StrSubstNo('..%1', ToDate));
                end;
