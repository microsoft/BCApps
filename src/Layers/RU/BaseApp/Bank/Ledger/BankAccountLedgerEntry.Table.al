...
table 271 "Bank Account Ledger Entry"
{
    ...
    fields
    {
        ...
        field(12490; "Agreement No."; Code[20])
        {
            ...
            TableRelation = if ("Bal. Account Type" = const(Customer)) "Customer Agreement"."No." where("Customer No." = field("Bal. Account No."))
            else
            if ("Bal. Account Type" = const(Vendor)) "Vendor Agreement" where("Vendor No." = field("Bal. Account No."));
        }
    }
