...
permissionset 1001 "LOCAL"
{
    ...
    Permissions = tabledata "Acc. Schedule Extension" = RIMD,
                  ...
                  tabledata "Excel Template Sheet Buffer" = RIMD,
                  tabledata "Export Log Entry" = RIMD,
                  tabledata "Format Version" = RIMD,
                  tabledata "Including In Report" = RIMD,
                  tabledata "Journal Posting Preview Setup" = RIMD,
                  tabledata "Key Including In Report" = RIMD,
                  tabledata "Page Indication XML Element" = RIMD,
                  tabledata "Person Document" = RIMD,
                  tabledata "Scalable Table Row" = RIMD,
                  tabledata "Stat. Report Data Change Log" = RIMD,
                  tabledata "Stat. Report Excel Sheet" = RIMD,
                  tabledata "Stat. Report Table Column" = RIMD,
                  tabledata "Stat. Report Table Row" = RIMD,
                  tabledata "Statutory Report" = RIMD,
                  tabledata "Statutory Report Buffer" = RIMD,
                  tabledata "Statutory Report Data Header" = RIMD,
                  tabledata "Statutory Report Data Value" = RIMD,
                  tabledata "Statutory Report Group" = RIMD,
                  tabledata "Statutory Report Table" = RIMD,
                  tabledata "Table Individual Requisite" = RIMD,
                  tabledata "Tax Diff. Corr. Dim. Filter" = RIMD,
                  tabledata "Tax Diff. FA Buffer" = RIMD,
                  tabledata "Tax Diff. FA Posting Buffer" = RIMD,
                  tabledata "Tax Diff. Group" = RIMD,
                  tabledata "Tax Reg. G/L Corr. Dim. Filter" = RIMD,
                  tabledata "Taxpayer Document Type" = RIMD,
                  tabledata "Vendor Agreement" = RIMD,
                  tabledata "XML Element Expression Line" = RIMD,
                  tabledata "XML Element Line" = RIMD;
}