...
#pragma warning restore
        ...
        field(12460; "Red Storno"; Boolean)
        {
            Caption = 'Red Storno';
            ...
            begin
                InventorySetup.Get();
                InventorySetup.TestField("Enable Red Storno");
            end;
        }
...
#pragma warning restore AA0074
    ...
    begin
        "Shortcut Dimension 1 Code" := PurchInvLine."Shortcut Dimension 1 Code";
        "Shortcut Dimension 2 Code" := PurchInvLine."Shortcut Dimension 2 Code";
        "Dimension Set ID" := PurchInvLine."Dimension Set ID";
        "Location Code" := PurchInvLine."Location Code";
        "Bin Code" := PurchInvLine."Bin Code";
        "Variant Code" := PurchInvLine."Variant Code";
        "Item Category Code" := PurchInvLine."Item Category Code";
        "Inventory Posting Group" := PurchInvLine."Posting Group";
        "Gen. Bus. Posting Group" := PurchInvLine."Gen. Bus. Posting Group";
        "Gen. Prod. Posting Group" := PurchInvLine."Gen. Prod. Posting Group";
        "Job No." := PurchInvLine."Job No.";
        "Job Task No." := PurchInvLine."Job Task No.";
        "Transaction Type" := PurchInvLine."Transaction Type";
        "Transport Method" := PurchInvLine."Transport Method";
        "Entry/Exit Point" := PurchInvLine."Entry Point";
        Area := PurchInvLine.Area;
        ...
        "Item Reference No." := PurchInvLine."Item Reference No.";
        "Document Line No." := PurchInvLine."Line No.";
        "Unit Cost" := PurchInvLine."Unit Cost (LCY)";
        "Unit Cost (ACY)" := PurchInvLine."Unit Cost";
        "Purchasing Code" := PurchInvLine."Purchasing Code";
        "Overhead Rate" := PurchInvLine."Overhead Rate";
        "Return Reason Code" := PurchInvLine."Return Reason Code";
    end;

    [Scope('OnPrem')]
    procedure CopyFromPurchCrMemoLine(PurchCrMemoLine: Record "Purch. Cr. Memo Line")
    begin
        "Shortcut Dimension 1 Code" := PurchCrMemoLine."Shortcut Dimension 1 Code";
        "Shortcut Dimension 2 Code" := PurchCrMemoLine."Shortcut Dimension 2 Code";
        "Dimension Set ID" := PurchCrMemoLine."Dimension Set ID";
        "Location Code" := PurchCrMemoLine."Location Code";
        "Bin Code" := PurchCrMemoLine."Bin Code";
        "Variant Code" := PurchCrMemoLine."Variant Code";
        "Item Category Code" := PurchCrMemoLine."Item Category Code";
        "Inventory Posting Group" := PurchCrMemoLine."Posting Group";
        "Gen. Bus. Posting Group" := PurchCrMemoLine."Gen. Bus. Posting Group";
        "Gen. Prod. Posting Group" := PurchCrMemoLine."Gen. Prod. Posting Group";
        "Job No." := PurchCrMemoLine."Job No.";
        "Job Task No." := PurchCrMemoLine."Job Task No.";
        "Transaction Type" := PurchCrMemoLine."Transaction Type";
        "Transport Method" := PurchCrMemoLine."Transport Method";
        "Entry/Exit Point" := PurchCrMemoLine."Entry Point";
        Area := PurchCrMemoLine.Area;
        ...
        "Item Reference No." := PurchCrMemoLine."Item Reference No.";
        "Document Line No." := PurchCrMemoLine."Line No.";
        "Unit Cost" := PurchCrMemoLine."Unit Cost (LCY)";
        "Unit Cost (ACY)" := PurchCrMemoLine."Unit Cost";
        "Purchasing Code" := PurchCrMemoLine."Purchasing Code";
        "Return Reason Code" := PurchCrMemoLine."Return Reason Code";
    end;
    ...
    begin
        ...
        "Inventory Posting Group" := SalesInvLine."Posting Group";
        ...
        "Entry/Exit Point" := SalesInvLine."Exit Point";
        ...
        "Item Reference No." := SalesInvLine."Item Reference No.";
    ...
    begin
        ...
        "Inventory Posting Group" := SalesCrMemoLine."Posting Group";
        ...
        "Entry/Exit Point" := SalesCrMemoLine."Exit Point";
        ...
        "Item Reference No." := SalesCrMemoLine."Item Reference No.";
    ...
    begin
        "Source Posting Group" := PurchInvHeader."Vendor Posting Group";
        "Salespers./Purch. Code" := PurchInvHeader."Purchaser Code";
        "Country/Region Code" := PurchInvHeader."Buy-from Country/Region Code";
        "Reason Code" := PurchInvHeader."Reason Code";
        "Document No." := PurchInvHeader."No.";
        "External Document No." := PurchInvHeader."Vendor Receipts No.";
        "Posting No. Series" := PurchInvHeader."No. Series";
        "Source Currency Code" := PurchInvHeader."Currency Code";
        "Source No." := PurchInvHeader."Buy-from Vendor No.";
        "Invoice-to Source No." := PurchInvHeader."Pay-to Vendor No.";
    end;

    [Scope('OnPrem')]
    procedure CopyFromPurchCrMemoHeader(PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.")
    begin
        "Source Posting Group" := PurchCrMemoHdr."Vendor Posting Group";
        "Salespers./Purch. Code" := PurchCrMemoHdr."Purchaser Code";
        "Country/Region Code" := PurchCrMemoHdr."Buy-from Country/Region Code";
        ...
        "Source No." := PurchCrMemoHdr."Buy-from Vendor No.";
        "Invoice-to Source No." := PurchCrMemoHdr."Pay-to Vendor No.";
    end;

    [Scope('OnPrem')]
    procedure CopyFromSalesInvHeader(SalesInvHeader: Record "Sales Invoice Header")
    begin
        "Source Posting Group" := SalesInvHeader."Customer Posting Group";
        "Salespers./Purch. Code" := SalesInvHeader."Salesperson Code";
        "Country/Region Code" := SalesInvHeader."Sell-to Country/Region Code";
        "Reason Code" := SalesInvHeader."Reason Code";
        "Document No." := SalesInvHeader."No.";
        "Posting No. Series" := SalesInvHeader."No. Series";
        "Source Currency Code" := SalesInvHeader."Currency Code";
        "Source No." := SalesInvHeader."Sell-to Customer No.";
        "Invoice-to Source No." := SalesInvHeader."Bill-to Customer No.";
    end;

    [Scope('OnPrem')]
    procedure CopyFromSalesCrMemoHeader(SalesCrMemoHeader: Record "Sales Cr.Memo Header")
    begin
        "Source Posting Group" := SalesCrMemoHeader."Customer Posting Group";
        "Salespers./Purch. Code" := SalesCrMemoHeader."Salesperson Code";
        "Country/Region Code" := SalesCrMemoHeader."Sell-to Country/Region Code";
        ...
        "Source No." := SalesCrMemoHeader."Sell-to Customer No.";
