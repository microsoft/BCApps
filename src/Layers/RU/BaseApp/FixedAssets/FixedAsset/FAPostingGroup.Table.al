...
table 5606 "FA Posting Group"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Purch. PD Gains Acc.';
            TableRelation = "G/L Account";
        }
        field(12406; "Purch. PD Losses Acc."; Code[20])
        {
            Caption = 'Purch. PD Losses Acc.';
            TableRelation = "G/L Account";
        }
        field(12407; "Purch. PD Charge FCY (FA)"; Code[20])
        {
            Caption = 'Purch. PD Charge FCY (FA)';
            TableRelation = "FA Charge";
        }
        field(12408; "Purch. PD Charge Conv. (FA)"; Code[20])
        {
            Caption = 'Purch. PD Charge Conv. (FA)';
            TableRelation = "FA Charge";
        }
        field(12410; Description; Text[250])
        {
            Caption = 'Description';
        }
    }
    ...
    [Scope('OnPrem')]
    procedure GetPDAccount(NeedGainAccount: Boolean): Code[20]
    begin
    ...
    [Scope('OnPrem')]
    procedure GetPDChargeFA(CurrencyCode: Code[10]): Code[20]
    begin
    ...
    [Scope('OnPrem')]
    procedure GetDisposalGainLossAccount(NeedGainAccount: Boolean): Code[20]
    begin
        if NeedGainAccount then begin
    ...
    procedure GetDisposalExpenseAccount(): Code[20]
    begin
