codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        InsertData(
          ...
          'GB', '796385274', XFOREIGN, XBLUE, '', '');
        InsertData(
          '44729910', 'Boybridge Tool Mart', '8 Grovenors Park', 'GB-N16 34Z', 'Mr.', 'David Campbell', 'GBP', 'GB', '279425763', XFOREIGN, '', '', '');
        InsertData(
          '44127904', 'WoodMart Supply Co.', '12 Industrial Heights', 'GB-SA3 7HI', 'Mr.', 'Joseph Matthews', 'GBP', 'GB', '741852963', XFOREIGN, '',
          '', '');
        InsertData(
        ...
        InsertData(
          '44127914', 'Mortimor Car Company', '43 Industrial Heights', 'GB-SA3 7HI', 'Mr.', 'Andrew R. Hill', 'GBP', 'GB',
          '741852979', XFOREIGN, '', '', '');
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Tommy Hukill';
        ...
        XAT: Label 'AT';
        XATU89574196: Label 'ATU89574196';
        XATU27486327: Label 'ATU27486327';
        XATU69752846: Label 'ATU69752846';
        XATU19754876: Label 'ATU19754876';
        XATU29526749: Label 'ATU29526749';
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'XATU27486327', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'XATU19754876', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", 'XATU29526749', '', '', XWaverlyGate, '');
