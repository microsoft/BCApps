    ...
    begin
        ...
        case DemoDataSetup."Company Type" of
            DemoDataSetup."Company Type"::VAT:
                begin
                    if DemoDataSetup."Advanced Setup" then // AT
                        TaxCategory := 'S'
                    else
                        TaxCategory := 'E';
                    InsertData('', DemoDataSetup.ServicesVATCode(), 0, 0, TaxCategory);
                    InsertData('', DemoDataSetup.GoodsVATCode(), 0, 0, TaxCategory);
                    ...
                    InsertData(DemoDataSetup.ExportCode(), DemoDataSetup.ServicesVATCode(), 0, 0, TaxCategory);
                    InsertData(DemoDataSetup.ExportCode(), DemoDataSetup.GoodsVATCode(), 0, 0, TaxCategory);
