codeunit 101550 "Create Contact"
{
    ...
    begin
        ...
        DemoDataSetup.Get();
        InsertData(XCT100239, XCaneShowroom, XRingwoodRoad, XMID, '', XDEA, XHR, XAT, 'GB-M61 2YG',
          0, XCT100239, '', '', '', 0);
        InsertData(XCT100240, XLordshipLaneFurnishers, X457LordshipLane, XS, '', XDEA, XLT, XAT, 'GB-NP5 6GH',
          0, XCT100240, '', '', '', 0);
        InsertData(XCT100241, XTimelessReproductions, X28TheTything, DemoDataSetup.ForeignCode(), XGBP, XENG, XHR, XGB, 'GB-OX16 0UA',
          0, XCT100241, '', '', '', 0);
        InsertData(XCT100242, XWyllieANDMar, XHighStreetRipley, XW, '', XDEA, XJO, XAT, 'GB-PO21 6HG',
          0, XCT100242, '', '', '', 0);
        InsertData(XCT100243, XCompohandlerLtd, XCarmunnockByPassBusby, XMID, '', XDEA, XRB, XAT, 'GB-TQ17 8HB',
          0, XCT100243, '', '', '', 0);
        InsertData(XCT100244, 'OK Furnishers', '92-94 West St Bedminster', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-SA1 2HS',
          0, XCT100244, '', '', '', 0);
        InsertData(XCT100245, 'TenTails Direct Ltd', 'Tower Road', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-TA3 4FD',
          0, XCT100245, '', '', '', 0);
        ...
        InsertData(XCT100005, 'Taylor"s Office Warehouse', '395 Westgate Drive', DemoDataSetup.ForeignCode(), 'USD', 'ENU', XOF, 'US', 'US-GA 31772',
          0, XCT100005, '', '', '', 0);
        InsertData(XCT100006, 'A. Gibson"s Law Firm', '2570 Swimthon Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-MO2 4RT',
          0, XCT100006, '', '', '', 0);
        InsertData(XCT100007, 'Officeland Of Manchester', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          0, XCT100007, '', '', '', 0);
        InsertData(XCT100008, 'TelecomPetit', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          0, XCT100008, '', '', '', 0);
        InsertData(XCT100009, 'DHL Express', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          0, XCT100009, '', '', '', 0);
        ...
        InsertData(XCT100012, 'eAmericonda', '1558 23rd Street', DemoDataSetup.ForeignCode(), 'USD', 'ENU', XHR, 'US', 'US-NY 11010',
          0, XCT100012, '', '', '', 0);
        InsertData(XCT100013, 'Rent a Truck', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          0, XCT100013, '', '', '', 0);
        ...
        InsertData(XCT100015, 'Triplelight Studio', '34 Johnson Street', DemoDataSetup.ForeignCode(), 'GBP', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          0, XCT100015, '', '', '', 0);
        InsertData(XCT100016, 'DanMøbler', 'Vindegade 72', DemoDataSetup.ForeignCode(), 'DKK', 'DAN', XRB, 'DK', 'DK-2100',
          0, XCT100016, '', '', '', 0);
        InsertData(XCT100017, 'Furnitures At Work', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          0, XCT100017, '', '', '', 0);
        ...
        InsertData(XCT100129, 'Stephanie Conroy', 'Tower Road', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, 'GB', 'GB-TA3 4FD',
          1, XCT100245, XFMAR, '', '', 0);
        ...
        InsertData(XCT100139, 'Katie Jordan', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XFMAR, '', '', 0);
        InsertData(XCT100140, XDavidHodgson, X192MarketSquare, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-B27 4KT',
          1, ContactNo(DATABASE::Customer, '10000'), XM, '', '', 0);
        InsertData(XCT100141, 'John Tippett', '8 Grovenors Park', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N16 34Z',
        ...
        InsertData(XCT100142, XSusanWEaton, XHighStreetRipley, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-PO21 6HG',
          1, XCT100242, XFMAR, '', '', 0);
        InsertData(XCT100143, 'Michael Patten', 'Tower Road', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-TA3 4FD',
          1, XCT100245, XM, '', '', 0);
        ...
        InsertData(XCT100146, 'Brian Burke', '43 Industrial Heights', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-SA3 7HI',
        ...
        InsertData(XCT100153, 'Gregory Weber', '4 Baker Street', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-W1 3AL',
          1, ContactNo(DATABASE::"Bank Account", XNBL), XM, '', '', 0);
        InsertData(XCT100154, 'Linda Contreras', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XFMAR, '', '', 0);
        InsertData(XCT100155, 'Frank Zhang', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XM, '', '', 0);
        InsertData(XCT100156, XJohnEmory, X192MarketSquare, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-B27 4KT',
          1, ContactNo(DATABASE::Customer, '10000'), XM, '', '', 0);
        ...
        InsertData(XCT100159, XJackCreasey, X1HighHolborn, DemoDataSetup.ForeignCode(), '', XENG, XOF, XGB, 'GB-WC1 3DG',
          1, ContactNo(DATABASE::"Bank Account", XWWBOPERATING), XM, '', '', 0);
        InsertData(XCT100160, 'Yvonne McKay', '456 Main Street', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-DY5 4DJ',
        ...
        InsertData(XCT100164, 'John Wood', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XM, '', '', 0);
        ...
        InsertData(XCT100170, XDeborahPoe, X1HighHolborn, DemoDataSetup.ForeignCode(), '', XENG, XOF, XGB, 'GB-WC1 3DG',
        ...
        InsertData(XCT100176, XSamanthaSmith, X457LordshipLane, DemoDataSetup.ForeignCode(), '', XENG, XLT, XGB, 'GB-NP5 6GH',
          1, XCT100240, XFMAR, '', '', 0);
        InsertData(XCT100177, 'Nigel Westbury', '92-94 West St Bedminster', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-SA1 2HS',
          1, XCT100244, XM, '', '', 0);
        ...
        InsertData(XCT100181, 'Antonio Bermejo', 'c/ Neptuno 18', DemoDataSetup.ForeignCode(), '', 'ESP', XRB, 'ES', 'ES-37001',
          1, ContactNo(DATABASE::Vendor, '34151086'), XM, '', '', 0);
        InsertData(XCT100182, 'Michael J. Hummer', 'Ortstraße 12', XMID, '', 'DEA', XRB, 'AT', 'AT-5730',
        ...
        InsertData(XCT100183, 'Jeremy Los', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XM, '', '', 0);
        InsertData(XCT100184, 'Robert Lyon', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XM, '', '', 0);
        InsertData(XCT100185, 'Arlene Huff', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XFMAR, '', '', 0);
        InsertData(XCT100186, 'Mary Baker', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XFMAR, '', '', 0);
        ...
        InsertData(XCT100196, 'Shelley Dick', '25 Kingston St', DemoDataSetup.ForeignCode(), '', 'ENU', XRB, 'US', 'US-IL 61236',
          1, XCT100004, XFMAR, '', '', 0);
        InsertData(XCT100197, 'Amy E. Alberts', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XF, '', '', 0);
        ...
        InsertData(XCT100201, 'Charles Fitzgerald', '235 Peachtree Street', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-PE17 4RN',
          1, ContactNo(DATABASE::Customer, '44756404'), XM, '', '', 0);
        InsertData(XCT100202, 'Janice Galvin', '100 Maidstone Ave.', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-ME5 6RL',
          1, ContactNo(DATABASE::Customer, '44180220'), XFMAR, '', '', 0);
        InsertData(XCT100203, 'Spencer Low', '43 Industrial Heights', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-SA3 7HI',
          1, ContactNo(DATABASE::Vendor, '44127914'), XM, '', '', 0);
        ...
        InsertData(XCT100207, 'Mikael Sandberg', 'Orkestergatan 24', DemoDataSetup.ForeignCode(), '', 'SVE', XRB, 'SE', 'SE-415 06',
          1, XCT100018, XM, '', '', 0);
        InsertData(XCT100208, 'Garrett Young', 'High Street Ripley', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-PO21 6HG',
          1, XCT100242, XM, '', '', 0);
        InsertData(XCT100209, 'Ann Beebe', '456 Main Street', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-DY5 4DJ',
          1, ContactNo(DATABASE::Customer, '44171511'), XFMAR, '', '', 0);
        InsertData(XCT100210, XStephanieBourne, X192MarketSquare, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-B27 4KT',
          1, ContactNo(DATABASE::Customer, '10000'), XFMAR, '', '', 0);
        InsertData(XCT100211, 'Peter Conelly', '57 East Reach', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-TA3 4FD',
          1, '', XM, '', '', 0);
        InsertData(XCT100212, 'Karen Archer', '14 The Broadway', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-TN27 6YD',
          1, '', XF, '', '', 0);
        InsertData(XCT100213, XPatrickMCook, X28TheTything, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-OX16 0UA',
          1, XCT100241, XM, '', '', 0);
        ...
        InsertData(XCT100216, 'Bonnie Kearney', 'Tower Road', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, XGB, 'GB-TA3 4FD',
          1, XCT100245, XF, '', '', 0);
        ...
        InsertData(XCT100223, 'Magnus Hedlund', 'Olavsgt. 589', DemoDataSetup.ForeignCode(), '', 'NOR', XJO, 'NO', 'NO-0661',
          1, '', XM, '', '', 0);
        InsertData(XCT100224, 'Laura Norman', 'Ortstraße 12', XMID, '', 'DEA', XRB, 'AT', 'AT-5730',
        ...
        InsertData(XCT100227, 'Susan Metters', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XFMAR, '', '', 0);
        InsertData(XCT100228, 'Wendy Wheeler', '457 Lordship Lane', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-NP5 6GH',
          1, XCT100240, XFUMAR, '', '', 0);
        InsertData(XCT100229, XJenniferRiegle, X10NorthLakeAvenue, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-N12 5XY',
        ...
        InsertData(XCT100237, XMichaelSullivan, X4BakerStreet, DemoDataSetup.ForeignCode(), '', XENG, XOF, XGB, 'GB-W1 3AL',
          1, ContactNo(DATABASE::"Bank Account", XNBL), XM, '', '', 0);
        InsertData(XCT100238, 'Erlingur Orn Jonsson', 'Reykjavikurvegi 66', DemoDataSetup.ForeignCode(), '', 'ISL', XOF, 'IS', 'IS-220',
          1, ContactNo(DATABASE::Customer, '35451236'), XM, '', '', 0);
        InsertData(XCT200001, 'Andy Teal', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XM, '', '', 0);
        ...
        InsertData(XCT200006, 'Mark McArthur', '65-73 Broadway West', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-BR1 2ES',
          1, '', XM, '', '', 0);
        InsertData(XCT200007, 'David Hamilton', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', '', 0);
        ...
        InsertData(XCT200009, 'Michael DeVoe', 'Industrieweg 11', DemoDataSetup.ForeignCode(), '', 'NLD', XOF, 'NL', 'NL-7202 BP',
          1, ContactNo(DATABASE::Customer, '31505050'), XM, '', '', 0);
        InsertData(XCT200010, 'Patricia Doyle', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          1, XCT100009, XFMAR, '', '', 0);
        InsertData(XCT200011, 'Kevin Wright', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
        ...
        InsertData(XCT200012, 'Jim Stewart', '340 Marlboro Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XEH, 'US', 'US-GA 31772',
          1, XCT100014, XM, '', '', 0);
        InsertData(XCT200013, 'Mike Nash', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XM, '', '', 0);
        ...
        InsertData(XCT200015, 'Tammy L. McDonald', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          1, XCT100009, XF, '', '', 0);
        ...
        InsertData(XCT200018, 'Rob Verhoff', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XM, '', '', 0);
        InsertData(XCT200019, 'Kevin Verboort', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XM, '', XJMANA, 0);
        InsertData(XCT200020, 'Michael Zeman', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', '', 0);
        InsertData(XCT200021, 'Hans Visser', '35 Brook Street', DemoDataSetup.ForeignCode(), '', 'ENG', XBC, XGB, 'GB-B27 4KT',
          1, '', XM, '', '', 0);
        InsertData(XCT200022, 'Lone Kuhlmann', 'Vindegade 72', DemoDataSetup.ForeignCode(), '', 'DAN', XRB, 'DK', 'DK-2100',
          1, XCT100016, XFMAR, '', '', 0);
        InsertData(XCT200023, 'Christopher E. Hill', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', XJMANA, 0);
        ...
        InsertData(XCT200033, 'Linda Randall', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XFMAR, '', '', 0);
        InsertData(XCT200034, 'Birgitte Vestphael', 'Orkestergatan 24', DemoDataSetup.ForeignCode(), '', 'SVE', XRB, 'SE', 'SE-415 06',
          1, XCT100018, XF, '', '', 0);
        InsertData(XCT200035, XCarlLanghorn, X28TheTything, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-OX16 0UA',
          1, XCT100241, XM, '', '', 0);
        ...
        InsertData(XCT200043, 'Jens Toft', 'Orkestergatan 24', DemoDataSetup.ForeignCode(), '', 'SVE', XRB, 'SE', 'SE-415 06',
          1, XCT100018, XM, '', '', 0);
        InsertData(XCT200044, 'Brian Clark', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XM, '', '', 0);
        ...
        InsertData(XCT200046, XJamesRHamilton, X172FieldGreen, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-WD2 4RG',
        ...
        InsertData(XCT200048, 'Stefan Delmarco', 'Orkestergatan 24', DemoDataSetup.ForeignCode(), '', 'SVE', XRB, 'SE', 'SE-415 06',
          1, XCT100018, XM, '', '', 0);
        InsertData(XCT200049, 'Gabriele Dickmann', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XF, '', '', 0);
        ...
        InsertData(XCT200052, 'Julie Bankert', '340 Marlboro Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XEH, 'US', 'US-GA 31772',
          1, XCT100014, XFMAR, '', XJMANA, 0);
        InsertData(XCT200053, 'Shaun Beasley', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200054, 'Anja Schmidt', 'Strandvejen 334', DemoDataSetup.ForeignCode(), '', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XFUMAR, '', '', 0);
        InsertData(XCT200055, 'Kevin McDowell', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', '', 0);
        InsertData(XCT200056, 'Frank Lee', 'Strandvejen 334', DemoDataSetup.ForeignCode(), '', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XM, '', XJMANA, 0);
        InsertData(XCT200057, 'Alan Brewer', '2570 Swimthon Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-MO2 4RT',
          1, XCT100006, XM, '', '', 0);
        ...
        InsertData(XCT200062, 'Marc Zimmerman', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200063, 'Michael Sean Ray', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XM, '', '', 0);
        InsertData(XCT200064, 'Peter Houston', '340 Marlboro Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XEH, 'US', 'US-GA 31772',
          1, XCT100014, XM, '', '', 0);
        InsertData(XCT200065, 'Jeff D. Henshaw', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', '', 0);
        InsertData(XCT200066, 'Mandy Vance', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XF, '', '', 0);
        InsertData(XCT200067, 'Anita Langers', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XFMAR, '', XJMANA, 0);
        InsertData(XCT200068, XAlexRoland, X172FieldGreen, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-WD2 4RG',
          1, ContactNo(DATABASE::Vendor, '50000'), XM, '', '', 0);
        ...
        InsertData(XCT200071, 'Tom Vande Velde', '1558 23rd Street', DemoDataSetup.ForeignCode(), '', 'ENU', XHR, 'US', 'US-NY 11010',
          1, XCT100012, XM, '', '', 0);
        InsertData(XCT200072, 'Amy S. Recker', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XFMAR, '', XJMANA, 0);
        ...
        InsertData(XCT200074, 'Tomas Navarro', 'Sgt. Millers Dirve', DemoDataSetup.ForeignCode(), '', 'ENU', XEH, 'US', 'US-IL 61236',
          1, XCT100001, XM, '', '', 0);
        InsertData(XCT200075, 'Brad Sutton', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200076, 'Mads Ebdrup', 'Vindegade 72', DemoDataSetup.ForeignCode(), '', 'DAN', XRB, 'DK', 'DK-2100',
          1, XCT100016, XM, '', '', 0);
        InsertData(XCT200077, 'Phil Spencer', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200078, 'Chris Okelberry', '34 Johnson Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-SA3 7HI',
          1, XCT100015, XM, '', XJMANA, 0);
        InsertData(XCT200079, XTinaGorenc, X86StokeNewington, DemoDataSetup.ForeignCode(), '', XENG, XOF, XGB, 'GB-B68 5TT',
          1, ContactNo(DATABASE::Customer, '30000'), XF, '', '', 0);
        InsertData(XCT200080, XPamelaAnsmanWolfe, X47HigherMarketStreet, DemoDataSetup.ForeignCode(), '', XENG, XOF, XGB, 'GB-B31 2AL',
          1, ContactNo(DATABASE::Customer, '30000'), XFMAR, '', '', 0);
        InsertData(XCT200081, 'Greg Chapman', '2 Drury Way', DemoDataSetup.ForeignCode(), '', 'ENG', XBC, XGB, 'GB-EH16 8JS',
          1, '', XM, '', '', 0);
        ...
        InsertData(XCT200086, 'Frank Pellow', 'Strandvejen 334', DemoDataSetup.ForeignCode(), '', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XM, '', '', 0);
        InsertData(XCT200087, 'Allan Vinther-Wahl', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XM, '', '', 0);
        ...
        InsertData(XCT200093, 'Richard Bready', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200094, 'David Campbell', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          1, XCT100009, XM, '', '', 0);
        ...
        InsertData(XCT200097, 'Michael Pfeiffer', '220 Richdale Ave', DemoDataSetup.ForeignCode(), '', 'ENU', XRB, 'US', 'US-NY 11010',
          1, XCT100003, XM, '', '', 0);
        InsertData(XCT200098, 'Dick Dievendorff', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200099, 'Andrew R. Hill', '620 Ingridson Av', DemoDataSetup.ForeignCode(), '', 'ENU', XLT, 'US', 'US-SC 27136',
          1, XCT100010, XM, '', '', 0);
        InsertData(XCT200100, 'Stuart Munson', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XM, '', '', 0);
        ...
        InsertData(XCT200102, 'Tamara Johnston', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
        ...
        InsertData(XCT200106, 'An Van Gysel', 'Parklaan 3', DemoDataSetup.ForeignCode(), '', 'NLB', XRB, 'BE', 'BE-2800',
          1, ContactNo(DATABASE::Vendor, '32554455'), XFMAR, '', '', 0);
        InsertData(XCT200107, 'Pete Male', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200108, 'Richard Carey', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XM, '', XJMANA, 0);
        ...
        InsertData(XCT200110, 'Douglas Groncki', '620 Ingridson Av', DemoDataSetup.ForeignCode(), '', 'ENU', XLT, 'US', 'US-SC 27136',
          1, XCT100010, XM, '', '', 0);
        InsertData(XCT200111, 'Keith Harris', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XM, '', '', 0);
        ...
        InsertData(XCT200115, 'Jeff Stammler', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XM, '', '', 0);
        InsertData(XCT200116, 'David Oliver Lawrence', '2570 Swimthon Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-MO2 4RT',
        ...
        InsertData(XCT200117, 'Lone Strandbygaard', 'Strandvejen 334', DemoDataSetup.ForeignCode(), '', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XFMAR, '', '', 0);
        InsertData(XCT200118, 'Lori Kane', '2570 Swimthon Street', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-MO2 4RT',
        ...
        InsertData(XCT200119, 'Kimberly B. Zimmermann', '435 Kingston Street', DemoDataSetup.ForeignCode(), '', 'ENU', XHR, 'US', 'US-NY 11010',
          1, XCT100011, XFMAR, '', '', 0);
        InsertData(XCT200120, 'Simon Rapier', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, XGB, 'GB-PL14 5GB',
          1, XCT100013, XM, '', '', 0);
        InsertData(XCT200121, 'Sam Abolrous', '1558 23rd Street', DemoDataSetup.ForeignCode(), '', 'ENU', XHR, 'US', 'US-NY 11010',
          1, XCT100012, XM, '', XJMANA, 0);
        InsertData(XCT200122, 'David M. Bradley', '1120 Newport Ave', DemoDataSetup.ForeignCode(), '', 'ENG', XLT, XGB, 'GB-M61 2YG',
          1, XCT100007, XM, '', '', 0);
        InsertData(XCT200123, 'Angela Barbariol', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XFMAR, '', '', 0);
        InsertData(XCT200124, 'Matthew Carroll', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        InsertData(XCT200125, 'Brian Cox', '854 Theater Road', DemoDataSetup.ForeignCode(), '', 'ENG', XEH, XGB, 'GB-WD1 6YG',
          1, XCT100017, XM, '', '', 0);
        ...
        InsertData(XCT200128, 'Sharon Hoepf', '220 Richdale Ave', DemoDataSetup.ForeignCode(), '', 'ENU', XRB, 'US', 'US-NY 11010',
          1, XCT100003, XFMAR, '', '', 0);
        InsertData(XCT200129, 'Nancy Buchanan', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XFMAR, '', '', 0);
        InsertData(XCT200130, XAlanSteiner, X28TheTything, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-OX16 0UA',
          1, XCT100241, XM, '', '', 0);
        InsertData(XCT200131, 'Linda Moschell', '1240 Yield mark Street', DemoDataSetup.ForeignCode(), '', 'ENG', XRB, XGB, 'GB-N12 5XY',
          1, XCT100008, XFMAR, '', XJMANA, 0);
        InsertData(XCT200132, 'Matthew Hink', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          1, XCT100009, XM, '', '', 0);
        ...
        InsertData(XCT200134, 'Steven B. Levy', '435 Kingston Street', DemoDataSetup.ForeignCode(), '', 'ENU', XHR, 'US', 'US-NY 11010',
          1, XCT100011, XM, '', '', 0);
        InsertData(XCT200135, 'Terry Adams', '810 South Newport Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XJO, XGB, 'GB-NP5 6GH',
          1, XCT100009, XM, '', '', 0);
    ...
    begin
        ...
        if Contact."Country/Region Code" = DemoDataSetup."Country/Region Code" then
