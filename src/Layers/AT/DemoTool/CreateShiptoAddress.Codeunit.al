codeunit 101222 "Create Ship-to Address"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('10000', XCHELTENHAM, XMontpellierHouse, XMontpellierDrive, '', XEXW, XBLUE, CreatePostCode.Convert('GB-DY5 4DJ'));
        InsertData('10000', XLONDON, X2KingdomStreet, XPaddington, '', XEXW, XBLUE, CreatePostCode.Convert('GB-GU7 5GT'));
        InsertData('20000', XFLEET, XBeaconHillRoad, XChurchCrookham, '', XEXW, XBLUE, CreatePostCode.Convert('GB-NP5 6GH'));
        InsertData('20000', UpperCase(XTWYCROSS), XManorPark, XTWYCROSS, '', XEXW, XBLUE, CreatePostCode.Convert('GB-OX16 0UA'));
    end;
}
