codeunit 110000 "Interface Basis Data"
{
    ...
    var
        ...
        UpdateVATStatementAT: Codeunit "Update VAT-AT";
        JobNo: Code[20];
    ...
    begin
        ...
        RunCodeunit(CODEUNIT::"Create Acc. Sched. Name RLG");
        RunCodeunit(CODEUNIT::"Create Acc. Schedule Line");
        RunCodeunit(CODEUNIT::"Create Acc. Sched. Line RLG");
        ...
        UpdateVATStatementAT.Update('UVA-2020', 'Österreichische USt ab 2020', '');
