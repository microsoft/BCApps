codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Thomas Icely';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Blake Fenbury';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Timothy Sugden';
