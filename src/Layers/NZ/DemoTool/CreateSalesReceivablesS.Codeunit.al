codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        "Create No. Series".InitFinalSeries("Sales & Receivables Setup"."Posted Tax Invoice Nos.", XSTAXINVplus, XPostedSalesTaxInvoice, 3);
        "Create No. Series".InitFinalSeries("Sales & Receivables Setup"."Posted Tax Credit Memo Nos", XSTAXCRplus, XPostedSalesTaxCreditMemo, 3);
    ...
    var
        ...
        XSTAXINVplus: Label 'S-TAXINV+';
        XPostedSalesTaxInvoice: Label 'Posted Sales Tax Invoice';
        XSTAXCRplus: Label 'S-TAXCR+';
        XPostedSalesTaxCreditMemo: Label 'Posted Sales Tax Credit Memo';
    ...
    begin
        ...
        "Sales & Receivables Setup"."Posted Tax Invoice Nos." := XSTAXINVplus;
        "Sales & Receivables Setup"."Posted Tax Credit Memo Nos" := XSTAXCRplus;
        "Sales & Receivables Setup".Modify();
    end;
}
