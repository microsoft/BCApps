codeunit 101222 "Create Ship-to Address"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('10000', XCHELTENHAM, XMontpellierHouse, XMontpellierDrive, '', XEXW, XBLUE, 'NZ-1015');
        InsertData('10000', XLONDON, X2KingdomStreet, XPaddington, '', XEXW, XBLUE, 'NZ-3201');
        InsertData('20000', XFLEET, XBeaconHillRoad, XChurchCrookham, '', XEXW, XBLUE, 'NZ-4851');
        InsertData('20000', UpperCase(XTWYCROSS), XManorPark, XTWYCROSS, '', XEXW, XBLUE, 'NZ-7001');
    end;
}
