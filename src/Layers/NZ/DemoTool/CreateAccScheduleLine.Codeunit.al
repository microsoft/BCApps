codeunit 101085 "Create Acc. Schedule Line"
{
    ...
    var
        ...
        XCATRANSFER: Label 'CA-TRANS', Comment = 'Cost Acct. Personnel Costs.';
        ...
        XSalesRetailMISC: Label 'Sales, Retail - MISC';
        XPurchRetailMISC: Label 'Purch, Retail - MISC';
        XTradingMarginMISC: Label 'Trading Margin, MISC';
