codeunit 101015 "Create G/L Account"
{
            ...
            DemoDataSetup."Company Type"::VAT:
                begin
                    ...
                    if DemoDataSetup."Advanced Setup" then begin
                        ...
                        InsertData('995613', StrSubstNo(XSalesVATPERCENTUnrealized, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995616', StrSubstNo(XSalesVATPERCENTUnrealized, DemoDataSetup.ServicesVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995620', StrSubstNo(XPurchaseVATPERCENT, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995621', StrSubstNo(XPurchaseVATPERCENT, DemoDataSetup.ServicesVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995623', StrSubstNo(XPurchaseVATPCTUnrealized, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995626', StrSubstNo(XPurchaseVATPCTUnrealized, DemoDataSetup.ServicesVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        ...
                        InsertData('995615', StrSubstNo(XSalesVATPERCENT, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995620', StrSubstNo(XPurchaseVATPERCENT, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995621', StrSubstNo(XPurchaseVATPERCENT, DemoDataSetup.ServicesVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995625', StrSubstNo(XPurchaseVATPERCENT, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995630', StrSubstNo(XSalesVATPERCENT, DemoDataSetup.GoodsVATText()), 0, 1, 0, '', 0, '', '', '', '', false);
                    end;
                end;
        end;
    ...
    var
        ...
        XSalesVATPERCENT: Label 'Sales VAT %1', Comment = '%1 = VAT percentage';
        XSalesVATPERCENTUnrealized: Label 'Sales VAT %1 Unrealized', Comment = '%1 = VAT percentage';
        XPurchaseVATPERCENTEU: Label 'Purchase VAT %1 EU', Comment = '%1 = VAT percentage';
        XPurchaseVATPERCENT: Label 'Purchase VAT %1', Comment = '%1 = VAT percentage';
        XPurchaseVATPCTUnrealized: Label 'Purchase VAT %1 Unrealized', Comment = '%1 = VAT percentage';
        ...
        XVendorPrepaymentsVAT: Label 'Vendor Prepayments VAT %1', Comment = '%1 = VAT percentage';
        XPurchasePrepaymentsTotal: Label 'Purchase Prepayments, Total';
        XSalesPrepayments: Label 'Sales Prepayments';
        XCustomerPrepaymentsVAT: Label 'Customer Prepayments VAT %1', Comment = '%1 = VAT percentage';
