codeunit 101252 "Create General Posting Setup"
{
    ...
    begin
        ...
        InsertData('', DemoDataSetup.MiscCode(), '996110', '997110');
        InsertData('', DemoDataSetup.NoVATCode(), '', '');
        InsertData('', DemoDataSetup.RawMatCode(), '996210', '997210');
        InsertData('', DemoDataSetup.RetailCode(), '996110', '997110');
        InsertData('', DemoDataSetup.ServicesCode(), '996410', '997110');
        InsertData('', DemoDataSetup.ManufactCode(), '996110', '997110');
        ...
        InsertData(DemoDataSetup.EUCode(), DemoDataSetup.MiscCode(), '996110', '997110');
        ...
        InsertData(DemoDataSetup.EUCode(), DemoDataSetup.RetailCode(), '996110', '997110');
        InsertData(DemoDataSetup.EUCode(), DemoDataSetup.ServicesCode(), '996420', '997110');
        InsertData(DemoDataSetup.EUCode(), DemoDataSetup.ManufactCode(), '996130', '997130');
