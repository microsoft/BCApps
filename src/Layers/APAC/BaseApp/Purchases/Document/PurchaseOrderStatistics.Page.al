...
#pragma warning restore AA0074
    ...
    begin
        ...
        TotalAmount1ACY := VATAmountLine.GetTotalLineAmountACY();
        VATAmountACY := VATAmountLine.GetTotalVATAmountACY();
    ...
    begin
        ...
        if Rec."Vendor Exchange Rate (ACY)" = 0 then begin
            if TempVATAmountLine1.GetAnyLineModified() then
