...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/FinancialMgt/WithholdingTax/WHTPND3.rdlc';
    ...
    var
        ...
        ONRIC_NumberCaptionLbl: Label 'Ã½NRIC Number';
        ...
        BahtCaptionLbl: Label 'ÃˆBaht';
        SatangCaptionLbl: Label 'Satang';
        BahtCaption_Control1500022Lbl: Label 'ÃˆBaht';
