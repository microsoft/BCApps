...
#pragma warning restore AA0005
...
#if not CLEAN29
    [Scope('OnPrem')]
    [Obsolete('Moved to codeunit WHT Sales Post', '29.0')]
    ...
    var
        WHTSalesPost: Codeunit Microsoft.Finance.WithholdingTax."WHT Sales Post";
    begin
        WHTSalesPost.InsertGenJournalWHT(
            SalesHeader, GenJnlLine, AccountNo, AmountWHT, SrcCode, GenJnlLineDocType, GenJnlLineDocNo, GenJnlLineExtDocNo, TotalSalesLineLCY);
    end;
#endif
