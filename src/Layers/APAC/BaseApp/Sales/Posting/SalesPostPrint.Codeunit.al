...
codeunit 82 "Sales-Post + Print"
{
    ...
    begin
        ...
        SalesHeader."Tax Document Marked" := false;
        case SalesHeader."Tax Document Type" of
            SalesHeader."Tax Document Type"::"Document Post":
                SalesHeader."Tax Document Marked" := true;
            SalesHeader."Tax Document Type"::Prompt:
    ...
    begin
        ...
        if SalesHeader."Tax Document Marked" then begin
