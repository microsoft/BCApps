codeunit 139452 "O365 Vendor Permission Test"
{
    ...
    begin
        ...
        // [SCENARIO 308913] Edit Posted Purchase Credit Memo with "Posted Purch. Cr.Memo - Update" from "Posted Purchase Credit Memo" card with "D365 Sales Doc, Post" permission set.
        Initialize();
        ...
        // [THEN] "Posted Purch. Cr.Memo - Update" opens, Posted Purchase Credit Memo is updated.
    ...
    begin
        // [FEATURE] [Purchase Credit Memo]
        // [SCENARIO 308913] Edit Posted Purchase Credit Memo with "Posted Purch. Cr.Memo - Update" from "Posted Purchase Credit Memos" list with "D365 Sales Doc, Post" permission set.
        Initialize();
        LibraryVariableStorage.Enqueue(LibraryUtility.GenerateGUID());  // "Adjustment Applies-to"
