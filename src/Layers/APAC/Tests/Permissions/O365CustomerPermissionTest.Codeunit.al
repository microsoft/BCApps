codeunit 139453 "O365 Customer Permission Test"
{
    ...
    begin
        ...
        // [SCENARIO 308913] Edit Posted Sales Credit Memo with "Pstd. Sales Cr. Memo - Update" from "Posted Sales Credit Memo" card with "D365 Sales Doc, Post".
        Initialize();
        LibraryVariableStorage.Enqueue(LibraryUtility.GenerateGUID());  // "Adjustment Applies-to"

        // [GIVEN] A user with "D365 Sales Doc, Post" permission set.
        LibraryLowerPermissions.SetSalesDocsPost();

        // [WHEN] Open "Pstd. Sales Cr. Memo - Update" page from "Posted Sales Credit Memo" card. Set new value for "Adjustment Applies-to", press OK.
    ...
    begin
        // [FEATURE] [Sales Credit Memo]
        // [SCENARIO 308913] Edit Posted Sales Credit Memo with "Pstd. Sales Cr. Memo - Update" from "Posted Sales Credit Memos" list with "D365 Sales Doc, Post".
        Initialize();
        LibraryVariableStorage.Enqueue(LibraryUtility.GenerateGUID());  // "Adjustment Applies-to"
        ...
        // [WHEN] Open "Pstd. Sales Cr. Memo - Update" page from "Posted Sales Credit Memos" list. Set new value for "Adjustment Applies-to", press OK.
