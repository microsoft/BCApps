    ...
    actions
    {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(Print)
                {
                    ...
                    trigger OnAction()
                    begin
                        VATStmtName.Get(Rec."Statement Template Name", Rec."Statement Name");
                ...
                action(GLVATReconciliation)
                {
                    ...
                    begin
                        ...
                        VATStmtName.SetFilter("Statement Template Name", Rec."Statement Template Name");
                ...
                action(VATStatementSchedule)
                {
                    ...
                    ToolTip = 'View the schedule details of the Account Proof for Sales VAT Advance Notification report.';
        ...
        area(Promoted)
        {
            ...
            group(Category_Report)
            {
                ...
                actionref(GLVATReconciliation_Promoted; GLVATReconciliation)
                {
                }
            }
        }
