codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        "Create No. Series".InitTempSeries("Purchases & Payables Setup"."Delivery Reminder Nos.", XPDELREM, XPurchaseDeliveryReminder);
        "Create No. Series".InitFinalSeries("Purchases & Payables Setup"."Issued Delivery Reminder Nos.", XPDELREMPLUS, XIssuedPurchaseDeliveryReminder, 4);
