codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        InsertData(
          '70000', XFabrikamInc, X5Porfidia, X57100, '', '', '',
          DemoDataSetup."Country/Region Code", '234567899', '', '', '', '');
        InsertData(
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Giovani Mariano';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Mario Iadanza';
    ...
    begin
        ...
        Vendor.Validate("Payment Method Code", XxBANKTRANSF);
