codeunit 117000 "Interface Service Management"
{
    ...
    begin
        ...
        CreateSalesInvoice(2, '40000', 19021204D);
        WorkDate(MakeAdjustments.AdjustDate(19021212D));
        CreateSalesInvoice(2, '50000', 19021212D);
        WorkDate(MakeAdjustments.AdjustDate(19030123D));
        CreateSalesInvoice(2, '30000', 19030123D);
        WorkDate(TempDate);
        ...
        if SalesHeader.Find('-') then
            repeat
                SalesHeader."Operation Type" := XxITVNSLS; //IT
                SalesHeader.Modify(); //IT
