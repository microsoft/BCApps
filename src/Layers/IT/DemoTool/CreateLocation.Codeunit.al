codeunit 101014 "Create Location"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          XYELLOW, XYellowWarehouse, '', XMainBristolStreet10, '', CreatePostCode.Convert('GB-BS3 6KL'), DemoDataSetup."Country/Region Code",
          X4401052144987, X4401052140000, '', '', XJeanneBosworth, false, false, false, false);

        InsertData(
          XGREEN, XGreenWarehouse, '', XMainLiverpoolStreet5, '', CreatePostCode.Convert('GB-L18 6SA'), DemoDataSetup."Country/Region Code",
          X4403098741299, X4403098741200, '', '', XChrisPreston, false, false, false, false);

        InsertData(
          XBLUE, XBlueWarehouse, '', XSouthEastStreet3, '', CreatePostCode.Convert('GB-B27 4KT'), DemoDataSetup."Country/Region Code",
          X4402082074533, X4402082075000, '', '', XJeffSmith, false, false, false, false);

        InsertData(
          XRED, XRedWarehouse, '', XMainAshfordStreet2, '', CreatePostCode.Convert('GB-TN27 6YD'), DemoDataSetup."Country/Region Code",
          X4405014240001, X4405014240002, '', '', XCarolePoland, false, false, false, false);

        InsertData(
          XWHITE, XWhiteWarehouse, '', XMerrilyGroveAvenue62, '', CreatePostCode.Convert('GB-WC1 2GS'), DemoDataSetup."Country/Region Code",
          X4405045679771, X4405045679772, '', '', '', false, false, false, false);

        InsertData(
          XSilver, XSilverWarehouse, '', XPier102, '', CreatePostCode.Convert('GB-WC1 2GS'), DemoDataSetup."Country/Region Code",
          X4405045679771, X4405045679772, '', '', '', false, false, false, false);

        // BEGIN IT
        InsertData(
          XGOLD, XSubcontractorWarehouse, '', '', '', '', '', '', '', '', '', '', false, false, false, false);
        // END IT
    ...
    var
        ...
        XGOLD: Label 'GOLD';
        XSubcontractorWarehouse: Label 'Subcontractor Warehouse';
    ...
    begin
        ...
        InsertData(
          ...
          CreatePostCode.Convert('GB-BS3 6KL'), DemoDataSetup."Country/Region Code",
        ...
        InsertData(
          ...
          CreatePostCode.Convert('GB-L18 6SA'), DemoDataSetup."Country/Region Code",
        ...
        InsertData(
          ...
          XSouthEastStreet3, '',
          CreatePostCode.Convert('GB-B27 4KT'), DemoDataSetup."Country/Region Code",
