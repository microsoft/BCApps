codeunit 101037 "Create Sales Line"
{
    ...
    begin
        ...
        InsertResource(2, '1001', 3, XTerry, XAssemblingFurnitureJanuary, '', 25);
        InsertResource(2, '1001', 3, XTerry, XAssemblingFurnitureJanuary, XMILES, 120);
        InsertResource(2, '1002', 3, XTerry, XAssemblingFurnitureJanuary, '', 25);
        InsertResource(2, '1002', 3, XTerry, XAssemblingFurnitureJanuary, XMILES, 96);
        InsertResource(2, '1003', 3, XTerry, XAssemblingFurnitureJanuary, '', 25);
        InsertResource(2, '1003', 3, XTerry, XAssemblingFurnitureJanuary, XMILES, 76);
        InsertData(2, '1005', 2, '1976-W', XRED, 4);
        InsertData(2, '1006', 2, '1976-W', XRED, 18);
        InsertData(2, '1007', 2, '1976-W', XRED, 17);
        InsertData(2, '1008', 2, '1976-W', XRED, 17);
        InsertData(2, '1009', 2, '1976-W', XRED, 34);
        InsertData(2, '1010', 2, '1976-W', XRED, 18);
        InsertDataAndUpdateUnitPrice(2, '1011', 2, '70000', '', 3, 4349 / 3);
        InsertDataAndUpdateUnitPrice(2, '1012', 2, '70000', '', 4, 5798.78 / 4);
        InsertDataAndUpdateUnitPrice(2, '1013', 2, '70000', '', 5, 7248.48 / 5);
        InsertDataAndUpdateUnitPrice(2, '1014', 2, '70000', '', 1, 1232.24);
        // Add new invoices here

        InsertData(3, '1001', 2, '1968-S', XRED, 2);
        InsertData(3, '1002', 2, '1896-S', XGREEN, 1);
        InsertData(3, '1003', 2, '766BC-C', XGREEN, 1);
        InsertData(3, '1004', 2, '766BC-C', XGREEN, 1);
        InsertData(3, '1005', 2, '1896-S', XRED, 1);
    ...
    begin
        ...
        SalesLine.Validate("Deductible %", 100);
