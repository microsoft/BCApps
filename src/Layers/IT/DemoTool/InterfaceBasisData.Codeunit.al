codeunit 110000 "Interface Basis Data"
{
    ...
    begin
        ...
        RunCodeunit(CODEUNIT::"Create VAT Register");
        ...
        RunCodeunit(CODEUNIT::"Create Exit Point (Intrastat)");
        RunCodeunit(CODEUNIT::"Create Area");
        RunCodeunit(CODEUNIT::"Create Transaction Spec.");
        RunCodeunit(CODEUNIT::"Create Withh. Tax Code");
        RunCodeunit(CODEUNIT::"Create Withh. Tax Code Lines");
        RunCodeunit(CODEUNIT::"Create Contribution Code");
        RunCodeunit(CODEUNIT::"Create Contr. Codes Lines");
        RunCodeunit(CODEUNIT::"Create Contribution Brackets");
