codeunit 118842 "Create Dist. Customer"
{
    ...
    begin
        CountryCode := CreatePostCode.GetCountryPrefix("Post Code"); // IT
        Customer.Init();
        ...
        Customer.Validate("Customer Posting Group", CreateCurrency.GetPostingGroup(CountryCode));
        Customer.Validate("Gen. Bus. Posting Group", CreateCurrency.GetBusPostingGroup(CountryCode));
