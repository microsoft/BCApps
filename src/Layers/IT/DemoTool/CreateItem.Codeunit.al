codeunit 101027 "Create Item"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('70000', 263, 134, '10000', '10-102', 250, 2.65, 2.3, 0.04, '94039030', '', '', '');
        InsertData('70001', 345, 176, '10000', '10-103', 250, 3.22, 2.8, 0.06, '94039030', '', '', '');
        InsertData('70002', 246, 125, '10000', '10-104', 250, 2.88, 2.5, 0.04, '94039030', '', '', '');
        InsertData('70003', 253, 129, '10000', '10-105', 250, 7.02, 6.1, 0.7, '94039030', '', '', '');
        InsertData('70010', 446, 227, '10000', '10-106', 250, 3.11, 2.7, 0.04, '94039030', '', '', '');
        InsertData('70011', 619, 316, '10000', '10-107', 250, 7.25, 6.3, 0.04, '94039090', '', '', '');
        InsertData('70040', 926, 472, '10000', '10-108', 250, 10.81, 9.4, 0.45, '94039030', '', '', '');
        InsertData('70041', 200, 102, '10000', '10-109', 250, 2.42, 2.1, 0.4, '94039030', '', '', '');
        InsertData('70060', 112, 57, '32456123', '10-110', 1000, 1.73, 1.5, 0.05, '94039010', '', '', '');
        InsertData('70100', 23, 12, '20000', '20-127', 150, 1.84, 1.6, 0.01, '99999999', XCAN, '', '');
        InsertData('70101', 23, 12, '20000', '20-128', 150, 1.84, 1.6, 0.01, '99999999', XCAN, '', '');
        InsertData('70102', 23, 12, '20000', '20-129', 150, 1.84, 1.6, 0.01, '99999999', XCAN, '', '');
        InsertData('70103', 23, 12, '20000', '20-130', 150, 1.84, 1.6, 0.01, '99999999', XCAN, '', '');
        InsertData('70104', 23, 12, '20000', '20-131', 150, 1.84, 1.6, 0.01, '99999999', XCAN, '', '');
        InsertData('70200', 11, 6, '10000', '10-111', 1200, 0.35, 0.3, 0.01, '94039010', '', '', '');
        InsertData('70201', 10, 5, '10000', '10-112', 1200, 0.23, 0.2, 0.01, '94039030', '', '', '');
        InsertData('80100', 49, 26, '46558855', '', 0, 0, 0, 0, '99999999', XBOX, XPACK, XPALLET);
        InsertData('1896-S', 5560, 4337, '30000', '30-111', 25, 39.79, 34.6, 1.2, '94033011', '', '', '');
        InsertData('1900-S', 1071, 835, '20000', '20-121', 50, 9.55, 8.3, 0.25, '94017100', '', '', '');
        InsertData('1906-S', 2409, 1879, '30000', '30-112', 25, 19.67, 17.1, 0.26, '94033091', '', '', '');
        InsertData('1908-S', 1056, 823, '30000', '30-113', 50, 15.99, 13.9, 0.25, '94013010', '', '', '');
        InsertData('1920-S', 3599, 2808, '20000', '20-122', 15, 28.06, 24.4, 0.9, '94033019', '', '', '');
        InsertData('1924-W', 1168, 699, '', '', 150, 15.77, 13.7, 0.84, '94033019', '', '', '');
        InsertData('1928-S', 305, 238, '10000', '10-101', 45, 4.03, 3.5, 0.03, '94052099', '', '', '');
        InsertData('1928-W', 2929, 1644, '', '', 50, 26.58, 23.1, 1.29, '94033019', '', '', '');
        InsertData('1936-S', 1071, 835, '20000', '20-123', 50, 9.55, 8.3, 0.25, '94017100', '', '', '');
        InsertData('1952-W', 1357, 801, '', '', 50, 18.19, 15.8, 1.24, '94033019', '', '', '');
        InsertData('1960-S', 1071, 835, '20000', '20-124', 50, 9.55, 8.3, 0.25, '94017100', '', '', '');
        InsertData('1964-S', 1071, 835, '20000', '20-125', 50, 9.55, 8.3, 0.25, '94017100', '', '', '');
        InsertData('1964-W', 2500, 1466, '', '', 50, 26.02, 22.6, 1.3, '94033091', '', '', '');
        InsertData('1968-S', 1056, 823, '30000', '30-114', 50, 15.99, 13.9, 0.25, '94013010', '', '', '');
        InsertData('1968-W', 8346, 6067, '', '', 50, 82.11, 0, 0, '94033019', '', '', '');
        InsertData('1972-S', 1056, 823, '30000', '30-115', 50, 15.99, 13.9, 0.25, '94013010', '', '', '');
        InsertData('1972-W', 8346, 6067, '', '', 50, 82.11, 71.4, 0.32, '94033019', '', '', '');
        InsertData('1976-W', 2193, 1289, '', '', 50, 21.88, 19, 1.3, '94033091', '', '', '');
        InsertData('1980-S', 1056, 823, '30000', '30-116', 50, 15.99, 13.9, 0.25, '94013010', '', '', '');
        InsertData('1984-W', 8346, 6067, '', '', 50, 82.11, 71.4, 0.32, '94033019', '', '', '');
        InsertData('1988-S', 1071, 835, '20000', '20-126', 50, 9.55, 8.3, 0.25, '94017100', '', '', '');
        InsertData('1988-W', 8346, 6067, '', '', 50, 82.11, 71.4, 0.32, '94033019', '', '', '');
        InsertData('1992-W', 8346, 6067, '', '', 50, 82.11, 71.4, 0.32, '94033019', '', '', '');
        InsertData('1996-S', 7763, 6055, '30000', '30-117', 100, 80.27, 69.8, 0.31, '94033019', '', '', '');
        InsertData('2000-S', 1056, 823, '30000', '30-118', 50, 15.99, 13.9, 0.25, '94013010', '', '', '');
        ...
        InsertData('766BC-A', 46350.76923, 30128, '', '', 10, 119.72, 104.1, 1.47, '94033019', '', '', '');
        InsertData('766BC-B', 15305.00086, 10666, '', '', 10, 155.96, 135.6, 6.67, '94033019', '', '', '');
        InsertData('766BC-C', 8087.69231, 5257, '', '', 10, 94.31, 82, 5.18, '94033019', '', '', '');
        ...
        case true of
            ...
            Item."No." in ['2000']:
                begin
                    ...
                    Item."Routing No." := '2000';
                    Item."Production BOM No." := '2000';
                    Item.Validate("Gen. Prod. Posting Group", DemoDataSetup.RetailCode());
                    Item."Inventory Posting Group" := DemoDataSetup.FinishedCode();
                    Item."Reordering Policy" := Item."Reordering Policy"::Order;
                end;
            Item."No." in ['2001', '2002', '2003']:
                begin
    ...
    begin
        InsertData('2000', 0, 0, '', '', 0, 0, 0, 0, '', '', '', '');
        InsertData('2001', 0, 0, '10000', '', 0, 0, 0, 0, '', '', '', '');
        InsertData('2002', 0, 0, '10000', '', 0, 0, 0, 0, '', '', '', '');
        InsertData('2003', 0, 0, '20000', '', 0, 0, 0, 0, '', XCAN, XCAN, XCAN);
    end;
