codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        ...
        InsertData(XGOLD, DemoDataSetup.FinishedCode(), '992120', '992121');
        InsertData(XGOLD, DemoDataSetup.RawMatCode(), '992130', '992131');
        InsertData(XGOLD, DemoDataSetup.ResaleCode(), '992110', '992111');
    end;
