codeunit 101579 "Create Marketing Setup"
{
    ...
    begin
        ...
        CreateNoSeries.InitBaseSeries(MarketingSetup."Campaign Nos.", XCAMP, XCampaign, XCP0001, XCP9999, '', '', 1,
          NoSeries."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."Segment Nos.", XSEGM, XSegment, XSM00001, XSM99999, '', '', 1,
          NoSeries."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."To-do Nos.", XTASK, XTaskDescr, XTD000001, XTD999999, '', '', 1,
          NoSeries."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);
        CreateNoSeries.InitBaseSeries(MarketingSetup."Opportunity Nos.", XOPP, XOpportunity, XOP000001, XOP999999, '', '', 1,
          NoSeries."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);
