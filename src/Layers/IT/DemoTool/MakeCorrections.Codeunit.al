        ...
        case Date of
            CA.AdjustDate(19020501D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      CA.AdjustDate(19020301D), CA.AdjustDate(19020331D), CA.AdjustDate(19020501D), StrSubstNo(VATDocNumber, XVAT1Q, Date2DMY(Date, 3)
              ),
                      CA.Convert('995710'), '9140', '9140', false, true);
            ...
            CA.AdjustDate(19020801D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      CA.AdjustDate(19020601D), CA.AdjustDate(19020630D), CA.AdjustDate(19020801D), StrSubstNo(VATDocNumber, XVAT2Q, Date2DMY(Date, 3)
              ),
                      CA.Convert('995710'), '9140', '9140', false, true);
                    CalcAndPostVAT.UseRequestPage(false);
                end;
            CA.AdjustDate(19021101D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      CA.AdjustDate(19020901D), CA.AdjustDate(19020930D), CA.AdjustDate(19021101D), StrSubstNo(VATDocNumber, XVAT3Q, Date2DMY(Date, 3)
              ),
                      CA.Convert('995710'), '9140', '9140', false, true);
                    CalcAndPostVAT.UseRequestPage(false);
                end;
