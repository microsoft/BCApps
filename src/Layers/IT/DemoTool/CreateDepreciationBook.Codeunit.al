codeunit 101808 "Create Depreciation Book"
{
    ...
    begin
        "FA Setup".Get();
        InsertData(
          "FA Setup"."Default Depr. Book", XCompanyBook, true, true, true, true, true, true, true, true, true, 10, true, true);
    end;
    ...
    procedure InsertData("Code": Code[10]; Description: Text[30]; "G/L Integration - Acq. Cost": Boolean; "G/L Integration - Depreciation": Boolean; "G/L Integration - Write Down": Boolean; "G/L Integration - Appreciation": Boolean; "G/L Integration - Custom 1": Boolean; "G/L Integration - Custom 2": Boolean; "G/L Integration - Disposal": Boolean; "G/L Integration - Maintenance": Boolean; "Use Rounding in Periodic Depr.": Boolean; "Default Final Rounding Amount": Decimal; "Calc. Anticipato Depreciation": Boolean; "Calc. Custom 2 Depreciation": Boolean)
    begin
        ...
        //BEGIN IT
        "Depreciation Book".Validate("Anticipated Depreciation Calc.", "Calc. Anticipato Depreciation");
        "Depreciation Book".Validate("Acc./Red. Depreciation Calc.", "Calc. Custom 2 Depreciation");
        //END IT
