codeunit 118831 "Create Whse. Journal Template"
{
    ...
    begin
        ...
        InsertData(
          ...
          SourceCodeSetup."Whse. Item Journal", XWJNLADJ, XWhseAdjustmentJournal, '5001', XxT06000);
        InsertData(
          XRECLASS, XReclassificationJournal, "Warehouse Journal Template".Type::Reclassification,
          SourceCodeSetup."Whse. Reclassification Journal", XWJNLRCLSS, XWhseReclassificationJournal, '6001', XxT07000);
        InsertData(
          XPHYSINVT, XPhysicalInventoryJournal, "Warehouse Journal Template".Type::"Physical Inventory",
          SourceCodeSetup."Whse. Phys. Invt. Journal", XWJNLPHYS, XWhsePhysInvtJournal, '7001', XxT08000);
    end;

    var
        XxT06000: Label 'T06000';
        XxT07000: Label 'T07000';
        XxT08000: Label 'T08000';
    ...
    begin
        if "No. Series" <> '' then
            "Create No. Series".InitBaseSeries(
              ...
              "No. Series2"."No. Series Type"::Normal, '', 0, '', false);
