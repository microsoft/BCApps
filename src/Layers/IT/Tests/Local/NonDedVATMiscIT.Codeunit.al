codeunit 144251 "Non Ded. VAT Misc. IT"
{
    Subtype = Test;
    ...
    begin
        ...
        AssignDeductiblePctToVATAmountLine(TempVATAmountLine, LibraryRandom.RandIntInRange(10, 50));
        ...
        TempVATAmountLine.TestField("Nondeductible Base", TempVATAmountLine."VAT Base" * (100 - GetDeductibleVATPctFromVATAmountLine(TempVATAmountLine)) / 100);

        // [THEN] "VAT Amount Line"."Nondeductible Amount" = 15
        TempVATAmountLine.TestField(
          "Nondeductible Amount", TempVATAmountLine."VAT Amount" * (100 - GetDeductibleVATPctFromVATAmountLine(TempVATAmountLine)) / 100);
    end;
    ...
    begin
        ...
        AssignDeductiblePctToVATAmountLine(TempVATAmountLine, 0);
        TempVATAmountLine.Insert();
    ...
    begin
        ...
        TempVATAmountLine."Line Amount" := LibraryRandom.RandIntInRange(10, 100);
        TempVATAmountLine."VAT %" := LibraryRandom.RandIntInRange(10, 100);
        AssignDeductiblePctToVATAmountLine(TempVATAmountLine, 100);
        TempVATAmountLine.Insert();
    ...
    begin
        LibraryERM.CreateVATPostingSetupWithAccounts(VATPostingSetup, VATCalculationType, LibraryRandom.RandDecInRange(10, 25, 2));
    ...
    begin
        VATAmountLine."Deductible %" := DeductiblePct;
    end;
