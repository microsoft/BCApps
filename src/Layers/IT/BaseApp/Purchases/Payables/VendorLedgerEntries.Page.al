    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Document Occurrence"; Rec."Document Occurrence")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action(BillList)
                {
                    ...
                    begin
                        if Rec."Document Type" = Rec."Document Type"::Payment then
                            PostedVendorBillHeader.SetRange("No.", Rec."Document No.")
                        else
                            PostedVendorBillHeader.SetRange("No.", Rec."Vendor Bill List");
