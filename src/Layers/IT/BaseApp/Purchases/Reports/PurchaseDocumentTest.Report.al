                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            if "Purchase Line"."Document Type" in ["Purchase Line"."Document Type"::Order, "Purchase Line"."Document Type"::Invoice, "Purchase Line"."Document Type"::"Credit Memo"] then
                                if VATPostingSetup.IsEUService("Purchase Line"."VAT Bus. Posting Group", "Purchase Line"."VAT Prod. Posting Group") then begin
                                    if "Purchase Line"."Service Tariff No." = '' then
                                        AddError(
                                          StrSubstNo(
                                            Text006, "Purchase Line".FieldCaption("Service Tariff No.")));
                                    if "Purchase Line"."Transport Method" = '' then
                                        AddError(
                                          StrSubstNo(
                                            Text12100, "Purchase Line".FieldCaption("Transport Method")));
                            ...
                            InclInVATReportErrorLogTemp.SetRange("Line No.", "Purchase Line"."Line No.");
