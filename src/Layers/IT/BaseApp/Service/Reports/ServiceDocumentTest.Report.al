                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            if "Service Line"."Gen. Prod. Posting Group" <> '' then begin
                                ...
                                if "Service Line"."Document Type" in ["Service Line"."Document Type"::Order, "Service Line"."Document Type"::Invoice, "Service Line"."Document Type"::"Credit Memo"] then
                                    if VATPostingSetup.IsEUService("Service Line"."VAT Bus. Posting Group", "Service Line"."VAT Prod. Posting Group") then begin
                                        if "Service Line"."Service Tariff No." = '' then
                                            AddError(
                                              StrSubstNo(
                                                Text006, "Service Line".FieldCaption("Service Line"."Service Tariff No.")));
                                        if "Service Line"."Transport Method" = '' then
                                            AddError(
                                              StrSubstNo(
                                                Text12100, "Service Line".FieldCaption("Service Line"."Transport Method")));
