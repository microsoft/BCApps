...
table 1382 "Item Templ."
{
    ...
    fields
    {
        ...
        field(12100; "Lifo Category"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                ValidateItemField(FieldNo("Lifo Category"));
            end;
        }
        field(12101; "Inventory Valuation"; Option)
        {
            ...
            trigger OnValidate()
            begin
                ValidateItemField(FieldNo("Inventory Valuation"));
            end;
        }
