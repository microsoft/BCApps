...
#pragma warning restore AA0074
    ...
    begin
        if GenJnlPosting then begin
            ...
            ShouldCheckNoOfDepreciationDays := (GenJnlLine."FA Posting Type" <> GenJnlLine."FA Posting Type"::Depreciation) and (GenJnlLine."FA Posting Type" <> GenJnlLine."FA Posting Type"::"Custom 1") and (GenJnlLine."FA Posting Type" <> GenJnlLine."FA Posting Type"::"Custom 2") and (GenJnlLine."No. of Depreciation Days" <> 0) and (GenJnlLine."FA Posting Type" <> GenJnlLine."FA Posting Type"::Derogatory);
        ...
        if not GenJnlPosting then begin
            ...
            ShouldCheckNoOfDepreciationDays := (FAJnlLine."FA Posting Type" <> FAJnlLine."FA Posting Type"::Depreciation) and (FAJnlLine."FA Posting Type" <> FAJnlLine."FA Posting Type"::"Custom 1") and (FAJnlLine."FA Posting Type" <> FAJnlLine."FA Posting Type"::"Custom 2") and (FAJnlLine."No. of Depreciation Days" <> 0) and (FAJnlLine."FA Posting Type" <> FAJnlLine."FA Posting Type"::Derogatory);
            OnCheckConsistencyOnAfterCalcShouldCheckNoOfDepreciationDays(GenJnlLine, FieldErrorText, ShouldCheckNoOfDepreciationDays, FAJnlLine);
            if ShouldCheckNoOfDepreciationDays then
