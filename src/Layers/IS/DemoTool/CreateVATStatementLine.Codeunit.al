codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        ...
        if (DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Evaluation) or (DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Standard) then begin
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('161', StrSubstNo(XValueofOverseasSalesTxt, DemoDataSetup.GoodsVATText(), ''), 1, '', 2, DemoDataSetup.ExportCode(), DemoDataSetup.GoodsVATCode(), '', 2, 0, false, 1, false);
            InsertData('170', StrSubstNo(XValueofOverseasSalesTxt, DemoDataSetup.GoodsVATText(), XTotalTxt), 2, '', 0, '', '', '161..169', 0, 0, true, 1, false);
            InsertData(
              '171', StrSubstNo(XValueofOverseasSalesTxt, DemoDataSetup.ServicesVATText(), ''), 1, '', 2, DemoDataSetup.ExportCode(), DemoDataSetup.ServicesVATCode(), '', 2, 0, false, 1, false);
            InsertData(
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData(
              '261', StrSubstNo(XValueofOverseasPurchasesTxt, DemoDataSetup.GoodsVATText(), ''), 1, '', 1, DemoDataSetup.ExportCode(), DemoDataSetup.GoodsVATCode(), '', 2, 0, false, 0, false);
            InsertData(
              '270', StrSubstNo(XValueofOverseasPurchasesTxt, DemoDataSetup.GoodsVATText(), XTotalTxt), 2, '', 0, '', '', '261..269', 0, 0, true, 0, false);
            InsertData(
              '271', StrSubstNo(XValueofOverseasPurchasesTxt, DemoDataSetup.ServicesVATText(), ''), 1, '', 1, DemoDataSetup.ExportCode(), DemoDataSetup.ServicesVATCode(), '', 2, 0, false, 0, false);
            InsertData(
