    ...
    begin
        case GLAccountCategory."Account Category" of
            GLAccountCategory."Account Category"::Assets:
                begin
                    UpdateGLAccounts(GLAccountCategory, '991000', '991000');
            ...
            GLAccountCategory."Account Category"::Liabilities:
                begin
                    ...
                    UpdateGLAccounts(GLAccountCategory, '995999', '995999');
                end;
            ...
            GLAccountCategory."Account Category"::Income:
                begin
                    ...
                    UpdateGLAccounts(GLAccountCategory, '996000', '996000');
                    UpdateGLAccounts(GLAccountCategory, '998995', '998995');
                    UpdateGLAccounts(GLAccountCategory, '999395', '999395');
                    UpdateGLAccounts(GLAccountCategory, '999495', '999495');
                    UpdateGLAccounts(GLAccountCategory, '999999', '999999');
                end;
