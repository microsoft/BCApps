...
#pragma warning restore AA0074
    ...
    /// <param name="MaxPostingDate">Maximum allowed posting date</param>
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckPostingDate(PostingDate: Date; Caption: Text[50]; EntryNo: BigInteger; JnlTemplName: Code[10]; var IsHandled: Boolean; var ReversalEntry: Record "Reversal Entry"; var MaxPostingDate: Date)
    begin
    end;
