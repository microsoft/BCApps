...
#pragma warning restore AA0470
    ...
    begin
        ...
        if GenJnlLine.FindFirst() then begin
            ...
            if BottomLine and not IsHandled and ((Balance - LastGenJnlLine."Balance (LCY)" = 0) or (GenJnlTemplate.Type = GenJnlTemplate.Type::Financial)) and not LastGenJnlLine.EmptyLine() then
