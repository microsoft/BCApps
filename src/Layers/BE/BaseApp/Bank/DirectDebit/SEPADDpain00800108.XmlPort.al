...
xmlport 1011 "SEPA DD pain.008.001.08"
{
                    ...
                    tableelement(paymentexportdata; "Payment Export Data")
                    {
                        ...
                        textelement(Dbtr)
                        {
                            ...
                            textelement(dbtrid)
                            {
                                ...
                                {
                                    XmlName = 'OrgId';
                                    fieldelement(AnyBIC; PaymentExportData."Recipient Bank BIC")
                                    {
                                    }
                                }
    ...
    begin
        FeatureTelemetry.LogUptake('0000N23', SEPADDExportFile.FeatureName(), Enum::"Feature Uptake Status"::Used);
        FeatureTelemetry.LogUsage('0000N24', SEPADDExportFile.FeatureName(), 'XmlPort SEPA DD pain.008.001.08');
        InitData();
    end;
