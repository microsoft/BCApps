codeunit 110000 "Interface Basis Data"
{
    ...
    begin
        ...
        GenJournalBatch.SetRange("Journal Template Name", XFINANC);
        GenJournalBatch.SetFilter(Name, '<>%1', XBANK);
        GenJournalBatch.DeleteAll();
        GenJournalBatch.SetRange("Journal Template Name", XGENERAL);
        GenJournalBatch.SetRange(Name, XCASH);
        GenJournalBatch.DeleteAll();
        ...
        CODEUNIT.Run(CODEUNIT::"Create EB");
        CODEUNIT.Run(CODEUNIT::"Create Domiciliation");
        CODEUNIT.Run(CODEUNIT::"Create CODA");
