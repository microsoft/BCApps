        ...
        case Date of
            CA.AdjustDate(19020501D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      0D, CA.AdjustDate(19020331D), CA.AdjustDate(19020501D), XPERIODIC, XDEFAULT,
            ...
            CA.AdjustDate(19020801D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      0D, CA.AdjustDate(19020630D), CA.AdjustDate(19020801D), XPERIODIC, XDEFAULT,
                      CA.Convert('995710'), false, true);
                    CalcAndPostVAT.UseRequestPage(false);
                end;
            CA.AdjustDate(19021101D):
                begin
                    ...
                    CalcAndPostVAT.InitializeRequest(
                      0D, CA.AdjustDate(19020930D), CA.AdjustDate(19021101D), XPERIODIC, XDEFAULT,
                      CA.Convert('995710'), false, true);
                    CalcAndPostVAT.UseRequestPage(false);
                end;
            else
