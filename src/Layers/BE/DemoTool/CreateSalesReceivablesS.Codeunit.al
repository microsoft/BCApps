codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        "Sales & Receivables Setup".Validate("S. Invoice Template Name", XSALES);
        "Sales & Receivables Setup".Validate("S. Cr. Memo Template Name", XSALESCR);
        "Sales & Receivables Setup".Validate("S. Prep. Inv. Template Name", XSALES);
        "Sales & Receivables Setup".Validate("S. Prep. Cr.Memo Template Name", XSALESCR);
        "Sales & Receivables Setup".Validate("IC Sales Invoice Template Name", XICSALES);
        "Sales & Receivables Setup".Validate("IC Sales Cr. Memo Templ. Name", XICSALESCR);
