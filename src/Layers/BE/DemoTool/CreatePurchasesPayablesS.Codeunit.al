codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        "Purchases & Payables Setup"."Copy Inv. No. To Pmt. Ref." := true;
        "Purchases & Payables Setup".Validate("P. Invoice Template Name", XPURCH);
        "Purchases & Payables Setup".Validate("P. Cr. Memo Template Name", XPURCHCR);
        "Purchases & Payables Setup".Validate("P. Prep. Inv. Template Name", XPURCH);
        "Purchases & Payables Setup".Validate("P. Prep. Cr.Memo Template Name", XPURCHCR);
        "Purchases & Payables Setup".Validate("IC Purch. Invoice Templ. Name", XICPURCH);
        "Purchases & Payables Setup".Validate("IC Purch. Cr. Memo Templ. Name", XICPURCHCR);
