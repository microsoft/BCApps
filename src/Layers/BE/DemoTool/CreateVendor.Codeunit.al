codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '0991000005', XLIERHERENT, '', '', '8712345000028');
        InsertData(
          '20000', XARDayPropertyManagement, X100DayDrive, CreatePostCode.Convert('GB-GU3 2SE'), XMr, XFrankLee, '',
          DemoDataSetup."Country/Region Code", '0990000014', XS, XYELLOW, '', '8712345000035');
        InsertData(
          '30000', XCoolWoodTechnologies, X33HitechDrive, CreatePostCode.Convert('GB-PO7 2HI'), XMr, XRichardBready, '',
          DemoDataSetup."Country/Region Code", '0989000023', XS, '', '', '');
        InsertData(
          '40000', XLewisHomeFurniture, X51RadcroftRoad, CreatePostCode.Convert('GB-IB7 7VN'), XMr, XJuliaCollins, '',
          DemoDataSetup."Country/Region Code", '0988000032', XNE, XGREEN, '', '');
        InsertData(
          '50000', XServiceElectronicsLtd, X172FieldGreen, CreatePostCode.Convert('GB-WD2 4RG'), XMr, XMarcZimmerman, '',
          DemoDataSetup."Country/Region Code", '0987000041', XLIERHERENT, '', '', '');
        InsertData(
        ...
        InsertData(
          '32456123', 'Groene Kater BVBA', 'Stationstraat 12', 'BE-1851', '', 'Roger Van Houten', 'EUR', 'BE', '0986000050', '', '', '', '');
        InsertData(
          '32554455', 'PURE-LOOK', 'Parklaan 3', 'BE-2800', '', 'Rob Caron', 'EUR', 'BE', '0985000059', '', '', '', '');
        InsertData(
          '32665544', 'Overschrijd de Grens SA', 'Boomgaardstraat 55', 'BE-8500', '', 'Tom Vande Velde', 'EUR', 'BE', '0984000068', '', '', '', '');
        InsertData(
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Stan Henthorn';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Jesse Lohman';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Wander Harmsen';
    ...
    begin
        ...
        if "Country Code" = DemoDataSetup."Country/Region Code" then
            Vendor.Validate("Enterprise No.", "VAT Registration No.")
        else
    ...
    begin
        ...
        InsertData(
          '20000', XFirstUpConsultants, X20AllanTuringRd, CreatePostCode.Convert('GB-GU3 2SE'), '', '', '',
          DemoDataSetup."Country/Region Code", '0990000014', '', '', XSurrey, '');
        UpdateContact('20000', XEvanMcIntosh);
        InsertData(
          '30000', XGraphicDesignInstitute, X6Arbachtalstrasse, CreatePostCode.Convert('DE-72800'), '', '', '',
          'DE', '521478963', '', '', XUnterAchalm, '');
        UpdateContact('30000', XBryceJasso);
        InsertData(
          '40000', XWideWorldImporters, X3000AviatorWay, CreatePostCode.Convert('GB-IB7 7VN'), '', '', '',
          DemoDataSetup."Country/Region Code", '0988000032', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", '0987000041', '', '', XWaverlyGate, '');
