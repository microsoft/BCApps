codeunit 134987 "ERM Financial Reports III"
{
    ...
    [Test]
    [HandlerFunctions('GeneralJournalTemplateListModalPageHandler,MessageHandler,PrintCheckWithReprintReqPageHandler,SuggestVendorPaymentsNewDocPerLineRequestPageHandler')]
    ...
    [Test]
    [HandlerFunctions('ApplyVendorEntriesModalPageHandler,VendorPrePaymentJournalHandler,GeneralJournalTemplateListModalPageHandler')]
