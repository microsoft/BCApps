codeunit 138400 "RS Pack Content - Evaluation"
{
    ...
    begin
        // [FEATURE] [Location Transfer]
        // [SCENARIO] Demo data contains 0 transfer orders.
        Initialize();
    ...
    begin
        ...
        // [SCENARIO] Demo data contains 0 transfer shipment
        Initialize();

        Assert.RecordCount(TransferShipmentHeader, 0);
        Assert.RecordCount(TransferShipmentLine, 0);
    end;
    ...
    begin
        ...
        // [SCENARIO] Demo data contains 0 transfer receipt
        Initialize();

        Assert.RecordCount(TransferReceiptHeader, 0);
        Assert.RecordCount(TransferReceiptLine, 0);
    end;
