codeunit 101208 "Create Job Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            InsertData(XSETTINGUP, XSettingUpFurnitureTxt, GetGLAccNo.WIPJobCosts(), GetGLAccNo.AccruedJobCosts(), GetGLAccNo.JobCostAppliedRetail(),
                        GetGLAccNo.JobCostAppliedRetail(), GetGLAccNo.JobCostAppliedResources(), GetGLAccNo.JobCostAppliedRawMaterials(), GetGLAccNo.JobCostAdjmtRetail(), GetGLAccNo.SalesOtherJobExpenses(),
                        GetGLAccNo.WIPJobSales(), GetGLAccNo.InvoicedJobSales(), GetGLAccNo.JobSalesAppliedRetail(), GetGLAccNo.JobSalesAdjmtRetail(), GetGLAccNo.JobCosts(), GetGLAccNo.JobSales());
    end;
