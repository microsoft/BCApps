codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        if DemoDataSetup."Company Type" = DemoDataSetup."Company Type"::"Sales Tax" then
            if "Currency Code" = '' then
                if TaxArea.Get(Vendor.County) then begin
    ...
    begin
        ...
        SetTaxLiable('10000');
        SetGSTHSTRegNo('10000', '123456789');
    ...
    local procedure SetGSTHSTRegNo("Code": Code[20]; RegNo: Text[20])
    begin
        Vendor.Get(Code);
        Vendor."VAT Registration No." := RegNo;
        Vendor.Modify(true);
    end;
}
