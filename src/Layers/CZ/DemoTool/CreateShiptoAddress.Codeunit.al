codeunit 101222 "Create Ship-to Address"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('10000', XCHELTENHAM, XMontpellierHouse, XMontpellierDrive, XBrynPaulDunton, XEXW, XMAIN, CreatePostCode.Convert('GB-GL50 1TY'));
        InsertData('10000', XLONDON, X2KingdomStreet, XPaddington, XJamesvanEaton, XEXW, XEAST, CreatePostCode.Convert('GB-W2 6BD'));
        InsertData('20000', XFLEET, XBeaconHillRoad, XChurchCrookham, XKatieMcAskillWhite, XEXW, XWEST, CreatePostCode.Convert('GB-GU52 8DY'));
        InsertData('20000', UpperCase(XTWYCROSS), XManorPark, XTWYCROSS, XJohnFredericksen, XEXW, XEAST, CreatePostCode.Convert('GB-CV9 3QN'));
    end;
}
