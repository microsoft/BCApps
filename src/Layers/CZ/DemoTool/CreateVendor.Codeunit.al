codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Evaluation then
            if Vendor."Country/Region Code" = DemoDataSetup."Country/Region Code" then
