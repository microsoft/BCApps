codeunit 101037 "Create Sales Line"
{
    ...
    begin
        ...
        InsertResource(2, '103001', 3, XTerry, XAssemblingFurnitureJanuary, XKM, 120); // NAVCZ
        InsertResource(2, '103002', 3, XTerry, XAssemblingFurnitureJanuary, '', 25);
        InsertResource(2, '103002', 3, XTerry, XAssemblingFurnitureJanuary, XKM, 96); // NAVCZ
        InsertResource(2, '103003', 3, XTerry, XAssemblingFurnitureJanuary, '', 25);
        InsertResource(2, '103003', 3, XTerry, XAssemblingFurnitureJanuary, XKM, 76); // NAVCZ
        ...
        InsertDataAndUpdateUnitPrice(2, '103015', 1, '998110', '', 1, 100.0); // NAVCZ
