codeunit 122008 "Create New Item Template"
{
    ...
    begin
        ...
        InsertPostingInfo(ItemTempl, DemoDataSetup.RetailCode(), DemoDataSetup.BaseVATItemCode(), DemoDataSetup.ResaleCode());
        ...
        InsertPostingInfo(ItemTempl, DemoDataSetup.ServicesCode(), DemoDataSetup.BaseVATServiceCode(), '');
    ...
    begin
        ...
        if ItemType = Enum::"Item Type"::Service then
            ItemTempl.Validate(Reserve, ItemTempl.Reserve::Never);
        ItemTempl.Modify(true);
    end;
