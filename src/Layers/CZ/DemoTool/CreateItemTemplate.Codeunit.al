codeunit 101997 "Create Item Template"
{
    ...
    begin
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, DemoDataSetup.RetailCode(), DemoDataSetup.BaseVATItemCode(), DemoDataSetup.ResaleCode());
        // NAVCZ
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.ServicesCode(), DemoDataSetup.BaseVATItemCode(), '');
        // NAVCZ
        InsertPricingInfo(ConfigTemplateHeader, false);
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.FreightCode(), DemoDataSetup.BaseVATItemCode(), '');
        // NAVCZ
        InsertPricingInfo(ConfigTemplateHeader, false);
