codeunit 101761 "Create Std. Gen. Journal Line"
{
    ...
    begin
        LineNo := 0;
        // NAVCZ
        InsertData(XGENERAL, XPAYROLL, 0, '995840', 100000, XPayrollJournal, XADM);
        InsertData(XGENERAL, XPAYROLL, 0, '995860', 30000, XPayrollJournal, XADM);
        InsertData(XGENERAL, XPAYROLL, 0, '995850', 1000, XPayrollJournal, XADM);
        // NAVCZ
        ...
        InsertData(XGENERAL, XPAYROLL, 0, '995870', 25000, XPayrollJournal, XADM); // NAVCZ
