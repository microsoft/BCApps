codeunit 118855 "Create Miniform Line"
{
    ...
    begin
        ...
        InsertData('WHSEACTLINES', 10000, MiniformLine.Area::Header, MiniformLine."Field Type"::Text, 5767, 2, XNumber, 20, ''); // NAVCZ
        ...
        InsertData('WHSEMOVELIST', 20000, MiniformLine.Area::Body, MiniformLine."Field Type"::Output, 5766, 2, XNumber, 20, ''); // NAVCZ
        ...
        InsertData('WHSEPICKLIST', 20000, MiniformLine.Area::Body, MiniformLine."Field Type"::Output, 5766, 2, XNumber, 20, ''); // NAVCZ
        ...
        InsertData('WHSEPUTLIST', 20000, MiniformLine.Area::Body, MiniformLine."Field Type"::Output, 5766, 2, XNumber, 20, ''); // NAVCZ
