codeunit 101080 "Create Gen. Journal Template"
{
    ...
    begin
        ...
        InsertData(
          XGENERAL, XGeneralJournal, "Gen. Journal Template".Type::General, false, '', // NAVCZ
          XGJNLGEN, '', '', '');
        InsertData(
    ...
    var
        ...
        XBANKS: Label 'BANKS';
        XBankStatements: Label 'Bank Statements';
        XCLOSING: Label 'CLOSING';
        XClosingOperations: Label 'Closing Operations';
    ...
    begin
        ...
        // NAVCZ
        "Gen. Journal Template".Validate("Allow VAT Difference", AllowVATDifference);
        if PostingReportId <> 0 then
            "Gen. Journal Template".Validate("Posting Report ID", PostingReportId);
        // NAVCZ
        "Gen. Journal Template".Modify();
    end;

    procedure InsertData(Name: Code[10]; Description: Text[80]; Type: Enum "Gen. Journal Template Type"; Recurring: Boolean; "Source Code": Code[10]; "No. Series": Code[10]; NoSeriesDescription: Text[30]; NoSeriesStartNo: Code[20]; NoSeriesEndNo: Code[20]; AllowVATDifference2: Boolean; PostingReportId2: Integer)
    begin
        // NAVCZ
        AllowVATDifference := AllowVATDifference2;
        PostingReportId := PostingReportId2;
        InsertData(Name, Description, Type, Recurring, "Source Code", "No. Series", NoSeriesDescription, NoSeriesStartNo, NoSeriesEndNo);
    end;
    ...
    begin
        InsertData(
          ...
          XGJNLGEN, XGeneralJournal, '1', 'G01000', true, 0); // NAVCZ
        ...
        // NAVCZ
        InsertData(
          XBANKS, XBankStatements, "Gen. Journal Template".Type::Payments, false, '',
          '', '', '', '', true, Report::"General Ledger Document CZL");
        InsertData(
          XCLOSING, XClosingOperations, "Gen. Journal Template".Type::General, false, '',
          '', '', '', '', true, Report::"General Ledger Document CZL");
        InsertData(
          XRECURRING, XRecurringGeneralJournal, "Gen. Journal Template".Type::General, true, '',
          XGJNLREC, XRecurringGeneralJournal, '6001', 'G07000', true, Report::"General Ledger Document CZL");
        // NAVCZ
    end;
