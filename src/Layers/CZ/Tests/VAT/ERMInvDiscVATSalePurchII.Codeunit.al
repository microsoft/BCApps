codeunit 134040 "ERM Inv Disc VAT Sale/Purch II"
{
    ...
    begin
        ...
        CustPostingGroup."Invoice Rounding Account" := LibraryERM.CreateGLAccountWithVATPostingSetup(VATPostingSetup, "General Posting Type"::Sale);
    ...
    begin
        ...
        VendPostingGroup."Invoice Rounding Account" := LibraryERM.CreateGLAccountWithVATPostingSetup(VATPostingSetup, "General Posting Type"::Sale);
