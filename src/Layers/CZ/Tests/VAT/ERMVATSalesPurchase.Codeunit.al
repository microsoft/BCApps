codeunit 134045 "ERM VAT Sales/Purchase"
{
    ...
    begin
        ...
        asserterror VerifyVATDateInGLEntries(PurchaseVATEntry, InitalVATDate); // The GL Entries from different transaction can be modified due to advance payments
    ...
    begin
        ...
        SalesLine.FindFirst();
        Assert.AreNearlyEqual(VATDifference, SalesLine."VAT Difference", LibraryERM.GetAmountRoundingPrecision(), StrSubstNo(AmountErr, SalesLine.FieldCaption("VAT Difference"), VATDifference, SalesLine.TableCaption()));
    end;
