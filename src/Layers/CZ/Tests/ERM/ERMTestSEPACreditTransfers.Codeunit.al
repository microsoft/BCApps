codeunit 134403 "ERM Test SEPA Credit Transfers"
{
    ...
    begin
        ...
        Assert.IsTrue(GenJnlLineRestrCheckCount <= 3, 'Record restrictions check should be done max 3 times for journal lines');
        Assert.IsTrue(GenJnlBatchRestrCheckCount <= 3, 'Record restrictions check should be done max 3 times for journal batch');
