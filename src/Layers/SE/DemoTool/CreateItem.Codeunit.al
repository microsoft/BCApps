codeunit 101027 "Create Item"
{
    ...
    begin
        InsertData('80102-T', 263, 134, '', '', 250, 2.65, 2.3, 0.04, '9403 90 30', '', '', '');
        InsertData('80103-T', 263, 134, '', '', 250, 2.65, 2.3, 0.04, '9403 90 30', '', '', '');
        InsertData('80208-T', 263, 134, '', '', 250, 2.65, 2.3, 0.04, '9403 90 30', '', '', '');
        InsertData('80216-T', 263, 134, '', '', 250, 2.65, 2.3, 0.04, '9403 90 30', '', '', '');
        InsertData('80218-T', 263, 134, '', '', 250, 2.65, 2.3, 0.04, '9403 90 30', '', '', '');
    end;
