codeunit 101005 "Create Finance Charge Terms"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          X1point5DOM, X1POINT5PCTforDomCustomers, 2, 30, 42, 42, '<5D>', '<1M>', XPCT4PCTfinancechargeofPCT6, XSumfinancechargeofPCT5);
        InsertData(
          X2POINT0FOR, X2POINT0PCTforForCustomers, 2, 30, 85, 42, '<7D>', '<1M>', XPCT4PCTfinancechargeofPCT6, XSumfinancechargeofPCT5);
    end;
    ...
    var
        ...
        X1POINT5PCTforDomCustomers: Label '2.0 % for Domestic Customers';
