codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Julian Bergqvist';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Alexander Jansson';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Yusuf Mattsson';
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '10000', XFabrikamInc, X10NorthLakeAvenue, CreatePostCode.Convert('GB-N12 5XY'), '', '', '',
          'US', '503912693', '', '', '', '');
        UpdateContact('10000', XKrystalYork);
        InsertData(
          '20000', XFirstUpConsultants, X20AllanTuringRd, CreatePostCode.Convert('GB-GU3 2SE'), '', '', '',
          DemoDataSetup."Country/Region Code", 'SE274863274501', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'SE197548769001', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", 'SE295267495601', '', '', XWaverlyGate, '');
