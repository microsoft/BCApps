codeunit 101014 "Create Location"
{
    ...
    var
        ...
        X520NMichiganAve: Label '520 N Michigan Ave';
        X9585SWWashingtonSquareRd: Label '9585 SW Washington Square Rd';
    ...
    begin
        InsertData(
          ...
          X520NMichiganAve, '',
          CreatePostCode.Convert('US-IL 60611'), XUS,
          '', '',
          '', '',
          XCarolePoland,
          false,
        ...
        InsertData(
          ...
          XSouthEastStreet3, '',
          CreatePostCode.Convert('US-GA 31772'), XUS,
          '', '',
          '', '',
          XJeffSmith,
          false,
        ...
        InsertData(
          ...
          X9585SWWashingtonSquareRd, '',
          CreatePostCode.Convert('US-OR 97223'), XUS,
          '', '',
          '', '',
          XChrisPreston,
          false,
