codeunit 101208 "Create Job Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            InsertData(
              XSETTINGUP, XSettingUpFurnitureTxt,
              CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.CostofLaborProjects(), '', '', '', '', '', CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.JobSalesApplied(), '', CreateGLAccount.CostofLaborProjects(), CreateGLAccount.JobSales());
    end;
