codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(XMAIN, DemoDataSetup.ResaleCode(), CreateGLAccount.FinishedGoods(), '');
        InsertData(XEAST, DemoDataSetup.ResaleCode(), CreateGLAccount.FinishedGoods(), '');
        InsertData(XWEST, DemoDataSetup.ResaleCode(), CreateGLAccount.FinishedGoods(), '');
    end;
}
