codeunit 101321 "Create Tax Groups"
{
    ...
    begin
        ...
        if DemoDataSetup."Company Type" = DemoDataSetup."Company Type"::"Sales Tax" then begin
            ...
            TaxSetup."Non-Taxable Tax Group Code" := NONTAXABLETok;
            TaxSetup.Modify();
        end;
    end;
    ...
    var
        ...
        XTaxableCONTOSOFurniture: Label 'Taxable Olympic Furniture';
        XLABOR: Label 'LABOR';
        ...
        XTaxableCONTOSOSupplies: Label 'Taxable Olympic Supplies';
