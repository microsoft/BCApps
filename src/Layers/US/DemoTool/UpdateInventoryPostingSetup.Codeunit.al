codeunit 118013 "Update Inventory Posting Setup"
{
    ...
    begin
        DemoDataSetup.Get();
        CreateInventoryPostingSetup.InsertData(XOUTLOG, DemoDataSetup.ResaleCode(), CreateGLAccount.FinishedGoods(), '');
        CreateInventoryPostingSetup.InsertData(XOWNLOG, DemoDataSetup.ResaleCode(), CreateGLAccount.FinishedGoods(), '');
    end;
}
