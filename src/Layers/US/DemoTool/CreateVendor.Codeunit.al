codeunit 101023 "Create Vendor"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '10000', 'Fabrikam, Inc.', X10NorthLakeAvenue, CreatePostCode.Convert('GB-N12 5XY'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('10000', XKrystalYork);
        SetTaxLiable('10000');
        SetPhoneNo('10000', '4255550101');
        InsertData(
          '20000', 'First Up Consultants', X100DayDrive, CreatePostCode.Convert('GB-GU3 2SE'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('20000', XEvanMcIntosh);
        SetTaxLiable('20000');
        InsertData(
          '30000', 'Graphic Design Institute', X33HitechDrive, CreatePostCode.Convert('GB-PO7 2HI'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('30000', XBryceJasso);
        SetTaxLiable('30000');
        InsertData(
          '40000', 'Wide World Importers', X51RadcroftRoad, CreatePostCode.Convert('GB-IB7 7VN'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('40000', XTobyRhode);
        SetTaxLiable('40000');
        InsertData(
          '50000', 'Nod Publishers', X172FieldGreen, CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
    ...
    local procedure SetPhoneNo("Code": Code[20]; PhoneNo: Text[30])
    begin
        Vendor.Get(Code);
