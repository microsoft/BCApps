codeunit 117565 "Add Salesperson/Purchaser"
{
    ...
    begin
        ...
        if DimensionValue."Dimension Code" = CreateDimension.GetGlobalDimensionCode(1) then
            DimensionValue."Global Dimension No." := 1;
        if DimensionValue."Dimension Code" = CreateDimension.GetGlobalDimensionCode(2) then
