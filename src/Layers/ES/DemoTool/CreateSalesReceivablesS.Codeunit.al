codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        "Create No. Series".InitFinalSeriesPrep("Sales & Receivables Setup"."Posted Prepmt. Inv. Nos.", XPRESINVplus, XPostedSalesPrepmtInv, XPRESINV, 94, 3);
        ...
        "Create No. Series".InitFinalSeriesPrep("Sales & Receivables Setup"."Posted Prepmt. Cr. Memo Nos.", XPRESCRPLUS, XPostedSalesPrepmtCrMemo, XPRESCR,
          94, 3);
    ...
    var
        ...
        XPRESINVplus: Label 'PRES-FIN+';
        XPostedSalesPrepmtInv: Label 'Posted Sales Prepmt. Inv.';
        XPRESCRPLUS: Label 'PRES-CR+';
        XPostedSalesPrepmtCrMemo: Label 'Posted Sales Prepmt. Cr. Memo';
        XPRESINV: Label 'PRES-INV';
        XPRESCR: Label 'PRES-CR';
