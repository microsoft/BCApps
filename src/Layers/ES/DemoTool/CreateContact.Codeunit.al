codeunit 101550 "Create Contact"
{
    ...
    begin
        ...
        InsertData(XCT100178, 'Lisa Jacobson', '395 Westgate Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XOF, 'US', 'US-GA 31772',
          1, XCT100005, XFMAR, '', '', 0);
        InsertData(XCT100179, 'Gustavo Camargo', 'Pol. Ind. 4', DemoDataSetup.ForeignCode(), '', '', XRB, 'ES', 'ES-07001',
        ...
        InsertData(XCT100181, 'Antonio Bermejo', 'c/ Neptuno 18', DemoDataSetup.ForeignCode(), '', '', XRB, 'ES', 'ES-37001',
          1, ContactNo(DATABASE::Vendor, '34151086'), XM, '', '', 0);
        ...
        InsertData(XCT100205, 'Trinidad Lara', 'Pol. Ind. 4', DemoDataSetup.ForeignCode(), '', '', XRB, 'ES', 'ES-07001',
          1, ContactNo(DATABASE::Vendor, '34280789'), XFMAR, '', '', 0);
        ...
        InsertData(XCT100213, XPatrickMCook, X28TheTything, XSCOT, '', XENG, XHR, XGB, 'GB-OX16 0UA',
          1, XCT100241, XM, '', '', 0);
        InsertData(XCT100214, 'Jose Edvaldo Saraiva', 'c/ Neptuno 18', DemoDataSetup.ForeignCode(), '', '', XRB, 'ES', 'ES-37001',
          1, ContactNo(DATABASE::Vendor, '34151086'), XM, '', '', 0);
        ...
        InsertData(XCT100230, 'Jaime Bastidas', 'Plaza Redonda 12', DemoDataSetup.ForeignCode(), '', '', XOF, 'ES', 'ES-08010',
        ...
        InsertData(XCT200028, 'Nuria Gonzalez', 'Pol. Ind. 4', DemoDataSetup.ForeignCode(), '', '', XRB, 'ES', 'ES-07001',
