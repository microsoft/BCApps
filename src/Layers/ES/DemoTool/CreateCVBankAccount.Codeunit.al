codeunit 101287 "Create C/V Bank Account"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '', '', XTHO, XThompsonsBank, XRussellHunter, XEllesboroughRoad47, CreatePostCode.Convert('GB-B27 4KT'),
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296696298, X44296696504, X1000, X1000100000, '', '');
        InsertData(
          '', '', XPAR, XParkHouseBankingGroup, XScottMacDonald, XWickRoad56, CreatePostCode.Convert('GB-B27 4KT'),
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296311044, X44296704144, X1100, X1100100000, '', '');
        InsertData(
          '', '20000', XECA, XECABank, XSheelaWord, XAnchorHouse43, CreatePostCode.Convert('GB-B27 4KT'),
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296196933, X44296151727, X1200, X1200100000,
        ...
        InsertData(
          X40000, X40000, XBEE, XBancoExteriorEspana, XFernandoBarrio, XAlamedaRecalde25, 'ES-08036', '', XEUR, '',
          X932334145, '', '', '', '', '');
        "Customer Bank Account".Validate("CCC No.", X11112222334444444444);
        "Customer Bank Account".Modify(true);
    ...
    var
        ...
        X40000: Label '40000';
        XBEE: Label 'BEE';
        XBancoExteriorEspana: Label 'Banco Exterior España';
        XFernandoBarrio: Label 'Fernando Barrio';
        XAlamedaRecalde25: Label 'Alameda Recalde 25';
        X932334145: Label '93-2 33 41 45';
        X11112222334444444444: Label '11112222334444444444';
    ...
    begin
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                "Customer Bank Account".County := CreatePostCode.FindCounty("Post Code");
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                "Vendor Bank Account".County := CreatePostCode.FindCounty("Post Code");
                if "Currency Code" <> '' then
                ...
                if "Vendor Bank Account".Code = XANT then
                    if "Vendor Bank Account"."Vendor No." in ['10000', '30000', '40000'] then
                        "Vendor Bank Account"."Use For Electronic Payments" := true;
