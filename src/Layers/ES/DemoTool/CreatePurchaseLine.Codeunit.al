codeunit 101039 "Create Purchase Line"
{
    ...
    begin
        ...
        if PurchaseLine."Document Type" = PurchaseLine."Document Type"::"Credit Memo" then
            if PurchaseLine."Document No." in ['109001', '109002'] then begin
                PurchHeader.Get(PurchaseLine."Document Type", PurchaseLine."Document No.");
                case PurchaseLine."Document No." of
                    '109001':
                        PurchHeader."Corrected Invoice No." := '108021';
                    '109002':
                        PurchHeader."Corrected Invoice No." := '108022';
                end;
                PurchHeader.Modify();
            end;
    end;
