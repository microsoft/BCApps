codeunit 101037 "Create Sales Line"
{
    ...
    begin
        ...
        InsertData(1, '101024', 2, '1976-W', XYELLOW, 3);
        InsertData(1, '101025', 2, '1964-W', XGREEN, 4);
        InsertData(1, '101026', 2, '1920-S', XGREEN, 4);
        InsertData(1, '101027', 2, '1936-S', XGREEN, 12);
        // Add new orders here
        ...
        InsertData(2, '103004', 2, '1976-W', XRED, 4);
        InsertData(2, '103005', 2, '1976-W', XRED, 18);
        InsertData(2, '103006', 2, '1976-W', XRED, 17);
        InsertData(2, '103007', 2, '1976-W', XRED, 17);
        InsertData(2, '103008', 2, '1976-W', XRED, 34);
        InsertData(2, '103009', 2, '1976-W', XRED, 18);
        InsertDataAndUpdateUnitPrice(2, '103010', 2, '70000', '', 3, 4349 / 3);
        InsertDataAndUpdateUnitPrice(2, '103011', 2, '70000', '', 4, 5798.78 / 4);
        InsertDataAndUpdateUnitPrice(2, '103012', 2, '70000', '', 5, 7248.48 / 5);
        InsertDataAndUpdateUnitPrice(2, '103013', 2, '70000', '', 1, 1232.24);
    ...
    begin
        ...
        if SalesLine."Document Type" = SalesLine."Document Type"::"Credit Memo" then
            if SalesLine."Document No." in ['104001', '104002', '104003', '104005'] then begin
                SalesHeader.Get(SalesLine."Document Type", SalesLine."Document No.");
                case SalesLine."Document No." of
                    '104001':
                        SalesHeader."Corrected Invoice No." := '103004';
                    '104002':
                        SalesHeader."Corrected Invoice No." := '103008';
                    '104003':
                        SalesHeader."Corrected Invoice No." := '103008';
                    '104005':
                        SalesHeader."Corrected Invoice No." := '103013';
                end;
                SalesHeader.Modify();
            end;
