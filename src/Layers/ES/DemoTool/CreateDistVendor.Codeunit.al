codeunit 118843 "Create Dist. Vendor"
{
    ...
    begin
        ...
        InsertData(
          ...
          XGrassblueLtd, XRB, XLondon, DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), 0, XCOD, 1, XWHITE, XCIF, '', XGIRO);
        InsertData(
          '61000', XElectronicsLtd, X354OxfordStreet, CreatePostCode.Convert('GB-N16 34Z'), DemoDataSetup."Country/Region Code",
          XElectronicsLtd, XRB, XLondon, DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), 0, XCOD, 2, XWHITE, XCPT, '', XCASH);
        InsertData(
          '62000', XWalkerHolland, X116KensingtonRoad, CreatePostCode.Convert('GB-WC1 3DG'), DemoDataSetup."Country/Region Code",
          XWalkerHolland, XRB, XLondon, DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), DemoDataSetup.DomesticCode(), 0, XCOD, 3, XWHITE, XCFR, '', XCASH);
    end;
