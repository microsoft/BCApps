        ...
        if Currency.Find('-') then
            repeat
                if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                    Currency.Validate("Unrealized Gains Acc.", CA.Convert('7681001'));
                    Currency.Validate("Unrealized Losses Acc.", CA.Convert('6681001'));
                    Currency.Validate("Realized Gains Acc.", CA.Convert('7681001'));
                    Currency.Validate("Realized Losses Acc.", CA.Convert('6681001'));
                    if DemoDataSetup."Additional Currency Code" = Currency.Code then begin
                        Currency.Validate("Realized G/L Gains Account", CA.Convert('7680001'));
                        Currency.Validate("Realized G/L Losses Account", CA.Convert('6680001'));
                        Currency.Validate("Residual Gains Account", CA.Convert('7690001'));
                        Currency.Validate("Residual Losses Account", CA.Convert('6690001'));
