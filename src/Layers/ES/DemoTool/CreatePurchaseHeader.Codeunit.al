codeunit 101038 "Create Purchase Header"
{
    ...
    begin
        ...
        // InsertData(1,'10000',07011903D,'23587','');
        // InsertData(1,'38458653',10011903D,'45885','');
        // InsertData(1,'30000',15011903D,'563','');
        // InsertData(1,'10000',18011903D,'24521','');
        InsertData(1, '40000', 19030107D, '23587', '');
        InsertData(1, '40000', 19030110D, '45885', '');
        InsertData(1, '30000', 19030115D, '563', XORDENPAGO);
        InsertData(1, '10000', 19030118D, '24521', XORDENPAGO);
        InsertData(1, '20000', 19030123D, '5966', '');
        // InsertData(1,'30000',26011903D,'599','');
        InsertData(1, '40000', 19030126D, '599', '');
        InsertData(1, '10000', 19030128D, '26874', '');
        InsertData(1, '47586622', 19030129D, XBTZ009, '');
        // InsertData(1,'38654478',29011903D,'43/3-66','');
        InsertData(1, '40000', 19030129D, '43/3-66', '');
    ...
    begin
        ...
        if "Payment Method" <> '' then begin
            "Purchase Header".Validate("Payment Method Code", "Payment Method");
            if "Payment Method" = XORDENPAGO then
                "Purchase Header".Validate("Payment Terms Code", X14DAYS);
        end;
