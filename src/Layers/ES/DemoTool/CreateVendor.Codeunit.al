codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Ruben Delgadillo';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Ismael Tejeda';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Francisco Matias';
        XBANK: Label 'BANK';
    ...
    begin
        ...
        if Vendor."No." <> '40000' then begin
            Vendor.Validate("Payment Terms Code", XCM);
            Vendor.Validate("Payment Method Code", XBANK);
        end else begin
            Vendor.Validate("Payment Terms Code", X3X30DAYS);
            Vendor.Validate("Payment Method Code", XPAGARE);
            Vendor."Preferred Bank Account Code" := XBEE;
        end;
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '274863274A', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '197548769A', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", '295267495A', '', '', XWaverlyGate, '');
