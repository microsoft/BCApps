        ...
        case DemoDataSetup."Company Type" of
            DemoDataSetup."Company Type"::VAT:
                begin
                    ...
                    InsertData(DemoDataSetup.EUCode(), DemoDataSetup.NoVATCode(), 0, 1, 'E');
                    ...
                    InsertData(DemoDataSetup.DomesticCode(), XNOTAX, 0, 4, 'E');
                    InsertData(DemoDataSetup.EUCode(), XNOTAX, 0, 4, 'E');
                    InsertData(DemoDataSetup.ExportCode(), XNOTAX, 0, 4, 'E');
                end;
