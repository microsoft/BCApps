codeunit 101908 "Make Corrections"
{
    ...
    begin
        ...
        "Gen. Journal Line".Validate("Gen. Posting Type", 0);
        ...
        "Gen. Journal Line".Validate("Bal. Gen. Posting Type", 0);
        "Gen. Journal Line".Validate("Bal. Gen. Bus. Posting Group", '');
        "Gen. Journal Line".Validate("Bal. Gen. Prod. Posting Group", '');
