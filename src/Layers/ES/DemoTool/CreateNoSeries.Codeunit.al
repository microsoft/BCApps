codeunit 101308 "Create No. Series"
{
    ...
    procedure InitFinalSeriesPrep(var SeriesCode: Code[20]; "Code": Code[20]; Description: Text[30]; PreCode: Code[10]; Year: Integer; No: Integer)
    var
        MainNo: Code[20];
    begin
        MainNo := PreCode + '10' + Format(No);
        InsertSeries(
          SeriesCode, Code, Description,
          MainNo + '001',
          MainNo + '999',
