codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        "Create No. Series".InitFinalSeriesPrep("Purchases & Payables Setup"."Posted Prepmt. Inv. Nos.", XPREPINVPLUS, XPostedPurchPrepmtInv, XPREPINV, 94, 3);
        ...
        "Create No. Series".InitFinalSeriesPrep("Purchases & Payables Setup"."Posted Prepmt. Cr. Memo Nos.", XPREPCRPLUS, XPostedPurchPrepmtCrMemo, XPREPCR, 94, 3);
