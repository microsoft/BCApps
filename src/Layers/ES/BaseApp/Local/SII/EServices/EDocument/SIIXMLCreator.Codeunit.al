...
codeunit 10750 "SII XML Creator"
{
    ...
    begin
        ...
        UpdateAmountBufferWithOneStopShop(HasEntries, Amount, TempVATEntry, false);
    ...
    begin
        ...
        UpdateAmountBufferWithOneStopShop(HasEntries, ReplacementAmount, TempVATEntry, true);
        ExportNonTaxableVATEntries(
    ...
    local procedure UpdateAmountBufferWithOneStopShop(var HasEntries: array[2] of Boolean; var Amount: array[2] of Decimal; var TempVATEntry: Record "VAT Entry" temporary; IsReplacement: Boolean)
    var
