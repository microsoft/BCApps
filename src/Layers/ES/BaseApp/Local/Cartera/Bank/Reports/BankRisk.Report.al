...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/Cartera/Bank/Reports/BankRisk.rdlc';
    ...
    dataset
    {
        dataitem(BankAcc; "Bank Account")
        {
            ...
            column(Credit_Limit_for_Discount___Posted_Receiv__Bills_Rmg__Amt_____ABS__Credit_Limit_for_Discount_Caption; DiscountPossibleLbl)
            {
            }
            column(Credit_Limit_for_Discount___Posted_Receiv__Bills_Rmg__Amt___NonPostedDiscAmt__ABS__Credit_Limit_for_Discount_Caption; DiscPossibleAfterPostingLbl)
            {
            }
    ...
    var
        ...
        DiscountPossibleLbl: Label 'Discount Possible';
        DiscPossibleAfterPostingLbl: Label 'Disc. Possible after Posting';
