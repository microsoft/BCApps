        ...
        dataitem("Finance Charge Memo Header"; "Finance Charge Memo Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                        ...
                        if not "Detailed Interest Rates Entry" then begin
                            ...
                            if VATPostingSetup.Get(Cust."VAT Bus. Posting Group", "VAT Prod. Posting Group") then
                                if VATPostingSetup."VAT %" <> 0 then begin
                                    ...
                                    TempVATAmountLine.SetCurrencyCode("Finance Charge Memo Header"."Currency Code");
                ...
                dataitem(VATCounter; "Integer")
                {
                    ...
                    column(VATAmountLine__VAT_EC_Base__Control56; TempVATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    ...
                    column(VATAmountLine__Amount_Including_VAT_EC__Control73; TempVATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__EC_Amount__Control1100002; TempVATAmountLine."EC Amount")
                    {
                    }
                    ...
                    column(VATAmountLine__VAT_EC_Base__Control52; TempVATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    ...
                    column(VATAmountLine__EC_Amount__Control1100003; TempVATAmountLine."EC Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__EC_Amount__Control1100145; TempVATAmountLine."EC Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__VAT_EC_Base__Control49; TempVATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__Amount_Including_VAT_EC__Control80; TempVATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__VAT_Amount__Control1100004; TempVATAmountLine."VAT Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode();
                        AutoFormatType = 1;
                    }
