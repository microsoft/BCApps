codeunit 134900 "ERM Batch Job"
{
    ...
    begin
        ...
        VerifyValuesOnVATPostingSetup(
              VATPostingSetupDestination, VATPostingSetupSource."VAT Identifier", VATPostingSetupSource."Sales VAT Stat. Cipher", VATPostingSetupSource."Purch. VAT Stat. Cipher");
    end;
    ...
    begin
        ...
        VATPostingSetup.TestField("Sales VAT Stat. Cipher", SalesVATStatCipher);
        VATPostingSetup.TestField("Purch. VAT Stat. Cipher", PurchVATStatCipher);
    end;
