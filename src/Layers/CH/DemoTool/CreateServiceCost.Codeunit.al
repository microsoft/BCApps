codeunit 117006 "Create Service Cost"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(XSTART, XStartspaceFee, '3430', 20, 1, XPCS, ServiceCost."Cost Type"::Other, '', 2);
        InsertData(XTR_EAST, XTravelspaceFee, '3430', 2, 1, XPCS, ServiceCost."Cost Type"::Travel, XE, 0.2);
        InsertData(XTR_MID, XTravelspaceFee, '3430', 1, 1, XPCS, ServiceCost."Cost Type"::Travel, XM, 0.1);
        InsertData(XTR_NORTH, XTravelspaceFee, '3430', 3, 1, XPCS, ServiceCost."Cost Type"::Travel, XN, 0.3);
        InsertData(XTR_SE, XTravelspaceFee, '3430', 4, 1, XPCS, ServiceCost."Cost Type"::Travel, XSE, 0.4);
        InsertData(XTR_SOUTH, XTravelspaceFee, '3430', 5, 1, XPCS, ServiceCost."Cost Type"::Travel, XS, 0.5);
        InsertData(XTR_WEST, XTravelspaceFee, '3430', 6, 1, XPCS, ServiceCost."Cost Type"::Travel, XW, 0.6);
    end;
