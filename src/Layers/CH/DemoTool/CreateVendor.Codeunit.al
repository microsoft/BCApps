codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Conrad Schmitt';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Alexandre Batard';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Theodore Levesque';
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'CHE-274.863.274MWST', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'CHE-197.548.769MWST', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", 'CHE-295.267.495MWST', '', '', XWaverlyGate, '');
