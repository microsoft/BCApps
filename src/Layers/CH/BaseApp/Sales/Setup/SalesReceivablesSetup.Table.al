...
table 311 "Sales & Receivables Setup"
{
	...
	field(10500; "Posting Date Check on Posting"; Boolean)
        ...
        field(11510; "Shipment on Ship and Invoice"; Boolean)
        {
            Caption = 'Shipment on Ship and Invoice';
            InitValue = true;
        }
        field(11511; "Automatic Interaction Log"; Boolean)
        {
            Caption = 'Automatic Interaction Log';
        }
        field(3010801; "Automatic recalculate Quotes"; Boolean)
        {
