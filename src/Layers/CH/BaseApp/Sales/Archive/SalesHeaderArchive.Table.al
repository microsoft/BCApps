...
#pragma warning restore AS0086
        ...
        field(3010801; "Quote Status"; Option)
        {
            Caption = 'Quote Status';
            Editable = false;
            OptionCaption = ' ,Converted to Order,Posted Order,Deleted';
            OptionMembers = " ","Converted to Order","Posted Order",Deleted;
        }
    ...
    keys
    {
        ...
        key(Key2; "Document Type", "No.", "Quote Status")
        {
        }
        key(Key3; "Document Type", "Sell-to Customer No.", "Bill-to Customer No.")
        {
        }
        key(Key4; "Document Type", "Sell-to Customer No.")
        {
        }
        key(Key5; "Document Type", "Bill-to Customer No.")
        {
        }
