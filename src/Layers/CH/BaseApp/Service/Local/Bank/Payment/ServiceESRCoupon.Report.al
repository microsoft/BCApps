...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Service/Local/Bank/Payment/ServiceESRCoupon.rdlc';
    ...
    dataset
    {
        dataitem(Head; "Service Invoice Header")
        {
            ...
            begin
                ...
                ServBankPaymentMgt.PrepareEsrService(Head, EsrSetup, EsrType, EsrAdr, AmtTxt, CurrencyCode, DocType, RefNo, CodingLine);
            end;
        }
    }
