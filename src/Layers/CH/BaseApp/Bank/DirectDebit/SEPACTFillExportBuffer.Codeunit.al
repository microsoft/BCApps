...
codeunit 1221 "SEPA CT-Fill Export Buffer"
{
    ...
    begin
        ...
        repeat
            ...
            PaymentExportData."Payment Reference" := TempGenJnlLine."Payment Reference";
            ...
            PaymentExportData.SetSwissExport(SwissExport);
            ...
            if SwissExport and (PaymentExportData."Swiss Payment Type" = PaymentExportData."Swiss Payment Type"::"1") then
                PaymentExportData.AddRemittanceText(TempGenJnlLine."Reference No.")
            else begin
