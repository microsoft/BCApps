codeunit 101219 "Create Job Posting Group SaaS"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            InsertData(XSETTINGUP, CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.CostofLaborProjects(), '', '', '', '', '', CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.JobSalesApplied(), '', CreateGLAccount.CostofLaborProjects(), CreateGLAccount.JobSales());
    end;
