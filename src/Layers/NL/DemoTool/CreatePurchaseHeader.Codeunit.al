codeunit 101038 "Create Purchase Header"
{
    ...
    begin
        ...
        InsertData(1, '47586622', 19030129D, XBTZ009, '', '11', '3');
        InsertData(1, '38654478', 19030129D, '43/3-66', '', '11', '3');
        InsertData(1, '01863656', 19030116D, XAWE1, '', '', '');
        InsertData(1, '01863656', 19030121D, XAWE2, '', '', '');
        InsertData(1, '43698547', 19030128D, '2265423', '', '11', '3');
    ...
    procedure InsertData("Document Type": Integer; "Buy-from Vendor No.": Code[20]; "Posting Date": Date; "Vendor Invoice No.": Code[20]; "Payment Method": Code[10]; "Transaction Type": Code[10]; "Transport Method": Code[10])
    begin
        ...
        "Purchase Header".Validate("Transaction Type", "Transaction Type");
        "Purchase Header".Validate("Transport Method", "Transport Method");
