codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Stern Westerink';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Laszlo Vanderslik';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Bart Vanderschans';
