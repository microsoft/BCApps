            ...
            case VATPostingSetup."VAT Prod. Posting Group" of
                DemoDataSetup.GoodsVATCode():
                    if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
                        SetAccounts(VATPostingSetup, '995510', '995530', '995530', '995515', '995535', '995525')
                    else
                ...
                DemoDataSetup.ServicesVATCode():
                    begin
                        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
                            SetAccounts(VATPostingSetup, '995511', '995531', '995521', '995516', '995536', '995526')
                        else
                ...
                DemoDataSetup.NoVATCode():
                    if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
                        SetAccounts(VATPostingSetup, '981514', '995520', '995520', '995515', '995535', '995525')
                    else
