codeunit 101036 "Create Sales Header"
{
    ...
    begin
        ...
        InsertData(1, '01445544', 19030121D, '11', '4');
        InsertData(1, '32656565', 19030109D, '11', '3');
        InsertData(1, '20000', 19030111D, '11', '1');
        InsertData(1, '30000', 19030112D, '', '');
        InsertData(1, '49633663', 19030114D, '11', '3');
        InsertData(1, '20000', 19030116D, '', '');
        InsertData(1, '35451236', 19030118D, '11', '4');
        InsertData(1, '38128456', 19030120D, '11', '3');
        InsertData(1, '42147258', 19030113D, '11', '3');
        InsertData(1, '43687129', 19030113D, '11', '3');
        InsertData(1, '20000', 19030115D, '', '');
        InsertData(1, '46897889', 19030119D, '11', '3');
        InsertData(1, '47563218', 19030120D, '11', '3');
        InsertData(1, '49633663', 19030122D, '', '');
        InsertData(1, '10000', 19030126D, '', '');
        InsertData(1, '20000', 19030127D, '', '');
        InsertData(1, '01454545', 19030127D, '11', '4');
        InsertData(1, '31987987', 19030123D, '', '');
        InsertData(1, '32789456', 19030127D, '11', '3');
    ...
    procedure InsertData("Document Type": Integer; "Sell-to Customer No.": Code[20]; "Posting Date": Date; "Transaction Type": Code[10]; "Transaction Method": Code[10])
    begin
        Clear("Sales Header");
        ...
        "Sales Header".Validate("Transaction Type", "Transaction Type");
        "Sales Header".Validate("Transport Method", "Transaction Method");
