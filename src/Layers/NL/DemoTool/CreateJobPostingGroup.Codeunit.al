codeunit 101208 "Create Job Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            InsertData(XSETTINGUP, XSettingUpFurnitureTxt, '992231', '992232', '997180', '997180', '997480', '997280', '997181', '996610', '992211', '992212', '996190', '996191', '997620', '996620')
        else
            InsertData(XSETTINGUP, XSettingUpFurnitureTxt, CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.CostofLaborProjects(), CreateGLAccount.CostofLaborProjects(), '', '', '', '', CreateGLAccount.WorkinProgress(), CreateGLAccount.WorkinProgress(), CreateGLAccount.JobSalesApplied(), '', CreateGLAccount.CostofLaborProjects(), CreateGLAccount.JobSales());
    end;
