codeunit 101029 "Create Cash Flow Data"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            CreateCFAccount_andGL('1060', XBuildingOccupancyCosts, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, CreateGLAccFilter(CreateGLAccount.SiteFees_Leases(), CreateGLAccount.InsurancesProperty()));
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            CreateCFAccount_andGL('1110', XOtherExpenses, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, CreateGLAccFilter(CreateGLAccount.OtherPropertyExpenses(), CreateGLAccount.OtherPropertyExpenses()));
