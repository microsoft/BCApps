...
codeunit 134831 "Alloc. Acc. Purch. E2E Tests"
{
    ...
    begin
        ...
        CreatePurchInvoiceWithAllocationAccount(PurchaseHeader, AllocationAccount."No.", 5, 59.95);
    ...
    local procedure CreatePurchInvoiceWithAllocationAccount(var PurchaseHeader: Record "Purchase Header"; AllocationAccountNo: Code[20]; Quantity: Decimal; DirectUnitCost: Decimal)
    var
        PurchaseLine: Record "Purchase Line";
    begin
        LibraryPurchase.CreatePurchHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, LibraryPurchase.CreateVendorNo());
        ...
        LibraryPurchase.CreatePurchaseLine(PurchaseLine, PurchaseHeader, PurchaseLine.Type::"Allocation Account", AllocationAccountNo, Quantity);
