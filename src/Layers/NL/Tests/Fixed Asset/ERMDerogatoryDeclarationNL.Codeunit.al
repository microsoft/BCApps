codeunit 144149 "ERM Derogatory Declaration NL"
{
    ...
    var
        ...
        CounterpartCountErr: Label 'The inherited W1 posting must create exactly one linked tax-book counterpart.';
        PostedFieldErr: Label 'The branch-introduced posted-journal Is Derogatory field must not exist.';
    ...
    [Test]
    procedure InheritedW1PostingCreatesSingleCounterpart()
    var
    ...
    begin
        // [SCENARIO 617336] NL uses inherited W1 derogatory posting
