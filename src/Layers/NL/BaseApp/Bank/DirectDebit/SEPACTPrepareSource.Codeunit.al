...
codeunit 1222 "SEPA CT-Prepare Source"
{
    ...
    [Obsolete('Use codeunit "SEPA CT-Prepare Source NL" instead.', '30.0')]
    procedure DisableRemittanceTruncationNotification(RemittanceNotification: Notification)
    var
        SEPACTPrepareSourceNL: Codeunit "SEPA CT-Prepare Source NL";
    begin
        SEPACTPrepareSourceNL.DisableRemittanceTruncationNotification(RemittanceNotification);
    end;
#endif
}
