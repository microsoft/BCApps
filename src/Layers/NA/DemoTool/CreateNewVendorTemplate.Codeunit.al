codeunit 122006 "Create New Vendor Template"
{
    ...
    begin
        ...
        InsertPostingInfo(VendorTempl, DemoDataSetup.DomesticCode(), '', DemoDataSetup.DomesticCode());
        InsertPaymentInfo(VendorTempl, CreatePaymentTerms.CashOnDeliveryCode(), CreatePaymentMethod.GetCashCode());
        InsertOtherInfo(VendorTempl, Contact.Type::Person, DemoDataSetup."Country/Region Code", false, false);
