codeunit 101551 "Create Contact Alt. Addr."
{
    ...
    procedure InsertData("Contact  No.": Code[20]; "Code": Code[10]; Name: Text[30]; Address: Text[30]; "Address 2": Text[30]; City: Text[30]; "Post Code": Code[20]; "Country Code": Code[10]; "Phone No.": Text[30]; "Extension No.": Text[30]; "Mobile Phone No.": Text[30]; Email: Text[80]; "Home Page": Text[80]; "Fax No.": Text[30]; "Telex Answer Back": Text[20]; County: Text[30])
    var
    ...
    begin
        ...
        "Contact Alt. Address".Validate(County, County);
    end;
