codeunit 122007 "Create New Customer Template"
{
    ...
    begin
        ...
        InsertPostingInfo(CustomerTempl, DemoDataSetup.DomesticCode(), '', DemoDataSetup.DomesticCode());
        InsertPaymentInfo(CustomerTempl, CreatePaymentTerms.CashOnDeliveryCode(), CreatePaymentMethod.GetCashCode());
        InsertOtherInfo(CustomerTempl, Contact.Type::Person, DemoDataSetup."Country/Region Code", false, false);
