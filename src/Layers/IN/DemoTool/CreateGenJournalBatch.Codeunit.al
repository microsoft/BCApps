codeunit 101232 "Create Gen. Journal Batch"
{
    ...
    begin
        ...
        InsertData(XBANKPYMTVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
        UpdatePostingNoSeries(XBANKPYMTVSourceCodeLbl, XUSERA, 'BNKPYV-P');
        InsertData(XBANKRCPTVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
        UpdatePostingNoSeries(XBANKRCPTVSourceCodeLbl, XUSERA, 'BNKRCV-P');
        InsertData(XCASHPYMTVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
        UpdatePostingNoSeries(XCASHPYMTVSourceCodeLbl, XUSERA, 'CSHPYV-P');
        InsertData(XCASHRCPTVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
        UpdatePostingNoSeries(XCASHRCPTVSourceCodeLbl, XUSERA, 'CSHRCV-P');
        InsertData(XCONTRAVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
        UpdatePostingNoSeries(XCONTRAVSourceCodeLbl, XUSERA, 'CNTRV-P');
        InsertData(XJOURNALVSourceCodeLbl, XUSERA, XDefaultJournal, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", '', true, false);
