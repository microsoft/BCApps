codeunit 101038 "Create Purchase Header"
{
    ...
    procedure InsertDataWithDocNo("Document Type": Integer; DocumentNo: Code[20]; "Buy-from Vendor No.": Code[20]; "Posting Date": Date; "Vendor Invoice No.": Code[20]; "Payment Method": Code[10])
    begin
        Clear("Purchase Header");
        "Purchase Header".Validate("Document Type", "Document Type");
        "Purchase Header"."No." := DocumentNo;
        "Purchase Header"."Posting Date" := CA.AdjustDate("Posting Date");
        "Purchase Header".Insert(true);
        "Purchase Header".Validate("Buy-from Vendor No.", "Buy-from Vendor No.");
        "Purchase Header".Validate("Posting Date");
    ...
    procedure CreateINPurchOrder()
    begin
        InsertData(1, '30000', 19030126D, 'VI-0001', '');

        InsertData(1, '10000', 19020630D, 'PO-1001', '');
        InsertData(1, '50000', 19020630D, 'PO-1002', '');
        InsertData(1, '30000', 19020630D, 'PO-1003', '');
        InsertData(1, '30000', 19020630D, 'PO-1004', '');
    end;

    procedure CreateINPurchInvoice()
    begin
        InsertData(2, '20000', 19020630D, 'PI-1001', '');
        InsertData(2, '40000', 19020630D, 'PI-1002', '');
    end;

    procedure CreateINPurchCrMemo()
    begin
        InsertDataWithDocNo(3, 'CM-1001', '10000', 19030112D, 'CM-1001', '');
        InsertDataWithDocNo(3, 'CM-1002', '10000', 19030125D, 'CM-1002', '');
    end;
}
