codeunit 110000 "Interface Basis Data"
{
    ...
    begin
        ...
        RunCodeunit(CODEUNIT::"Create FA With Depr. Book IN");
    ...
    begin
        ...
        if PurchaseHeader.Find('-') then
            repeat
                if not (PurchaseHeader."Vendor Invoice No." In ['PO-1002', 'PO-1003', 'PI-1001', 'PI-1002'])
                and (PurchaseHeader."Vendor Cr. Memo No." <> 'CM-1001') then begin
