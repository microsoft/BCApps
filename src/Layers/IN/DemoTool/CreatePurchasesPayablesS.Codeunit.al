codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        "Create No. Series".InitFinalSeries("Purchases & Payables Setup"."GST Liability Adj. Jnl Nos.", XGSTLAJN, XGSTLiabAdjJnl, 1);
        "Purchases & Payables Setup"."RCM Exempt Start Date (Unreg)" := DMY2Date(1, 4, 2020);
        "Purchases & Payables Setup"."RCM Exempt End Date (Unreg)" := DMY2Date(2, 4, 2020);
        EnableManualNoSeries("Purchases & Payables Setup"."Credit Memo Nos.");
