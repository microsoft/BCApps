codeunit 101027 "Create Item"
{
    ...
    begin
        ...
        UpdateItemGST('1936-S', DemoDataSetup.NoVATCode(), '0989', '0989001');
        UpdateItemGST('1968-S', DemoDataSetup.NoVATCode(), '0988', '0988001');
        UpdateItemGST('1988-S', DemoDataSetup.NoVATCode(), '0989', '0989001');
        UpdateItemGST('1960-S', DemoDataSetup.NoVATCode(), '', '');
        UpdateItemGST('1964-S', DemoDataSetup.NoVATCode(), '', '');
    end;
    ...
    local procedure UpdateItemGST(ItemNo: Code[20]; VATProdPostingGrp: Code[20]; GSTGrpupCode: Code[20]; HSNCode: Code[10])
    var
        Item: Record Item;
    begin
        if Item.Get(ItemNo) then begin
            Item."VAT Prod. Posting Group" := VATProdPostingGrp;
            Item."GST Group Code" := GSTGrpupCode;
            Item."HSN/SAC Code" := HSNCode;
            Item.Modify()
        end;
    end;
