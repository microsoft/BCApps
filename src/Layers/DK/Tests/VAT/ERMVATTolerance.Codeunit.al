codeunit 134042 "ERM VAT Tolerance"
{
    ...
    begin
        ...
        repeat
            ...
            VerifyVATOnStatistics(TempPurchaseLine."VAT Prod. Posting Group", VATAmount - Round(VATAmount * TolerancePctForCalculation / 100), VATAmountLine);
        until TempPurchaseLine.Next() = 0;
    end;
    ...
    begin
        ...
        repeat
            ...
            VerifyVATOnStatistics(TempSalesLine."VAT Prod. Posting Group", VATAmount - Round(VATAmount * TolerancePctForCalculation / 100), VATAmountLine);
    ...
    local procedure VerifyVATOnStatistics(VATId: Code[20]; VATAmount: Decimal; var VATAmountLine: Record "VAT Amount Line")
    begin
