codeunit 118013 "Update Inventory Posting Setup"
{
    ...
    begin
        DemoDataSetup.Get();
        CreateInventoryPostingSetup.InsertData(XOUTLOG, DemoDataSetup.ResaleCode(), '16200', '16200');
        CreateInventoryPostingSetup.InsertData(XOWNLOG, DemoDataSetup.ResaleCode(), '16200', '16200');
    end;
}
