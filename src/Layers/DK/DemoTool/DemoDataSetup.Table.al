table 101900 "Demo Data Setup"
{
    ...
    var
        ...
        XVAT: Label 'VAT';
        XVATSrv: Label 'VATSRV', Locked = true;
        XNOVAT: Label 'NO VAT';
        XMISC: Label 'MISC';
        XFULL: Label 'FULL';
        ...
        XVAT25SERV: Label 'VAT25SERV', Locked = true;
    ...
    begin
        if "Data Type" = "Data Type"::Standard then
            exit(XVAT25SERV);

        TestField("Services VAT Rate");
        if "Data Type" = "Data Type"::Extended then
            exit(XVATSrv + Format("Services VAT Rate"));
        exit(XVAT25SERV);
    end;
