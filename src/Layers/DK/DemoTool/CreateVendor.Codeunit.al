codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XCIF: Label 'CIF';
        X1M8D: Label '1M(8D)';
        XKrystalYork: Label 'Krystal York', Comment = 'CELA approved translation: Lillian Hansen';
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Per Busk';
        XBryceJasso: Label 'Bryce Jasso', Comment = 'CELA approved translation: Rene Madsen';
    ...
    begin
        ...
        InsertData(
          '40000', XLewisHomeFurniture, X51RadcroftRoad, CreatePostCode.Convert('GB-M22 5TG'), '', '', '',
          'GB', 'GB555555555', '', '', '', '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XServiceElectronicsLtd, X172FieldGreen, CreatePostCode.Convert('US-GA 31772'), '', '', '',
          'US', '', '', '', '', '');
