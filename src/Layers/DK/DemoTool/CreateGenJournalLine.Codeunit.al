codeunit 101081 "Create Gen. Journal Line"
{
    ...
    begin
        ...
        "Exactly Balanced" := false;
        InsertDailyEntry(
          XGENERAL, CreateGenJournalBatch.GetDailyJournalBatchName(), 3, XNBL, 19030119D, 1, 'BANK1', XPaymentDescription1,
          3, CreateBankAccount.GetCheckingBankAccountCode(), -2000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, CreateGenJournalBatch.GetDailyJournalBatchName(), 3, XNBL, 19030119D, 1, 'BANK2', XPaymentDescription2,
          3, CreateBankAccount.GetCheckingBankAccountCode(), -3000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, CreateGenJournalBatch.GetDailyJournalBatchName(), 3, XNBL, 19030119D, 1, 'DEPOSIT3', XPaymentDescription3,
          3, CreateBankAccount.GetCheckingBankAccountCode(), -4000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, CreateGenJournalBatch.GetDailyJournalBatchName(), 3, XNBL, 19030119D, 1, 'DEPOSIT4', XPaymentDescription4,
          3, CreateBankAccount.GetCheckingBankAccountCode(), -4000.0, '', '', 0, '', 0D);
    end;
