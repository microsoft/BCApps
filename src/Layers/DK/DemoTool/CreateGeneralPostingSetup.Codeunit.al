codeunit 101252 "Create General Posting Setup"
{
    ...
    begin
        ...
        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.RetailCode(), '01030', '01700', '16200', '02700', '16200', '02010', '02800');
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.RetailCode(), '01020', '01700', '16200', '02700', '16200', '02010', '02800');
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.RetailCode(), '01010', '01700', '16200', '02700', '16200', '02010', '02800');

        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.ServicesCode(), '01030', '01700', '02100', '02700', '', '', '02800');
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.ServicesCode(), '01020', '01700', '02100', '02700', '', '', '02800');
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.ServicesCode(), '01010', '01700', '02100', '02700', '', '', '02800');

        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.NoVATCode(), '01030', '01700', '16200', '02700', '16200', '02010', '02800');
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.NoVATCode(), '01020', '01700', '16200', '02700', '16200', '02010', '02800');
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.NoVATCode(), '01010', '01700', '16200', '02700', '16200', '02010', '02800');

        InsertData2('', DemoDataSetup.RetailCode(), '', '', '', '', '16200', '02010', '02800');
        InsertData2('', DemoDataSetup.NoVATCode(), '', '', '', '', '16200', '02010', '02800');
    end;
    ...
    begin
        if GeneralPostingSetup."Gen. Bus. Posting Group" <> '' then
            if AdjustForPmtDisc then begin
                GeneralPostingSetup.Validate("Sales Pmt. Disc. Debit Acc.", '40300');
                GeneralPostingSetup.Validate("Purch. Pmt. Disc. Credit Acc.", '20200');
                GeneralPostingSetup.Validate("Sales Pmt. Disc. Credit Acc.", '40300');
                GeneralPostingSetup.Validate("Purch. Pmt. Disc. Debit Acc.", '20200');
            end;
    end;
    ...
    begin
        if GeneralPostingSetup."Gen. Bus. Posting Group" <> '' then
            if AdjustForPmtDisc then begin
                GeneralPostingSetup.Validate("Sales Pmt. Tol. Debit Acc.", '61900');
                GeneralPostingSetup.Validate("Purch. Pmt. Tol. Credit Acc.", '61900');
                GeneralPostingSetup.Validate("Sales Pmt. Tol. Credit Acc.", '61900');
                GeneralPostingSetup.Validate("Purch. Pmt. Tol. Debit Acc.", '61900');
            end;
    end;
