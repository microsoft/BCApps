codeunit 119100 "Create Chart Definitions"
{
    ...
    begin
        ...
        CreateAccScheduleLine(XCashFlowAccSchedNameTxt, '10', XTotalReceivablesTxt, '17100|17200|24020..24040',
          PostingAccounts, BalanceAtDate);
        CreateAccScheduleLine(XCashFlowAccSchedNameTxt, '20', XTotalPayablesTxt, '25100|25400|24010', PostingAccounts, BalanceAtDate);
        CreateAccScheduleLine(XCashFlowAccSchedNameTxt, '30', XTotalLiquidFundsTxt, '18100..18300', PostingAccounts, BalanceAtDate);
        ...
        CreateAccScheduleName(
          ...
          XPeriodsColumnLayoutNameTxt);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '10', XTotalRevenueCreditTxt, '01997', TotalAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '11', XTotalRevenueTxt, '-10', Formula, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '20', XTotalGoodsSoldTxt, '02897|02997', TotalAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '30', XTotalExternalCostsTxt, '03600|04097|03597|04997|05297|05997',
          PostingAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '40', XTotalPersonnelCostsTxt,
          '03297', PostingAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '50', XTotalFADepricationTxt, '06997', PostingAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '60', XOtherExpensesTxt, '07997', PostingAccounts, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '70', XTotalExpenditureTxt, '-20..60', Formula, NetChange);
        CreateAccScheduleLine(XIncAndExpAccSchedNameTxt, '80', XEarningsBeforeInterestTxt, '11+70', Formula, NetChange);
        ...
        CreateAccScheduleName(
          XCashCycleAccSchedNameTxt, StrSubstNo(XAccSchedDescrTxt, ChartManagement.CashCycleChartName()), XPeriodsColumnLayoutNameTxt);
        CreateAccScheduleLine(XCashCycleAccSchedNameTxt, '10', XTotalRevenueTxt, '01997', TotalAccounts, BalanceAtDate);
        CreateAccScheduleLine(XCashCycleAccSchedNameTxt, '20',
          XTotalReceivablesTxt, '17100|17200|24020..24040', PostingAccounts, BalanceAtDate);
        CreateAccScheduleLine(XCashCycleAccSchedNameTxt, '30', XTotalPayablesTxt, '25100|25400|24010', PostingAccounts, NetChange);
        CreateAccScheduleLine(XCashCycleAccSchedNameTxt, '40', XTotalInventoryTxt, '16997', PostingAccounts, NetChange);
        ...
        CreateAccScheduleName(
          XReducedTrialBalanceAccSchedNameTxt, XReducedTrialBalanceAccSchedDescriptionTxt, XPeriodsColumnLayoutNameTxt);
        CreateAccScheduleLineExtended(XReducedTrialBalanceAccSchedNameTxt, '10', XTotalIncomeTxt, '01997',
          TotalAccounts, NetChange, true);
        CreateAccScheduleLineExtended(XReducedTrialBalanceAccSchedNameTxt, '20', XTotalCostTxt, '02897|02997',
          TotalAccounts, NetChange, true);
        CreateAccScheduleLine(XReducedTrialBalanceAccSchedNameTxt, '30', XGrossMarginTxt, '-10-20', Formula, NetChange);
        ...
        CreateAccScheduleLine(XReducedTrialBalanceAccSchedNameTxt, '50', XOperatingExpensesTxt,
          '03297|06997|03600|04097|03597|04997|05297|05997', PostingAccounts, NetChange);
        CreateAccScheduleLine(XReducedTrialBalanceAccSchedNameTxt, '60', XOperatingMarginTxt, '30 - 50', Formula, NetChange);
        ...
        CreateAccScheduleLine(XReducedTrialBalanceAccSchedNameTxt, '80', XOtherExpensesTxt,
          '07997', PostingAccounts, NetChange);
        CreateAccScheduleLineExtended(XReducedTrialBalanceAccSchedNameTxt, '90', XIncomeBeforeInterestAndTaxTxt, '07799',
          TotalAccounts, NetChange, true);
    end;
