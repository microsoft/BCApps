codeunit 101085 "Create Acc. Schedule Line"
{
    ...
    var
        ...
        XSalesAdjmtRetail: Label 'Sales Adjmt, Retail';
    ...
    begin
        ...
        InsertData(XANALYSIS, '101', XInventory, '16997', 1, '', '', '', '', false, false);
        InsertData(XANALYSIS, '102', XAccountsReceivable, '17100..17400|17510', 0, '', '', '', '', false, false);
        InsertData(XANALYSIS, '103', XSecurities, '10998', 1, '', '', '', '', false, false);
        InsertData(XANALYSIS, '104', XLiquidAssets, '18997', 1, '', '', '', '', false, false);
        ...
        InsertData(XANALYSIS, '111', XRevolvingCredit, '23100', 0, '', '', '', '', false, false);
        InsertData(XANALYSIS, '112', XAccountsPayable, '25100..25400', 0, '', '', '', '', false, false);
        InsertData(XANALYSIS, '113', XVAT, '24997', 1, '', '', '', '', false, false);
        InsertData(XANALYSIS, '114', XPersonnelrelatedItems, '27997', 1, '', '', '', '', false, false);
        InsertData(XANALYSIS, '115', XOtherLiabilities, '26997', 1, '', '', '', '', false, false);
        ...
        InsertData(XREVENUE, '', '', '', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '', XSalesofRetail, '', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '11', XSalesRetailDom, '01010', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '12', XSalesRetailEU, '01020', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '13', XSalesRetailExport, '01030', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '14', XSalesAdjmtRetail, '01600|01610|01700', 0, '', '', '', '', false, false);
        InsertData(XREVENUE, '16', XSalesofRetailTotal, '11..14', 2, '', '', '', '', false, false);
        InsertData(XREVENUE, '', '', '', 0, '', '', '', '', false, false);
        InsertData(
          XREVENUE, '21', XRevenueArea10to55Total,
          '01010|01020|01030|01600|01610|01700', 0, '10..55', '', '', '', false, false);
        InsertData(
          XREVENUE, '22', XRevenueArea40to85Total,
         '01010|01020|01030|01600|01610|01700', 0, '40..85', '', '', '', false, false);
        InsertData(
          XREVENUE, '23', XRevenuenoAreacodeTotal,
          '01010|01020|01030|01600|01610|01700', 0, '''''', '', '', '', false, false);
        InsertData(
          XREVENUE, '34', XRevenueTotal,
          '21..23', 2, '', '', '', '', false, true);
    end;
