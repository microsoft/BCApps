codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('', DemoDataSetup.ResaleCode(), '16200', '16200');
    end;

    procedure CreateEvaluationData()
    begin
        DemoDataSetup.Get();
        InsertData(XMAIN, DemoDataSetup.ResaleCode(), '16200', '16200');
        InsertData(XEAST, DemoDataSetup.ResaleCode(), '16200', '16200');
        InsertData(XWEST, DemoDataSetup.ResaleCode(), '16200', '16200');
    end;
}
