codeunit 122008 "Create New Item Template"
{
    ...
    begin
        ...
        InsertPostingInfo(ItemTempl, DemoDataSetup.RetailCode(), CreateVATProdPostingGr.GetNormalVATProdPostingGroup(), DemoDataSetup.ResaleCode());
        ...
        InsertPostingInfo(ItemTempl, DemoDataSetup.ServicesCode(), CreateVATProdPostingGr.GetNormalVATProdPostingGroup(), '');
