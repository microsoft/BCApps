codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        InsertData(
          '44756404', 'Furniture Industries', '23 Charington Cresent', 'GB-E12 5TG', 'Mr.', 'Stephen A. Mew', '',
          'NO', '796385274', 'MID', XBLUE, '', '');
        InsertData(
          '44729910', 'Boybridge Tool Mart', '8 Grovenors Park', 'GB-N16 34Z', 'Mr.', 'David Campbell', 'GBP', 'GB', '279425763', 'OSL', '', '', '');
        InsertData(
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Emil Stensen';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Sebastian Berger';
    ...
    begin
        ...
        Vendor.Validate("Vendor Posting Group", CreateCurrency.GetPostingGroup("Currency Code"));
        Vendor.Validate("Gen. Bus. Posting Group", CreateCurrency.GetVendBusPostingGroup("Currency Code"));
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'NO 274 863 274', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", 'NO 197 548 769', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", 'NO 295 267 495', '', '', XWaverlyGate, '');
