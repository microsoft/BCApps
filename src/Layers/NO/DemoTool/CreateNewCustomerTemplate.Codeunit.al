codeunit 122007 "Create New Customer Template"
{
    ...
    begin
        ...
        InsertPostingInfo(CustomerTempl, CreateGenBusPostingGr.VendorDomesticCode(), CreateVATBusPostingGr.VendorHighVatCode(), DemoDataSetup.DomesticCode());
        ...
        InsertPostingInfo(CustomerTempl, CreateGenBusPostingGr.VendorForeignCode(), CreateVATBusPostingGr.VendorHighVatCode(), DemoDataSetup.ForeignCode());
