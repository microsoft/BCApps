codeunit 122006 "Create New Vendor Template"
{
    ...
    begin
        ...
        InsertPostingInfo(VendorTempl, CreateGenBusPostingGr.VendorDomesticCode(), CreateVATBusPostingGr.VendorHighVatCode(), DemoDataSetup.DomesticCode());
        ...
        InsertPostingInfo(VendorTempl, CreateGenBusPostingGr.VendorForeignCode(), CreateVATBusPostingGr.VendorHighVatCode(), DemoDataSetup.EUCode());
