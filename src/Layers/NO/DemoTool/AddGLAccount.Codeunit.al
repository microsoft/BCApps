codeunit 117559 "Add G/L Account"
{
    ...
    begin
        ...
        CreateGLAccount.InsertData(
          '995796', XPrepaidHardwareContractslc, 0, 1, 0, '', 2, XCUSTDOM, DemoDataSetup.ServicesCode(), XCUSTHIGHVAT, XHIGHVAT, true);
        CreateGLAccount.InsertData(
          '995797', XPrepaidSoftwareContractslc, 0, 1, 0, '', 2, XCUSTDOM, DemoDataSetup.ServicesCode(), XCUSTHIGHVAT, XHIGHVAT, true);
        ...
        CreateGLAccount.InsertData(
          '996955', XServiceContractSalelc, 0, 0, 0, '', 2, XCUSTDOM, DemoDataSetup.ServicesCode(), XCUSTHIGHVAT, XHIGHVAT, true);
