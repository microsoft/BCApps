codeunit 101997 "Create Item Template"
{
    ...
    begin
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, DemoDataSetup.RetailCode(), xHIGHTxt, DemoDataSetup.ResaleCode());
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, DemoDataSetup.NoVATCode(), xWITHOUTTxt, DemoDataSetup.ResaleCode());
        InsertPricingInfo(ConfigTemplateHeader, false);
        // Service template
        InsertTemplateHeader(ConfigTemplateHeader, xServiceDescTxt);
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.ServicesCode(), xHIGHTxt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
        ...
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.NoVATCode(), xWITHOUTTxt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
        // Freight template
        InsertTemplateHeader(ConfigTemplateHeader, DemoDataSetup.FreightCode());
        InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, DemoDataSetup.FreightCode(), xHIGHTxt, '');
        InsertPricingInfo(ConfigTemplateHeader, false);
