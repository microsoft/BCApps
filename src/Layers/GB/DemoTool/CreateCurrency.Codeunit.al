        ...
        if Currency.Find('-') then
            repeat
                if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                    ...
                    Currency.Validate("Realized Gains Acc.", CA.Convert(CreateGLAccount.InterestIncome()));
                    Currency.Validate("Realized Losses Acc.", CA.Convert(CreateGLAccount.InterestIncome()));
                end;
                Currency.Modify();
