codeunit 101252 "Create General Posting Setup"
{
    ...
    begin
        ...
        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.RetailCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.RetailCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.RetailCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());

        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.ServicesCode(), CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.ServicesCode(), CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.ServicesCode(), CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());

        InsertData2(DemoDataSetup.DomesticCode(), DemoDataSetup.NoVATCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
        InsertData2(DemoDataSetup.EUCode(), DemoDataSetup.NoVATCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
        InsertData2(DemoDataSetup.ExportCode(), DemoDataSetup.NoVATCode(), CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
