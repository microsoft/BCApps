codeunit 101219 "Create Job Posting Group SaaS"
{
    ...
    begin
        InsertData(XSETTINGUP, CreateGLAccount.WIPJobCosts(), CreateGLAccount.WIPAccruedCosts(), CreateGLAccount.JobCostsApplied(), '', '', '', '', '', CreateGLAccount.WIPJobSales(), CreateGLAccount.WIPInvoicedSales(), CreateGLAccount.JobSalesApplied(), '', CreateGLAccount.JobCosts(), CreateGLAccount.JobSales());
    end;
