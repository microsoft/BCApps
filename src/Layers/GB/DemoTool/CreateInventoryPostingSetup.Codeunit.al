codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('', DemoDataSetup.ResaleCode(), CreateGLAccount.GoodsforResale(), '');
    end;
    ...
    begin
        DemoDataSetup.Get();
        InsertData(XMAIN, DemoDataSetup.ResaleCode(), CreateGLAccount.GoodsforResale(), '');
        InsertData(XEAST, DemoDataSetup.ResaleCode(), CreateGLAccount.GoodsforResale(), '');
        InsertData(XWEST, DemoDataSetup.ResaleCode(), CreateGLAccount.GoodsforResale(), '');
    end;
}
