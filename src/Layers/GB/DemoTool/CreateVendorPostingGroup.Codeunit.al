codeunit 101093 "Create Vendor Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            ...
            InsertData(DemoDataSetup.EUCode(), XVendorsInEUTxt, CreateGLAccount.AccountsPayableDomestic(), '', CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.InterestIncome(), CreateGLAccount.InterestIncome());
            InsertData(DemoDataSetup.ForeignCode(), XForeignVendorsTxt, CreateGLAccount.AccountsPayableDomestic(), '', CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.InterestIncome(), CreateGLAccount.InterestIncome());
        end;
    end;
