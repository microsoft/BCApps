codeunit 101208 "Create Job Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            ...
            InsertData(
              XSETTINGUP, XSettingUpFurnitureTxt,
              CreateGLAccount.WIPJobCosts(), CreateGLAccount.WIPAccruedCosts(), CreateGLAccount.JobCostsApplied(), '', '', '', '', '', CreateGLAccount.WIPJobSales(), CreateGLAccount.WIPInvoicedSales(), CreateGLAccount.JobSalesApplied(), '', CreateGLAccount.JobCosts(), CreateGLAccount.JobSales());
    end;
