#if not CLEAN27
codeunit 144525 "Test Submit VAT Declare Rqst"
{
    Subtype = Test;
    ...
    begin
        ...
        CODEUNIT.Run(CODEUNIT::"Create VAT Declaration Request", VATReportHeader);
        LibraryLowerPermissions.SetO365Setup();

        // [WHEN] Submitting a correct request
        CODEUNIT.Run(CODEUNIT::"Submit VAT Declaration Request", VATReportHeader);
