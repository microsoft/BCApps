                ...
                begin
                    if FADeprBook.FindFirst() then
                        if FADeprBook."Disposal Date" > 0D then
                            FADeprBook."Depreciable Basis" := 0
                        else
