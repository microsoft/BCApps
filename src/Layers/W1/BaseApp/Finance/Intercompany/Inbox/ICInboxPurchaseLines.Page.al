...
/// <summary>
/// List part page for displaying and managing intercompany inbox purchase document lines.
/// Provides line-level detail view for purchase transactions received from IC partners.
/// </summary>
