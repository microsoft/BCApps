...
#pragma warning restore AS0072
    ...
    var
        ...
        ServiceNameParmLbl: Label 'ExcelTemplateAgedAccountsPayable', Locked = true;
    ...
    begin
        TelemetryDimensions.Add('CodeunitId', Format(Codeunit::"Run Template Aged Acc. Pay.", 0, 9));
        TelemetryDimensions.Add('ExcelTemplateName', ServiceNameParmLbl);
        FeatureTelemetry.LogUsage('0000ONS', 'Excel Template', 'Run Aged Acc. Pay. Excel Report', TelemetryDimensions);
    end;
}
