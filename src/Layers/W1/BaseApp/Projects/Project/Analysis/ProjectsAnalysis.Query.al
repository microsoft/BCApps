...
query 486 ProjectsAnalysis
{
    QueryType = Normal;
    DataAccessIntent = ReadOnly;
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Project Ad-hoc Analysis';
    AboutTitle = 'About Project Ad-hoc Analysis';
    AboutText = 'The Project Analysis a query that joins data from project ledger entries with project master data.';
