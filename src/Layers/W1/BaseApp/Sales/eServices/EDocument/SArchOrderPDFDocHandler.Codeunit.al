...
codeunit 5021 "S.Arch.Order PDF Doc.Handler" implements IPdfDocumentHandler
{
    var
        SalesArchivedOrderLbl: Label 'Sales Archived Order';

    /// <summary>
    /// Generates a PDF blob for Sales Archived Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"S.Arch.Order";
        ReportSelections.GetPdfReportForCust(TempBlob, ReportUsage, SalesHeaderArchive, SalesHeaderArchive."Bill-to Customer No.");
        DocumentMailing.GetAttachmentFileName(Name, SalesHeaderArchive."No.", SalesArchivedOrderLbl, ReportUsage.AsInteger());
