...
report 5176 "Archived Blanket Sales Order"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Sales/Archive/ArchivedBlanketSalesOrder.rdlc';
    ...
    begin
        ...
        FormatDocument.SetSalesPerson(SalespersonPurchaser, SalesHeaderArchive."Salesperson Code", SalesPersonText);
