...
codeunit 5453 "Purch. Order PDF Doc.Handler" implements IPdfDocumentHandler
{
    /// <summary>
    /// Generates a PDF blob for Purchase Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"P.Order";
