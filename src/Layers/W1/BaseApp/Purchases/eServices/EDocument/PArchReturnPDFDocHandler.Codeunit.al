...
codeunit 5025 "P.Arch.Return PDF Doc.Handler" implements IPdfDocumentHandler
{
    var
        PurchaseArchivedReturnOrderLbl: Label 'Purchase Archived Return Order';

    /// <summary>
    /// Generates a PDF blob for Purchase Archived Return Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"P.Arch.Return";
        ReportSelections.GetPdfReportForVend(TempBlob, ReportUsage, PurchaseHeaderArchive, PurchaseHeaderArchive."Buy-from Vendor No.");
        DocumentMailing.GetAttachmentFileName(Name, PurchaseHeaderArchive."No.", PurchaseArchivedReturnOrderLbl, ReportUsage.AsInteger());
