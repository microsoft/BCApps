...
#pragma warning restore AA0470
    ...
    procedure InsertCostBudgetRegister(CostBudgetEntryNo: BigInteger; CostBudgetName: Code[10]; CostBudgetAmount: Decimal): BigInteger
    var
    ...
    procedure UpdateCostBudgetRegister(CostBudgetRegNo: BigInteger; CostBudgetEntryNo: BigInteger; CostBudgetAmount: Decimal)
    var
        CostBudgetReg: Record "Cost Budget Register";
