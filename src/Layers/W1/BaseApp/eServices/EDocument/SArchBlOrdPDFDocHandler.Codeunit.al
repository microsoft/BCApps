...
codeunit 5028 "S.Arch.Bl.Ord PDF Doc.Handler" implements IPdfDocumentHandler
{
    var
        SalesArchivedBlanketOrderLbl: Label 'Sales Archived Blanket Order';

    /// <summary>
    /// Generates a PDF blob for Sales Archived Blanket Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"S.Arch.Blanket";
        ReportSelections.GetPdfReportForCust(TempBlob, ReportUsage, SalesHeaderArchive, SalesHeaderArchive."Bill-to Customer No.");
        DocumentMailing.GetAttachmentFileName(Name, SalesHeaderArchive."No.", SalesArchivedBlanketOrderLbl, ReportUsage.AsInteger());
