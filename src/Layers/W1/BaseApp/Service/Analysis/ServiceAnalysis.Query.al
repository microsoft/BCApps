...
query 5900 "Service Analysis"
{
    QueryType = Normal;
    DataAccessIntent = ReadOnly;
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Service Ad-hoc Analysis';
    AboutTitle = 'About Service Ad-hoc Analysis';
    AboutText = 'The Service Analysis is a query that joins data from service ledger entries with service master data.';
