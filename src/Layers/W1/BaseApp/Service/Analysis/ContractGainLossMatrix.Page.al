                ...
                field(TotalGainLoss; TotalGainLoss)
                {
                    ...
                    begin
                        ...
                        if ReasonFilter <> '' then
                            ContractGainLossEntry.SetRange("Reason Code", ReasonFilter);
                        if AmountType = AmountType::"Net Change" then
...
#pragma warning restore AA0074
    ...
    begin
        if AmountType = AmountType::"Net Change" then
            ReasonCode.SetRange("Date Filter", Rec."Period Start", Rec."Period End")
        else
            ReasonCode.SetRange("Date Filter", PeriodStart, Rec."Period End");
    end;
    ...
    begin
        ContractGainLossEntry.Reset();
        ContractGainLossEntry.SetCurrentKey("Reason Code", "Change Date");
        ContractGainLossEntry.SetFilter("Reason Code", ReasonFilter);
        if AmountType = AmountType::"Net Change" then
            ContractGainLossEntry.SetRange("Change Date", Rec."Period Start", Rec."Period End")
        else
    ...
    begin
        ContractGainLossEntry.Reset();
        ContractGainLossEntry.SetCurrentKey("Reason Code", "Change Date");
        ContractGainLossEntry.SetRange("Reason Code", MatrixRecords[MATRIX_ColumnOrdinal].Code);
        if AmountType = AmountType::"Net Change" then
            ContractGainLossEntry.SetRange("Change Date", Rec."Period Start", Rec."Period End")
        else
            ContractGainLossEntry.SetRange("Change Date", 0D, Rec."Period End");
