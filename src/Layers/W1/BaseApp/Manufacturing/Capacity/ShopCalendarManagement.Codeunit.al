...
codeunit 99000755 "Shop Calendar Management"
{
    ...
    [EventSubscriber(ObjectType::Table, Database::"Work Center", 'OnAfterModifyEvent', '', true, false)]
    local procedure OnAfterModifyWorkCenter(var Rec: Record "Work Center"; var xRec: Record "Work Center"; RunTrigger: Boolean)
    begin
        Clear(WorkCenter);
    end;

    [EventSubscriber(ObjectType::Table, Database::"Shop Calendar Holiday", 'OnAfterModifyEvent', '', true, false)]
    ...
    [EventSubscriber(ObjectType::Table, Database::"Capacity Unit of Measure", 'OnAfterModifyEvent', '', true, false)]
