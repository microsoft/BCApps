codeunit 134149 "ERM Derogatory Depr. Posting"
{
    ...
    begin
        SuccessfulComposedFrenchTestBodyRestoresFeatureStateBody();
    end;
    ...
    begin
        FailedComposedFrenchTestBodyRestoresFeatureStateBody();
    end;
    ...
    begin
        ...
        asserterror
        begin
            FinalMaintenanceLinkValidationRunsAfterPostingEventBody();
            CompleteTestBody();
        end;
        RestoreFeatureStateAfterTestBody();
    end;
    ...
    local procedure FailedComposedFrenchTestBodyRestoresFeatureStateBody()
    var
        FeatureDataUpdateStatus: Record "Feature Data Update Status";
        DepreciationBookRecordRef: RecordRef;
    ...
    local procedure FinalMaintenanceLinkValidationRunsAfterPostingEventBody()
    var
        MaintenanceLedgerEntry: Record "Maintenance Ledger Entry";
        FAJournalLine: Record "FA Journal Line";
    ...
    local procedure SuccessfulComposedFrenchTestBodyRestoresFeatureStateBody()
    var
        FeatureDataUpdateStatus: Record "Feature Data Update Status";
        DepreciationBookRecordRef: RecordRef;
        PreviousFeatureStatus: Enum "Feature Status";
