codeunit 135095 "OCR Web Service Tests"
{
    ...
    begin
        UndoSetReadyForOCR("Incoming Document Status"::New)
    end;
    ...
    begin
        UndoSetReadyForOCR("Incoming Document Status"::Released)
    end;

    local procedure UndoSetReadyForOCR(InitialDocumentStatus: Enum "Incoming Document Status")
    var
        IncomingDocument: Record "Incoming Document";
        IncomingDocumentAttachment: Record "Incoming Document Attachment";
        TempBlob: Codeunit "Temp Blob";
