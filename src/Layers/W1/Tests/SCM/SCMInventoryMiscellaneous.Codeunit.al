codeunit 137293 "SCM Inventory Miscellaneous"
{
    ...
    begin
        ...
        CreateAndPostItemJournalLine(Item."No.", PickQty, Location.Code, 'PICK');
    ...
    begin
        ...
        CreateNonDirectedPickLocation(Location, false, true);
        LibraryWarehouse.CreateWarehouseEmployee(WarehouseEmployee, Location.Code, true);
        LibraryInventory.CreateItem(Item);
        CreateAndPostItemJournalLine(Item."No.", QtyPerBin, Location.Code, Location."Receipt Bin Code");
        CreateAndPostItemJournalLine(Item."No.", QtyPerBin, Location.Code, 'PICK');
    ...
    begin
        ...
        CreateNonDirectedPickLocation(Location, true, false);
        LibraryInventory.CreateItem(Item);
        CreateAndPostItemJournalLine(Item."No.", QtyPerBin, Location.Code, Location."Receipt Bin Code");
        CreateAndPostItemJournalLine(Item."No.", QtyPerBin, Location.Code, 'PICK');
        CreateAndPostItemJournalLine(Item."No.", QtyPerBin, Location.Code, Location."Shipment Bin Code");
    ...
    begin
        ...
        CreateNonDirectedPickLocation(Location, true, true);
        CreateBin(Bin, Location.Code, 'RECEIPT2', '', '');
        LibraryWarehouse.CreateWarehouseEmployee(WarehouseEmployee, Location.Code, true);
        LibraryInventory.CreateItem(Item);
        ...
        Location.Validate("Receipt Bin Code", 'RECEIPT2');
        Location.Modify(true);
    ...
    begin
        ...
        LibraryWarehouse.CreateWarehouseEmployee(WarehouseEmployee, Location.Code, true);
        LibraryInventory.CreateItem(Item);
        CreateAndPostItemJournalLine(Item."No.", InventoryQty, Location.Code, 'PICK');
    ...
    begin
        ...
        CreateBin(Bin, Location.Code, 'SHIP2', '', '');
        Location.Validate("Shipment Bin Code", 'SHIP2');
        Location.Modify(true);
        ShipmentNo := CreateSales(Item."No.", Location.Code, InventoryQty, false, true, false, 0);
    ...
    local procedure CreateNonDirectedPickLocation(var Location: Record Location; RequirePutAway: Boolean; RequirePick: Boolean)
    var
        Bin: Record Bin;
    begin
        ...
        Location.Validate("Receipt Bin Code", 'RECEIPT');
        Location.Validate("Shipment Bin Code", 'SHIP');
        Location.Modify(true);
    end;
