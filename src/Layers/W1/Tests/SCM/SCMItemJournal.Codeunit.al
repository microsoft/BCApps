codeunit 137033 "SCM Item Journal"
{
    ...
    begin
        ...
        // [SCENARIO] Outbound postings from a bin are blocked when the Bin Content "Block Movement" is "Outbound"
        Initialize();
    ...
    begin
        // [FEATURE] [Item Journal] [Sales] [Bin Content] [AI test 0.4]
        // [SCENARIO] Outbound postings from a bin are blocked when the Bin Content "Block Movement" is "All"
        Initialize();
