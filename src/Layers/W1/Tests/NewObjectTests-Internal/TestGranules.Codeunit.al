    ...
    begin
        ...
        if TempTableDataAllObj.FindSet() then
            repeat
                ...
                Assert.IsFalse(TempAllLocalExpandedPermission.IsEmpty, StrSubstNo(TableDataNotInLocalPermissionSetTxt, TempTableDataAllObj."Object ID", TempTableDataAllObj.Name));
            until TempTableDataAllObj.Next() = 0;
    end;
