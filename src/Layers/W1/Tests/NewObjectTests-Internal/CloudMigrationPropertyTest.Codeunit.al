codeunit 135160 "Cloud Migration Property Test"
{
    ...
    begin
        ...
        ListOfTablesToMigrate.Add(9650); // Database::"Custom Report Layout" - obsoleted; the table still replicates until its schema is dropped, so it stays in the migration set by ID rather than by a compile-time reference (see Deposits Page Setup, table 500)
