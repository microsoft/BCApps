...
codeunit 134834 AmtAutoFormatCurrFCYCodeBef
{
    Subtype = Test;
    ...
    begin
        ...
        Assert.AreEqual(FormatValue(AmountAutoFormatCurrency.Case1FCY, Currency."Amount Decimal Places", Currency."ISO Code", Currency."Currency Symbol Position"), AmountAutoFormatCurrencyTestPage.Case1FCY.Value(), 'The return value for Amount FCY is not correctly formatted');
        Assert.AreEqual(FormatValue(AmountAutoFormatCurrency.Case2FCY, Currency."Unit-Amount Decimal Places", Currency."ISO Code", Currency."Currency Symbol Position"), AmountAutoFormatCurrencyTestPage.Case2FCY.Value(), 'The return value for Unit-Amount FCY is not correctly formatted');
