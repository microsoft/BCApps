codeunit 119201 "Create Web Services"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Evaluation then begin
            WebServiceManagement.CreateWebService(
              WebService."Object Type"::Page, PAGE::"Acc. Sched. KPI WS Dimensions", 'powerbifinance', true);
            WebServiceManagement.CreateWebService(WebService."Object Type"::Query, QUERY::"Dimension Sets", '', true);
        end else
            WebServiceManagement.CreateWebService(
              WebService."Object Type"::Page, PAGE::"Acc. Sched. KPI Web Service", 'powerbifinance', true);
        ...
        WebServiceManagement.CreateWebService(
          WebService."Object Type"::Query, QUERY::"Item Sales by Customer", 'ItemSalesByCustomer', true);
        WebServiceManagement.CreateWebService(WebService."Object Type"::Query, QUERY::"Item Sales and Profit", 'ItemSalesAndProfit', true);
        WebServiceManagement.CreateWebService(
          WebService."Object Type"::Query, QUERY::"Sales Orders by Sales Person", 'SalesOrdersBySalesPerson', true);
    ...
    begin
        WebServiceManagement.CreateTenantWebService(
          TenantWebService."Object Type"::Query, QUERY::"Segment Lines", 'SegmentLines', true);
    ...
    begin
        WebServiceManagement.CreateTenantWebService(
          TenantWebService."Object Type"::Page, PAGE::"Job List", JobListTxt, true);
        ...
        WebServiceManagement.CreateTenantWebService(
          TenantWebService."Object Type"::Page, PAGE::"Job Task Lines", JobTaskLinesTxt, true);
        ...
        WebServiceManagement.CreateTenantWebService(
          TenantWebService."Object Type"::Page, PAGE::"Job Planning Lines", JobPlanningLinesTxt, true);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo("Credit Limit (LCY)"),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo("Balance Due"),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedCustLedgEntry.FieldNo("Posting Date"),
          DATABASE::"Detailed Cust. Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId,
          DetailedCustLedgEntry.FieldNo("Cust. Ledger Entry No."), DATABASE::"Detailed Cust. Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedCustLedgEntry.FieldNo(Amount),
          DATABASE::"Detailed Cust. Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedCustLedgEntry.FieldNo("Amount (LCY)"),
          DATABASE::"Detailed Cust. Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedCustLedgEntry.FieldNo("Transaction No."),
          DATABASE::"Detailed Cust. Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedCustLedgEntry.FieldNo("Entry No."),
          DATABASE::"Detailed Cust. Ledg. Entry", metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Vendor.FieldNo("Balance Due"),
          DATABASE::Vendor, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedVendorLedgEntry.FieldNo("Posting Date"),
          DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId,
          DetailedVendorLedgEntry.FieldNo("Applied Vend. Ledger Entry No."), DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedVendorLedgEntry.FieldNo(Amount),
          DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedVendorLedgEntry.FieldNo("Amount (LCY)"),
          DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedVendorLedgEntry.FieldNo("Transaction No."),
          DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, DetailedVendorLedgEntry.FieldNo("Entry No."),
          DATABASE::"Detailed Vendor Ledg. Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId,
          DetailedVendorLedgEntry.FieldNo("Remaining Pmt. Disc. Possible"), DATABASE::"Detailed Vendor Ledg. Entry", metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Job.FieldNo("Search Description"),
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, JobLedgerEntry.FieldNo("Posting Date"),
          DATABASE::"Job Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, JobLedgerEntry.FieldNo("Total Cost"),
          DATABASE::"Job Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, JobLedgerEntry.FieldNo("Entry No."),
          DATABASE::"Job Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, JobLedgerEntry.FieldNo("Entry Type"),
          DATABASE::"Job Ledger Entry", metaData);
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesHeader.FieldNo("No."),
          DATABASE::"Sales Header", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesHeader.FieldNo("Requested Delivery Date"),
          DATABASE::"Sales Header", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesHeader.FieldNo("Shipment Date"),
          DATABASE::"Sales Header", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesHeader.FieldNo("Due Date"),
          DATABASE::"Sales Header", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo(Quantity),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo(Amount),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo("No."),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo(Description),
          DATABASE::"Sales Line", metaData);
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("No."),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo(Name),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("Account Type"),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("Debit/Credit"),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLEntry.FieldNo("Posting Date"),
          DATABASE::"G/L Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLEntry.FieldNo(Amount),
          DATABASE::"G/L Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLEntry.FieldNo("Entry No."),
          DATABASE::"G/L Entry", metaData);
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("No."), DATABASE::"G/L Account",
          metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo(Name), DATABASE::"G/L Account",
          metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("Account Type"),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLAccount.FieldNo("Debit/Credit"),
          DATABASE::"G/L Account", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLBudgetEntry.FieldNo(Date),
          DATABASE::"G/L Budget Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, GLBudgetEntry.FieldNo(Amount),
          DATABASE::"G/L Budget Entry", metaData);
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Entry No."),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Posting Date"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Customer No."),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Sales (LCY)"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo(Name),
          DATABASE::Customer, metaData);
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesHeader.FieldNo("No."), DATABASE::"Sales Header",
          metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo("No."), DATABASE::"Sales Line",
          metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo(Quantity),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo("Qty. Invoiced (Base)"),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, SalesLine.FieldNo("Qty. Shipped (Base)"),
          DATABASE::"Sales Line", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo("Base Unit of Measure"),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo(Description),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo(Inventory),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo("Unit Price"),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo("No."),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo(Name),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo(Balance),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo("Country/Region Code"),
          DATABASE::Customer, metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Customer.FieldNo("No."),
          DATABASE::Customer, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, ItemLedgerEntry.FieldNo("Item No."),
          DATABASE::"Item Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, ItemLedgerEntry.FieldNo(Quantity),
          DATABASE::"Item Ledger Entry", metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Entry No."),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Due Date"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Remaining Amt. (LCY)"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo(Open),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Customer Posting Group"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Sales (LCY)"),
          DATABASE::"Cust. Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, CustLedgerEntry.FieldNo("Posting Date"),
    ...
    begin
        ...
        ODataUtility.GetTenantWebServiceMetadata(TenantWebService, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, VendorLedgerEntry.FieldNo("Entry No."),
          DATABASE::"Vendor Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, VendorLedgerEntry.FieldNo("Due Date"),
          DATABASE::"Vendor Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, VendorLedgerEntry.FieldNo("Remaining Amt. (LCY)"),
          DATABASE::"Vendor Ledger Entry", metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, VendorLedgerEntry.FieldNo(Open),
          DATABASE::"Vendor Ledger Entry", metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo(Inventory),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo("Qty. on Purch. Order"),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Item.FieldNo("Unit Price"),
          DATABASE::Item, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Vendor.FieldNo("No."),
          DATABASE::Vendor, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Vendor.FieldNo(Name),
          DATABASE::Vendor, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Vendor.FieldNo(Balance),
          DATABASE::Vendor, metaData);
        WebServiceManagement.CreateTenantWebServiceColumnForQuery(TenantWebService.RecordId, Vendor.FieldNo("Country/Region Code"),
          DATABASE::Vendor, metaData);
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(ID),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(Value),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Period Type"),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(Date),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Date Sorting"),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Period Type Sorting"),
          DATABASE::"Power BI Chart Buffer");
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Period Type Sorting"),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Measure Name"),
          DATABASE::"Power BI Chart Buffer");
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Measure No."),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Measure Name"),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(Value),
    ...
    begin
        ...
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(ID),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Row No."),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo(Value),
          DATABASE::"Power BI Chart Buffer");
        WebServiceManagement.CreateTenantWebServiceColumnForPage(TenantWebService.RecordId, PowerBIChartBuffer.FieldNo("Measure Name"),
