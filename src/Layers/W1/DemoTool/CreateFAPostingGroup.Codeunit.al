codeunit 101803 "Create FA Posting Group"
{
    ...
    /// <summary>
    /// Gets the mapped derogatory account or the default account if the mapped account does not exist.
    /// </summary>
    /// <param name="DerogatoryAccNo">The derogatory account number to map.</param>
    /// <param name="DefaultAccNo">The default account number.</param>
    /// <returns>The mapped account number if it exists; otherwise, the default account number.</returns>
