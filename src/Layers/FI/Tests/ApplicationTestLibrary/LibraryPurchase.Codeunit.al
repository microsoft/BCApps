...
codeunit 130512 "Library - Purchase"
{
    ...
    begin
        ...
        // - posted credit memo
        TransferPurchaseHdrMandatoryFields(PurchaseHeader);
        DocumentNo := PostPurchaseDocument2(PurchaseHeader, NewShipReceive, NewInvoice);
    end;

    procedure PostPurchaseDocument2(var PurchaseHeader: Record "Purchase Header"; NewShipReceive: Boolean; NewInvoice: Boolean) DocumentNo: Code[20]
    var
        NoSeries: Codeunit "No. Series";
