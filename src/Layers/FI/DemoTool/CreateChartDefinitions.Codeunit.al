codeunit 119100 "Create Chart Definitions"
{
    ...
    begin
        ...
        CreateAccScheduleLine(
          XIncAndExpAccSchedNameTxt, '30', XTotalExternalCostsTxt, CreateAccScheduleData_TotalOperatingExpenses(), TotalAccounts, NetChange);
        CreateAccScheduleLine(
        ...
        CreateAccScheduleLine(
          XReducedTrialBalanceAccSchedNameTxt, '50', XOperatingExpensesTxt, CreateAccScheduleData_OperatingExpenses(), TotalAccounts, NetChange);
    ...
    local procedure CreateAccScheduleData_TotalOperatingExpenses(): Text
    begin
    ...
    local procedure CreateAccScheduleData_OperatingExpenses(): Text
    begin
        exit(StrSubstNo('%1|%2|%3|%4|%5|%6',
          '3720',
          '3769',
