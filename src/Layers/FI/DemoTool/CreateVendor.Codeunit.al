codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Tommy Tuominen';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Arto Salonen';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Ilkka Pietikainen';
        ...
        case Vendor."No." of
            ...
            '20000':
                begin
                    ...
                    Vendor.Validate("Payment Terms Code", X30DAYS); //FI
                end;
            '10000':
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '274863274', '', '', XSurrey, '');
