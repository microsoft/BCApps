codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Cristobal Tapia';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Manuel Paez';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Santiago Brito';
