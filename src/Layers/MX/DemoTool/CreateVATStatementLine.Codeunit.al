codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        ...
        InsertData(
          '1010', StrSubstNo(XSalesVATPERCENToutgoing, DemoDataSetup.GoodsVATText()), 1, '', 2, DemoDataSetup.DomesticCode(), DemoDataSetup.GoodsVATCode(), '', 3, 0, false, 1, false);
        InsertData(
          '1019', StrSubstNo(XSalesVATPERCENToutgoing, DemoDataSetup.GoodsVATText()), 2, '', 0, '', '', '1010..1018', 0, 0, true, 1, false);
        InsertData(
          '1020', StrSubstNo(XSalesVATPERCENToutgoing, DemoDataSetup.ServicesVATText()), 1, '', 2, DemoDataSetup.DomesticCode(), DemoDataSetup.ServicesVATCode(), '', 3, 0, false, 1, false);
        InsertData(
          '1029', StrSubstNo(XSalesVATPERCENToutgoing, DemoDataSetup.ServicesVATText()), 2, '', 0, '', '', '1020..1028', 0, 0, true, 1, false);
        InsertData(
          '1030', StrSubstNo(XVATPERCENTonEUPurchasesetc, DemoDataSetup.GoodsVATText()), 1, '', 1, DemoDataSetup.EUCode(), DemoDataSetup.GoodsVATCode(), '', 1, 1, false, 1, false);
        InsertData(
          '1039', StrSubstNo(XVATPERCENTonEUPurchasesetc, DemoDataSetup.GoodsVATText()), 2, '', 0, '', '', '1030..1038', 0, 0, true, 1, false);
        InsertData(
          '1040', StrSubstNo(XVATPERCENTonEUPurchasesetc, DemoDataSetup.ServicesVATText()), 1, '', 1, DemoDataSetup.EUCode(), DemoDataSetup.ServicesVATCode(), '', 3, 1, false, 1, false);
        InsertData(
          '1049', StrSubstNo(XVATPERCENTonEUPurchasesetc, DemoDataSetup.ServicesVATText()), 2, '', 0, '', '', '1040..1048', 0, 0, true, 1, false);
        InsertData('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false);
        InsertData(
