codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Aaron Loton';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Blake Springthorpe';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Patrick Cochran';
        X53004084612: Label '53004084612';
        X30DAYS: Label '30 DAYS';
        X20077917: Label '20077917';
        X53002085116: Label '53002085116';
        X52004084116: Label '52004084116';
        X20030073: Label '20030073';
        ...
        case Vendor."No." of
            ...
            '20000':
                begin
                    ...
                    Vendor.Validate(ABN, X53002085116);
                    Vendor.Registered := true;
                    Vendor.Validate("Payment Terms Code", X30DAYS);
                end;
            '30000':
                begin
                    Vendor.Validate(ABN, X52004084116);
                    Vendor.Registered := true;
                    Vendor.Validate("Payment Terms Code", X30DAYS);
                end;
            '40000':
            ...
            '50000':
                begin
                    ...
                    AddressID."Table Key" := Vendor.GetPosition();
                    AddressID."Address Type" := AddressID."Address Type"::Main;
                    AddressID.Validate("Address ID", X20030073);
                    AddressID."Bar Code System" := AddressID."Bar Code System"::"4-State Bar Code";
                    AddressID.Insert();
                end;
            '49454647':
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '274863274B01', '', '', XSurrey, '');
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '197548769B01', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", '295267495B01', '', '', XWaverlyGate, '');
