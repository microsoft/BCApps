codeunit 101222 "Create Ship-to Address"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData('10000', XCHELTENHAM, XMontpellierHouse, XMontpellierDrive, '', XEXW, XBLUE, 'AU-2600');
        InsertData('10000', XLONDON, X2KingdomStreet, XPaddington, '', XEXW, XBLUE, 'AU-2360');
        InsertData('20000', XFLEET, XBeaconHillRoad, XChurchCrookham, '', XEXW, XBLUE, 'AU-4006');
        InsertData('20000', UpperCase(XTWYCROSS), XManorPark, XTWYCROSS, '', XEXW, XBLUE, 'AU-3002');
    end;
}
