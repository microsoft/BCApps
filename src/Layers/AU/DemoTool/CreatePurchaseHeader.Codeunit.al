codeunit 101038 "Create Purchase Header"
{
    ...
    begin
        ...
        if "Document Type" = 3 then begin
            ...
            "Purchase Header".Validate("Reason Code", ReasonCode.Code);
            case "Buy-from Vendor No." of
                '30000':
                    "Purchase Header"."Adjustment Applies-to" := '12345';
                '01863656':
                    "Purchase Header"."Adjustment Applies-to" := '108024';
            end;
        end;
