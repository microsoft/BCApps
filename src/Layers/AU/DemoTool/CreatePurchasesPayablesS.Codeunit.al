codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        "Create No. Series".InitFinalSeries("Purchases & Payables Setup"."Posted Tax Invoice Nos.", XPTAXINVPLUS, XPostedPurchaseTaxInvoice, 8);
        "Create No. Series".InitFinalSeries("Purchases & Payables Setup"."WHT Certificate No. Series", XWHTCERT, XWHTCertificate, 8);
        "Create No. Series".InitFinalSeries("Purchases & Payables Setup"."Posted Tax Credit Memo Nos", XPTAXCRPLUS, XPostedPurchaseTaxCreditMemo, 8);
        "Purchases & Payables Setup"."Post Dated Check Template" := XPAYMENT;
        "Purchases & Payables Setup"."Post Dated Check Batch" := XBANK;
        "Purchases & Payables Setup"."GST Prod. Posting Group" := DemoDataSetup.NoVATCode();
        ...
        "Purchases & Payables Setup"."Copy Line Descr. to G/L Entry" := true;
    ...
    begin
        ...
        "Purchases & Payables Setup"."Document Default Line Type" := "Purchases & Payables Setup"."Document Default Line Type"::Item;
        "Purchases & Payables Setup"."GST Prod. Posting Group" := DemoDataSetup.NonGST();
        "Purchases & Payables Setup"."Invoice Nos." := "Purchases & Payables Setup"."Posted Invoice Nos.";
        "Purchases & Payables Setup"."Credit Memo Nos." := "Purchases & Payables Setup"."Posted Credit Memo Nos.";
        "Purchases & Payables Setup"."Copy Line Descr. to G/L Entry" := true;
        "Purchases & Payables Setup".Modify();
    ...
    begin
        ...
        "Purchases & Payables Setup"."Posted Tax Invoice Nos." := XPTAXINVPLUS;
        "Purchases & Payables Setup"."Posted Tax Credit Memo Nos" := XPTAXCRPLUS;
        "Purchases & Payables Setup"."WHT Certificate No. Series" := XWHTCERT;
        "Purchases & Payables Setup".Modify();
    end;
}
