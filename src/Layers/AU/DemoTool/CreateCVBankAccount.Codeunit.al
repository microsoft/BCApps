    ...
    begin
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                PostCode.Reset();
                if PostCode.Get("Customer Bank Account"."Post Code", "Customer Bank Account".City) then
                    "Customer Bank Account".County := PostCode.County;
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                PostCode.Reset();
                if PostCode.Get("Vendor Bank Account"."Post Code", "Vendor Bank Account".City) then
                    "Vendor Bank Account".County := PostCode.County;
                if "Currency Code" <> '' then
