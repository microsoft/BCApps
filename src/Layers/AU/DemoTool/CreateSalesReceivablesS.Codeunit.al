codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        "Sales & Receivables Setup"."Post Dated Check Template" := XCASHRCPT;
        "Sales & Receivables Setup"."Post Dated Check Batch" := XBANK;
        ...
        "Sales & Receivables Setup"."Copy Line Descr. to G/L Entry" := true;
