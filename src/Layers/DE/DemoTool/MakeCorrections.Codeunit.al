        ...
        case Date of
            CA.AdjustDate(19020501D):
                begin
                    ...
                    //   0D,CA.AdjustDate(31031902D),CA.AdjustDate(01051902D),STRSUBSTNO(VATDocNumber,XVAT1Q,DATE2DMY(Date,3)),
            ...
            CA.AdjustDate(19020801D):
                begin
                    ...
                    // CalcAndPostVAT.InitializeRequest(
                    //   0D,CA.AdjustDate(30061902D),CA.AdjustDate(01081902D),STRSUBSTNO(VATDocNumber,XVAT2Q,DATE2DMY(Date,3)),
                    //   CA.Convert('995710'),FALSE,TRUE);
                    CalcAndPostVAT.InitializeRequest(
            ...
            CA.AdjustDate(19021101D):
                begin
                    ...
                    // CalcAndPostVAT.InitializeRequest(
                    //   0D,CA.AdjustDate(30091902D),CA.AdjustDate(01111902D),STRSUBSTNO(VATDocNumber,XVAT3Q,DATE2DMY(Date,3)),
                    //   CA.Convert('995710'),FALSE,TRUE);
                    CalcAndPostVAT.InitializeRequest(
