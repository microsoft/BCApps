codeunit 101023 "Create Vendor"
{
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '895741963', XNW, '', '', '8712345000028');
        InsertData(
          '20000', XARDayPropertyManagement, X100DayDrive, CreatePostCode.Convert('GB-GU3 2SE'), XMr, XFrankLee, '',
          DemoDataSetup."Country/Region Code", '274863274', XE, XYELLOW, '', '8712345000035');
        InsertData(
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '197548769', XMID, XGREEN, '', '');
        InsertData(
          '50000', XServiceElectronicsLtd, X172FieldGreen, CreatePostCode.Convert('GB-WD2 4RG'), XMr, XMarcZimmerman, '',
          DemoDataSetup."Country/Region Code", '295267495', XE, '', '', '');
        InsertData(
        ...
        InsertData(
          '49454647', 'VAG - Jürgensen', 'Süderweg 15', 'DE-20097', '', '', 'EUR', 'DE', '521478963', XN, '', '', '');
        InsertData(
          '49494949', 'KKA Büromaschinen Gmbh', 'Immermannstraße 92', 'DE-86899', '', '', 'EUR', 'DE', '456123985', XS, '', '', '');
        InsertData(
          '49989898', 'JB-Spedition', 'Grünfahrtsweg 20', 'DE-80997', '', '', 'EUR', 'DE', '125874259', XS, '', '', '');
        InsertData(
    ...
    var
        ...
        XEvanMcIntosh: Label 'Evan McIntosh', Comment = 'CELA approved translation: Falk Neuman';
        XBryceJasso: Label 'Bryce Jasso';
        XTobyRhode: Label 'Toby Rhode', Comment = 'CELA approved translation: Han Carstens';
        XRaymondHillard: Label 'Raymond Hillard', Comment = 'CELA approved translation: Berend Martin';
        XN: Label 'N';
        XMID: Label 'MID';
        XE: Label 'E';
        XNW: Label 'NW';
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '895741963', '', '', XSurrey, '');
        UpdateContact('20000', XEvanMcIntosh);
        InsertData(
          '30000', XGraphicDesignInstitute, X6Arbachtalstrasse, CreatePostCode.Convert('GB-B31 2AL'), '', '', '',
          'GB', '796385274', '', '', XUnterAchalm, '');
        UpdateContact('30000', XBryceJasso);
        InsertData(
          '40000', XWideWorldImporters, X3000AviatorWay, CreatePostCode.Convert('GB-IB7 7VN'), '', '', '',
          DemoDataSetup."Country/Region Code", '197548769', '', '', XManchesterBusinessPark, '');
        UpdateContact('40000', XTobyRhode);
        InsertData(
          '50000', XNodPublishers, "X2-4WaterlooPlace", CreatePostCode.Convert('GB-WD2 4RG'), '', '', '',
          DemoDataSetup."Country/Region Code", '295267495', '', '', XWaverlyGate, '');
