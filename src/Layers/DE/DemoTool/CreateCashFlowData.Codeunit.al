codeunit 101029 "Create Cash Flow Data"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            CreateCFAccount_andGL('1060', XBuildingOccupancyCosts, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, CreateGLAccFilter('998110', '998130'))
        else
            CreateCFAccount_andGL('1060', XBuildingOccupancyCosts, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, CreateGLAccFilter(CreateGLAccount.Incomefromsecurities(), CreateGLAccount.InterestIncome()));
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            CreateCFAccount_andGL('1110', XOtherExpenses, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, StrSubstNo('%1|%2', CreateGLAccFilter('998410', '998430'), MakeAdjustments.Convert('998450')))
        else
            CreateCFAccount_andGL('1110', XOtherExpenses, CFAccount."Account Type"::Entry, 3, '', CFAccount."Source Type"::"G/L Budget", CFAccount."G/L Integration"::Budget, CreateGLAccFilter(CreateGLAccount.Samplescontestsgifts(), CreateGLAccount.TravelExpenses()));
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
            CreateCFAccount_andGL('2100', XCashFlowFunds, CFAccount."Account Type"::Entry, 1, '', CFAccount."Source Type"::"Liquid Funds", CFAccount."G/L Integration"::Balance, CreateGLAccFilter('992940', '992910'))
        else
            CreateCFAccount_andGL('2100', XCashFlowFunds, CFAccount."Account Type"::Entry, 1, '', CFAccount."Source Type"::"Liquid Funds", CFAccount."G/L Integration"::Balance, CreateGLAccFilter(CreateGLAccount.CashandBank(), CreateGLAccount.PettyCash()));
