        ...
        case DemoDataSetup."Company Type" of
            DemoDataSetup."Company Type"::VAT:
                begin
                    ...
                    InsertData(DemoDataSetup.DomesticCode(), 'EUST', 100, 2, 'S');
            ...
            case VATPostingSetup."VAT Prod. Posting Group" of
                DemoDataSetup.GoodsVATCode():
                    if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                        if VATPostingSetup."VAT Calculation Type" = VATPostingSetup."VAT Calculation Type"::"Reverse Charge VAT" then
                            SetAccounts(VATPostingSetup, '995610', '995625', '995620', '995615', '995635', '995625')
                        else
                ...
                DemoDataSetup.NoVATCode():
                    if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                        ...
                        SetAccounts(VATPostingSetup, CreateGLAccount.MiscVATPayable(), CreateGLAccount.MiscVATReceivables(), CreateGLAccount.MiscVATPayable(), '', '', '');
                'EUST':
                    if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then
                        VATPostingSetup.Validate("Purchase VAT Account", CA.Convert('995629'));
            end;
