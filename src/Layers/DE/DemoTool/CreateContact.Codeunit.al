codeunit 101550 "Create Contact"
{
    ...
    begin
        ...
        DemoDataSetup.Get();
        InsertData(XCT100239, XCaneShowroom, XRingwoodRoad, XS, '', XDEU, XHR, XDE, 'GB-M61 2YG',
          0, XCT100239, '', '', '', 0);
        InsertData(XCT100240, XLordshipLaneFurnishers, X457LordshipLane, XMID, '', XDEU, XLT, XDE, 'GB-NP5 6GH',
          0, XCT100240, '', '', '', 0);
        InsertData(XCT100241, XTimelessReproductions, X28TheTything, XN, '', XDEU, XHR, XDE, 'GB-OX16 0UA',
          0, XCT100241, '', '', '', 0);
        InsertData(XCT100242, XWyllieANDMar, XHighStreetRipley, XW, '', XDEU, XJO, XDE, 'GB-PO21 6HG',
          0, XCT100242, '', '', '', 0);
        InsertData(XCT100243, XCompohandlerLtd, XCarmunnockByPassBusby, XW, '', XDEU, XRB, XDE, 'GB-TQ17 8HB',
          0, XCT100243, '', '', '', 0);
        ...
        InsertData(XCT100019, 'WoodImex Ltd', 'Strandvejen 334', DemoDataSetup.ForeignCode(), 'DKK', 'DAN', XBC, 'DK', 'DK-2950',
          0, XCT100019, '', '', '', 0);
        InsertData(XCT100120, 'Patrick Sands', '340 Marlboro Drive', DemoDataSetup.ForeignCode(), 'USD', 'ENU', XEH, 'US', 'US-GA 31772',
          1, XCT100014, XM, '', '', 0);
        InsertData(XCT100121, 'Sussie Leth', 'Strandvejen 334', DemoDataSetup.ForeignCode(), 'DKK', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XFMAR, '', '', 0);
        InsertData(XCT100122, 'Michael Graff', 'Süderweg 15', XN, '', 'DEU', XRB, 'DE', 'DE-20097',
        ...
        InsertData(XCT100124, XAdamBarr, X457LordshipLane, DemoDataSetup.ForeignCode(), '', XENG, XLT, XGB, 'GB-NP5 6GH',
          1, XCT100240, XM, '', '', 0);
        InsertData(XCT100125, XAndrewLan, XRingwoodRoad, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-M61 2YG',
          1, XCT100239, XM, '', '', 0);
        InsertData(XCT100126, XTracyTallman, XCarmunnockByPassBusby, XSE, '', XENG, XRB, XGB, 'GB-TQ17 8HB',
          1, XCT100243, XFMAR, '', '', 0);
        InsertData(XCT100127, XBarbaraMoreland, XCarmunnockByPassBusby, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-TQ17 8HB',
          1, XCT100243, XFMAR, '', '', 0);
        InsertData(XCT100128, XMarkHarrington, X10NorthLakeAvenue, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-N12 5XY',
          1, ContactNo(DATABASE::Vendor, '10000'), XM, '', '', 0);
        InsertData(XCT100129, 'Stephanie Conroy', 'Tower Road', XN, '', 'ENG', XHR, 'GB', 'GB-TA3 4FD',
          1, XCT100245, XFMAR, '', '', 0);
        InsertData(XCT100130, 'Brannon Jones', '92-94 West St Bedminster', DemoDataSetup.ForeignCode(), '', 'ENG', XHR, 'GB', 'GB-SA1 2HS',
          1, XCT100244, XM, '', '', 0);
        InsertData(XCT100131, 'Kevin F. Browne', '210 Bimer Drive', DemoDataSetup.ForeignCode(), '', 'ENG', XOF, 'GB', 'GB-PL14 5GB',
          1, XCT100013, XM, '', '', 0);
        ...
        InsertData(XCT100133, 'Tony Madigan', 'Orkestergatan 24', DemoDataSetup.ForeignCode(), '', 'SVE', XRB, 'SE', 'SE-415 06',
          1, XCT100018, XM, '', '', 0);
        InsertData(XCT100134, XJuliaMoseley, XHighStreetRipley, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-PO21 6HG',
          1, XCT100242, XFMAR, '', '', 0);
        ...
        InsertData(XCT100142, XSusanWEaton, XHighStreetRipley, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-PO21 6HG',
          1, XCT100242, XFMAR, '', '', 0);
        ...
        InsertData(XCT100147, XJohnEvans, X457LordshipLane, DemoDataSetup.ForeignCode(), '', XENG, XLT, XGB, 'GB-NP5 6GH',
          1, XCT100240, XM, '', '', 0);
        ...
        InsertData(XCT100161, 'Jose Ignacio Peiro Alba', 'c/ Neptuno 18', DemoDataSetup.ForeignCode(), '', 'ESP', XRB, 'ES', 'ES-37001',
          1, ContactNo(DATABASE::Vendor, '34151086'), XM, '', '', 0);
        InsertData(XCT100162, XJulieTaftRider, X172FieldGreen, DemoDataSetup.ForeignCode(), '', XENG, XRB, XGB, 'GB-WD2 4RG',
        ...
        InsertData(XCT100169, 'Birgit Seidl', 'Süderweg 15', XN, '', 'DEU', XRB, 'DE', 'DE-20097',
        ...
        InsertData(XCT100176, XSamanthaSmith, X457LordshipLane, DemoDataSetup.ForeignCode(), '', XENG, XLT, XGB, 'GB-NP5 6GH',
          1, XCT100240, XFMAR, '', '', 0);
        ...
        InsertData(XCT100186, 'Mary Baker', '210 Bimer Drive', XNW, '', 'ENG', XOF, 'GB', 'GB-PL14 5GB',
          1, XCT100013, XFMAR, '', '', 0);
        InsertData(XCT100187, XScottBishop, XRingwoodRoad, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-M61 2YG',
          1, XCT100239, XM, '', '', 0);
        InsertData(XCT100188, XJaneClayton, XRingwoodRoad, DemoDataSetup.ForeignCode(), '', XENG, XHR, XGB, 'GB-M61 2YG',
          1, XCT100239, XFMAR, '', '', 0);
        ...
        InsertData(XCT100197, 'Amy E. Alberts', '854 Theater Road', XNE, '', 'ENG', XEH, 'GB', 'GB-WD1 6YG',
          1, XCT100017, XF, '', '', 0);
        InsertData(XCT100198, 'Cornelia Weiler', 'Plett Straße 187', XMID, '', 'DEU', XOF, 'DE', 'DE-60320',
        ...
        InsertData(XCT100200, 'Jan Miksovsky', 'Immermannstraße 92', XS, '', 'DEU', XRB, 'DE', 'DE-86899',
        ...
        InsertData(XCT100225, 'Linda Meisner', 'Süderweg 15', XN, '', 'DEU', XRB, 'DE', 'DE-20097',
        ...
        InsertData(XCT100231, 'Marianne Wier', 'Immermannstraße 92', XS, '', 'DEU', XRB, 'DE', 'DE-86899',
        ...
        InsertData(XCT200004, 'Jay Jamison', '340 Marlboro Drive', DemoDataSetup.ForeignCode(), '', 'ENU', XEH, 'US', 'US-GA 31772',
          1, XCT100014, XFMAR, '', '', 0);
        InsertData(XCT200005, 'Tom Getzinger', 'Süderweg 15', XN, '', 'DEU', XRB, 'DE', 'DE-20097',
        ...
        InsertData(XCT200036, 'Daniel Weisman', 'Strandvejen 334', DemoDataSetup.ForeignCode(), '', 'DAN', XBC, 'DK', 'DK-2950',
          1, XCT100019, XM, '', '', 0);
        InsertData(XCT200037, XJonathanMollerup, XHighStreetRipley, DemoDataSetup.ForeignCode(), '', XENG, XJO, XGB, 'GB-PO21 6HG',
    ...
    begin
        ...
        FrCharacters := ' "&(),./:;<=>?@[\]^_`~‘’àáâãäåæéêëìíîïðñòöõôóøùúûüý';
        ToCharacters := '.                       aaaaaaaeeeiiiidnoooooouuuuy';
