codeunit 101803 "Create FA Posting Group"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            ...
            InsertData(XPLANT, CreateGLAccount.Building(), CreateGLAccount.Building(), CreateGLAccount.Building(), CreateGLAccount.Building(), CreateGLAccount.Building(), CreateGLAccount.Building(), CreateGLAccount.DepreciationFixedAssets(), CreateGLAccount.DepreciationFixedAssets(), CreateGLAccount.DepreciationFixedAssets());
            InsertData(XPROPERTY, CreateGLAccount.Land(), CreateGLAccount.Land(), CreateGLAccount.Land(), CreateGLAccount.Land(), CreateGLAccount.Land(), CreateGLAccount.Land(), CreateGLAccount.DepreciationFixedAssets(), CreateGLAccount.DepreciationFixedAssets(), CreateGLAccount.DepreciationFixedAssets());
