codeunit 110000 "Interface Basis Data"
{
    ...
    begin
        ...
        // RunCodeunit(CODEUNIT::"Create Intrastat Report Selec.");
        ...
        RunCodeunit(CODEUNIT::"Create Acc. Sched. Name SKR03");
        RunCodeunit(CODEUNIT::"Create Acc. Schedule Line");
        RunCodeunit(CODEUNIT::"Create Acc. Sched. Line SKR03");
        ...
        // RunCodeunit(CODEUNIT::"Create VAT Report Selec.");
        ...
        RunCodeunit(CODEUNIT::"Create Transaction Specifi.");
        ...
        RunCodeunit(CODEUNIT::"Create Delivery Reminders");
