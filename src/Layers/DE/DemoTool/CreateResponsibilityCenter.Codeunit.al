codeunit 118020 "Create Responsibility Center"
{
    ...
    begin
        Resp.DeleteAll();
        InsertData(XBIRMINGHAM, XCRONUSBirminghamRC, XMainStreet14, CreatePostCode.Convert('GB-B27 4KT'), '+49-161 818192', '+49-161 818100', XAaronNicholls, XBLUE);
        InsertData(XLONDON, XCRONUSLondonRC, XKensingtonStreet22, CreatePostCode.Convert('GB-N12 5XY'), '+49-999 154642', '+49-999 154625', XJackSRichins, '');
