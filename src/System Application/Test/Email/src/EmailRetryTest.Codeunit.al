...
codeunit 134703 "Email Retry Test"
{
    ...
    begin
        ...
        EmailOutbox := SetupEmailOutbox(EmailMessage.GetId(), Enum::"Email Connector"::"Test Email Connector", TempAccount."Account Id", 'Test Subject1', TempAccount."Email Address", UserSecurityId(), Enum::"Email Status"::Processing, 0);
    ...
    begin
        ...
        CreateEmailMessageAndEmailOutboxRecord(11, TempAccount);
    ...
    begin
        ...
        CreateEmailMessageAndEmailOutboxRecord(12, TempAccount);
