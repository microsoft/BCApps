...
codeunit 135074 "AppSource Gallery Test"
{
    ...
    begin
        // Given
        AddToFormatRegionStore('da-DK');
        AppSourceProductManager.InitDependencies(AppSourceDependencyProvider);
    ...
    /*
        ...
        begin
            ...
            AppSourceProductManagerTSetUserSettingsProvider;
    ...
    begin
        AppSourceDependencyProvider.SetFormatRegionOrDefault(FormatRegion);
    ...
    var
        AppSourceDependencyProvider: Codeunit "Test Dependency Provider";
    begin
        AppSourceDependencyProvider.InitDefaults();
        AppSourceProductManager.InitDependencies(AppSourceDependencyProvider);
    end;
