...
//sing System.Apps.AppSource;
using System.TestLibraries.Utilities;

codeunit 135075 "AppSource Product Manager Test"
{
    Subtype = Test;
    ...
    var
        AppSourceGalleryTestLibrary: Codeunit "AppSource Gallery Test Library";
        UniqueId: Text;
        AppId: Text;
    begin
        // Given
        ...
        // When 
        AppId := AppSourceGalleryTestLibrary.ExtractAppIDFromUniqueProductID(UniqueId);

        // Then
        LibraryAssert.AreEqual('0984da34-5ec1-4ac1-9575-b73fb2212327', AppId, 'Expected AppId to be extracted from UniqueId');
    end;
    ...
    begin
        ...
        // Then
        LibraryAssert.AreEqual('', AppId, 'Expected AppId to be empty when not present in the UniqueId');
    end;
    ...
    /*
        ...
        begin
            ...
            AppSourceGalleryTestLibrary.Initialize();
            // Override dependencies
            AppSourceGalleryTestLibrary.SetDependencies(AppSourceGalleryTestLibrary);

            // Given
            AppSourceGalleryTestLibrary.AddToFormatRegionStore('da-DK');
            ...
            AppSourceGalleryTestLibrary.EnqueueHyperLink();

            // When 
            AppSourceGalleryTestLibrary.OpenAppSource();

            // Then
            // Asserted in handler
            AppSourceGalleryTestLibrary.AssertCleanedUp();
            AssertCleanedUp();
        end;
        ...
        begin
            ...
            // Given
            AppSourceGalleryTestLibrary.AddToUserSettingsLanguageIDStore(3082); //es-ES
            ...
            // When 
            AppSourceGalleryTestLibrary.OpenAppInAppSource(UniqueId);
        ...
        begin
            ...
            // Then
            LibraryAssert.AreEqual(TempProduct.Count, 1, 'The number of products is incorrect.');
            LibraryAssert.AreEqual('Dynamics 365 Business Central', TempProduct.DisplayName, 'The product name is incorrect.');
            AppSourceProductManagerTest.AssertCleanedUp();
            AssertCleanedUp();
        end;
        ...
        begin
            ...
            // Then
            LibraryAssert.AreEqual(2, TempProduct.Count, 'The number of products is incorrect.');
            TempProduct.FindSet();
            LibraryAssert.AreEqual('Dynamics 365 Business Central - First', TempProduct.DisplayName, 'The first product name is incorrect.');
            TempProduct.Next();
            LibraryAssert.AreEqual('Dynamics 365 Business Central - Second', TempProduct.DisplayName, 'The second product name is incorrect.');
