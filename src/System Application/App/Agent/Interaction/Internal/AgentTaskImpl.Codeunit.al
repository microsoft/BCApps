...
codeunit 4300 "Agent Task Impl."
{
    ...
    procedure CreateTask(AgentUserSecurityID: Guid; TaskTitle: Text[150]; ExternalID: Text[2048]; BillingType: Enum "AgentTaskBillingType"; var NewAgentTask: Record "Agent Task")
    begin
