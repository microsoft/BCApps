...
codeunit 7800 "Azure Functions Authentication"
{
    ...
    /// <returns>Instance of Azure function response object.</returns>
    [NonDebuggable]
    procedure CreateOAuth2WithCert(Endpoint: Text; AuthenticationCode: Text; ClientId: Text; Cert: SecretText; OAuthAuthorityUrl: Text; Scope: Text; ResourceURL: Text): Interface "Azure Functions Authentication"
    var
