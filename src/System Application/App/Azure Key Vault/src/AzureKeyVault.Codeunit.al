...
codeunit 2200 "Azure Key Vault"
{
    ...
    begin
        ...
        AzureKeyVaultImpl.GetAzureKeyVaultSecret(SecretName, Secret, CallerModuleInfo);
    end;
    ...
    begin
        NavApp.GetCallerModuleInfo(CallerModuleInfo);
        AzureKeyVaultImpl.GetAzureKeyVaultCertificate(CertificateName, Certificate, CallerModuleInfo);
    end;
