...
An in-depth architecture overview of the Graph module (layering, data model, request flow, design patterns, REST-vs-Graph comparison) is in the [Architecture section](#sharepoint-graph-api-module--architecture) at the end of this document.
