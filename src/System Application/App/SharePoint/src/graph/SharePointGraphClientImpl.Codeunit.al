...
codeunit 9120 "SharePoint Graph Client Impl."
{
    ...
    begin
        ...
        if ListId = '' then begin
            SharePointGraphResponse.SetError(InvalidListIdErr);
            Session.LogMessage('0000UKB', InvalidListIdErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;

        if ItemId = '' then begin
            SharePointGraphResponse.SetError(InvalidItemIdErr);
            Session.LogMessage('0000UKC', InvalidItemIdErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
        ...
        if not SharePointGraphParser.ParseListItemDetail(JsonResponse, GraphListItem) then begin
            ...
            Session.LogMessage('0000UKF', FailedToParseListItemErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
        ...
        SharePointGraphResponse.SetSuccess();
        Session.LogMessage('0000UKG', StrSubstNo(OperationSuccessTelemetryMsg, 'GetListItem'), Verbosity::Normal, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
        exit(SharePointGraphResponse);
    end;
    ...
    begin
        ...
        if ListId = '' then begin
            SharePointGraphResponse.SetError(InvalidListIdErr);
            Session.LogMessage('0000UKH', InvalidListIdErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;

        if ItemId = '' then begin
            SharePointGraphResponse.SetError(InvalidItemIdErr);
            Session.LogMessage('0000UKI', InvalidItemIdErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;

        if FieldsJsonObject.Keys().Count() = 0 then begin
            SharePointGraphResponse.SetError(InvalidFieldsErr);
            Session.LogMessage('0000UKJ', InvalidFieldsErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
        ...
        if not SharePointGraphRequestHelper.Patch(SharePointGraphUriBuilder.GetUpdateListItemFieldsEndpoint(ListId, ItemId), FieldsJsonObject, JsonResponse) then begin
            ...
            SharePointGraphResponse.SetError(ErrorMessage);
            Session.LogMessage('0000UKL', ErrorMessage, Verbosity::Error, DataClassification::CustomerContent, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
    ...
    begin
        ...
        if NewName = '' then begin
            ...
            Session.LogMessage('0000UKU', InvalidNewNameErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
    ...
    begin
        ...
        if NewName = '' then begin
            SharePointGraphResponse.SetRequestHelper(SharePointGraphRequestHelper);
            SharePointGraphResponse.SetError(InvalidNewNameErr);
            Session.LogMessage('0000UKV', InvalidNewNameErr, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', GraphSharePointCategoryLbl);
            exit(SharePointGraphResponse);
        end;
