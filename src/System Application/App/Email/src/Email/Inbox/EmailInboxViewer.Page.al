...
page 81 "Email Inbox Viewer"
{
    ...
    begin
        EmailMessageImpl.Get(Rec."Message Id");

        FromDisplayName := StrSubstNo(FromDisplayNameLbl, Rec."Sender Name", Rec."Sender Address");
    ...
    var
        ...
        PageCaptionTxt: Label 'Email Inbox';
}
