...
codeunit 8904 "Email Message"
{
    ...
    /// <param name="ContentId">The Content ID of the inline attachment.</param>
    ...
    begin
        EmailMessageImpl.AddAttachment(AttachmentName, ContentType, AttachmentBase64, InLine, ContentId);
    end;
