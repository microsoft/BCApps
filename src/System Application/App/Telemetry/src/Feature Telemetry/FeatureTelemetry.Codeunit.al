...
codeunit 8703 "Feature Telemetry"
{
        ...
        case ALTelemetryScope of
            Enum::"AL Telemetry Scope"::All:
                begin
                    ...
                    FeatureTelemetryImpl.LogUsage(EventId, FeatureName, EventName, CustomDimensions, CallerModuleInfo, CallerCallStackModuleInfos);
                end;
            else
                FeatureTelemetryImpl.LogUsage(EventId, FeatureName, EventName, CustomDimensions, CallerModuleInfo);
        end;
    ...
    begin
        NavApp.GetCallerModuleInfo(CallerModuleInfo);
        FeatureTelemetryImpl.LogUptake(EventId, FeatureName, FeatureUptakeStatus, false, DummyCustomDimensions, CallerModuleInfo);
    end;
    ...
    begin
        NavApp.GetCallerModuleInfo(CallerModuleInfo);
        FeatureTelemetryImpl.LogUptake(EventId, FeatureName, FeatureUptakeStatus, false, CustomDimensions, CallerModuleInfo);
    end;
