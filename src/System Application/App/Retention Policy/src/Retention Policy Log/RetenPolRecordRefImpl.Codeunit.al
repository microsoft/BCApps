...
/// </summary>
codeunit 3920 "Reten. Pol. Record Ref. Impl." implements "Record Reference"
{
    Access = Internal;
    ...
    var
        RetenPolRecordRefImpl: Codeunit "Reten. Pol. Record Ref. Impl.";
    begin
        ...
        if RecordRef.Number = Database::"Retention Policy Log Entry" then begin
            RecordReference := RetenPolRecordRefImpl;
            RetenPolRecordRefImpl.SetInitializedCalledModuleId(CallerModuleInfo.Id);
            IsInitialized := true;
        end;
    end;
