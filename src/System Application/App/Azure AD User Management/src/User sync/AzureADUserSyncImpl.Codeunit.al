...
codeunit 9029 "Azure AD User Sync Impl."
{
    ...
    var
        ...
        FailedToUserUpdateTxt: Label 'Failed to update for user security ID [%1] with authentication object ID [%2]. Blank Guids indicate users not present in BC. [%3]', Comment = '%1 = user security ID (guid); %2 = authentication object ID (guid); %3 = ErrorCallStack', Locked = true;
