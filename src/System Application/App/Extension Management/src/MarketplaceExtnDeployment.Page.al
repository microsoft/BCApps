...
page 2510 "Marketplace Extn Deployment"
{
    ...
    var
        ...
        ImportantDisclaimerLbl: Label 'When installing a Marketplace app, it may require additional apps to be installed as dependencies. Make sure to review the provider''s terms of use and privacy policy review before proceeding. For more information on installing and uninstalling apps, see the link below.';
