...
codeunit 7760 "Copilot Capability Install"
{
    ...
    var
        ...
        DraftFlowsLearnMoreLbl: Label 'https://go.microsoft.com/fwlink/?linkid=2252769', Locked = true;
    ...
    begin
        ...
        RegisterSaaSCapability(Enum::"Copilot Capability"::"Draft Flows", Enum::"Copilot Availability"::Preview, DraftFlowsLearnMoreLbl);
    end;
