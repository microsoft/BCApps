        ...
        area(Content)
        {
            group(Deactivate)
            {
                ...
                field(DeactivateReason; DeactivateOption)
                {
                    ...
                    OptionCaption = ',Not relevant to our business,Users are not ready for it yet,Performance is not good enough,There are privacy concerns,Suggestions not accurate enough,Suggestions are not helpful,Suggestions are offensive or inappropriate,Doesn''t work with my customizations,Prefer not to give a reason,Our reason is not listed here';
                }
            }
        }
    }
