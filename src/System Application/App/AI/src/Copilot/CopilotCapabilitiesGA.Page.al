        ...
        area(Processing)
        {
            action(Activate)
            {
                ...
                begin
                    ...
                    Session.LogAuditMessage(StrSubstNo(CopilotFeatureActivatedLbl, Rec.Capability, Rec."App Id", UserSecurityId()), SecurityOperationResult::Success, AuditCategory::ApplicationManagement, 5, 0);
                end;
            }
            action(Deactivate)
            {
