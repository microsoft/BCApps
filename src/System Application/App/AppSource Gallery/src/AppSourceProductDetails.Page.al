...
page 2516 "AppSource Product Details"
{
    ...
    var
        ...
        InstallNewAppWarningLbl: Label 'You are installing a new AppSource app.\If this is a Contact Me app, please ensure that you have contacted the publisher before proceeding to ensure you have the proper licensing, guidance and app dependencies in place. If this is a transactable plan, you will need to have purchased appropriate licenses on the online AppSource Marketplace to be able to use the app.\Do you want to continue with the installation?';
    ...
    begin
        ...
        CurrentRecordCanBeInstalled := (AppID <> '') and (not CurrentRecordCanBeUninstalled);
    end;
