...
//     procedure SetDependencies(AppSourceGalleryTestLibrary: Codeunit "AppSource Gallery Test Library")
//     begin
//         Dependencies := AppSourceGalleryTestLibrary;
//     end;
...
//         //Hyperlink(StrSubstNo(AppSourceListingUriLbl, 'en', UniqueProductIDValue));
//     end;
