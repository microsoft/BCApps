...
codeunit 396 NoSeriesManagement
{
...
#if not CLEAN24
    [Obsolete('Please use procedure TestManual(NoSeriesCode: Code[20]) in codeunit "No. Series" instead.', '24.0')]
    ...
    [Obsolete('Please use procedure IsManual(NoSeriesCode: Code[20]) in codeunit "No. Series" instead.', '24.0')]
    ...
    [Obsolete('Please use procedure TestManual(NoSeriesCode: Code[20]; DocumentNo: Code[20]) in codeunit "No. Series" instead.', '24.0')]
